...
lb_r_void_0p lb_window_10mac_cursor(uint8_t lb_cursor) {
    ...
    } _lb_r11.value; })); void* _lb_sq12 __attribute__((unused)) = lb_window_sel(lb_name); lb_c_window_7msg_ptr(_lb_sq10, _lb_sq12); }); if (_lb_o9 == ((void*)0)) {
...
lb_r_unit lb_window_14mac_set_cursor(struct lb_window_State* lb_state, uint8_t lb_cursor) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/window/macos/cursor.lucb:17:5";
    if (!!(((!((lb_state)->native_cursor == ((void*)0))) && ((lb_state)->cursor == lb_cursor)))) 
    {
        lb_pos = "src/std/window/macos/cursor.lucb:17:5";
        return ((lb_r_unit){ .failed = false });
    }
    lb_pos = "src/std/window/macos/cursor.lucb:18:5";
    ...
    lb_pos = "src/std/window/macos/cursor.lucb:19:5";
    lb_pos = "src/std/window/macos/cursor.lucb:20:5";
    if (!!((((lb_state)->native_cursor == ((void*)0)) || (!((lb_state)->cursor == lb_cursor))))) 
    {
        lb_pos = "src/std/window/macos/cursor.lucb:21:9";
        (lb_state)->native_cursor = (({ lb_r_void_0p _lb_r14 = lb_window_10mac_cursor(lb_cursor); if (_lb_r14.failed) {
            (void)(lb_x_window_23objc_autoreleasePoolPop(lb_pool));
            return ((lb_r_unit){ .error = _lb_r14.error, .failed = true });
        } _lb_r14.value; }));
        lb_pos = "src/std/window/macos/cursor.lucb:22:9";
        (lb_state)->cursor = lb_cursor;
    }
    lb_pos = "src/std/window/macos/cursor.lucb:23:5";
    if (!!(((((lb_state)->pointer_inside || (lb_state)->primary_down)) && ({ void* _lb_sq15 __attribute__((unused)) = lb_window_required((lb_state)->native); void* _lb_sq16 __attribute__((unused)) = lb_window_sel("isKeyWindow"); lb_c_window_8msg_bool(_lb_sq15, _lb_sq16); })))) 
    {
        lb_pos = "src/std/window/macos/cursor.lucb:24:9";
        (void)(({ void* _lb_sq17 __attribute__((unused)) = lb_window_required((lb_state)->native_cursor); void* _lb_sq18 __attribute__((unused)) = lb_window_sel("set"); lb_c_window_8msg_void(_lb_sq17, _lb_sq18); }));
    }
    (void)(lb_x_window_23objc_autoreleasePoolPop(lb_pool));
    return ((lb_r_unit){ .failed = false });
}
void lb_window_15cursor_callback(void* lb_object, void* lb_selector, void* lb_event) {
    ...
    struct lb_window_State* lb_state __attribute__((unused)) = ({ struct lb_window_State* _lb_o19 = lb_window_9get_state(lb_object); if (_lb_o19 == ((void*)0)) {
        return;
    } _lb_o19; });
    lb_pos = "src/std/window/macos/cursor.lucb:28:5";
    void* lb_cursor __attribute__((unused)) = ({ void* _lb_o20 = (lb_state)->native_cursor; if (_lb_o20 == ((void*)0)) {
        return;
    } _lb_o20; });
    lb_pos = "src/std/window/macos/cursor.lucb:29:5";
    (void)(({ void* _lb_sq21 __attribute__((unused)) = lb_cursor; void* _lb_sq22 __attribute__((unused)) = lb_window_sel("set"); lb_c_window_8msg_void(_lb_sq21, _lb_sq22); }));
}
__attribute__((weak)) void lb_interop_Packet_0g1_str_init(lb_interop_Packet_0g1_str* self, lb_str lb_value, void* lb_storage, lb_fn_0F1_void_0p_unit lb_dispose) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
