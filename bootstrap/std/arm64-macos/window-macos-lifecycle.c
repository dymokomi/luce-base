...
typedef struct lb_a_5c_str_0a3 { char* d[3]; } lb_a_5c_str_0a3;
typedef struct lb_a_5c_str_0a13 { char* d[13]; } lb_a_5c_str_0a13;
...
LB_RES(lb_window_Window, lb_r_window_Window);
LB_RES(lb_window_Size, lb_r_window_Size);
LB_RES(uint8_t, lb_r_input_Cursor);
...
lb_r_unit lb_window_14mac_set_cursor(struct lb_window_State* lb_state, uint8_t lb_cursor);
...
void lb_window_21mac_cancel_text_input(struct lb_window_State* lb_state);
lb_r_window_State_0p lb_window_8mac_open(lb_window_Options lb_options);
void lb_window_8mac_show(struct lb_window_State* lb_state);
lb_window_Size lb_window_8mac_size(struct lb_window_State* lb_state);
void lb_window_10mac_resize(struct lb_window_State* lb_state, uint32_t lb_width, uint32_t lb_height);
...
lb_r_unit lb_window_13setup_classes(void);
lb_r_unit lb_window_13finish_launch(void* lb_app);
lb_r_void_0p lb_window_10make_class(char* lb_parent, char* lb_name);
void lb_window_15launch_callback(void* lb_object, void* lb_selector, void* lb_notification);

void* lb_window_10view_class = ((void*)0);
void* lb_window_14delegate_class = ((void*)0);
void* lb_window_application = ((void*)0);
...
__attribute__((weak)) lb_interop_Transfer_0g1_str lb_interop_Transfer_0g1_str_plain(void) {
    ...
    lb_pos = "src/std/window/windows/native.lucb:20:5";
...
lb_r_window_State_0p lb_window_8mac_open(lb_window_Options lb_options) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/window/macos/lifecycle.lucb:45:5";
    ...
    lb_pos = "src/std/window/macos/lifecycle.lucb:46:5";
    lb_pos = "src/std/window/macos/lifecycle.lucb:47:5";
    (void)((({ lb_r_unit _lb_r7 = lb_window_13setup_classes(); if (_lb_r7.failed) {
        (void)(lb_x_window_23objc_autoreleasePoolPop(lb_pool));
        return ((lb_r_window_State_0p){ .error = _lb_r7.error, .failed = true });
    } (void)0; })));
    lb_pos = "src/std/window/macos/lifecycle.lucb:48:5";
    if (!!((lb_window_application == ((void*)0)))) 
    {
        lb_pos = "src/std/window/macos/lifecycle.lucb:49:9";
        ...
        } _lb_r10.value; })); void* _lb_sq11 __attribute__((unused)) = lb_window_sel("sharedApplication"); lb_c_window_7msg_ptr(_lb_sq9, _lb_sq11); }); if (_lb_o8 == ((void*)0)) {
        ...
        lb_pos = "src/std/window/macos/lifecycle.lucb:50:9";
        (void)((({ lb_r_unit _lb_r13 = lb_window_13finish_launch(lb_app); if (_lb_r13.failed) {
            (void)(lb_x_window_23objc_autoreleasePoolPop(lb_pool));
            return ((lb_r_window_State_0p){ .error = _lb_r13.error, .failed = true });
        } (void)0; })));
        lb_pos = "src/std/window/macos/lifecycle.lucb:51:9";
        if (!!((!({ void* _lb_sq14 __attribute__((unused)) = lb_app; void* _lb_sq15 __attribute__((unused)) = lb_window_sel("setActivationPolicy:"); int64_t _lb_sq16 __attribute__((unused)) = 0LL; lb_c_window_10msg_policy(_lb_sq14, _lb_sq15, _lb_sq16); })))) 
        {
        ...
        lb_pos = "src/std/window/macos/lifecycle.lucb:53:9";
        lb_window_application = lb_app;
    }
    lb_pos = "src/std/window/macos/lifecycle.lucb:54:5";
    struct lb_window_State* lb_state __attribute__((unused)) = (({ lb_r_window_State_0p _lb_r18 = ({ lb_iface _lb_a19 = lb_memory_heap; lb_o_u8_0s _lb_ao19 = lb_alloc_call(_lb_a19, sizeof(lb_window_State), _Alignof(lb_window_State)); lb_r_window_State_0p _lb_r19; if (!_lb_ao19.present) { _lb_r19 = ((lb_r_window_State_0p){ .error = { .code = 208273409, .message = (lb_str){"memory.exhausted", 16} }, .failed = true }); } else { lb_window_State* _lb_p19 = (lb_window_State*)_lb_ao19.value.data; *_lb_p19 = ((lb_window_State){}); _lb_r19.value = _lb_p19; _lb_r19.failed = false; } _lb_r19; }); if (_lb_r18.failed) {
        (void)(lb_x_window_23objc_autoreleasePoolPop(lb_pool));
        return ((lb_r_window_State_0p){ .error = _lb_r18.error, .failed = true });
    } _lb_r18.value; }));
    lb_pos = "src/std/window/macos/lifecycle.lucb:55:5";
    lb_pos = "src/std/window/macos/lifecycle.lucb:56:5";
    (lb_state)->native_cursor = (({ lb_r_void_0p _lb_r20 = lb_window_10mac_cursor(((uint8_t)0u)); if (_lb_r20.failed) {
        (void)(lb_window_11mac_destroy(lb_state));
        (void)(lb_x_window_23objc_autoreleasePoolPop(lb_pool));
        return ((lb_r_window_State_0p){ .error = _lb_r20.error, .failed = true });
    } _lb_r20.value; }));
    lb_pos = "src/std/window/macos/lifecycle.lucb:57:5";
    LuceWindowMacRect lb_rect __attribute__((unused)) = ({ LuceWindowMacExtent _lb_sq21 __attribute__((unused)) = ((LuceWindowMacExtent){.width = lb_to_f((uint64_t)(lb_options.width), 0), .height = lb_to_f((uint64_t)(lb_options.height), 0)}); ((LuceWindowMacRect){.size = _lb_sq21}); });
    lb_pos = "src/std/window/macos/lifecycle.lucb:58:5";
    void* lb_allocated __attribute__((unused)) = ({ void* _lb_o22 = ({ void* _lb_sq23 __attribute__((unused)) = (({ lb_r_void_0p _lb_r24 = lb_window_12native_class("NSWindow"); if (_lb_r24.failed) {
        (void)(lb_window_11mac_destroy(lb_state));
        (void)(lb_x_window_23objc_autoreleasePoolPop(lb_pool));
        return ((lb_r_window_State_0p){ .error = _lb_r24.error, .failed = true });
    } _lb_r24.value; })); void* _lb_sq25 __attribute__((unused)) = lb_window_sel("alloc"); lb_c_window_7msg_ptr(_lb_sq23, _lb_sq25); }); if (_lb_o22 == ((void*)0)) {
    ...
    (void)(({ void* _lb_sq35 __attribute__((unused)) = lb_native; void* _lb_sq36 __attribute__((unused)) = lb_window_sel("setReleasedWhenClosed:"); bool _lb_sq37 __attribute__((unused)) = false; lb_c_window_12msg_bool_arg(_lb_sq35, _lb_sq36, _lb_sq37); }));
    lb_pos = "src/std/window/macos/lifecycle.lucb:63:5";
    void* lb_view_allocated __attribute__((unused)) = ({ void* _lb_o38 = ({ void* _lb_sq39 __attribute__((unused)) = lb_window_required(lb_window_10view_class); void* _lb_sq40 __attribute__((unused)) = lb_window_sel("alloc"); lb_c_window_7msg_ptr(_lb_sq39, _lb_sq40); }); if (_lb_o38 == ((void*)0)) {
    ...
    void* lb_view __attribute__((unused)) = ({ void* _lb_o42 = ({ void* _lb_sq43 __attribute__((unused)) = lb_view_allocated; void* _lb_sq44 __attribute__((unused)) = lb_window_sel("initWithFrame:"); LuceWindowMacRect _lb_sq45 __attribute__((unused)) = lb_rect; lb_c_window_13msg_init_view(_lb_sq43, _lb_sq44, _lb_sq45); }); if (_lb_o42 == ((void*)0)) {
    ...
    lb_pos = "src/std/window/macos/lifecycle.lucb:65:5";
    (lb_state)->view = lb_view;
    ...
    (void)(({ void* _lb_sq47 __attribute__((unused)) = lb_native; void* _lb_sq48 __attribute__((unused)) = lb_window_sel("setContentView:"); void* _lb_sq49 __attribute__((unused)) = lb_view; lb_c_window_10msg_object(_lb_sq47, _lb_sq48, _lb_sq49); }));
    ...
    } _lb_r52.value; })); void* _lb_sq53 __attribute__((unused)) = lb_window_sel("alloc"); lb_c_window_7msg_ptr(_lb_sq51, _lb_sq53); }); if (_lb_o50 == ((void*)0)) {
    ...
    void* lb_tracking __attribute__((unused)) = ({ void* _lb_o55 = ({ void* _lb_sq56 __attribute__((unused)) = lb_tracking_allocated; void* _lb_sq57 __attribute__((unused)) = lb_window_sel("initWithRect:options:owner:userInfo:"); LuceWindowMacRect _lb_sq58 __attribute__((unused)) = lb_rect; uint64_t _lb_sq59 __attribute__((unused)) = ((uint64_t)(((uint64_t)(((uint64_t)(((uint64_t)(1ULL | 4ULL)) | 32ULL)) | 512ULL)) | 1024ULL)); void* _lb_sq60 __attribute__((unused)) = lb_view; void* _lb_sq61 __attribute__((unused)) = ((void*)0); lb_c_window_17msg_init_tracking(_lb_sq56, _lb_sq57, _lb_sq58, _lb_sq59, _lb_sq60, _lb_sq61); }); if (_lb_o55 == ((void*)0)) {
    ...
    (void)(({ void* _lb_sq63 __attribute__((unused)) = lb_view; void* _lb_sq64 __attribute__((unused)) = lb_window_sel("addTrackingArea:"); void* _lb_sq65 __attribute__((unused)) = lb_tracking; lb_c_window_10msg_object(_lb_sq63, _lb_sq64, _lb_sq65); }));
    lb_pos = "src/std/window/macos/lifecycle.lucb:73:5";
    (void)(({ void* _lb_sq66 __attribute__((unused)) = lb_tracking; void* _lb_sq67 __attribute__((unused)) = lb_window_sel("release"); lb_c_window_8msg_void(_lb_sq66, _lb_sq67); }));
    lb_pos = "src/std/window/macos/lifecycle.lucb:74:5";
    void* lb_delegate __attribute__((unused)) = ({ void* _lb_o68 = ({ void* _lb_sq69 __attribute__((unused)) = lb_window_required(lb_window_14delegate_class); void* _lb_sq70 __attribute__((unused)) = lb_window_sel("new"); lb_c_window_7msg_ptr(_lb_sq69, _lb_sq70); }); if (_lb_o68 == ((void*)0)) {
    ...
    lb_pos = "src/std/window/macos/lifecycle.lucb:75:5";
    (lb_state)->delegate = lb_delegate;
    ...
    (void)(({ void* _lb_sq72 __attribute__((unused)) = lb_native; void* _lb_sq73 __attribute__((unused)) = lb_window_sel("setDelegate:"); void* _lb_sq74 __attribute__((unused)) = lb_delegate; lb_c_window_10msg_object(_lb_sq72, _lb_sq73, _lb_sq74); }));
    lb_pos = "src/std/window/macos/lifecycle.lucb:78:5";
    (void)(({ void* _lb_sq75 __attribute__((unused)) = lb_native; void* _lb_sq76 __attribute__((unused)) = lb_window_sel("setAcceptsMouseMovedEvents:"); bool _lb_sq77 __attribute__((unused)) = true; lb_c_window_12msg_bool_arg(_lb_sq75, _lb_sq76, _lb_sq77); }));
    lb_pos = "src/std/window/macos/lifecycle.lucb:79:5";
    (void)(((void)(({ void* _lb_sq78 __attribute__((unused)) = lb_native; void* _lb_sq79 __attribute__((unused)) = lb_window_sel("makeFirstResponder:"); void* _lb_sq80 __attribute__((unused)) = lb_view; lb_c_window_15msg_bool_object(_lb_sq78, _lb_sq79, _lb_sq80); }))));
    ...
    } _lb_r83.value; })); void* _lb_sq84 __attribute__((unused)) = lb_window_sel("alloc"); lb_c_window_7msg_ptr(_lb_sq82, _lb_sq84); }); if (_lb_o81 == ((void*)0)) {
    ...
    (void)(({ void* _lb_sq93 __attribute__((unused)) = lb_native; void* _lb_sq94 __attribute__((unused)) = lb_window_sel("setTitle:"); void* _lb_sq95 __attribute__((unused)) = lb_title; lb_c_window_10msg_object(_lb_sq93, _lb_sq94, _lb_sq95); }));
    lb_pos = "src/std/window/macos/lifecycle.lucb:84:5";
    (void)(({ void* _lb_sq96 __attribute__((unused)) = lb_native; void* _lb_sq97 __attribute__((unused)) = lb_window_sel("center"); lb_c_window_8msg_void(_lb_sq96, _lb_sq97); }));
    lb_pos = "src/std/window/macos/lifecycle.lucb:85:5";
    struct lb_window_State* _lb_ret98 = lb_state;
    (void)(({ void* _lb_sq99 __attribute__((unused)) = lb_title; void* _lb_sq100 __attribute__((unused)) = lb_window_sel("release"); lb_c_window_8msg_void(_lb_sq99, _lb_sq100); }));
    (void)(lb_x_window_23objc_autoreleasePoolPop(lb_pool));
    return ((lb_r_window_State_0p){ .value = _lb_ret98, .failed = false });
    (void)(({ void* _lb_sq101 __attribute__((unused)) = lb_title; void* _lb_sq102 __attribute__((unused)) = lb_window_sel("release"); lb_c_window_8msg_void(_lb_sq101, _lb_sq102); }));
    (void)(lb_x_window_23objc_autoreleasePoolPop(lb_pool));
    lb_trap("unreachable");
}
void lb_window_8mac_show(struct lb_window_State* lb_state) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/window/macos/lifecycle.lucb:112:5";
    void* lb_pool __attribute__((unused)) = ({ void* _lb_fr = lb_x_window_24objc_autoreleasePoolPush(); if (!_lb_fr) lb_trap("null_foreign"); _lb_fr; });
    lb_pos = "src/std/window/macos/lifecycle.lucb:113:5";
    lb_pos = "src/std/window/macos/lifecycle.lucb:114:5";
    (void)(({ void* _lb_sq103 __attribute__((unused)) = lb_window_required(lb_window_application); void* _lb_sq104 __attribute__((unused)) = lb_window_sel("activateIgnoringOtherApps:"); bool _lb_sq105 __attribute__((unused)) = true; lb_c_window_12msg_bool_arg(_lb_sq103, _lb_sq104, _lb_sq105); }));
    lb_pos = "src/std/window/macos/lifecycle.lucb:115:5";
    (void)(({ void* _lb_sq106 __attribute__((unused)) = lb_window_required((lb_state)->native); void* _lb_sq107 __attribute__((unused)) = lb_window_sel("makeKeyAndOrderFront:"); void* _lb_sq108 __attribute__((unused)) = ((void*)0); lb_c_window_10msg_object(_lb_sq106, _lb_sq107, _lb_sq108); }));
    (void)(lb_x_window_23objc_autoreleasePoolPop(lb_pool));
}
lb_window_Size lb_window_8mac_size(struct lb_window_State* lb_state) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/window/macos/lifecycle.lucb:118:5";
    void* lb_pool __attribute__((unused)) = ({ void* _lb_fr = lb_x_window_24objc_autoreleasePoolPush(); if (!_lb_fr) lb_trap("null_foreign"); _lb_fr; });
    lb_pos = "src/std/window/macos/lifecycle.lucb:119:5";
    ...
    LuceWindowMacRect lb_bounds __attribute__((unused)) = ({ void* _lb_sq109 __attribute__((unused)) = lb_view; void* _lb_sq110 __attribute__((unused)) = lb_window_sel("bounds"); lb_c_window_8msg_rect(_lb_sq109, _lb_sq110); });
    lb_pos = "src/std/window/macos/lifecycle.lucb:122:5";
    LuceWindowMacRect lb_backing __attribute__((unused)) = ({ void* _lb_sq111 __attribute__((unused)) = lb_view; void* _lb_sq112 __attribute__((unused)) = lb_window_sel("convertRectToBacking:"); LuceWindowMacRect _lb_sq113 __attribute__((unused)) = lb_bounds; lb_c_window_11msg_backing(_lb_sq111, _lb_sq112, _lb_sq113); });
    lb_pos = "src/std/window/macos/lifecycle.lucb:123:5";
    lb_window_Size _lb_ret114 = ({ double _lb_sq115 __attribute__((unused)) = lb_bounds.size.width; double _lb_sq116 __attribute__((unused)) = lb_bounds.size.height; double _lb_sq117 __attribute__((unused)) = lb_backing.size.width; double _lb_sq118 __attribute__((unused)) = lb_backing.size.height; double _lb_sq119 __attribute__((unused)) = ({ void* _lb_sq120 __attribute__((unused)) = lb_window_required((lb_state)->native); void* _lb_sq121 __attribute__((unused)) = lb_window_sel("backingScaleFactor"); lb_c_window_10msg_double(_lb_sq120, _lb_sq121); }); ((lb_window_Size){.width = _lb_sq115, .height = _lb_sq116, .pixel_width = _lb_sq117, .pixel_height = _lb_sq118, .scale = _lb_sq119}); });
    (void)(lb_x_window_23objc_autoreleasePoolPop(lb_pool));
    return _lb_ret114;
    (void)(lb_x_window_23objc_autoreleasePoolPop(lb_pool));
    lb_trap("unreachable");
...
void lb_window_10mac_resize(struct lb_window_State* lb_state, uint32_t lb_width, uint32_t lb_height) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/window/macos/lifecycle.lucb:126:5";
    void* lb_pool __attribute__((unused)) = ({ void* _lb_fr = lb_x_window_24objc_autoreleasePoolPush(); if (!_lb_fr) lb_trap("null_foreign"); _lb_fr; });
    lb_pos = "src/std/window/macos/lifecycle.lucb:127:5";
    lb_pos = "src/std/window/macos/lifecycle.lucb:128:5";
    (void)(({ void* _lb_sq122 __attribute__((unused)) = lb_window_required((lb_state)->native); void* _lb_sq123 __attribute__((unused)) = lb_window_sel("setContentSize:"); LuceWindowMacExtent _lb_sq124 __attribute__((unused)) = ((LuceWindowMacExtent){.width = lb_to_f((uint64_t)(lb_width), 0), .height = lb_to_f((uint64_t)(lb_height), 0)}); lb_c_window_10msg_extent(_lb_sq122, _lb_sq123, _lb_sq124); }));
    (void)(lb_x_window_23objc_autoreleasePoolPop(lb_pool));
}
void lb_window_8mac_pump(struct lb_window_State* lb_waiting) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/window/macos/lifecycle.lucb:131:5";
    void* lb_app __attribute__((unused)) = ({ void* _lb_o125 = lb_window_application; if (_lb_o125 == ((void*)0)) {
        return;
    } _lb_o125; });
    lb_pos = "src/std/window/macos/lifecycle.lucb:132:5";
    void* lb_pool __attribute__((unused)) = ({ void* _lb_fr = lb_x_window_24objc_autoreleasePoolPush(); if (!_lb_fr) lb_trap("null_foreign"); _lb_fr; });
    lb_pos = "src/std/window/macos/lifecycle.lucb:133:5";
    lb_pos = "src/std/window/macos/lifecycle.lucb:134:5";
    void* lb_date_class __attribute__((unused)) = ({ void* _lb_o126 = lb_x_window_13objc_getClass("NSDate"); if (_lb_o126 == ((void*)0)) {
        (void)(lb_trap_text(((lb_str){"AppKit has no NSDate class", 26})));
    } _lb_o126; });
    lb_pos = "src/std/window/macos/lifecycle.lucb:135:5";
    void* lb_past __attribute__((unused)) = lb_window_required(({ void* _lb_sq127 __attribute__((unused)) = lb_date_class; void* _lb_sq128 __attribute__((unused)) = lb_window_sel("distantPast"); lb_c_window_7msg_ptr(_lb_sq127, _lb_sq128); }));
    ...
    for (;;) {
        ...
        if (!((((size_t)(lb_count)) < ((size_t)(256ULL))))) break;
        {
            ...
            void* lb_event __attribute__((unused)) = ({ void* _lb_o129 = ({ void* _lb_sq130 __attribute__((unused)) = lb_app; void* _lb_sq131 __attribute__((unused)) = lb_window_sel("nextEventMatchingMask:untilDate:inMode:dequeue:"); uint64_t _lb_sq132 __attribute__((unused)) = ((uint64_t)lb_not_u((uint64_t)(((uint64_t)lb_conv_s((int64_t)(0LL), 64, 1, 64, 0, 1))), 64)); void* _lb_sq133 __attribute__((unused)) = lb_past; void* _lb_sq134 __attribute__((unused)) = NSDefaultRunLoopMode; bool _lb_sq135 __attribute__((unused)) = true; lb_c_window_8msg_next(_lb_sq130, _lb_sq131, _lb_sq132, _lb_sq133, _lb_sq134, _lb_sq135); }); if (_lb_o129 == ((void*)0)) {
                break;
            } _lb_o129; });
            lb_pos = "src/std/window/macos/lifecycle.lucb:139:9";
            (void)(({ void* _lb_sq136 __attribute__((unused)) = lb_app; void* _lb_sq137 __attribute__((unused)) = lb_window_sel("sendEvent:"); void* _lb_sq138 __attribute__((unused)) = lb_event; lb_c_window_10msg_object(_lb_sq136, _lb_sq137, _lb_sq138); }));
            ...
            lb_pos = "src/std/window/macos/lifecycle.lucb:142:9";
            if (!!((((((size_t)((lb_waiting)->count)) > ((size_t)(0ULL))) || (lb_waiting)->close_requested) || (lb_waiting)->overflowed))) 
            {
                lb_pos = "src/std/window/macos/lifecycle.lucb:143:13";
                break;
            }
        }
    }
    lb_pos = "src/std/window/macos/lifecycle.lucb:144:5";
    (void)(({ void* _lb_sq140 __attribute__((unused)) = lb_app; void* _lb_sq141 __attribute__((unused)) = lb_window_sel("updateWindows"); lb_c_window_8msg_void(_lb_sq140, _lb_sq141); }));
    (void)(lb_x_window_23objc_autoreleasePoolPop(lb_pool));
}
void lb_window_11mac_destroy(struct lb_window_State* lb_state) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/window/macos/lifecycle.lucb:147:5";
    void* lb_pool __attribute__((unused)) = ({ void* _lb_fr = lb_x_window_24objc_autoreleasePoolPush(); if (!_lb_fr) lb_trap("null_foreign"); _lb_fr; });
    lb_pos = "src/std/window/macos/lifecycle.lucb:148:5";
    lb_pos = "src/std/window/macos/lifecycle.lucb:149:5";
    (lb_state)->destroyed = true;
    lb_pos = "src/std/window/macos/lifecycle.lucb:150:5";
    (void)(lb_window_16mac_clear_marked(lb_state));
    lb_pos = "src/std/window/macos/lifecycle.lucb:151:5";
    void* _lb_o142 = (lb_state)->view;
    if (_lb_o142 != ((void*)0)) {
        void* lb_view __attribute__((unused)) = _lb_o142;
        {
            lb_pos = "src/std/window/macos/lifecycle.lucb:152:9";
            (void)(lb_window_9set_state(lb_view, ((void*)0)));
        }
    }
    lb_pos = "src/std/window/macos/lifecycle.lucb:153:5";
    void* _lb_o143 = (lb_state)->delegate;
    if (_lb_o143 != ((void*)0)) {
        void* lb_delegate __attribute__((unused)) = _lb_o143;
        {
            lb_pos = "src/std/window/macos/lifecycle.lucb:154:9";
            (void)(lb_window_9set_state(lb_delegate, ((void*)0)));
        }
    }
    lb_pos = "src/std/window/macos/lifecycle.lucb:155:5";
    void* _lb_o144 = (lb_state)->native;
    if (_lb_o144 != ((void*)0)) {
        void* lb_native __attribute__((unused)) = _lb_o144;
        {
            lb_pos = "src/std/window/macos/lifecycle.lucb:156:9";
            (void)(({ void* _lb_sq145 __attribute__((unused)) = lb_native; void* _lb_sq146 __attribute__((unused)) = lb_window_sel("setDelegate:"); void* _lb_sq147 __attribute__((unused)) = ((void*)0); lb_c_window_10msg_object(_lb_sq145, _lb_sq146, _lb_sq147); }));
            lb_pos = "src/std/window/macos/lifecycle.lucb:157:9";
            (void)(({ void* _lb_sq148 __attribute__((unused)) = lb_native; void* _lb_sq149 __attribute__((unused)) = lb_window_sel("orderOut:"); void* _lb_sq150 __attribute__((unused)) = ((void*)0); lb_c_window_10msg_object(_lb_sq148, _lb_sq149, _lb_sq150); }));
            lb_pos = "src/std/window/macos/lifecycle.lucb:158:9";
            (void)(({ void* _lb_sq151 __attribute__((unused)) = lb_native; void* _lb_sq152 __attribute__((unused)) = lb_window_sel("close"); lb_c_window_8msg_void(_lb_sq151, _lb_sq152); }));
        }
    }
    lb_pos = "src/std/window/macos/lifecycle.lucb:161:5";
    if (!!((!(lb_state)->presentation_held))) 
    {
        lb_pos = "src/std/window/macos/lifecycle.lucb:162:9";
        (void)(lb_window_8mac_free(lb_state));
    }
    (void)(lb_x_window_23objc_autoreleasePoolPop(lb_pool));
}
void lb_window_8mac_free(struct lb_window_State* lb_state) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/window/macos/lifecycle.lucb:165:5";
    void* lb_pool __attribute__((unused)) = ({ void* _lb_fr = lb_x_window_24objc_autoreleasePoolPush(); if (!_lb_fr) lb_trap("null_foreign"); _lb_fr; });
    lb_pos = "src/std/window/macos/lifecycle.lucb:166:5";
    lb_pos = "src/std/window/macos/lifecycle.lucb:167:5";
    void* _lb_o153 = (lb_state)->native;
    if (_lb_o153 != ((void*)0)) {
        void* lb_native __attribute__((unused)) = _lb_o153;
        {
            lb_pos = "src/std/window/macos/lifecycle.lucb:168:9";
            (void)(({ void* _lb_sq154 __attribute__((unused)) = lb_native; void* _lb_sq155 __attribute__((unused)) = lb_window_sel("release"); lb_c_window_8msg_void(_lb_sq154, _lb_sq155); }));
        }
    }
    lb_pos = "src/std/window/macos/lifecycle.lucb:169:5";
    void* _lb_o156 = (lb_state)->view;
    if (_lb_o156 != ((void*)0)) {
        void* lb_view __attribute__((unused)) = _lb_o156;
        {
            lb_pos = "src/std/window/macos/lifecycle.lucb:170:9";
            (void)(({ void* _lb_sq157 __attribute__((unused)) = lb_view; void* _lb_sq158 __attribute__((unused)) = lb_window_sel("release"); lb_c_window_8msg_void(_lb_sq157, _lb_sq158); }));
        }
    }
    lb_pos = "src/std/window/macos/lifecycle.lucb:171:5";
    void* _lb_o159 = (lb_state)->delegate;
    if (_lb_o159 != ((void*)0)) {
        void* lb_delegate __attribute__((unused)) = _lb_o159;
        {
            lb_pos = "src/std/window/macos/lifecycle.lucb:172:9";
            (void)(({ void* _lb_sq160 __attribute__((unused)) = lb_delegate; void* _lb_sq161 __attribute__((unused)) = lb_window_sel("release"); lb_c_window_8msg_void(_lb_sq160, _lb_sq161); }));
        }
    }
...
__attribute__((weak)) void lb_interop_Packet_0g1_str_init(lb_interop_Packet_0g1_str* self, lb_str lb_value, void* lb_storage, lb_fn_0F1_void_0p_unit lb_dispose) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/window/windows/native.lucb:4:1";
    self->value = lb_value;
    lb_pos = "src/std/window/windows/native.lucb:5:5";
...
__attribute__((weak)) void lb_interop_Packet_0g1_str_release(const lb_interop_Packet_0g1_str* self) {
    ...
    void* _lb_o162 = self->storage;
    if (_lb_o162 != ((void*)0)) {
        void* lb_storage __attribute__((unused)) = _lb_o162;
        {
            lb_pos = "src/std/window/windows/native.lucb:10:5";
            (void)(((({ lb_fn_0F1_void_0p_unit _lb_o163 = self->dispose; if (_lb_o163 == ((void*)0)) {
...
__attribute__((weak)) void lb_interop_Packet_0g1_u8_0c_release(const lb_interop_Packet_0g1_u8_0c* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/window/windows/native.lucb:9:5";
    void* _lb_o164 = self->storage;
    if (_lb_o164 != ((void*)0)) {
        void* lb_storage __attribute__((unused)) = _lb_o164;
        {
            lb_pos = "src/std/window/windows/native.lucb:10:5";
            (void)(((({ lb_fn_0F1_void_0p_unit _lb_o165 = self->dispose; if (_lb_o165 == ((void*)0)) {
                (void)(lb_trap_text(((lb_str){"a packet has storage without a disposer", 39})));
            } _lb_o165; })))(lb_storage));
        }
    }
...
lb_r_unit lb_window_13setup_classes(void) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/window/macos/lifecycle.lucb:17:5";
    if (!!((lb_window_14delegate_class == ((void*)0)))) 
    {
        lb_pos = "src/std/window/macos/lifecycle.lucb:18:9";
        void* lb_native_type __attribute__((unused)) = (({ lb_r_void_0p _lb_r166 = lb_window_10make_class("NSObject", "LuceBaseWindowDelegateV1"); if (_lb_r166.failed) {
            return ((lb_r_unit){ .error = _lb_r166.error, .failed = true });
        } _lb_r166.value; }));
        lb_pos = "src/std/window/macos/lifecycle.lucb:19:9";
        lb_pos = "src/std/window/macos/lifecycle.lucb:20:9";
        (void)((({ lb_r_unit _lb_r167 = lb_window_10add_method(lb_native_type, "windowShouldClose:", ((void*)(lb_window_14close_callback)), "B@:@"); if (_lb_r167.failed) {
            (void)(lb_x_window_21objc_disposeClassPair(lb_native_type));
            return ((lb_r_unit){ .error = _lb_r167.error, .failed = true });
        } (void)0; })));
        lb_pos = "src/std/window/macos/lifecycle.lucb:21:9";
        (void)((({ lb_r_unit _lb_r168 = lb_window_10add_method(lb_native_type, "windowDidResize:", ((void*)(lb_window_15resize_callback)), "v@:@"); if (_lb_r168.failed) {
            (void)(lb_x_window_21objc_disposeClassPair(lb_native_type));
            return ((lb_r_unit){ .error = _lb_r168.error, .failed = true });
        } (void)0; })));
        lb_pos = "src/std/window/macos/lifecycle.lucb:22:9";
        (void)((({ lb_r_unit _lb_r169 = lb_window_10add_method(lb_native_type, "windowDidChangeBackingProperties:", ((void*)(lb_window_15resize_callback)), "v@:@"); if (_lb_r169.failed) {
            (void)(lb_x_window_21objc_disposeClassPair(lb_native_type));
            return ((lb_r_unit){ .error = _lb_r169.error, .failed = true });
        } (void)0; })));
        lb_pos = "src/std/window/macos/lifecycle.lucb:23:9";
        (void)((({ lb_r_unit _lb_r170 = lb_window_10add_method(lb_native_type, "windowDidBecomeKey:", ((void*)(lb_window_14focus_callback)), "v@:@"); if (_lb_r170.failed) {
            (void)(lb_x_window_21objc_disposeClassPair(lb_native_type));
            return ((lb_r_unit){ .error = _lb_r170.error, .failed = true });
        } (void)0; })));
        lb_pos = "src/std/window/macos/lifecycle.lucb:24:9";
        (void)((({ lb_r_unit _lb_r171 = lb_window_10add_method(lb_native_type, "windowDidResignKey:", ((void*)(lb_window_14focus_callback)), "v@:@"); if (_lb_r171.failed) {
            (void)(lb_x_window_21objc_disposeClassPair(lb_native_type));
            return ((lb_r_unit){ .error = _lb_r171.error, .failed = true });
        } (void)0; })));
        lb_pos = "src/std/window/macos/lifecycle.lucb:25:9";
        (void)((({ lb_r_unit _lb_r172 = lb_window_10add_method(lb_native_type, "luceDidFinishLaunching:", ((void*)(lb_window_15launch_callback)), "v@:@"); if (_lb_r172.failed) {
            (void)(lb_x_window_21objc_disposeClassPair(lb_native_type));
            return ((lb_r_unit){ .error = _lb_r172.error, .failed = true });
        } (void)0; })));
        lb_pos = "src/std/window/macos/lifecycle.lucb:26:9";
        (void)(lb_x_window_22objc_registerClassPair(lb_native_type));
        lb_pos = "src/std/window/macos/lifecycle.lucb:27:9";
        lb_window_14delegate_class = lb_native_type;
    }
    lb_pos = "src/std/window/macos/lifecycle.lucb:28:5";
    if (!!((lb_window_10view_class == ((void*)0)))) 
    {
        lb_pos = "src/std/window/macos/lifecycle.lucb:29:9";
        void* lb_native_type __attribute__((unused)) = (({ lb_r_void_0p _lb_r173 = lb_window_10make_class("NSView", "LuceBaseWindowViewV1"); if (_lb_r173.failed) {
            return ((lb_r_unit){ .error = _lb_r173.error, .failed = true });
        } _lb_r173.value; }));
        lb_pos = "src/std/window/macos/lifecycle.lucb:30:9";
        lb_pos = "src/std/window/macos/lifecycle.lucb:31:9";
        (void)((({ lb_r_unit _lb_r174 = lb_window_10add_method(lb_native_type, "acceptsFirstResponder", ((void*)(lb_window_12view_accepts)), "B@:"); if (_lb_r174.failed) {
            (void)(lb_x_window_21objc_disposeClassPair(lb_native_type));
            return ((lb_r_unit){ .error = _lb_r174.error, .failed = true });
        } (void)0; })));
        lb_pos = "src/std/window/macos/lifecycle.lucb:32:9";
        (void)((({ lb_r_unit _lb_r175 = lb_window_10add_method(lb_native_type, "isFlipped", ((void*)(lb_window_12view_accepts)), "B@:"); if (_lb_r175.failed) {
            (void)(lb_x_window_21objc_disposeClassPair(lb_native_type));
            return ((lb_r_unit){ .error = _lb_r175.error, .failed = true });
        } (void)0; })));
        lb_pos = "src/std/window/macos/lifecycle.lucb:33:9";
        (void)((({ lb_r_unit _lb_r176 = lb_window_10add_method(lb_native_type, "cursorUpdate:", ((void*)(lb_window_15cursor_callback)), "v@:@"); if (_lb_r176.failed) {
            (void)(lb_x_window_21objc_disposeClassPair(lb_native_type));
            return ((lb_r_unit){ .error = _lb_r176.error, .failed = true });
        } (void)0; })));
        lb_pos = "src/std/window/macos/lifecycle.lucb:34:9";
        (void)((({ lb_r_unit _lb_r177 = lb_window_23mac_register_text_input(lb_native_type); if (_lb_r177.failed) {
            (void)(lb_x_window_21objc_disposeClassPair(lb_native_type));
            return ((lb_r_unit){ .error = _lb_r177.error, .failed = true });
        } (void)0; })));
        lb_pos = "src/std/window/macos/lifecycle.lucb:35:9";
        lb_a_5c_str_0a3 lb_keys __attribute__((unused)) = ((lb_a_5c_str_0a3){{"keyDown:", "keyUp:", "flagsChanged:"}});
        lb_pos = "src/std/window/macos/lifecycle.lucb:36:9";
        lb_a_5c_str_0a3 _lb_seq178 = lb_keys;
        for (size_t _lb_i178 = 0; _lb_i178 < 3; _lb_i178++) {
            char* lb_name __attribute__((unused)) = _lb_seq178.d[_lb_i178];
            {
                lb_pos = "src/std/window/macos/lifecycle.lucb:37:13";
                (void)((({ lb_r_unit _lb_r179 = lb_window_10add_method(lb_native_type, lb_name, ((void*)(lb_window_12key_callback)), "v@:@"); if (_lb_r179.failed) {
                    (void)(lb_x_window_21objc_disposeClassPair(lb_native_type));
                    return ((lb_r_unit){ .error = _lb_r179.error, .failed = true });
                } (void)0; })));
            }
        }
        lb_pos = "src/std/window/macos/lifecycle.lucb:38:9";
        lb_a_5c_str_0a13 lb_pointer __attribute__((unused)) = ((lb_a_5c_str_0a13){{"mouseDown:", "mouseUp:", "rightMouseDown:", "rightMouseUp:", "otherMouseDown:", "otherMouseUp:", "mouseMoved:", "mouseDragged:", "rightMouseDragged:", "otherMouseDragged:", "scrollWheel:", "mouseEntered:", "mouseExited:"}});
        lb_pos = "src/std/window/macos/lifecycle.lucb:39:9";
        lb_a_5c_str_0a13 _lb_seq180 = lb_pointer;
        for (size_t _lb_i180 = 0; _lb_i180 < 13; _lb_i180++) {
            char* lb_name __attribute__((unused)) = _lb_seq180.d[_lb_i180];
            {
                lb_pos = "src/std/window/macos/lifecycle.lucb:40:13";
                (void)((({ lb_r_unit _lb_r181 = lb_window_10add_method(lb_native_type, lb_name, ((void*)(lb_window_16pointer_callback)), "v@:@"); if (_lb_r181.failed) {
                    (void)(lb_x_window_21objc_disposeClassPair(lb_native_type));
                    return ((lb_r_unit){ .error = _lb_r181.error, .failed = true });
                } (void)0; })));
            }
        }
        lb_pos = "src/std/window/macos/lifecycle.lucb:41:9";
        (void)(lb_x_window_22objc_registerClassPair(lb_native_type));
        lb_pos = "src/std/window/macos/lifecycle.lucb:42:9";
        lb_window_10view_class = lb_native_type;
    }
...
lb_r_unit lb_window_13finish_launch(void* lb_app) {
    ...
    } _lb_r183.value; })); void* _lb_sq184 __attribute__((unused)) = lb_window_sel("currentApplication"); lb_c_window_7msg_ptr(_lb_sq182, _lb_sq184); }));
    lb_pos = "src/std/window/macos/lifecycle.lucb:93:5";
    if (!!(({ void* _lb_sq185 __attribute__((unused)) = lb_running; void* _lb_sq186 __attribute__((unused)) = lb_window_sel("isFinishedLaunching"); lb_c_window_8msg_bool(_lb_sq185, _lb_sq186); }))) 
    {
        lb_pos = "src/std/window/macos/lifecycle.lucb:94:9";
        return ((lb_r_unit){ .failed = false });
    }
    lb_pos = "src/std/window/macos/lifecycle.lucb:95:5";
    void* lb_observer __attribute__((unused)) = ({ void* _lb_o187 = ({ void* _lb_sq188 __attribute__((unused)) = lb_window_required(lb_window_14delegate_class); void* _lb_sq189 __attribute__((unused)) = lb_window_sel("new"); lb_c_window_7msg_ptr(_lb_sq188, _lb_sq189); }); if (_lb_o187 == ((void*)0)) {
    ...
    void* lb_center __attribute__((unused)) = lb_window_required(({ void* _lb_sq191 __attribute__((unused)) = (({ lb_r_void_0p _lb_r192 = lb_window_12native_class("NSNotificationCenter"); if (_lb_r192.failed) {
        (void)(({ void* _lb_sq193 __attribute__((unused)) = lb_observer; void* _lb_sq194 __attribute__((unused)) = lb_window_sel("release"); lb_c_window_8msg_void(_lb_sq193, _lb_sq194); }));
        return ((lb_r_unit){ .error = _lb_r192.error, .failed = true });
    } _lb_r192.value; })); void* _lb_sq195 __attribute__((unused)) = lb_window_sel("defaultCenter"); lb_c_window_7msg_ptr(_lb_sq191, _lb_sq195); }));
    lb_pos = "src/std/window/macos/lifecycle.lucb:98:5";
    (void)(({ void* _lb_sq196 __attribute__((unused)) = lb_center; void* _lb_sq197 __attribute__((unused)) = lb_window_sel("addObserver:selector:name:object:"); void* _lb_sq198 __attribute__((unused)) = lb_observer; void* _lb_sq199 __attribute__((unused)) = lb_window_sel("luceDidFinishLaunching:"); void* _lb_sq200 __attribute__((unused)) = NSApplicationDidFinishLaunchingNotification; void* _lb_sq201 __attribute__((unused)) = lb_app; lb_c_window_11msg_observe(_lb_sq196, _lb_sq197, _lb_sq198, _lb_sq199, _lb_sq200, _lb_sq201); }));
    lb_pos = "src/std/window/macos/lifecycle.lucb:99:5";
    lb_pos = "src/std/window/macos/lifecycle.lucb:100:5";
    (void)(({ void* _lb_sq202 __attribute__((unused)) = lb_app; void* _lb_sq203 __attribute__((unused)) = lb_window_sel("run"); lb_c_window_8msg_void(_lb_sq202, _lb_sq203); }));
    (void)(({ void* _lb_sq204 __attribute__((unused)) = lb_center; void* _lb_sq205 __attribute__((unused)) = lb_window_sel("removeObserver:"); void* _lb_sq206 __attribute__((unused)) = lb_observer; lb_c_window_10msg_object(_lb_sq204, _lb_sq205, _lb_sq206); }));
    (void)(({ void* _lb_sq207 __attribute__((unused)) = lb_observer; void* _lb_sq208 __attribute__((unused)) = lb_window_sel("release"); lb_c_window_8msg_void(_lb_sq207, _lb_sq208); }));
    return ((lb_r_unit){ .failed = false });
}
lb_r_void_0p lb_window_10make_class(char* lb_parent, char* lb_name) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/window/macos/lifecycle.lucb:10:5";
    void* lb_native_type __attribute__((unused)) = ({ void* _lb_o209 = ({ void* _lb_sq210 __attribute__((unused)) = (({ lb_r_void_0p _lb_r211 = lb_window_12native_class(lb_parent); if (_lb_r211.failed) {
        return ((lb_r_void_0p){ .error = _lb_r211.error, .failed = true });
    } _lb_r211.value; })); char* _lb_sq212 __attribute__((unused)) = lb_name; size_t _lb_sq213 __attribute__((unused)) = 0ULL; lb_x_window_22objc_allocateClassPair(_lb_sq210, _lb_sq212, _lb_sq213); }); if (_lb_o209 == ((void*)0)) {
        lb_r_void_0p _lb_err214 = ((lb_r_void_0p){ .error = { .code = (int32_t)(lb_window_failed), .message = ((lb_str){"could not allocate a native window class", 40}) }, .failed = true });
        return _lb_err214;
    } _lb_o209; });
    lb_pos = "src/std/window/macos/lifecycle.lucb:11:5";
    lb_pos = "src/std/window/macos/lifecycle.lucb:12:5";
    if (!!((!lb_x_window_13class_addIvar(lb_native_type, "luceState", 8ULL, 3ULL, "^v")))) 
    {
        lb_pos = "src/std/window/macos/lifecycle.lucb:13:9";
        lb_r_void_0p _lb_err215 = ((lb_r_void_0p){ .error = { .code = (int32_t)(lb_window_failed), .message = ((lb_str){"could not register native window state", 38}) }, .failed = true });
        (void)(lb_x_window_21objc_disposeClassPair(lb_native_type));
        return _lb_err215;
    }
    lb_pos = "src/std/window/macos/lifecycle.lucb:14:5";
    void* _lb_ret216 = lb_native_type;
    return ((lb_r_void_0p){ .value = _lb_ret216, .failed = false });
    lb_trap("unreachable");
}
void lb_window_15launch_callback(void* lb_object, void* lb_selector, void* lb_notification) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/window/macos/lifecycle.lucb:103:5";
    (void)(((void)(lb_object)));
    lb_pos = "src/std/window/macos/lifecycle.lucb:104:5";
    (void)(((void)(lb_selector)));
    lb_pos = "src/std/window/macos/lifecycle.lucb:105:5";
    void* lb_app __attribute__((unused)) = lb_window_required(({ void* _lb_sq217 __attribute__((unused)) = lb_notification; void* _lb_sq218 __attribute__((unused)) = lb_window_sel("object"); lb_c_window_7msg_ptr(_lb_sq217, _lb_sq218); }));
    ...
    void* lb_event __attribute__((unused)) = lb_window_required(({ void* _lb_sq220 __attribute__((unused)) = lb_event_class; void* _lb_sq221 __attribute__((unused)) = lb_window_sel("otherEventWithType:location:modifierFlags:timestamp:windowNumber:context:subtype:data1:data2:"); uint64_t _lb_sq222 __attribute__((unused)) = 15ULL; LuceWindowMacPoint _lb_sq223 __attribute__((unused)) = ((LuceWindowMacPoint){}); uint64_t _lb_sq224 __attribute__((unused)) = 0ULL; double _lb_sq225 __attribute__((unused)) = 0x0p+0; int64_t _lb_sq226 __attribute__((unused)) = 0LL; void* _lb_sq227 __attribute__((unused)) = ((void*)0); int16_t _lb_sq228 __attribute__((unused)) = 0LL; int64_t _lb_sq229 __attribute__((unused)) = 0LL; int64_t _lb_sq230 __attribute__((unused)) = 0LL; lb_c_window_10msg_wakeup(_lb_sq220, _lb_sq221, _lb_sq222, _lb_sq223, _lb_sq224, _lb_sq225, _lb_sq226, _lb_sq227, _lb_sq228, _lb_sq229, _lb_sq230); }));
    lb_pos = "src/std/window/macos/lifecycle.lucb:108:5";
    (void)(({ void* _lb_sq231 __attribute__((unused)) = lb_app; void* _lb_sq232 __attribute__((unused)) = lb_window_sel("postEvent:atStart:"); void* _lb_sq233 __attribute__((unused)) = lb_event; bool _lb_sq234 __attribute__((unused)) = true; lb_c_window_8msg_post(_lb_sq231, _lb_sq232, _lb_sq233, _lb_sq234); }));
    lb_pos = "src/std/window/macos/lifecycle.lucb:109:5";
    (void)(({ void* _lb_sq235 __attribute__((unused)) = lb_app; void* _lb_sq236 __attribute__((unused)) = lb_window_sel("stop:"); void* _lb_sq237 __attribute__((unused)) = ((void*)0); lb_c_window_10msg_object(_lb_sq235, _lb_sq236, _lb_sq237); }));
}
