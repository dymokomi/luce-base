...
void lb_sync_8sleep_on(void* lb_address, uint32_t lb_value) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    {
        lb_pos = "src/std/sync.lucb:25:9";
        (void)(((void)(lb_x_sync_12__ulock_wait(lb_sync_16compare_and_wait, lb_address, ((uint64_t)lb_conv_u((uint64_t)(lb_value), 32, 0, 64, 0, 1)), 0ULL))));
    }
}
void lb_sync_8wake_one(void* lb_address) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    {
        lb_pos = "src/std/sync.lucb:34:9";
        (void)(((void)(lb_x_sync_12__ulock_wake(lb_sync_16compare_and_wait, lb_address, 0ULL))));
    }
}
void lb_sync_10wake_every(void* lb_address) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    {
        lb_pos = "src/std/sync.lucb:42:9";
        (void)(((void)(lb_x_sync_12__ulock_wake(((uint32_t)(lb_sync_16compare_and_wait | lb_sync_8wake_all)), lb_address, 0ULL))));
    }
}
