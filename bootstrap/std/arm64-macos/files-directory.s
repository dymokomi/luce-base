    ...
    .p2align 2
    .globl _lb_files_directory_0init
_lb_files_directory_0init:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    sub sp, sp, #16
    mov sp, x29
    ...
    .no_dead_strip _lb_files_Directory_open
...
L1_4:
    ...
    .no_dead_strip _lb_files_Directory_descriptor
...
L2_9:
    ...
    .no_dead_strip _lb_files_Directory_metadata
...
L3_7:
    ...
    .p2align 2
    .globl _lb_files_Directory_14entry_metadata
    .no_dead_strip _lb_files_Directory_14entry_metadata
_lb_files_Directory_14entry_metadata:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    sub sp, sp, #432
    sub x16, x29, #24
...
L4_7:
    ...
    .p2align 2
    .globl _lb_files_Directory_14open_directory
    .no_dead_strip _lb_files_Directory_14open_directory
_lb_files_Directory_14open_directory:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    sub sp, sp, #192
    sub x16, x29, #24
...
L5_7:
    ...
    .no_dead_strip _lb_files_Directory_9open_file
...
L6_22:
    ...
    .no_dead_strip _lb_files_Directory_next
...
L7_3:
    ...
    add x21, x27, #16
    sub x22, x29, #272
    adrp x23, l_text_10@PAGE
    add x23, x23, l_text_10@PAGEOFF
    sub x26, x29, #312
    add x24, x26, #8
    add x9, x28, #8
    str x9, [sp, #24]
...
L7_17:
    ...
    .no_dead_strip _lb_files_Directory_close
...
L8_7:
    ...
    .p2align 2
    .globl _lb_files_Directory_destroy
    .no_dead_strip _lb_files_Directory_destroy
_lb_files_Directory_destroy:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    sub sp, sp, #80
    sub x16, x29, #24
...
L12_3:
    ...
    .p2align 2
    .globl _lb_files_12release_list
    .no_dead_strip _lb_files_12release_list
_lb_files_12release_list:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    sub sp, sp, #32
    sub x16, x29, #32
...
L14_11:
    ...
    .no_dead_strip _lb_memory_copy_0g1_str
...
L15_10:
    adrp x0, l_text_53@PAGE
    add x0, x0, l_text_53@PAGEOFF
    adrp x1, l_text_54@PAGE
    add x1, x1, l_text_54@PAGEOFF
    bl _lb_core_7trap_at
L15_9:
    b L15_8
L15_7:
...
L16_8:
    ...
    .p2align 3
    .quad _lb_files_directory_0init
