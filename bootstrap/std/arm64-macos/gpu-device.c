...
lb_r_gpu_Device lb_gpu_Device_open(uint8_t lb_backend) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/gpu/device.lucb:9:9";
    (void)((({ lb_r_unit _lb_r7 = lb_gpu_12check_thread(); if (_lb_r7.failed) {
        return ((lb_r_gpu_Device){ .error = _lb_r7.error, .failed = true });
    } (void)0; })));
    lb_pos = "src/std/gpu/device.lucb:10:9";
    uint8_t lb_selected __attribute__((unused)) = (({ lb_r_gpu_Backend _lb_r8 = lb_gpu_14select_backend(lb_backend); if (_lb_r8.failed) {
        return ((lb_r_gpu_Device){ .error = _lb_r8.error, .failed = true });
    } _lb_r8.value; }));
    lb_pos = "src/std/gpu/device.lucb:11:9";
    void* lb_native __attribute__((unused)) = (({ lb_r_void_0p _lb_r9 = lb_gpu_19backend_device_open(lb_selected); if (_lb_r9.failed) {
        return ((lb_r_gpu_Device){ .error = _lb_r9.error, .failed = true });
    } _lb_r9.value; }));
    lb_pos = "src/std/gpu/device.lucb:12:9";
    lb_pos = "src/std/gpu/device.lucb:13:9";
    struct lb_gpu_DeviceState* lb_state __attribute__((unused)) = (({ lb_r_gpu_DeviceState_0p _lb_r10 = ({ lb_iface _lb_a11 = lb_memory_heap; lb_o_u8_0s _lb_ao11 = lb_alloc_call(_lb_a11, sizeof(lb_gpu_DeviceState), _Alignof(lb_gpu_DeviceState)); lb_r_gpu_DeviceState_0p _lb_r11; if (!_lb_ao11.present) { _lb_r11 = ((lb_r_gpu_DeviceState_0p){ .error = { .code = 208273409, .message = (lb_str){"memory.exhausted", 16} }, .failed = true }); } else { lb_gpu_DeviceState* _lb_p11 = (lb_gpu_DeviceState*)_lb_ao11.value.data; *_lb_p11 = ((lb_gpu_DeviceState){.backend = lb_selected, .native = lb_native, .references = 1ULL}); _lb_r11.value = _lb_p11; _lb_r11.failed = false; } _lb_r11; }); if (_lb_r10.failed) {
        (void)(lb_gpu_22backend_device_destroy(lb_selected, lb_native));
        return ((lb_r_gpu_Device){ .error = _lb_r10.error, .failed = true });
    } _lb_r10.value; }));
    lb_pos = "src/std/gpu/device.lucb:14:9";
    lb_gpu_Device _lb_ret12 = ((lb_gpu_Device){.state = lb_state});
    return ((lb_r_gpu_Device){ .value = _lb_ret12, .failed = false });
    lb_trap("unreachable");
}
lb_r_gpu_Backend lb_gpu_Device_backend(const lb_gpu_Device* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/gpu/device.lucb:17:9";
    uint8_t _lb_ret13 = (((({ lb_r_gpu_DeviceState_0p _lb_r14 = lb_gpu_Device_checked(self); if (_lb_r14.failed) {
        return ((lb_r_gpu_Backend){ .error = _lb_r14.error, .failed = true });
    } _lb_r14.value; }))))->backend;
    return ((lb_r_gpu_Backend){ .value = _lb_ret13, .failed = false });
    lb_trap("unreachable");
}
void lb_gpu_Device_destroy(lb_gpu_Device* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/gpu/device.lucb:20:9";
    struct lb_gpu_DeviceState* lb_state __attribute__((unused)) = ({ struct lb_gpu_DeviceState* _lb_o15 = self->state; if (_lb_o15 == ((void*)0)) {
        return;
    } _lb_o15; });
    ...
    (void)(lb_gpu_14release_device(lb_state));
}
lb_r_gpu_DeviceState_0p lb_gpu_Device_checked(const lb_gpu_Device* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/gpu/device.lucb:26:9";
    (void)((({ lb_r_unit _lb_r16 = lb_gpu_12check_thread(); if (_lb_r16.failed) {
        return ((lb_r_gpu_DeviceState_0p){ .error = _lb_r16.error, .failed = true });
    } (void)0; })));
    lb_pos = "src/std/gpu/device.lucb:27:9";
    struct lb_gpu_DeviceState* _lb_ret17 = ({ struct lb_gpu_DeviceState* _lb_o18 = self->state; if (_lb_o18 == ((void*)0)) {
        lb_r_gpu_DeviceState_0p _lb_err19 = ((lb_r_gpu_DeviceState_0p){ .error = { .code = (int32_t)(lb_gpu_closed), .message = ((lb_str){"the GPU device is closed", 24}) }, .failed = true });
        return _lb_err19;
    } _lb_o18; });
    return ((lb_r_gpu_DeviceState_0p){ .value = _lb_ret17, .failed = false });
    lb_trap("unreachable");
}
void lb_gpu_14release_device(struct lb_gpu_DeviceState* lb_state) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/gpu/device.lucb:35:5";
    { size_t* lb__cell20 = &((lb_state)->references);
    (*(lb__cell20)) = (size_t)(lb_sub_u((uint64_t)((*(lb__cell20))), (uint64_t)(1ULL), 64)); }
    lb_pos = "src/std/gpu/device.lucb:36:5";
    if (!!(((lb_state)->references == 0ULL))) 
    {
        lb_pos = "src/std/gpu/device.lucb:37:9";
        (void)(lb_gpu_22backend_device_destroy((lb_state)->backend, (lb_state)->native));
        lb_pos = "src/std/gpu/device.lucb:38:9";
        lb_release_call(lb_memory_heap, (lb_span){ (void*)(lb_state), sizeof(lb_gpu_DeviceState) });
    }
}
__attribute__((weak)) void lb_interop_Packet_0g1_str_init(lb_interop_Packet_0g1_str* self, lb_str lb_value, void* lb_storage, lb_fn_0F1_void_0p_unit lb_dispose) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
