...
L0_2:
    ...
    mov w15, w9
L0_3:
    adrp x19, _lb_net_16nonblocking_flag@PAGE
    add x19, x19, _lb_net_16nonblocking_flag@PAGEOFF
    str w15, [x19]
    ldrb w19, [x14]
    cbnz w19, L0_19
    b L0_7
...
L0_15:
    ...
    mov w14, w9
L0_16:
    adrp x15, _lb_net_16keepalive_option@PAGE
    add x15, x15, _lb_net_16keepalive_option@PAGEOFF
    str w14, [x15]
    ldr x19, [sp, #8]
    mov sp, x29
    ldp x29, x30, [sp], #16
