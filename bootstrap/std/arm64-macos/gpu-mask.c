...
typedef struct lb_a_gpu_Vertex_0a6 { lb_gpu_Vertex d[6]; } lb_a_gpu_Vertex_0a6;
...
lb_r_unit lb_gpu_11canvas_mask(struct lb_gpu_Canvas* lb_canvas, lb_cspan lb_pixels, uint32_t lb_width, uint32_t lb_height, lb_gpu_Rect lb_rectangle, lb_gpu_Color lb_color, lb_gpu_Clip lb_clip, double lb_target_width, double lb_target_height) {
    lb_a_gpu_Vertex_0a6 _lb_ad18;
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/gpu/mask.lucb:16:5";
    (void)((({ lb_r_unit _lb_r7 = lb_gpu_11check_color(lb_color); if (_lb_r7.failed) {
        return ((lb_r_unit){ .error = _lb_r7.error, .failed = true });
    } (void)0; })));
    lb_pos = "src/std/gpu/mask.lucb:17:5";
    if (!!((((((lb_width == 0ULL) || (lb_height == 0ULL)) || (((uint32_t)(lb_width)) > ((uint32_t)(16384ULL)))) || (((uint32_t)(lb_height)) > ((uint32_t)(16384ULL)))) || (!((lb_pixels.length) == (size_t)(lb_mul_u((uint64_t)(((size_t)lb_conv_u((uint64_t)(lb_width), 32, 0, 64, 0, 1))), (uint64_t)(((size_t)lb_conv_u((uint64_t)(lb_height), 32, 0, 64, 0, 1))), 64))))))) 
    {
        lb_pos = "src/std/gpu/mask.lucb:18:9";
        lb_r_unit _lb_err8 = ((lb_r_unit){ .error = { .code = (int32_t)(lb_gpu_16invalid_geometry), .message = ((lb_str){"coverage dimensions must match tightly packed pixels, in 1..16384", 65}) }, .failed = true });
        return _lb_err8;
    }
    lb_pos = "src/std/gpu/mask.lucb:19:5";
    if (!!(((((lb_rectangle.width == 0x0p+0) || (lb_rectangle.height == 0x0p+0)) || (lb_clip.width == 0ULL)) || (lb_clip.height == 0ULL)))) 
    {
        lb_pos = "src/std/gpu/mask.lucb:20:9";
        return ((lb_r_unit){ .failed = false });
    }
    lb_pos = "src/std/gpu/mask.lucb:21:5";
    size_t lb_words __attribute__((unused)) = (size_t)(lb_div_u((uint64_t)(((size_t)(lb_add_u((uint64_t)((lb_pixels.length)), (uint64_t)(3ULL), 64)))), (uint64_t)(4ULL), 64));
    lb_pos = "src/std/gpu/mask.lucb:22:5";
    if (!!((((size_t)(lb_words)) > ((size_t)((size_t)(lb_sub_u((uint64_t)(4194304ULL), (uint64_t)((lb_canvas)->coverage_count), 64))))))) 
    {
        lb_pos = "src/std/gpu/mask.lucb:23:9";
        lb_r_unit _lb_err9 = ((lb_r_unit){ .error = { .code = (int32_t)(lb_gpu_13command_limit), .message = ((lb_str){"a frame supports at most 16 MiB of coverage images", 50}) }, .failed = true });
        return _lb_err9;
    }
    lb_pos = "src/std/gpu/mask.lucb:24:5";
    size_t lb_needed __attribute__((unused)) = (size_t)(lb_add_u((uint64_t)((lb_canvas)->coverage_count), (uint64_t)(lb_words), 64));
    lb_pos = "src/std/gpu/mask.lucb:25:5";
    if (!!((((size_t)(lb_needed)) > ((size_t)(((lb_canvas)->coverage.length)))))) 
    {
        lb_pos = "src/std/gpu/mask.lucb:26:9";
        size_t lb_capacity __attribute__((unused)) = ({ size_t _lb_sq10 __attribute__((unused)) = lb_needed; size_t _lb_sq11 __attribute__((unused)) = ({ size_t _lb_sq12 __attribute__((unused)) = 4194304ULL; size_t _lb_sq13 __attribute__((unused)) = lb_gpu_10canvas_max(1024ULL, (size_t)(lb_mul_u((uint64_t)(((lb_canvas)->coverage.length)), (uint64_t)(2ULL), 64))); lb_gpu_10canvas_min(_lb_sq12, _lb_sq13); }); lb_gpu_10canvas_max(_lb_sq10, _lb_sq11); });
        lb_pos = "src/std/gpu/mask.lucb:27:9";
        lb_span lb_grown __attribute__((unused)) = (({ lb_r_u32_0s _lb_r14 = ({ lb_iface _lb_a15 = lb_memory_heap; size_t _lb_n15 = (size_t)(lb_capacity); lb_r_u32_0s _lb_r15; if (_lb_n15 > UINT64_C(1152921504606846976)) { _lb_r15 = ((lb_r_u32_0s){ .error = { .code = 208273409, .message = (lb_str){"memory.exhausted", 16} }, .failed = true }); } else { size_t _lb_bytes15 = sizeof(uint32_t) * _lb_n15; lb_o_u8_0s _lb_ao15 = lb_alloc_call(_lb_a15, _lb_bytes15, _Alignof(uint32_t)); if (_lb_bytes15 != 0 && !_lb_ao15.present) { _lb_r15 = ((lb_r_u32_0s){ .error = { .code = 208273409, .message = (lb_str){"memory.exhausted", 16} }, .failed = true }); } else { _lb_r15.value.data = _lb_ao15.value.data; _lb_r15.value.length = _lb_n15; _lb_r15.failed = false; } } _lb_r15; }); if (_lb_r14.failed) {
            return ((lb_r_unit){ .error = _lb_r14.error, .failed = true });
        } _lb_r14.value; }));
        lb_pos = "src/std/gpu/mask.lucb:28:9";
        if (!!((((size_t)((lb_canvas)->coverage_count)) > ((size_t)(0ULL))))) 
        {
            lb_pos = "src/std/gpu/mask.lucb:29:13";
            (void)(lb_memory_copy_0g1_u32(lb_grown, (lb_canvas)->coverage, (lb_canvas)->coverage_count));
        }
        lb_pos = "src/std/gpu/mask.lucb:30:9";
        if (!!((((size_t)(((lb_canvas)->coverage.length))) > ((size_t)(0ULL))))) 
        {
            lb_pos = "src/std/gpu/mask.lucb:31:13";
            { lb_span _lb_s16 = (lb_canvas)->coverage; lb_release_call(lb_memory_heap, (lb_span){ (void*)(_lb_s16.data), lb_mul_u(_lb_s16.length, sizeof(uint32_t), 64) }); }
        }
        lb_pos = "src/std/gpu/mask.lucb:32:9";
        (lb_canvas)->coverage = lb_grown;
    }
    lb_pos = "src/std/gpu/mask.lucb:33:5";
    float lb_left __attribute__((unused)) = ((float)(((((lb_rectangle.x * 0x1.0000000000000p+1) / lb_target_width) - 0x1.0000000000000p+0))));
    lb_pos = "src/std/gpu/mask.lucb:34:5";
    float lb_right __attribute__((unused)) = ((float)(((((((lb_rectangle.x + lb_rectangle.width)) * 0x1.0000000000000p+1) / lb_target_width) - 0x1.0000000000000p+0))));
    lb_pos = "src/std/gpu/mask.lucb:35:5";
    float lb_top __attribute__((unused)) = ((float)(((0x1.0000000000000p+0 - ((lb_rectangle.y * 0x1.0000000000000p+1) / lb_target_height)))));
    lb_pos = "src/std/gpu/mask.lucb:36:5";
    float lb_bottom __attribute__((unused)) = ((float)(((0x1.0000000000000p+0 - ((((lb_rectangle.y + lb_rectangle.height)) * 0x1.0000000000000p+1) / lb_target_height)))));
    lb_pos = "src/std/gpu/mask.lucb:37:5";
    lb_gpu_Vertex lb_a __attribute__((unused)) = ((lb_gpu_Vertex){.x = lb_left, .y = lb_top, .w = 0x1.000000p+0f, .red = ((float)(lb_color.red)), .green = ((float)(lb_color.green)), .blue = ((float)(lb_color.blue)), .alpha = 0x1.000000p+0f});
    lb_pos = "src/std/gpu/mask.lucb:38:5";
    lb_gpu_Vertex lb_b __attribute__((unused)) = lb_a;
    lb_pos = "src/std/gpu/mask.lucb:39:5";
    lb_gpu_Vertex lb_lower_right __attribute__((unused)) = lb_a;
    lb_pos = "src/std/gpu/mask.lucb:40:5";
    lb_gpu_Vertex lb_d __attribute__((unused)) = lb_a;
    lb_pos = "src/std/gpu/mask.lucb:41:5";
    lb_b.x = lb_right;
    lb_pos = "src/std/gpu/mask.lucb:42:5";
    lb_lower_right.x = lb_right;
    lb_pos = "src/std/gpu/mask.lucb:43:5";
    lb_lower_right.y = lb_bottom;
    lb_pos = "src/std/gpu/mask.lucb:44:5";
    lb_d.y = lb_bottom;
    lb_pos = "src/std/gpu/mask.lucb:45:5";
    (void)((({ lb_r_unit _lb_r17 = lb_gpu_Canvas_triangles(lb_canvas, ((lb_cspan){(void*)((_lb_ad18 = ((lb_a_gpu_Vertex_0a6){{lb_a, lb_b, lb_lower_right, lb_a, lb_lower_right, lb_d}}), _lb_ad18.d)), 6ULL}), lb_clip, false, ((lb_o_gpu_Viewport){ .present = false })); if (_lb_r17.failed) {
        return ((lb_r_unit){ .error = _lb_r17.error, .failed = true });
    } (void)0; })));
    lb_pos = "src/std/gpu/mask.lucb:48:5";
    for (size_t lb_word __attribute__((unused)) = (size_t)(0ULL); lb_word < (size_t)(lb_words); lb_word++) {
        {
            lb_pos = "src/std/gpu/mask.lucb:49:9";
            uint32_t lb_packed __attribute__((unused)) = 0ULL;
            lb_pos = "src/std/gpu/mask.lucb:50:9";
            for (size_t lb_byte __attribute__((unused)) = (size_t)(0ULL); lb_byte < (size_t)(((size_t)lb_conv_s((int64_t)(4LL), 64, 1, 64, 0, 1))); lb_byte++) {
                {
                    lb_pos = "src/std/gpu/mask.lucb:51:13";
                    size_t lb_index __attribute__((unused)) = (size_t)(lb_add_u((uint64_t)((size_t)(lb_mul_u((uint64_t)(lb_word), (uint64_t)(4ULL), 64))), (uint64_t)(lb_byte), 64));
                    lb_pos = "src/std/gpu/mask.lucb:52:13";
                    if (!!((((size_t)(lb_index)) < ((size_t)((lb_pixels.length)))))) 
                    {
                        lb_pos = "src/std/gpu/mask.lucb:53:17";
                        { uint32_t* lb__cell21 = &(lb_packed);
                        (*(lb__cell21)) = (*(lb__cell21)) | ((uint32_t)(lb_shl_u((uint64_t)(((uint32_t)lb_conv_u((uint64_t)((*({ lb_cspan _lb_ix22 = lb_pixels; &((uint8_t*)_lb_ix22.data)[lb_at((uint64_t)(lb_index), _lb_ix22.length)]; }))), 8, 0, 32, 0, 1))), (uint64_t)(((uint32_t)lb_conv_u((uint64_t)(((size_t)(lb_mul_u((uint64_t)(lb_byte), (uint64_t)(8ULL), 64)))), 64, 0, 32, 0, 1))), 32))); }
                    }
                }
            }
            lb_pos = "src/std/gpu/mask.lucb:54:9";
            (*({ lb_span _lb_ix23 = (lb_canvas)->coverage; &((uint32_t*)_lb_ix23.data)[lb_at((uint64_t)((size_t)(lb_add_u((uint64_t)((lb_canvas)->coverage_count), (uint64_t)(lb_word), 64))), _lb_ix23.length)]; })) = lb_packed;
        }
    }
    lb_pos = "src/std/gpu/mask.lucb:55:5";
    (*({ lb_span _lb_ix24 = (lb_canvas)->draws; &((lb_gpu_Draw*)_lb_ix24.data)[lb_at((uint64_t)((size_t)(lb_sub_u((uint64_t)((lb_canvas)->draw_count), (uint64_t)(1ULL), 64))), _lb_ix24.length)]; })).mask = ((MaskRegion){.x = ((float)(lb_rectangle.x)), .y = ((float)(lb_rectangle.y)), .width = ((float)(lb_rectangle.width)), .height = ((float)(lb_rectangle.height)), .columns = lb_width, .rows = lb_height, .offset = ((uint32_t)lb_conv_u((uint64_t)(((size_t)(lb_mul_u((uint64_t)((lb_canvas)->coverage_count), (uint64_t)(4ULL), 64)))), 64, 0, 32, 0, 1)), .reserved = 0ULL});
    lb_pos = "src/std/gpu/mask.lucb:57:5";
    (lb_canvas)->coverage_count = lb_needed;
    return ((lb_r_unit){ .failed = false });
}
__attribute__((weak)) void lb_interop_Packet_0g1_str_init(lb_interop_Packet_0g1_str* self, lb_str lb_value, void* lb_storage, lb_fn_0F1_void_0p_unit lb_dispose) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
