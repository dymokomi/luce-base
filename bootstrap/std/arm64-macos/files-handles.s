...
L7_6:
L7_7:
    adrp x12, _lb_files_14transfer_limit@PAGE
    add x12, x12, _lb_files_14transfer_limit@PAGEOFF
    ldr x12, [x12]
    cmp x15, x12
    b.hs L7_10
L7_9:
...
L13_34:
    ...
    b L13_36
L13_35:
    adrp x12, _lb_platform_windows@PAGE
    add x12, x12, _lb_platform_windows@PAGEOFF
    ldrb w12, [x12]
    cbnz w12, L13_37
    b L13_38
L13_37:
...
L14_14:
    ...
    add x12, x12, _lb_files_create@PAGEOFF
    ldrsw x12, [x12]
    adrp x13, _lb_files_14exclusive_flag@PAGE
    add x13, x13, _lb_files_14exclusive_flag@PAGEOFF
    ldrsw x13, [x13]
    orr w13, w12, w13
    movz x10, #5
    cmp w15, w10
