...
L1_19:
    ...
    adrp x1, l_text_81@PAGE
    add x1, x1, l_text_81@PAGEOFF
    bl _lb_core_7trap_at
1:
    mov x15, x9
    cbnz x19, L1_24
...
L30_19:
    ...
    movk x9, #3178, lsl #16
    str w9, [x14]
    adrp x15, l_text_74@PAGE
    add x15, x15, l_text_74@PAGEOFF
    add x12, x14, #8
    str x15, [x12]
    add x14, x14, #16
    movz x9, #60
...
L31_10:
    ...
    adrp x1, l_text_78@PAGE
    add x1, x1, l_text_78@PAGEOFF
    bl _lb_core_7trap_at
L31_9:
    b L31_8
L31_7:
