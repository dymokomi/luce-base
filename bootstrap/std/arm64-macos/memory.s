...
L8_12:
    ...
    adrp x12, _lb_memory_quarantine@PAGE
    add x12, x12, _lb_memory_quarantine@PAGEOFF
    movz x10, #64
    cmp x15, x10
    b.lo 1f
...
L19_12:
    ...
    udiv x11, x14, x10
    msub x15, x11, x10, x14
    adrp x12, _lb_memory_10held_pages@PAGE
    add x12, x12, _lb_memory_10held_pages@PAGEOFF
    movz x10, #8
    cmp x15, x10
    b.lo 1f
...
L24_2:
    ...
    mov x15, x9
L24_3:
    adrp x12, _lb_memory_sites@PAGE
    add x12, x12, _lb_memory_sites@PAGEOFF
    movz x10, #257
    cmp x15, x10
    b.lo 1f
