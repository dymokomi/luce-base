...
int32_t lb_c_errno(void) {
    ...
    {
        lb_pos = "src/std/c.lucb:15:9";
        int32_t _lb_ret7 = (*(({ int32_t* _lb_fr = lb_c_c_9mac_errno(); if (!_lb_fr) lb_trap("null_foreign"); _lb_fr; })));
        return _lb_ret7;
    }
    lb_trap("unreachable");
}
void lb_c_9set_errno(int32_t lb_value) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    {
        lb_pos = "src/std/c.lucb:24:9";
        (*(({ int32_t* _lb_fr = lb_c_c_9mac_errno(); if (!_lb_fr) lb_trap("null_foreign"); _lb_fr; }))) = lb_value;
    }
}
void* lb_c_stdin(void) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
