...
bool lb_thread_7is_main(void) {
    ...
    {
        lb_pos = "src/std/thread.lucb:125:9";
        bool _lb_ret36 = ({ int32_t _lb_sq37 __attribute__((unused)) = lb_x_thread_15pthread_main_np(); int32_t _lb_sq38 __attribute__((unused)) = 0LL; (!(_lb_sq37 == _lb_sq38)); });
        return _lb_ret36;
    }
    lb_trap("unreachable");
}
...
void* lb_thread_trampoline(void* lb_raw) {
    ...
    if (!!((((size_t)((lb_start)->name_length)) > ((size_t)(0ULL))))) 
    {
        ...
        {
            lb_pos = "src/std/thread.lucb:74:13";
            (void)(((void)(lb_c_thread_11mac_setname(lb_text))));
        }
    }
    lb_pos = "src/std/thread.lucb:77:5";
    { lb_span _lb_s55 = (lb_start)->name; lb_release_call(lb_memory_heap, (lb_span){ (void*)(_lb_s55.data), lb_mul_u(_lb_s55.length, sizeof(uint8_t), 64) }); }
    lb_pos = "src/std/thread.lucb:78:5";
    lb_release_call(lb_memory_heap, (lb_span){ (void*)(lb_start), sizeof(lb_thread_Start) });
    lb_pos = "src/std/thread.lucb:79:5";
    (void)((lb_entry)(lb_context));
    lb_pos = "src/std/thread.lucb:80:5";
    void* _lb_ret56 = ((void*)0);
    return _lb_ret56;
    lb_trap("unreachable");
}
