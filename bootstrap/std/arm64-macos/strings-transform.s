    ...
    .p2align 2
    .globl _lb_strings_transform_0init
_lb_strings_transform_0init:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    sub sp, sp, #16
    mov sp, x29
...
L1_7:
    ...
    .no_dead_strip _lb_strings_trim
_lb_strings_trim:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    sub sp, sp, #128
...
L2_13:
    ...
    .no_dead_strip _lb_strings_join
_lb_strings_join:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    sub sp, sp, #480
...
L3_30:
    ...
    .no_dead_strip _lb_strings_copy
_lb_strings_copy:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    sub sp, sp, #240
...
L4_6:
    ...
    .no_dead_strip _lb_strings_8to_upper
...
L5_17:
    ...
    .no_dead_strip _lb_strings_8to_lower
...
L6_17:
    ...
    .no_dead_strip _lb_strings_release
_lb_strings_release:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    sub sp, sp, #80
...
L7_1:
    ...
    .no_dead_strip _lb_strings_17terminated_buffer
...
L9_8:
    ...
    .p2align 3
    .quad _lb_strings_transform_0init
