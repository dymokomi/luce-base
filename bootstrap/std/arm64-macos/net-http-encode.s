    ...
    .p2align 2
    .globl _lb_net_11http_encode_0init
_lb_net_11http_encode_0init:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    sub sp, sp, #16
    mov sp, x29
    ...
    .p2align 2
    .globl _lb_net_16http_encode_head
    .no_dead_strip _lb_net_16http_encode_head
_lb_net_16http_encode_head:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    movz x16, #5712
    sub sp, sp, x16
...
L1_16:
    ...
    ldr x9, [sp, #256]
    str x9, [x14]
    adrp x25, _lb_vt_io_SliceWriter_Writer@PAGE
    add x25, x25, _lb_vt_io_SliceWriter_Writer@PAGEOFF
    add x15, x14, #8
    str x25, [x15]
    mov x9, x14
    ldr x0, [x9]
...
L1_13:
    ...
    add x9, x20, #8
    str x9, [sp, #216]
    adrp x9, l_text_11@PAGE
    add x9, x9, l_text_11@PAGEOFF
    str x9, [sp, #208]
    sub x9, x29, #1040
    str x9, [sp, #200]
    ldr x9, [sp, #200]
    ...
    sub x9, x29, #1072
    str x9, [sp, #184]
    adrp x9, _lb_vt_io_SliceWriter_Writer@PAGE
    add x9, x9, _lb_vt_io_SliceWriter_Writer@PAGEOFF
    str x9, [sp, #176]
    ldr x9, [sp, #184]
    add x9, x9, #8
    str x9, [sp, #168]
...
L1_160:
    ...
    movz x16, #5272
    sub x8, x29, x16
    bl _lb_net_18http_parse_request
    movz x16, #5272
    sub x15, x29, x16
    add x14, x15, #120
    ldrb w14, [x14]
...
L1_161:
    ...
    movz x16, #5432
    sub x8, x29, x16
    bl _lb_net_19http_parse_response
    movz x16, #5432
    sub x15, x29, x16
    add x14, x15, #120
    ldrb w14, [x14]
...
L1_169:
    ...
    .p2align 2
    .globl _lb_net_16http_write_chunk
    .no_dead_strip _lb_net_16http_write_chunk
...
L2_20:
    ...
    .p2align 2
    .globl _lb_net_15http_end_chunks
    .no_dead_strip _lb_net_15http_end_chunks
_lb_net_15http_end_chunks:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    sub sp, sp, #128
    sub x16, x29, #24
...
L3_1:
    ...
    .p2align 2
    .globl _lb_net_HttpBodyWriter_over
    .no_dead_strip _lb_net_HttpBodyWriter_over
_lb_net_HttpBodyWriter_over:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    sub sp, sp, #224
    sub x16, x29, #24
...
L4_8:
    ...
    .p2align 2
    .globl _lb_net_HttpBodyWriter_write
    .no_dead_strip _lb_net_HttpBodyWriter_write
...
L5_9:
    ...
    .p2align 2
    .globl _lb_net_HttpBodyWriter_finish
    .no_dead_strip _lb_net_HttpBodyWriter_finish
_lb_net_HttpBodyWriter_finish:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    sub sp, sp, #352
    sub x16, x29, #24
...
L6_5:
    ...
    .p2align 2
    .globl _lb_net_HttpBodyWriter_check
_lb_net_HttpBodyWriter_check:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    sub sp, sp, #112
    sub x16, x29, #24
...
L7_7:
    ...
    .p2align 3
    .quad _lb_net_11http_encode_0init
...
l_text_44:
    ...
    .p2align 3
    .globl _lb_vt_io_SliceWriter_Writer
    .weak_definition _lb_vt_io_SliceWriter_Writer
_lb_vt_io_SliceWriter_Writer:
    .quad _lb_io_SliceWriter_write
