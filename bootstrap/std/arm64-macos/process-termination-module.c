...
lb_r_unit lb_process_19termination_install(void);
void lb_process_19termination_restore(void);

lb_sync_Mutex lb_process_16termination_lock = {};
_Atomic(uint64_t) lb_process_18termination_owners = 0;
_Atomic(uint64_t) lb_process_22termination_generation = 0;
_Atomic(bool) lb_process_19termination_closing = false;
...
bool lb_process_TerminationStatus_requested(const lb_process_TerminationStatus* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/process/termination/module.lucb:14:9";
    bool _lb_ret7 = ({ uint64_t _lb_sq8 __attribute__((unused)) = ((uint64_t)atomic_load_explicit(&(lb_process_22termination_generation), memory_order_acquire)); uint64_t _lb_sq10 __attribute__((unused)) = self->generation; (!(_lb_sq8 == _lb_sq10)); });
    return _lb_ret7;
    lb_trap("unreachable");
}
lb_r_unit lb_process_Termination_init(lb_process_Termination* self) {
    ...
    (void)(lb_sync_Mutex_lock(&(lb_process_16termination_lock)));
    lb_pos = "src/std/process/termination/module.lucb:28:9";
    lb_pos = "src/std/process/termination/module.lucb:29:9";
    if (!!(((bool)atomic_load_explicit(&(lb_process_19termination_closing), memory_order_acquire)))) 
    {
        lb_pos = "src/std/process/termination/module.lucb:30:13";
        lb_r_unit _lb_err12 = ((lb_r_unit){ .error = { .code = (int32_t)(lb_process_failed), .message = ((lb_str){"the process is already closing", 30}) }, .failed = true });
        (void)(lb_sync_Mutex_unlock(&(lb_process_16termination_lock)));
        return _lb_err12;
    }
    lb_pos = "src/std/process/termination/module.lucb:31:9";
    self->observation = ({ uint64_t _lb_sq13 __attribute__((unused)) = ((uint64_t)atomic_load_explicit(&(lb_process_22termination_generation), memory_order_acquire)); ((lb_process_TerminationStatus){.generation = _lb_sq13}); });
    lb_pos = "src/std/process/termination/module.lucb:32:9";
    uint64_t lb_count __attribute__((unused)) = ((uint64_t)atomic_load_explicit(&(lb_process_18termination_owners), memory_order_relaxed));
    lb_pos = "src/std/process/termination/module.lucb:33:9";
    (void)((atomic_store_explicit(&(lb_process_18termination_owners), (uint64_t)((uint64_t)(lb_add_u((uint64_t)(lb_count), (uint64_t)(1ULL), 64))), memory_order_release), (void)0));
    lb_pos = "src/std/process/termination/module.lucb:34:9";
    if (!!((lb_count == 0ULL))) 
    {
        lb_pos = "src/std/process/termination/module.lucb:38:9";
        (void)(({ lb_error _lb_fe17 __attribute__((unused)); int32_t _lb_v17 __attribute__((unused)) = 0; (void)(({ lb_r_unit _lb_r18 = lb_process_19termination_install(); if (_lb_r18.failed) {
            _lb_fe17 = _lb_r18.error;
            goto _lb_fh17;
        } (void)0; })); goto _lb_cd17; _lb_fh17: { 
            lb_error lb_failure __attribute__((unused)) = _lb_fe17;
            {
                lb_pos = "src/std/process/termination/module.lucb:36:17";
                (void)((atomic_store_explicit(&(lb_process_18termination_owners), (uint64_t)(0ULL), memory_order_release), (void)0));
                lb_pos = "src/std/process/termination/module.lucb:37:17";
                lb_r_unit _lb_err20 = ((lb_r_unit){ .error = { .code = (int32_t)((lb_failure.code)), .message = (lb_failure.message) }, .failed = true });
                (void)(lb_sync_Mutex_unlock(&(lb_process_16termination_lock)));
                return _lb_err20;
            }
        } _lb_cd17: __attribute__((unused)); (void)0; }));
    }
    lb_pos = "src/std/process/termination/module.lucb:38:9";
    self->active = true;
    (void)(lb_sync_Mutex_unlock(&(lb_process_16termination_lock)));
...
lb_process_TerminationStatus lb_process_Termination_status(const lb_process_Termination* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/process/termination/module.lucb:41:9";
    lb_process_TerminationStatus _lb_ret21 = self->observation;
    return _lb_ret21;
    lb_trap("unreachable");
}
void lb_process_Termination_close(lb_process_Termination* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/process/termination/module.lucb:44:9";
    if (!!((!self->active))) 
    {
        lb_pos = "src/std/process/termination/module.lucb:45:13";
        return;
    }
    lb_pos = "src/std/process/termination/module.lucb:46:9";
    (void)(lb_sync_Mutex_lock(&(lb_process_16termination_lock)));
    lb_pos = "src/std/process/termination/module.lucb:47:9";
    lb_pos = "src/std/process/termination/module.lucb:48:9";
    self->active = false;
    lb_pos = "src/std/process/termination/module.lucb:49:9";
    if (!!(({ uint64_t _lb_sq22 __attribute__((unused)) = ((uint64_t)atomic_fetch_sub_explicit(&(lb_process_18termination_owners), (uint64_t)(1ULL), memory_order_acq_rel)); uint64_t _lb_sq24 __attribute__((unused)) = 1ULL; (_lb_sq22 == _lb_sq24); }))) 
    {
        lb_pos = "src/std/process/termination/module.lucb:50:13";
        (void)(lb_process_19termination_restore());
    }
    (void)(lb_sync_Mutex_unlock(&(lb_process_16termination_lock)));
}
__attribute__((weak)) void lb_interop_Packet_0g1_str_init(lb_interop_Packet_0g1_str* self, lb_str lb_value, void* lb_storage, lb_fn_0F1_void_0p_unit lb_dispose) {
...
lb_r_unit lb_process_19termination_install(void) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    {
        lb_pos = "src/std/process/termination/module.lucb:56:9";
        (void)((({ lb_r_unit _lb_r29 = lb_process_25termination_posix_install(); if (_lb_r29.failed) {
...
void lb_process_19termination_restore(void) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    {
        lb_pos = "src/std/process/termination/module.lucb:62:9";
        (void)(lb_process_25termination_posix_restore());
    }
}
