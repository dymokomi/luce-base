...
L5_26:
    ...
    str x19, [x15]
    add x15, x14, #120
    adrp x13, _lb_gpu_19check_surface_frame@GOTPAGE
    ldr x13, [x13, _lb_gpu_19check_surface_frame@GOTPAGEOFF]
    str x13, [x15]
    add x15, x14, #128
    adrp x13, _lb_gpu_20submit_surface_frame@GOTPAGE
    ldr x13, [x13, _lb_gpu_20submit_surface_frame@GOTPAGEOFF]
    str x13, [x15]
    add x14, x14, #136
