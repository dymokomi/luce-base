...
typedef struct lb_interop_Reference_0g1_gpu_Frame lb_interop_Reference_0g1_gpu_Frame;
typedef struct lb_interop_Reference_0g1_gpu_FrameState lb_interop_Reference_0g1_gpu_FrameState;
typedef struct lb_interop_Owner_0g1_gpu_Frame lb_interop_Owner_0g1_gpu_Frame;
typedef struct lb_interop_Reservation_0g1_gpu_Frame lb_interop_Reservation_0g1_gpu_Frame;
...
LB_RES(struct lb_gpu_SurfaceState*, lb_r_gpu_SurfaceState_0p);
...
LB_RES(struct lb_gpu_Frame*, lb_r_gpu_Frame_0p);
...
typedef struct lb_interop_Reservation_0g1_gpu_Frame {
    struct lb_interop_Owner_0g1_gpu_Frame* owner;
} lb_interop_Reservation_0g1_gpu_Frame;
LB_RES(lb_interop_Reservation_0g1_gpu_Frame, lb_r_interop_Reservation_0g1_gpu_Frame);
...
lb_r_gpu_SurfaceState_0p lb_gpu_Surface_checked(const lb_gpu_Surface* self);
...
lb_r_gpu_PresentResult lb_gpu_20submit_surface_frame(void* lb_context, lb_gpu_Canvas lb_canvas, lb_gpu_Color lb_color);
void lb_gpu_21release_surface_frame(void* lb_context);
void lb_gpu_15release_surface(struct lb_gpu_SurfaceState* lb_state);
...
lb_r_gpu_Surface lb_gpu_Surface_open(lb_gpu_Device lb_device, lb_window_Window lb_target) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/gpu/surface.lucb:9:9";
    struct lb_gpu_DeviceState* lb_device_state __attribute__((unused)) = (({ lb_r_gpu_DeviceState_0p _lb_r7 = lb_gpu_Device_checked(&(lb_device)); if (_lb_r7.failed) {
        return ((lb_r_gpu_Surface){ .error = _lb_r7.error, .failed = true });
    } _lb_r7.value; }));
    lb_pos = "src/std/gpu/surface.lucb:10:9";
    lb_window_Presentation lb_host __attribute__((unused)) = (({ lb_r_window_Presentation _lb_r8 = lb_window_Window_20acquire_presentation(&(lb_target)); if (_lb_r8.failed) {
        return ((lb_r_gpu_Surface){ .error = _lb_r8.error, .failed = true });
    } _lb_r8.value; }));
    lb_pos = "src/std/gpu/surface.lucb:11:9";
    lb_pos = "src/std/gpu/surface.lucb:12:9";
    void* lb_native __attribute__((unused)) = (({ lb_r_void_0p _lb_r9 = lb_gpu_20backend_surface_open(lb_device_state, lb_host); if (_lb_r9.failed) {
        (void)(lb_window_Presentation_destroy(&(lb_host)));
        return ((lb_r_gpu_Surface){ .error = _lb_r9.error, .failed = true });
    } _lb_r9.value; }));
    lb_pos = "src/std/gpu/surface.lucb:13:9";
    lb_pos = "src/std/gpu/surface.lucb:14:9";
    struct lb_gpu_SurfaceState* lb_state __attribute__((unused)) = (({ lb_r_gpu_SurfaceState_0p _lb_r10 = ({ lb_iface _lb_a11 = lb_memory_heap; lb_o_u8_0s _lb_ao11 = lb_alloc_call(_lb_a11, sizeof(lb_gpu_SurfaceState), _Alignof(lb_gpu_SurfaceState)); lb_r_gpu_SurfaceState_0p _lb_r11; if (!_lb_ao11.present) { _lb_r11 = ((lb_r_gpu_SurfaceState_0p){ .error = { .code = 208273409, .message = (lb_str){"memory.exhausted", 16} }, .failed = true }); } else { lb_gpu_SurfaceState* _lb_p11 = (lb_gpu_SurfaceState*)_lb_ao11.value.data; *_lb_p11 = ((lb_gpu_SurfaceState){.device = lb_device_state, .host = lb_host, .native = lb_native, .references = 1ULL}); _lb_r11.value = _lb_p11; _lb_r11.failed = false; } _lb_r11; }); if (_lb_r10.failed) {
        (void)(lb_gpu_23backend_surface_destroy(lb_device_state, lb_host, lb_native));
        (void)(lb_window_Presentation_destroy(&(lb_host)));
        return ((lb_r_gpu_Surface){ .error = _lb_r10.error, .failed = true });
    } _lb_r10.value; }));
    lb_pos = "src/std/gpu/surface.lucb:15:9";
    { size_t* lb__cell12 = &((lb_device_state)->references);
    (*(lb__cell12)) = (size_t)(lb_add_u((uint64_t)((*(lb__cell12))), (uint64_t)(1ULL), 64)); }
    lb_pos = "src/std/gpu/surface.lucb:16:9";
    lb_gpu_Surface _lb_ret13 = ((lb_gpu_Surface){.state = lb_state});
    return ((lb_r_gpu_Surface){ .value = _lb_ret13, .failed = false });
    lb_trap("unreachable");
}
lb_r_window_Size lb_gpu_Surface_size(const lb_gpu_Surface* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
...
lb_r_gpu_PresentResult lb_gpu_Surface_13clear_present(const lb_gpu_Surface* self, lb_gpu_Color lb_color) {
    ...
    struct lb_gpu_SurfaceState* lb_state __attribute__((unused)) = (({ lb_r_gpu_SurfaceState_0p _lb_r17 = lb_gpu_Surface_checked(self); if (_lb_r17.failed) {
        return ((lb_r_gpu_PresentResult){ .error = _lb_r17.error, .failed = true });
    } _lb_r17.value; }));
    lb_pos = "src/std/gpu/surface.lucb:31:9";
    (void)((({ lb_r_unit _lb_r18 = lb_gpu_11check_color(lb_color); if (_lb_r18.failed) {
        return ((lb_r_gpu_PresentResult){ .error = _lb_r18.error, .failed = true });
    } (void)0; })));
    lb_pos = "src/std/gpu/surface.lucb:33:9";
    (void)(((void)((({ lb_r_window_Size _lb_r19 = lb_window_Presentation_size(&((lb_state)->host)); if (_lb_r19.failed) {
        return ((lb_r_gpu_PresentResult){ .error = _lb_r19.error, .failed = true });
    } _lb_r19.value; })))));
    lb_pos = "src/std/gpu/surface.lucb:34:9";
    if (!!((lb_state)->active_frame)) 
    {
        lb_pos = "src/std/gpu/surface.lucb:35:13";
        lb_r_gpu_PresentResult _lb_err20 = ((lb_r_gpu_PresentResult){ .error = { .code = (int32_t)(lb_gpu_12frame_in_use), .message = ((lb_str){"finish the active frame before presenting", 41}) }, .failed = true });
        return _lb_err20;
    }
    lb_pos = "src/std/gpu/surface.lucb:36:9";
    uint8_t _lb_ret21 = (({ lb_r_gpu_PresentResult _lb_r22 = lb_gpu_21backend_clear_present((lb_state)->device, (lb_state)->host, (lb_state)->native, lb_color); if (_lb_r22.failed) {
        return ((lb_r_gpu_PresentResult){ .error = _lb_r22.error, .failed = true });
    } _lb_r22.value; }));
    return ((lb_r_gpu_PresentResult){ .value = _lb_ret21, .failed = false });
    lb_trap("unreachable");
}
lb_r_gpu_PresentResult lb_gpu_Surface_render(const lb_gpu_Surface* self, lb_gpu_Canvas lb_canvas, lb_gpu_Color lb_color) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/gpu/surface.lucb:42:9";
    struct lb_gpu_SurfaceState* lb_state __attribute__((unused)) = (({ lb_r_gpu_SurfaceState_0p _lb_r23 = lb_gpu_Surface_checked(self); if (_lb_r23.failed) {
        return ((lb_r_gpu_PresentResult){ .error = _lb_r23.error, .failed = true });
    } _lb_r23.value; }));
    lb_pos = "src/std/gpu/surface.lucb:43:9";
    (void)((({ lb_r_unit _lb_r24 = lb_gpu_11check_color(lb_color); if (_lb_r24.failed) {
        return ((lb_r_gpu_PresentResult){ .error = _lb_r24.error, .failed = true });
    } (void)0; })));
    lb_pos = "src/std/gpu/surface.lucb:44:9";
    (void)(((void)((({ lb_r_window_Size _lb_r25 = lb_window_Presentation_size(&((lb_state)->host)); if (_lb_r25.failed) {
        return ((lb_r_gpu_PresentResult){ .error = _lb_r25.error, .failed = true });
    } _lb_r25.value; })))));
    lb_pos = "src/std/gpu/surface.lucb:45:9";
    if (!!((lb_state)->active_frame)) 
    {
        lb_pos = "src/std/gpu/surface.lucb:46:13";
        lb_r_gpu_PresentResult _lb_err26 = ((lb_r_gpu_PresentResult){ .error = { .code = (int32_t)(lb_gpu_12frame_in_use), .message = ((lb_str){"finish the active frame before presenting", 41}) }, .failed = true });
        return _lb_err26;
    }
    lb_pos = "src/std/gpu/surface.lucb:47:9";
    uint8_t _lb_ret27 = (({ lb_r_gpu_PresentResult _lb_r28 = lb_gpu_14backend_render((lb_state)->device, (lb_state)->host, (lb_state)->native, lb_canvas, lb_color); if (_lb_r28.failed) {
        return ((lb_r_gpu_PresentResult){ .error = _lb_r28.error, .failed = true });
    } _lb_r28.value; }));
    return ((lb_r_gpu_PresentResult){ .value = _lb_ret27, .failed = false });
    lb_trap("unreachable");
}
lb_r_interop_Reference_0g1_gpu_Frame lb_gpu_Surface_frame(const lb_gpu_Surface* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/gpu/surface.lucb:52:9";
    struct lb_gpu_SurfaceState* lb_state __attribute__((unused)) = (({ lb_r_gpu_SurfaceState_0p _lb_r29 = lb_gpu_Surface_checked(self); if (_lb_r29.failed) {
        return ((lb_r_interop_Reference_0g1_gpu_Frame){ .error = _lb_r29.error, .failed = true });
    } _lb_r29.value; }));
    lb_pos = "src/std/gpu/surface.lucb:53:9";
    if (!!((lb_state)->active_frame)) 
    {
        lb_pos = "src/std/gpu/surface.lucb:54:13";
        lb_r_interop_Reference_0g1_gpu_Frame _lb_err30 = ((lb_r_interop_Reference_0g1_gpu_Frame){ .error = { .code = (int32_t)(lb_gpu_12frame_in_use), .message = ((lb_str){"the surface already has an active frame", 39}) }, .failed = true });
        return _lb_err30;
    }
    lb_pos = "src/std/gpu/surface.lucb:55:9";
    lb_window_Size lb_size __attribute__((unused)) = (({ lb_r_window_Size _lb_r31 = lb_window_Presentation_size(&((lb_state)->host)); if (_lb_r31.failed) {
        return ((lb_r_interop_Reference_0g1_gpu_Frame){ .error = _lb_r31.error, .failed = true });
    } _lb_r31.value; }));
    lb_pos = "src/std/gpu/surface.lucb:56:9";
    struct lb_gpu_Frame* lb_native __attribute__((unused)) = (({ lb_r_gpu_Frame_0p _lb_r32 = ({ lb_iface _lb_a33 = lb_memory_allocator; lb_o_u8_0s _lb_ao33 = lb_alloc_call(_lb_a33, sizeof(lb_gpu_Frame), _Alignof(lb_gpu_Frame)); lb_r_gpu_Frame_0p _lb_r33; if (!_lb_ao33.present) { _lb_r33 = ((lb_r_gpu_Frame_0p){ .error = { .code = 208273409, .message = (lb_str){"memory.exhausted", 16} }, .failed = true }); } else { lb_gpu_Frame* _lb_p33 = (lb_gpu_Frame*)_lb_ao33.value.data; memset(_lb_p33, 0, sizeof(lb_gpu_Frame)); lb_r_unit _lb_init33 = lb_gpu_Frame_init(_lb_p33, lb_size); if (_lb_init33.failed) { _lb_r33.failed = true; _lb_r33.error = _lb_init33.error; lb_release_call(_lb_a33, _lb_ao33.value); } else { _lb_r33.value = _lb_p33; _lb_r33.failed = false; } } _lb_r33; }); if (_lb_r32.failed) {
        return ((lb_r_interop_Reference_0g1_gpu_Frame){ .error = _lb_r32.error, .failed = true });
    } _lb_r32.value; }));
    lb_pos = "src/std/gpu/surface.lucb:57:9";
    lb_interop_Reference_0g1_gpu_Frame lb_owner __attribute__((unused)) = (({ lb_r_interop_Reference_0g1_gpu_Frame _lb_r34 = lb_interop_Reference_0g1_gpu_Frame_adopt(lb_native, lb_gpu_10frame_type, ((lb_iface){ ((void*)0), ((void*)0) })); if (_lb_r34.failed) {
        return ((lb_r_interop_Reference_0g1_gpu_Frame){ .error = _lb_r34.error, .failed = true });
    } _lb_r34.value; }));
    lb_pos = "src/std/gpu/surface.lucb:58:9";
    lb_pos = "src/std/gpu/surface.lucb:59:9";
    struct lb_gpu_FrameState* lb_recording __attribute__((unused)) = ({ lb_interop_Reference_0g1_gpu_FrameState _lb_rc = ((({ lb_r_interop_Reference_0g1_gpu_FrameState _lb_r35 = lb_gpu_Frame_11state_value(lb_native); if (_lb_r35.failed) {
        (void)(lb_interop_Reference_0g1_gpu_Frame_release(&(lb_owner)));
        return ((lb_r_interop_Reference_0g1_gpu_Frame){ .error = _lb_r35.error, .failed = true });
    } _lb_r35.value; }))); lb_interop_Reference_0g1_gpu_FrameState_value(&_lb_rc); });
    lb_pos = "src/std/gpu/surface.lucb:60:9";
    (lb_recording)->presentation = ((void*)(lb_state));
    lb_pos = "src/std/gpu/surface.lucb:61:9";
    (lb_recording)->validate = lb_gpu_19check_surface_frame;
    lb_pos = "src/std/gpu/surface.lucb:62:9";
    (lb_recording)->submit = lb_gpu_20submit_surface_frame;
    lb_pos = "src/std/gpu/surface.lucb:63:9";
    (lb_recording)->release = lb_gpu_21release_surface_frame;
    lb_pos = "src/std/gpu/surface.lucb:64:9";
    { size_t* lb__cell36 = &((lb_state)->references);
    (*(lb__cell36)) = (size_t)(lb_add_u((uint64_t)((*(lb__cell36))), (uint64_t)(1ULL), 64)); }
    lb_pos = "src/std/gpu/surface.lucb:65:9";
    (lb_state)->active_frame = true;
    lb_pos = "src/std/gpu/surface.lucb:66:9";
    lb_interop_Reference_0g1_gpu_Frame _lb_ret37 = lb_owner;
    return ((lb_r_interop_Reference_0g1_gpu_Frame){ .value = _lb_ret37, .failed = false });
    lb_trap("unreachable");
}
lb_r_unit lb_gpu_Surface_9wait_idle(const lb_gpu_Surface* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/gpu/surface.lucb:72:9";
    struct lb_gpu_SurfaceState* lb_state __attribute__((unused)) = (({ lb_r_gpu_SurfaceState_0p _lb_r38 = lb_gpu_Surface_checked(self); if (_lb_r38.failed) {
        return ((lb_r_unit){ .error = _lb_r38.error, .failed = true });
    } _lb_r38.value; }));
    lb_pos = "src/std/gpu/surface.lucb:73:9";
    (void)((({ lb_r_unit _lb_r39 = lb_gpu_20backend_surface_wait((lb_state)->device, (lb_state)->native); if (_lb_r39.failed) {
...
void lb_gpu_Surface_destroy(lb_gpu_Surface* self) {
    ...
    struct lb_gpu_SurfaceState* lb_state __attribute__((unused)) = ({ struct lb_gpu_SurfaceState* _lb_o40 = self->state; if (_lb_o40 == ((void*)0)) {
        return;
    } _lb_o40; });
    lb_pos = "src/std/gpu/surface.lucb:79:9";
    (void)(lb_gpu_14require_thread());
    lb_pos = "src/std/gpu/surface.lucb:80:9";
    self->state = ((void*)0);
    lb_pos = "src/std/gpu/surface.lucb:81:9";
    (lb_state)->closed = true;
    lb_pos = "src/std/gpu/surface.lucb:82:9";
    (void)(lb_gpu_15release_surface(lb_state));
}
__attribute__((weak)) void lb_interop_Packet_0g1_str_init(lb_interop_Packet_0g1_str* self, lb_str lb_value, void* lb_storage, lb_fn_0F1_void_0p_unit lb_dispose) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
...
lb_r_gpu_SurfaceState_0p lb_gpu_Surface_checked(const lb_gpu_Surface* self) {
    ...
    (void)((({ lb_r_unit _lb_r45 = lb_gpu_12check_thread(); if (_lb_r45.failed) {
        return ((lb_r_gpu_SurfaceState_0p){ .error = _lb_r45.error, .failed = true });
    } (void)0; })));
    lb_pos = "src/std/gpu/surface.lucb:86:9";
    struct lb_gpu_SurfaceState* lb_state __attribute__((unused)) = ({ struct lb_gpu_SurfaceState* _lb_o46 = self->state; if (_lb_o46 == ((void*)0)) {
        lb_r_gpu_SurfaceState_0p _lb_err47 = ((lb_r_gpu_SurfaceState_0p){ .error = { .code = (int32_t)(lb_gpu_closed), .message = ((lb_str){"the GPU surface is closed", 25}) }, .failed = true });
        return _lb_err47;
    } _lb_o46; });
    ...
    if (!!((lb_state)->closed)) 
    {
        ...
        lb_r_gpu_SurfaceState_0p _lb_err48 = ((lb_r_gpu_SurfaceState_0p){ .error = { .code = (int32_t)(lb_gpu_closed), .message = ((lb_str){"the GPU surface is closed", 25}) }, .failed = true });
        return _lb_err48;
    }
    lb_pos = "src/std/gpu/surface.lucb:89:9";
    struct lb_gpu_SurfaceState* _lb_ret49 = lb_state;
    return ((lb_r_gpu_SurfaceState_0p){ .value = _lb_ret49, .failed = false });
    lb_trap("unreachable");
}
__attribute__((weak)) void lb_interop_Reference_0g1_gpu_Frame_init(lb_interop_Reference_0g1_gpu_Frame* self, struct lb_interop_Owner_0g1_gpu_Frame* lb_owner) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
...
__attribute__((weak)) lb_r_gpu_Frame_0p lb_interop_Reference_0g1_gpu_Frame_get(const lb_interop_Reference_0g1_gpu_Frame* self) {
    ...
    return ((lb_r_gpu_Frame_0p){ .value = _lb_ret59, .failed = false });
    lb_trap("unreachable");
}
__attribute__((weak)) struct lb_gpu_Frame* lb_interop_Reference_0g1_gpu_Frame_value(const lb_interop_Reference_0g1_gpu_Frame* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
...
__attribute__((weak)) lb_r_interop_Lease lb_interop_Reference_0g1_gpu_Frame_lease(const lb_interop_Reference_0g1_gpu_Frame* self) {
    ...
    return ((lb_r_interop_Lease){ .value = _lb_ret67, .failed = false });
    lb_trap("unreachable");
}
__attribute__((weak)) lb_r_unit lb_interop_Reference_0g1_gpu_Frame_18validate_interface(struct lb_ownership_Object* lb_object) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
...
__attribute__((weak)) lb_r_gpu_FrameState_0p lb_interop_Reference_0g1_gpu_FrameState_get(const lb_interop_Reference_0g1_gpu_FrameState* self) {
    ...
    return ((lb_r_gpu_FrameState_0p){ .value = _lb_ret84, .failed = false });
    lb_trap("unreachable");
}
__attribute__((weak)) uint64_t lb_interop_Reference_0g1_gpu_FrameState_identity(const lb_interop_Reference_0g1_gpu_FrameState* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
...
__attribute__((weak)) lb_r_interop_Lease lb_interop_Reference_0g1_gpu_FrameState_lease(const lb_interop_Reference_0g1_gpu_FrameState* self) {
    ...
    return ((lb_r_interop_Lease){ .value = _lb_ret89, .failed = false });
    lb_trap("unreachable");
}
__attribute__((weak)) lb_r_unit lb_interop_Reference_0g1_gpu_FrameState_18validate_interface(struct lb_ownership_Object* lb_object) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
...
lb_r_unit lb_gpu_19check_surface_frame(void* lb_context, lb_window_Size lb_acquired) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/gpu/surface.lucb:111:5";
    struct lb_gpu_SurfaceState* lb_state __attribute__((unused)) = ((struct lb_gpu_SurfaceState*)(lb_context));
    lb_pos = "src/std/gpu/surface.lucb:112:5";
    (void)((({ lb_r_unit _lb_r94 = lb_gpu_12check_thread(); if (_lb_r94.failed) {
        return ((lb_r_unit){ .error = _lb_r94.error, .failed = true });
    } (void)0; })));
    lb_pos = "src/std/gpu/surface.lucb:113:5";
    if (!!((lb_state)->closed)) 
    {
        lb_pos = "src/std/gpu/surface.lucb:114:9";
        lb_r_unit _lb_err95 = ((lb_r_unit){ .error = { .code = (int32_t)(lb_gpu_closed), .message = ((lb_str){"the frame's surface is closed", 29}) }, .failed = true });
        return _lb_err95;
    }
    lb_pos = "src/std/gpu/surface.lucb:115:5";
    lb_window_Size lb_size __attribute__((unused)) = (({ lb_r_window_Size _lb_r96 = lb_window_Presentation_size(&((lb_state)->host)); if (_lb_r96.failed) {
        return ((lb_r_unit){ .error = _lb_r96.error, .failed = true });
    } _lb_r96.value; }));
    lb_pos = "src/std/gpu/surface.lucb:116:5";
    if (!!(((((!(lb_size.width == lb_acquired.width)) || (!(lb_size.height == lb_acquired.height))) || (!(lb_size.pixel_width == lb_acquired.pixel_width))) || (!(lb_size.pixel_height == lb_acquired.pixel_height))))) 
    {
        lb_pos = "src/std/gpu/surface.lucb:117:9";
        lb_r_unit _lb_err97 = ((lb_r_unit){ .error = { .code = (int32_t)(lb_gpu_13frame_resized), .message = ((lb_str){"the surface changed size; begin a new frame", 43}) }, .failed = true });
        return _lb_err97;
    }
    return ((lb_r_unit){ .failed = false });
}
lb_r_gpu_PresentResult lb_gpu_20submit_surface_frame(void* lb_context, lb_gpu_Canvas lb_canvas, lb_gpu_Color lb_color) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/gpu/surface.lucb:120:5";
    struct lb_gpu_SurfaceState* lb_state __attribute__((unused)) = ((struct lb_gpu_SurfaceState*)(lb_context));
    lb_pos = "src/std/gpu/surface.lucb:121:5";
    uint8_t _lb_ret98 = (({ lb_r_gpu_PresentResult _lb_r99 = lb_gpu_14backend_render((lb_state)->device, (lb_state)->host, (lb_state)->native, lb_canvas, lb_color); if (_lb_r99.failed) {
        return ((lb_r_gpu_PresentResult){ .error = _lb_r99.error, .failed = true });
    } _lb_r99.value; }));
    return ((lb_r_gpu_PresentResult){ .value = _lb_ret98, .failed = false });
    lb_trap("unreachable");
}
void lb_gpu_21release_surface_frame(void* lb_context) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/gpu/surface.lucb:124:5";
    (void)(lb_gpu_14require_thread());
    lb_pos = "src/std/gpu/surface.lucb:125:5";
    struct lb_gpu_SurfaceState* lb_state __attribute__((unused)) = ((struct lb_gpu_SurfaceState*)(lb_context));
    lb_pos = "src/std/gpu/surface.lucb:126:5";
    (lb_state)->active_frame = false;
    lb_pos = "src/std/gpu/surface.lucb:127:5";
    (void)(lb_gpu_15release_surface(lb_state));
}
void lb_gpu_15release_surface(struct lb_gpu_SurfaceState* lb_state) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/gpu/surface.lucb:102:5";
    { size_t* lb__cell100 = &((lb_state)->references);
    (*(lb__cell100)) = (size_t)(lb_sub_u((uint64_t)((*(lb__cell100))), (uint64_t)(1ULL), 64)); }
    lb_pos = "src/std/gpu/surface.lucb:103:5";
    if (!!(((lb_state)->references == 0ULL))) 
    {
        lb_pos = "src/std/gpu/surface.lucb:104:9";
        (void)(lb_gpu_23backend_surface_destroy((lb_state)->device, (lb_state)->host, (lb_state)->native));
        lb_pos = "src/std/gpu/surface.lucb:105:9";
        (void)(lb_window_Presentation_destroy(&((lb_state)->host)));
        lb_pos = "src/std/gpu/surface.lucb:106:9";
        (void)(lb_gpu_14release_device((lb_state)->device));
        lb_pos = "src/std/gpu/surface.lucb:107:9";
        lb_release_call(lb_memory_heap, (lb_span){ (void*)(lb_state), sizeof(lb_gpu_SurfaceState) });
    }
}
__attribute__((weak)) bool lb_interop_Owner_0g1_gpu_Frame_7is_open(struct lb_ownership_Object* lb_object) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
