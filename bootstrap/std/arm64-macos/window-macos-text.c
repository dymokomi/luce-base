...
size_t lb_window_13mac_not_found = 9223372036854775807ULL;
...
void lb_window_21mac_cancel_text_input(struct lb_window_State* lb_state) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/window/macos/text.lucb:105:5";
    (void)(lb_window_16mac_clear_marked(lb_state));
    lb_pos = "src/std/window/macos/text.lucb:106:5";
    void* _lb_o24 = (lb_state)->view;
    if (_lb_o24 != ((void*)0)) {
        void* lb_view __attribute__((unused)) = _lb_o24;
        {
            lb_pos = "src/std/window/macos/text.lucb:107:9";
            ...
            if (_lb_o25 != ((void*)0)) {
                ...
                {
                    lb_pos = "src/std/window/macos/text.lucb:108:13";
...
LuceWindowMacRange lb_window_16mac_marked_range(void* lb_object, void* lb_selector) {
    ...
    struct lb_window_State* lb_state __attribute__((unused)) = ({ struct lb_window_State* _lb_o56 = lb_window_9get_state(lb_object); if (_lb_o56 == ((void*)0)) {
        LuceWindowMacRange _lb_ret57 = ((LuceWindowMacRange){.location = lb_window_13mac_not_found, .length = 0ULL});
        return _lb_ret57;
    } _lb_o56; });
    lb_pos = "src/std/window/macos/text.lucb:72:5";
    void* lb_text __attribute__((unused)) = ({ void* _lb_o58 = (lb_state)->marked_text; if (_lb_o58 == ((void*)0)) {
        LuceWindowMacRange _lb_ret59 = ((LuceWindowMacRange){.location = lb_window_13mac_not_found, .length = 0ULL});
        return _lb_ret59;
    } _lb_o58; });
    lb_pos = "src/std/window/macos/text.lucb:73:5";
    LuceWindowMacRange _lb_ret60 = ({ size_t _lb_sq61 __attribute__((unused)) = 0ULL; size_t _lb_sq62 __attribute__((unused)) = ((size_t)lb_conv_u((uint64_t)(({ void* _lb_sq63 __attribute__((unused)) = lb_text; void* _lb_sq64 __attribute__((unused)) = lb_window_sel("length"); lb_c_window_8msg_uint(_lb_sq63, _lb_sq64); })), 64, 0, 64, 0, 1)); ((LuceWindowMacRange){.location = _lb_sq61, .length = _lb_sq62}); });
    return _lb_ret60;
    lb_trap("unreachable");
}
LuceWindowMacRange lb_window_18mac_selected_range(void* lb_object, void* lb_selector) {
    ...
    struct lb_window_State* lb_state __attribute__((unused)) = ({ struct lb_window_State* _lb_o65 = lb_window_9get_state(lb_object); if (_lb_o65 == ((void*)0)) {
        LuceWindowMacRange _lb_ret66 = ((LuceWindowMacRange){.location = 0ULL, .length = 0ULL});
        return _lb_ret66;
    } _lb_o65; });
    lb_pos = "src/std/window/macos/text.lucb:77:5";
    LuceWindowMacRange _lb_ret67 = ((LuceWindowMacRange){.location = (lb_state)->marked_selection, .length = (lb_state)->marked_length});
    return _lb_ret67;
    lb_trap("unreachable");
}
void* lb_window_21mac_marked_attributes(void* lb_object, void* lb_selector) {
    ...
    void* lb_array_type __attribute__((unused)) = ({ void* _lb_o68 = lb_x_window_13objc_getClass("NSArray"); if (_lb_o68 == ((void*)0)) {
        void* _lb_ret69 = ((void*)0);
        return _lb_ret69;
    } _lb_o68; });
    lb_pos = "src/std/window/macos/text.lucb:81:5";
    void* _lb_ret70 = ({ void* _lb_sq71 __attribute__((unused)) = lb_array_type; void* _lb_sq72 __attribute__((unused)) = lb_window_sel("array"); lb_c_window_7msg_ptr(_lb_sq71, _lb_sq72); });
    return _lb_ret70;
    lb_trap("unreachable");
}
void* lb_window_18mac_text_substring(void* lb_object, void* lb_selector, LuceWindowMacRange lb_range, struct LuceWindowMacRange* lb_actual) {
    ...
    struct LuceWindowMacRange* _lb_o73 = lb_actual;
    if (_lb_o73 != ((void*)0)) {
        struct LuceWindowMacRange* lb_destination __attribute__((unused)) = _lb_o73;
        {
...
size_t lb_window_14mac_text_index(void* lb_object, void* lb_selector, LuceWindowMacPoint lb_point) {
    ...
    size_t _lb_ret75 = lb_window_13mac_not_found;
    return _lb_ret75;
    lb_trap("unreachable");
}
LuceWindowMacRect lb_window_13mac_text_rect(void* lb_object, void* lb_selector, LuceWindowMacRange lb_range, struct LuceWindowMacRange* lb_actual) {
    ...
    struct LuceWindowMacRange* _lb_o76 = lb_actual;
    if (_lb_o76 != ((void*)0)) {
        struct LuceWindowMacRange* lb_destination __attribute__((unused)) = _lb_o76;
        {
    ...
    struct lb_window_State* lb_state __attribute__((unused)) = ({ struct lb_window_State* _lb_o77 = lb_window_9get_state(lb_object); if (_lb_o77 == ((void*)0)) {
        LuceWindowMacRect _lb_ret78 = ((LuceWindowMacRect){});
        return _lb_ret78;
    } _lb_o77; });
    lb_pos = "src/std/window/macos/text.lucb:95:5";
    void* lb_native __attribute__((unused)) = ({ void* _lb_o79 = (lb_state)->native; if (_lb_o79 == ((void*)0)) {
        LuceWindowMacRect _lb_ret80 = ((LuceWindowMacRect){});
        return _lb_ret80;
    } _lb_o79; });
    lb_pos = "src/std/window/macos/text.lucb:96:5";
    LuceWindowMacRect _lb_ret81 = ({ void* _lb_sq82 __attribute__((unused)) = lb_native; void* _lb_sq83 __attribute__((unused)) = lb_window_sel("convertRectToScreen:"); LuceWindowMacRect _lb_sq84 __attribute__((unused)) = ({ LuceWindowMacExtent _lb_sq85 __attribute__((unused)) = ((LuceWindowMacExtent){.width = 0x1.0000000000000p+0, .height = 0x1.2000000000000p+4}); ((LuceWindowMacRect){.size = _lb_sq85}); }); lb_c_window_11msg_backing(_lb_sq82, _lb_sq83, _lb_sq84); });
    return _lb_ret81;
    lb_trap("unreachable");
}
void lb_window_16mac_text_command(void* lb_object, void* lb_selector, void* lb_command) {
...
void* lb_window_14mac_plain_text(void* lb_value) {
    ...
    void* lb_string_type __attribute__((unused)) = ({ void* _lb_o86 = lb_x_window_13objc_getClass("NSString"); if (_lb_o86 == ((void*)0)) {
        void* _lb_ret87 = ((void*)0);
        return _lb_ret87;
    } _lb_o86; });
    lb_pos = "src/std/window/macos/text.lucb:23:5";
    if (!!(({ void* _lb_sq88 __attribute__((unused)) = lb_value; void* _lb_sq89 __attribute__((unused)) = lb_window_sel("isKindOfClass:"); void* _lb_sq90 __attribute__((unused)) = lb_string_type; lb_c_window_15msg_bool_object(_lb_sq88, _lb_sq89, _lb_sq90); }))) 
    {
        lb_pos = "src/std/window/macos/text.lucb:24:9";
        void* _lb_ret91 = lb_value;
        return _lb_ret91;
    }
    lb_pos = "src/std/window/macos/text.lucb:25:5";
    void* _lb_ret92 = ({ void* _lb_sq93 __attribute__((unused)) = lb_value; void* _lb_sq94 __attribute__((unused)) = lb_window_sel("string"); lb_c_window_7msg_ptr(_lb_sq93, _lb_sq94); });
    return _lb_ret92;
    lb_trap("unreachable");
}
