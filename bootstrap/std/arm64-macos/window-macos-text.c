...
size_t lb_window_13mac_not_found(void);
...
lb_r_unit lb_window_23mac_register_text_input(void* lb_native_type) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/window/macos/text.lucb:8:5";
    ...
    {
        lb_pos = "src/std/window/macos/text.lucb:10:9";
    ...
    lb_pos = "src/std/window/macos/text.lucb:20:5";
    ...
    lb_pos = "src/std/window/macos/text.lucb:21:5";
...
void lb_window_16mac_clear_marked(struct lb_window_State* lb_state) {
    ...
    if (_lb_o21 != ((void*)0)) {
        ...
        {
            lb_pos = "src/std/window/macos/text.lucb:31:9";
            (void)(({ void* _lb_sq22 __attribute__((unused)) = lb_text; void* _lb_sq23 __attribute__((unused)) = lb_window_sel("release"); lb_c_window_8msg_void(_lb_sq22, _lb_sq23); }));
        }
    }
    lb_pos = "src/std/window/macos/text.lucb:32:5";
    (lb_state)->marked_text = ((void*)0);
    lb_pos = "src/std/window/macos/text.lucb:33:5";
    (lb_state)->marked_selection = 0ULL;
    lb_pos = "src/std/window/macos/text.lucb:34:5";
    (lb_state)->marked_length = 0ULL;
}
void lb_window_21mac_cancel_text_input(struct lb_window_State* lb_state) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/window/macos/text.lucb:107:5";
    (void)(lb_window_16mac_clear_marked(lb_state));
    lb_pos = "src/std/window/macos/text.lucb:108:5";
    void* _lb_o24 = (lb_state)->view;
    if (_lb_o24 != ((void*)0)) {
        void* lb_view __attribute__((unused)) = _lb_o24;
        {
            lb_pos = "src/std/window/macos/text.lucb:109:9";
            void* _lb_o25 = ({ void* _lb_sq26 __attribute__((unused)) = lb_view; void* _lb_sq27 __attribute__((unused)) = lb_window_sel("inputContext"); lb_c_window_7msg_ptr(_lb_sq26, _lb_sq27); });
            if (_lb_o25 != ((void*)0)) {
                void* lb_context __attribute__((unused)) = _lb_o25;
                {
                    lb_pos = "src/std/window/macos/text.lucb:110:13";
                    (void)(({ void* _lb_sq28 __attribute__((unused)) = lb_context; void* _lb_sq29 __attribute__((unused)) = lb_window_sel("discardMarkedText"); lb_c_window_8msg_void(_lb_sq28, _lb_sq29); }));
                }
            }
        }
    }
...
void lb_window_15mac_insert_text(void* lb_object, void* lb_selector, void* lb_value, LuceWindowMacRange lb_replacement) {
    ...
    struct lb_window_State* lb_state __attribute__((unused)) = ({ struct lb_window_State* _lb_o34 = lb_window_9get_state(lb_object); if (_lb_o34 == ((void*)0)) {
        return;
    } _lb_o34; });
    lb_pos = "src/std/window/macos/text.lucb:38:5";
    (void)(lb_window_16mac_clear_marked(lb_state));
    lb_pos = "src/std/window/macos/text.lucb:39:5";
    if (!!((!(lb_state)->text_input))) 
    {
        lb_pos = "src/std/window/macos/text.lucb:40:9";
        return;
    }
    lb_pos = "src/std/window/macos/text.lucb:41:5";
    void* lb_text __attribute__((unused)) = ({ void* _lb_o35 = lb_window_14mac_plain_text(lb_value); if (_lb_o35 == ((void*)0)) {
        return;
    } _lb_o35; });
    lb_pos = "src/std/window/macos/text.lucb:42:5";
    size_t lb_count __attribute__((unused)) = ((size_t)lb_conv_u((uint64_t)(({ void* _lb_sq36 __attribute__((unused)) = lb_text; void* _lb_sq37 __attribute__((unused)) = lb_window_sel("length"); lb_c_window_8msg_uint(_lb_sq36, _lb_sq37); })), 64, 0, 64, 0, 1));
    lb_pos = "src/std/window/macos/text.lucb:44:5";
    if (!!((((size_t)(lb_count)) > ((size_t)((size_t)(lb_sub_u((uint64_t)(256ULL), (uint64_t)((lb_state)->count), 64))))))) 
    {
        lb_pos = "src/std/window/macos/text.lucb:45:9";
    ...
    for (size_t lb_index __attribute__((unused)) = (size_t)(0ULL); lb_index < (size_t)(lb_count); lb_index++) {
        {
            ...
            (void)(({ struct lb_window_State* _lb_sq39 __attribute__((unused)) = lb_state; uint16_t _lb_sq40 __attribute__((unused)) = ({ void* _lb_sq41 __attribute__((unused)) = lb_text; void* _lb_sq42 __attribute__((unused)) = lb_window_sel("characterAtIndex:"); size_t _lb_sq43 __attribute__((unused)) = lb_index; lb_c_window_13msg_character(_lb_sq41, _lb_sq42, _lb_sq43); }); lb_window_10push_utf16(_lb_sq39, _lb_sq40); }));
        }
    }
    lb_pos = "src/std/window/macos/text.lucb:49:5";
    if (!!((!((lb_state)->pending_surrogate == 0ULL)))) 
    {
        lb_pos = "src/std/window/macos/text.lucb:50:9";
        (lb_state)->pending_surrogate = 0ULL;
        lb_pos = "src/std/window/macos/text.lucb:51:9";
...
void lb_window_14mac_set_marked(void* lb_object, void* lb_selector, void* lb_value, LuceWindowMacRange lb_selection, LuceWindowMacRange lb_replacement) {
    ...
    struct lb_window_State* lb_state __attribute__((unused)) = ({ struct lb_window_State* _lb_o44 = lb_window_9get_state(lb_object); if (_lb_o44 == ((void*)0)) {
        return;
    } _lb_o44; });
    lb_pos = "src/std/window/macos/text.lucb:55:5";
    (void)(lb_window_16mac_clear_marked(lb_state));
    lb_pos = "src/std/window/macos/text.lucb:56:5";
    if (!!((!(lb_state)->text_input))) 
    {
        lb_pos = "src/std/window/macos/text.lucb:57:9";
        return;
    }
    lb_pos = "src/std/window/macos/text.lucb:58:5";
    void* lb_text __attribute__((unused)) = ({ void* _lb_o45 = lb_window_14mac_plain_text(lb_value); if (_lb_o45 == ((void*)0)) {
        return;
    } _lb_o45; });
    lb_pos = "src/std/window/macos/text.lucb:59:5";
    if (!!(({ uint64_t _lb_sq46 __attribute__((unused)) = ({ void* _lb_sq47 __attribute__((unused)) = lb_text; void* _lb_sq48 __attribute__((unused)) = lb_window_sel("length"); lb_c_window_8msg_uint(_lb_sq47, _lb_sq48); }); uint64_t _lb_sq49 __attribute__((unused)) = 0ULL; (((uint64_t)(_lb_sq46)) > ((uint64_t)(_lb_sq49))); }))) 
    {
        lb_pos = "src/std/window/macos/text.lucb:60:9";
        (lb_state)->marked_text = ({ void* _lb_sq50 __attribute__((unused)) = lb_text; void* _lb_sq51 __attribute__((unused)) = lb_window_sel("copy"); lb_c_window_7msg_ptr(_lb_sq50, _lb_sq51); });
        lb_pos = "src/std/window/macos/text.lucb:61:9";
        (lb_state)->marked_selection = lb_selection.location;
        lb_pos = "src/std/window/macos/text.lucb:62:9";
        (lb_state)->marked_length = lb_selection.length;
    }
}
void lb_window_10mac_unmark(void* lb_object, void* lb_selector) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/window/macos/text.lucb:65:5";
    struct lb_window_State* _lb_o52 = lb_window_9get_state(lb_object);
    if (_lb_o52 != ((void*)0)) {
        struct lb_window_State* lb_state __attribute__((unused)) = _lb_o52;
        {
            lb_pos = "src/std/window/macos/text.lucb:66:9";
            (void)(lb_window_16mac_clear_marked(lb_state));
        }
    }
}
bool lb_window_14mac_has_marked(void* lb_object, void* lb_selector) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/window/macos/text.lucb:69:5";
    struct lb_window_State* lb_state __attribute__((unused)) = ({ struct lb_window_State* _lb_o53 = lb_window_9get_state(lb_object); if (_lb_o53 == ((void*)0)) {
        bool _lb_ret54 = false;
        return _lb_ret54;
    } _lb_o53; });
    lb_pos = "src/std/window/macos/text.lucb:70:5";
    bool _lb_ret55 = (!((lb_state)->marked_text == ((void*)0)));
    return _lb_ret55;
    lb_trap("unreachable");
}
LuceWindowMacRange lb_window_16mac_marked_range(void* lb_object, void* lb_selector) {
    ...
    struct lb_window_State* lb_state __attribute__((unused)) = ({ struct lb_window_State* _lb_o56 = lb_window_9get_state(lb_object); if (_lb_o56 == ((void*)0)) {
        LuceWindowMacRange _lb_ret57 = ({ size_t _lb_sq58 __attribute__((unused)) = lb_window_13mac_not_found(); size_t _lb_sq59 __attribute__((unused)) = 0ULL; ((LuceWindowMacRange){.location = _lb_sq58, .length = _lb_sq59}); });
        return _lb_ret57;
    } _lb_o56; });
    lb_pos = "src/std/window/macos/text.lucb:74:5";
    void* lb_text __attribute__((unused)) = ({ void* _lb_o60 = (lb_state)->marked_text; if (_lb_o60 == ((void*)0)) {
        LuceWindowMacRange _lb_ret61 = ({ size_t _lb_sq62 __attribute__((unused)) = lb_window_13mac_not_found(); size_t _lb_sq63 __attribute__((unused)) = 0ULL; ((LuceWindowMacRange){.location = _lb_sq62, .length = _lb_sq63}); });
        return _lb_ret61;
    } _lb_o60; });
    lb_pos = "src/std/window/macos/text.lucb:75:5";
    LuceWindowMacRange _lb_ret64 = ({ size_t _lb_sq65 __attribute__((unused)) = 0ULL; size_t _lb_sq66 __attribute__((unused)) = ((size_t)lb_conv_u((uint64_t)(({ void* _lb_sq67 __attribute__((unused)) = lb_text; void* _lb_sq68 __attribute__((unused)) = lb_window_sel("length"); lb_c_window_8msg_uint(_lb_sq67, _lb_sq68); })), 64, 0, 64, 0, 1)); ((LuceWindowMacRange){.location = _lb_sq65, .length = _lb_sq66}); });
    return _lb_ret64;
    lb_trap("unreachable");
}
LuceWindowMacRange lb_window_18mac_selected_range(void* lb_object, void* lb_selector) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/window/macos/text.lucb:78:5";
    struct lb_window_State* lb_state __attribute__((unused)) = ({ struct lb_window_State* _lb_o69 = lb_window_9get_state(lb_object); if (_lb_o69 == ((void*)0)) {
        LuceWindowMacRange _lb_ret70 = ((LuceWindowMacRange){.location = 0ULL, .length = 0ULL});
        return _lb_ret70;
    } _lb_o69; });
    lb_pos = "src/std/window/macos/text.lucb:79:5";
    LuceWindowMacRange _lb_ret71 = ((LuceWindowMacRange){.location = (lb_state)->marked_selection, .length = (lb_state)->marked_length});
    return _lb_ret71;
    lb_trap("unreachable");
}
void* lb_window_21mac_marked_attributes(void* lb_object, void* lb_selector) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/window/macos/text.lucb:82:5";
    void* lb_array_type __attribute__((unused)) = ({ void* _lb_o72 = lb_x_window_13objc_getClass("NSArray"); if (_lb_o72 == ((void*)0)) {
        void* _lb_ret73 = ((void*)0);
        return _lb_ret73;
    } _lb_o72; });
    lb_pos = "src/std/window/macos/text.lucb:83:5";
    void* _lb_ret74 = ({ void* _lb_sq75 __attribute__((unused)) = lb_array_type; void* _lb_sq76 __attribute__((unused)) = lb_window_sel("array"); lb_c_window_7msg_ptr(_lb_sq75, _lb_sq76); });
    return _lb_ret74;
    lb_trap("unreachable");
}
void* lb_window_18mac_text_substring(void* lb_object, void* lb_selector, LuceWindowMacRange lb_range, struct LuceWindowMacRange* lb_actual) {
    ...
    struct LuceWindowMacRange* _lb_o77 = lb_actual;
    if (_lb_o77 != ((void*)0)) {
        struct LuceWindowMacRange* lb_destination __attribute__((unused)) = _lb_o77;
        {
            lb_pos = "src/std/window/macos/text.lucb:87:9";
            (*(lb_destination)) = ({ size_t _lb_sq78 __attribute__((unused)) = lb_window_13mac_not_found(); size_t _lb_sq79 __attribute__((unused)) = 0ULL; ((LuceWindowMacRange){.location = _lb_sq78, .length = _lb_sq79}); });
        }
    }
    lb_pos = "src/std/window/macos/text.lucb:88:5";
    void* _lb_ret80 = ((void*)0);
    return _lb_ret80;
    lb_trap("unreachable");
}
size_t lb_window_14mac_text_index(void* lb_object, void* lb_selector, LuceWindowMacPoint lb_point) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/window/macos/text.lucb:91:5";
    size_t _lb_ret81 = lb_window_13mac_not_found();
    return _lb_ret81;
    lb_trap("unreachable");
}
LuceWindowMacRect lb_window_13mac_text_rect(void* lb_object, void* lb_selector, LuceWindowMacRange lb_range, struct LuceWindowMacRange* lb_actual) {
    ...
    struct LuceWindowMacRange* _lb_o82 = lb_actual;
    if (_lb_o82 != ((void*)0)) {
        struct LuceWindowMacRange* lb_destination __attribute__((unused)) = _lb_o82;
        {
            lb_pos = "src/std/window/macos/text.lucb:95:9";
            (*(lb_destination)) = lb_range;
        }
    }
    lb_pos = "src/std/window/macos/text.lucb:96:5";
    struct lb_window_State* lb_state __attribute__((unused)) = ({ struct lb_window_State* _lb_o83 = lb_window_9get_state(lb_object); if (_lb_o83 == ((void*)0)) {
        LuceWindowMacRect _lb_ret84 = ((LuceWindowMacRect){});
        return _lb_ret84;
    } _lb_o83; });
    lb_pos = "src/std/window/macos/text.lucb:97:5";
    void* lb_native __attribute__((unused)) = ({ void* _lb_o85 = (lb_state)->native; if (_lb_o85 == ((void*)0)) {
        LuceWindowMacRect _lb_ret86 = ((LuceWindowMacRect){});
        return _lb_ret86;
    } _lb_o85; });
    lb_pos = "src/std/window/macos/text.lucb:98:5";
    LuceWindowMacRect _lb_ret87 = ({ void* _lb_sq88 __attribute__((unused)) = lb_native; void* _lb_sq89 __attribute__((unused)) = lb_window_sel("convertRectToScreen:"); LuceWindowMacRect _lb_sq90 __attribute__((unused)) = ({ LuceWindowMacExtent _lb_sq91 __attribute__((unused)) = ((LuceWindowMacExtent){.width = 0x1.0000000000000p+0, .height = 0x1.2000000000000p+4}); ((LuceWindowMacRect){.size = _lb_sq91}); }); lb_c_window_11msg_backing(_lb_sq88, _lb_sq89, _lb_sq90); });
    return _lb_ret87;
    lb_trap("unreachable");
}
void lb_window_16mac_text_command(void* lb_object, void* lb_selector, void* lb_command) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/window/macos/text.lucb:102:5";
    (void)(((void)(lb_command)));
}
void* lb_window_14mac_plain_text(void* lb_value) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/window/macos/text.lucb:24:5";
    void* lb_string_type __attribute__((unused)) = ({ void* _lb_o92 = lb_x_window_13objc_getClass("NSString"); if (_lb_o92 == ((void*)0)) {
        void* _lb_ret93 = ((void*)0);
        return _lb_ret93;
    } _lb_o92; });
    lb_pos = "src/std/window/macos/text.lucb:25:5";
    if (!!(({ void* _lb_sq94 __attribute__((unused)) = lb_value; void* _lb_sq95 __attribute__((unused)) = lb_window_sel("isKindOfClass:"); void* _lb_sq96 __attribute__((unused)) = lb_string_type; lb_c_window_15msg_bool_object(_lb_sq94, _lb_sq95, _lb_sq96); }))) 
    {
        lb_pos = "src/std/window/macos/text.lucb:26:9";
        void* _lb_ret97 = lb_value;
        return _lb_ret97;
    }
    lb_pos = "src/std/window/macos/text.lucb:27:5";
    void* _lb_ret98 = ({ void* _lb_sq99 __attribute__((unused)) = lb_value; void* _lb_sq100 __attribute__((unused)) = lb_window_sel("string"); lb_c_window_7msg_ptr(_lb_sq99, _lb_sq100); });
    return _lb_ret98;
    lb_trap("unreachable");
}
size_t lb_window_13mac_not_found(void) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/window/macos/text.lucb:5:5";
    size_t _lb_ret101 = (size_t)(lb_shr_u((uint64_t)(((size_t)lb_not_u((uint64_t)(((size_t)lb_conv_s((int64_t)(0LL), 64, 1, 64, 0, 1))), 64))), (uint64_t)((size_t)(1LL)), 64));
    return _lb_ret101;
    lb_trap("unreachable");
}
