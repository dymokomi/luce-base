...
lb_r_window_State_0p lb_window_Presentation_checked(const lb_window_Presentation* self);
...
lb_r_window_Size lb_window_Presentation_size(const lb_window_Presentation* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/window/presentation.lucb:9:9";
    struct lb_window_State* lb_state __attribute__((unused)) = (({ lb_r_window_State_0p _lb_r7 = lb_window_Presentation_checked(self); if (_lb_r7.failed) {
        return ((lb_r_window_Size){ .error = _lb_r7.error, .failed = true });
    } _lb_r7.value; }));
    {
        lb_pos = "src/std/window/presentation.lucb:11:13";
        lb_window_Size _lb_ret8 = lb_window_8mac_size(lb_state);
        return ((lb_r_window_Size){ .value = _lb_ret8, .failed = false });
    }
    lb_trap("unreachable");
}
lb_r_bool lb_window_Presentation_visible(const lb_window_Presentation* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/window/presentation.lucb:19:9";
    struct lb_window_State* lb_state __attribute__((unused)) = (({ lb_r_window_State_0p _lb_r9 = lb_window_Presentation_checked(self); if (_lb_r9.failed) {
        return ((lb_r_bool){ .error = _lb_r9.error, .failed = true });
    } _lb_r9.value; }));
    {
        lb_pos = "src/std/window/presentation.lucb:21:13";
        void* lb_native __attribute__((unused)) = lb_window_required((lb_state)->native);
        lb_pos = "src/std/window/presentation.lucb:22:13";
        bool _lb_ret10 = (({ void* _lb_sq11 __attribute__((unused)) = lb_native; void* _lb_sq12 __attribute__((unused)) = lb_window_sel("isVisible"); lb_c_window_8msg_bool(_lb_sq11, _lb_sq12); }) && (!({ void* _lb_sq13 __attribute__((unused)) = lb_native; void* _lb_sq14 __attribute__((unused)) = lb_window_sel("isMiniaturized"); lb_c_window_8msg_bool(_lb_sq13, _lb_sq14); })));
        return ((lb_r_bool){ .value = _lb_ret10, .failed = false });
    }
    lb_trap("unreachable");
}
lb_r_void_0p lb_window_Presentation_10macos_view(const lb_window_Presentation* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/window/presentation.lucb:33:9";
    struct lb_window_State* lb_state __attribute__((unused)) = (({ lb_r_window_State_0p _lb_r15 = lb_window_Presentation_checked(self); if (_lb_r15.failed) {
        return ((lb_r_void_0p){ .error = _lb_r15.error, .failed = true });
    } _lb_r15.value; }));
    {
        lb_pos = "src/std/window/presentation.lucb:35:13";
        void* _lb_ret16 = lb_window_required((lb_state)->view);
        return ((lb_r_void_0p){ .value = _lb_ret16, .failed = false });
    }
    lb_trap("unreachable");
}
lb_r_void_0p lb_window_Presentation_14windows_handle(const lb_window_Presentation* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/window/presentation.lucb:40:9";
    struct lb_window_State* lb_state __attribute__((unused)) = (({ lb_r_window_State_0p _lb_r17 = lb_window_Presentation_checked(self); if (_lb_r17.failed) {
        return ((lb_r_void_0p){ .error = _lb_r17.error, .failed = true });
    } _lb_r17.value; }));
    {
    }
    lb_pos = "src/std/window/presentation.lucb:43:9";
    lb_r_void_0p _lb_err18 = ((lb_r_void_0p){ .error = { .code = (int32_t)(lb_window_unsupported), .message = ((lb_str){"this window has no Windows handle", 33}) }, .failed = true });
    return _lb_err18;
    lb_trap("unreachable");
}
void lb_window_Presentation_destroy(lb_window_Presentation* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/window/presentation.lucb:46:9";
    struct lb_window_State* lb_state __attribute__((unused)) = ({ struct lb_window_State* _lb_o19 = self->state; if (_lb_o19 == ((void*)0)) {
        return;
    } _lb_o19; });
    lb_pos = "src/std/window/presentation.lucb:50:9";
    (void)(({ lb_error _lb_fe20 __attribute__((unused)); int32_t _lb_v20 __attribute__((unused)) = 0; (void)(({ lb_r_unit _lb_r21 = lb_window_12check_thread(); if (_lb_r21.failed) {
        _lb_fe20 = _lb_r21.error;
        goto _lb_fh20;
    } (void)0; })); goto _lb_cd20; _lb_fh20: { 
        lb_error lb_failure __attribute__((unused)) = _lb_fe20;
        {
            lb_pos = "src/std/window/presentation.lucb:48:13";
            (void)(((void)(lb_failure)));
            lb_pos = "src/std/window/presentation.lucb:49:13";
            (void)(lb_trap_text(((lb_str){"presentation lease destruction requires the main thread", 55})));
        }
    } _lb_cd20: __attribute__((unused)); (void)0; }));
    lb_pos = "src/std/window/presentation.lucb:50:9";
    self->state = ((void*)0);
    lb_pos = "src/std/window/presentation.lucb:51:9";
    (lb_state)->presentation_held = false;
    {
        lb_pos = "src/std/window/presentation.lucb:53:13";
        if (!!((lb_state)->destroyed)) 
        {
            lb_pos = "src/std/window/presentation.lucb:54:17";
...
lb_r_window_State_0p lb_window_Presentation_checked(const lb_window_Presentation* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/window/presentation.lucb:59:9";
    (void)((({ lb_r_unit _lb_r26 = lb_window_12check_thread(); if (_lb_r26.failed) {
        return ((lb_r_window_State_0p){ .error = _lb_r26.error, .failed = true });
    } (void)0; })));
    lb_pos = "src/std/window/presentation.lucb:60:9";
    struct lb_window_State* lb_state __attribute__((unused)) = ({ struct lb_window_State* _lb_o27 = self->state; if (_lb_o27 == ((void*)0)) {
        lb_r_window_State_0p _lb_err28 = ((lb_r_window_State_0p){ .error = { .code = (int32_t)(lb_window_closed), .message = ((lb_str){"the presentation lease is closed", 32}) }, .failed = true });
        return _lb_err28;
    } _lb_o27; });
    lb_pos = "src/std/window/presentation.lucb:61:9";
    if (!!((lb_state)->destroyed)) 
    {
        lb_pos = "src/std/window/presentation.lucb:62:13";
        lb_r_window_State_0p _lb_err29 = ((lb_r_window_State_0p){ .error = { .code = (int32_t)(lb_window_closed), .message = ((lb_str){"the presentation window is closed", 33}) }, .failed = true });
        return _lb_err29;
    }
    lb_pos = "src/std/window/presentation.lucb:63:9";
    struct lb_window_State* _lb_ret30 = lb_state;
    return ((lb_r_window_State_0p){ .value = _lb_ret30, .failed = false });
    lb_trap("unreachable");
}
