...
L0_2:
    ...
    mov w15, w9
L0_3:
    adrp x12, _lb_process_12non_blocking@PAGE
    add x12, x12, _lb_process_12non_blocking@PAGEOFF
    str w15, [x12]
    ldrb w12, [x14]
    cbnz w12, L0_4
    b L0_5
...
L5_104:
    ...
    sub x26, x29, #1200
    sub x22, x29, #1208
    adrp x27, _lb_process_7poll_in@PAGE
    add x27, x27, _lb_process_7poll_in@PAGEOFF
    add x28, x22, #4
    add x9, x22, #6
    str x9, [sp, #112]
    add x23, x26, #8
