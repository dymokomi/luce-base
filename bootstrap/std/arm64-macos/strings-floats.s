    ...
    .p2align 2
    .globl _lb_strings_floats_0init
_lb_strings_floats_0init:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    sub sp, sp, #16
    mov sp, x29
    ...
    .no_dead_strip _lb_strings_9parse_f64
...
L1_34:
    ...
    adrp x1, l_text_61@PAGE
    add x1, x1, l_text_61@PAGEOFF
    bl _lb_core_7trap_at
L1_33:
    ldr d24, [x19]
    b L1_36
...
L1_67:
    ...
    .no_dead_strip _lb_strings_9parse_f32
...
L2_67:
    ...
    .no_dead_strip _lb_strings_10format_f64
...
L3_4:
    ...
    .no_dead_strip _lb_strings_10format_f32
...
L7_19:
    ...
    bl _lb_strings_NumericLocale_handle
    mov x14, x0
    adrp x12, l_text_26@PAGE
    add x12, x12, l_text_26@PAGEOFF
    sub x13, x29, #144
    ldrsw x13, [x13]
    ldr d24, [x19]
    movz x16, #16
...
L8_13:
    ...
    adrp x1, l_text_56@PAGE
    add x1, x1, l_text_56@PAGEOFF
    bl _lb_core_7trap_at
1:
    mov x15, x9
    cmp x15, x14
...
L10_19:
    ...
    .no_dead_strip _lb_memory_read_0g1_f64
...
L11_3:
    ...
    .no_dead_strip _lb_memory_read_0g1_u64
...
L12_3:
    ...
    .no_dead_strip _lb_memory_read_0g1_f32
...
L13_3:
    ...
    .no_dead_strip _lb_memory_read_0g1_u32
