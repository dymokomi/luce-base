...
void lb_process_12stop_command(int32_t lb_pid);
int32_t lb_c_errno(void);
lb_r_unit lb_process_12pull_command(struct lb_process_Capture* lb_stream, struct lb_process_CommandState* lb_state);
...
lb_r_i32 lb_process_15capture_command(int32_t lb_pid, struct lb_process_Capture* lb_out_, struct lb_process_Capture* lb_err, struct lb_process_CommandState* lb_state) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/process/command/posix.lucb:11:5";
    lb_pos = "src/std/process/command/posix.lucb:12:5";
    if (!!((({ int32_t _lb_sq7 __attribute__((unused)) = lb_x_process_fcntl((lb_out_)->descriptor, lb_process_9set_flags, lb_process_12non_blocking); int32_t _lb_sq8 __attribute__((unused)) = 0LL; (((int32_t)(_lb_sq7)) < ((int32_t)(_lb_sq8))); }) || ({ int32_t _lb_sq9 __attribute__((unused)) = lb_x_process_fcntl((lb_err)->descriptor, lb_process_9set_flags, lb_process_12non_blocking); int32_t _lb_sq10 __attribute__((unused)) = 0LL; (((int32_t)(_lb_sq9)) < ((int32_t)(_lb_sq10))); })))) 
    {
        lb_pos = "src/std/process/command/posix.lucb:13:9";
        lb_r_i32 _lb_err11 = ((lb_r_i32){ .error = { .code = (int32_t)(lb_process_failed), .message = ((lb_str){"the command output cannot be read", 33}) }, .failed = true });
        (void)(lb_process_12stop_command(lb_pid));
        return _lb_err11;
    }
    lb_pos = "src/std/process/command/posix.lucb:14:5";
    for (;;) {
        lb_pos = "src/std/process/command/posix.lucb:14:5";
        if (!(true)) break;
        {
            lb_pos = "src/std/process/command/posix.lucb:15:9";
            if (!!(((bool)atomic_load_explicit(&((lb_state)->cancelled), memory_order_acquire)))) 
            {
                lb_pos = "src/std/process/command/posix.lucb:16:13";
                lb_r_i32 _lb_err13 = ((lb_r_i32){ .error = { .code = (int32_t)(lb_process_failed), .message = ((lb_str){"command cancelled", 17}) }, .failed = true });
                (void)(lb_process_12stop_command(lb_pid));
                return _lb_err13;
            }
            lb_pos = "src/std/process/command/posix.lucb:17:9";
            lb_a_process_Poll_0a2 lb_watched __attribute__((unused));
            lb_pos = "src/std/process/command/posix.lucb:18:9";
            ((lb_watched).d[0]) = ((Poll){.descriptor = ((lb_out_)->open ? (lb_out_)->descriptor : ((int32_t)(-1LL))), .events = lb_process_7poll_in, .returned = 0LL});
            lb_pos = "src/std/process/command/posix.lucb:19:9";
            ((lb_watched).d[1]) = ((Poll){.descriptor = ((lb_err)->open ? (lb_err)->descriptor : ((int32_t)(-1LL))), .events = lb_process_7poll_in, .returned = 0LL});
            lb_pos = "src/std/process/command/posix.lucb:20:9";
            if (!!(({ int32_t _lb_sq14 __attribute__((unused)) = lb_x_process_poll(((struct Poll*)(lb_watched.d)), 2ULL, 20LL); int32_t _lb_sq15 __attribute__((unused)) = 0LL; (((int32_t)(_lb_sq14)) < ((int32_t)(_lb_sq15))); }))) 
            {
                lb_pos = "src/std/process/command/posix.lucb:21:13";
                if (!!(({ int32_t _lb_sq16 __attribute__((unused)) = lb_c_errno(); int32_t _lb_sq17 __attribute__((unused)) = lb_c_interrupted; (_lb_sq16 == _lb_sq17); }))) 
                {
                    lb_pos = "src/std/process/command/posix.lucb:22:17";
                    continue;
                }
                lb_pos = "src/std/process/command/posix.lucb:23:13";
                lb_r_i32 _lb_err18 = ((lb_r_i32){ .error = { .code = (int32_t)(lb_process_failed), .message = ((lb_str){"the command output cannot be read", 33}) }, .failed = true });
                (void)(lb_process_12stop_command(lb_pid));
                return _lb_err18;
            }
            lb_pos = "src/std/process/command/posix.lucb:24:9";
            if (!!(((lb_out_)->open && (!(((lb_watched).d[0]).returned == 0LL))))) 
            {
                lb_pos = "src/std/process/command/posix.lucb:25:13";
                (void)((({ lb_r_unit _lb_r19 = lb_process_12pull_command(lb_out_, lb_state); if (_lb_r19.failed) {
                    (void)(lb_process_12stop_command(lb_pid));
                    return ((lb_r_i32){ .error = _lb_r19.error, .failed = true });
                } (void)0; })));
            }
            lb_pos = "src/std/process/command/posix.lucb:26:9";
            if (!!(((lb_err)->open && (!(((lb_watched).d[1]).returned == 0LL))))) 
            {
                lb_pos = "src/std/process/command/posix.lucb:27:13";
                (void)((({ lb_r_unit _lb_r20 = lb_process_12pull_command(lb_err, lb_state); if (_lb_r20.failed) {
                    (void)(lb_process_12stop_command(lb_pid));
                    return ((lb_r_i32){ .error = _lb_r20.error, .failed = true });
                } (void)0; })));
            }
            lb_pos = "src/std/process/command/posix.lucb:30:9";
            if (!!(((!(lb_out_)->open) && (!(lb_err)->open)))) 
            {
                lb_pos = "src/std/process/command/posix.lucb:31:13";
                int32_t lb_status __attribute__((unused)) = 0LL;
                lb_pos = "src/std/process/command/posix.lucb:32:13";
                int32_t lb_result __attribute__((unused)) = lb_x_process_waitpid(lb_pid, &(lb_status), 1LL);
                lb_pos = "src/std/process/command/posix.lucb:33:13";
                if (!!((lb_result == lb_pid))) 
                {
                    lb_pos = "src/std/process/command/posix.lucb:34:17";
                    int32_t _lb_ret21 = lb_status;
                    return ((lb_r_i32){ .value = _lb_ret21, .failed = false });
                }
                lb_pos = "src/std/process/command/posix.lucb:35:13";
                if (!!(((((int32_t)(lb_result)) < ((int32_t)(0LL))) && ({ int32_t _lb_sq22 __attribute__((unused)) = lb_c_errno(); int32_t _lb_sq23 __attribute__((unused)) = lb_c_interrupted; (!(_lb_sq22 == _lb_sq23)); })))) 
                {
                    lb_pos = "src/std/process/command/posix.lucb:36:17";
                    lb_r_i32 _lb_err24 = ((lb_r_i32){ .error = { .code = (int32_t)(lb_process_failed), .message = ((lb_str){"the command status cannot be read", 33}) }, .failed = true });
                    (void)(lb_process_12stop_command(lb_pid));
                    return _lb_err24;
                }
            }
...
void lb_process_12stop_command(int32_t lb_pid) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/process/command/posix.lucb:7:5";
    (void)(((void)(lb_x_process_kill(((int32_t)lb_neg_s((int64_t)(lb_pid), 32)), 9LL))));
    lb_pos = "src/std/process/command/posix.lucb:8:5";
    (void)(lb_process_terminate(lb_pid));
}
lb_r_unit lb_process_12pull_command(struct lb_process_Capture* lb_stream, struct lb_process_CommandState* lb_state) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/process/command/posix.lucb:39:5";
    lb_a_u8_0a4096 lb_bytes __attribute__((unused)) = {};
    lb_pos = "src/std/process/command/posix.lucb:40:5";
    intptr_t lb_count __attribute__((unused)) = lb_c_process_6c_read((lb_stream)->descriptor, &(((lb_bytes).d[0])), 4096ULL);
    lb_pos = "src/std/process/command/posix.lucb:41:5";
    if (!!((lb_count == 0LL))) 
    {
        lb_pos = "src/std/process/command/posix.lucb:42:9";
        (lb_stream)->open = false;
    }
    else {
        lb_pos = "src/std/process/command/posix.lucb:43:5";
        if (!!((((intptr_t)(lb_count)) > ((intptr_t)(0LL))))) 
        {
            lb_pos = "src/std/process/command/posix.lucb:44:9";
            (void)((({ lb_r_unit _lb_r29 = lb_process_14command_append(lb_state, ({ const lb_a_u8_0a4096* _lb_sp30 = &(lb_bytes); size_t _lb_sn30 = 4096ULL; uint8_t* _lb_sd30 = (uint8_t*)(_lb_sp30->d); size_t _lb_ss30 = 0; size_t _lb_se30 = (size_t)(((size_t)lb_conv_s((int64_t)(lb_count), 64, 1, 64, 0, 1))); lb_check_index(_lb_ss30, _lb_sn30 + 1); lb_check_index(_lb_se30, _lb_sn30 + 1); if (_lb_ss30 > _lb_se30) lb_trap("index out of bounds"); (lb_span){ (void*)(_lb_sd30 + _lb_ss30), _lb_se30 - _lb_ss30 }; })); if (_lb_r29.failed) {
                return ((lb_r_unit){ .error = _lb_r29.error, .failed = true });
            } (void)0; })));
        }
        else {
            lb_pos = "src/std/process/command/posix.lucb:45:5";
            if (!!((({ int32_t _lb_sq31 __attribute__((unused)) = lb_c_errno(); int32_t _lb_sq32 __attribute__((unused)) = lb_c_interrupted; (!(_lb_sq31 == _lb_sq32)); }) && ({ int32_t _lb_sq33 __attribute__((unused)) = lb_c_errno(); int32_t _lb_sq34 __attribute__((unused)) = lb_process_11would_block; (!(_lb_sq33 == _lb_sq34)); })))) 
            {
                lb_pos = "src/std/process/command/posix.lucb:46:9";
                lb_r_unit _lb_err35 = ((lb_r_unit){ .error = { .code = (int32_t)(lb_process_failed), .message = ((lb_str){"the command output cannot be read", 33}) }, .failed = true });
                return _lb_err35;
            }
        }
    }
