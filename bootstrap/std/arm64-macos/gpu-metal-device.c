...
lb_r_gpu_MetalDevice_0p lb_gpu_17metal_device_open(void) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/gpu/metal/device.lucb:6:5";
    void* lb_pool __attribute__((unused)) = ({ void* _lb_fr = lb_x_gpu_24objc_autoreleasePoolPush(); if (!_lb_fr) lb_trap("null_foreign"); _lb_fr; });
    lb_pos = "src/std/gpu/metal/device.lucb:7:5";
    lb_pos = "src/std/gpu/metal/device.lucb:8:5";
    struct lb_gpu_MetalDevice* lb_state __attribute__((unused)) = (({ lb_r_gpu_MetalDevice_0p _lb_r7 = ({ lb_iface _lb_a8 = lb_memory_heap; lb_o_u8_0s _lb_ao8 = lb_alloc_call(_lb_a8, sizeof(lb_gpu_MetalDevice), _Alignof(lb_gpu_MetalDevice)); lb_r_gpu_MetalDevice_0p _lb_r8; if (!_lb_ao8.present) { _lb_r8 = ((lb_r_gpu_MetalDevice_0p){ .error = { .code = 208273409, .message = (lb_str){"memory.exhausted", 16} }, .failed = true }); } else { lb_gpu_MetalDevice* _lb_p8 = (lb_gpu_MetalDevice*)_lb_ao8.value.data; *_lb_p8 = ((lb_gpu_MetalDevice){}); _lb_r8.value = _lb_p8; _lb_r8.failed = false; } _lb_r8; }); if (_lb_r7.failed) {
        (void)(lb_x_gpu_23objc_autoreleasePoolPop(lb_pool));
        return ((lb_r_gpu_MetalDevice_0p){ .error = _lb_r7.error, .failed = true });
    } _lb_r7.value; }));
    lb_pos = "src/std/gpu/metal/device.lucb:9:5";
    lb_pos = "src/std/gpu/metal/device.lucb:11:5";
    (lb_state)->device = ({ void* _lb_o9 = lb_x_gpu_MTLCreateSystemDefaultDevice(); if (_lb_o9 == ((void*)0)) {
        lb_r_gpu_MetalDevice_0p _lb_err10 = ((lb_r_gpu_MetalDevice_0p){ .error = { .code = (int32_t)(lb_gpu_unavailable), .message = ((lb_str){"no Metal device is available", 28}) }, .failed = true });
        (void)(lb_gpu_20metal_device_destroy(lb_state));
        (void)(lb_x_gpu_23objc_autoreleasePoolPop(lb_pool));
        return _lb_err10;
    } _lb_o9; });
    lb_pos = "src/std/gpu/metal/device.lucb:12:5";
    (lb_state)->queue = ({ void* _lb_o11 = ({ void* _lb_sq12 __attribute__((unused)) = lb_gpu_14metal_required((lb_state)->device); void* _lb_sq13 __attribute__((unused)) = lb_gpu_9metal_sel("newCommandQueue"); lb_c_gpu_9metal_ptr(_lb_sq12, _lb_sq13); }); if (_lb_o11 == ((void*)0)) {
        lb_r_gpu_MetalDevice_0p _lb_err14 = ((lb_r_gpu_MetalDevice_0p){ .error = { .code = (int32_t)(lb_gpu_failed), .message = ((lb_str){"could not create a Metal command queue", 38}) }, .failed = true });
        (void)(lb_gpu_20metal_device_destroy(lb_state));
        (void)(lb_x_gpu_23objc_autoreleasePoolPop(lb_pool));
        return _lb_err14;
    } _lb_o11; });
    lb_pos = "src/std/gpu/metal/device.lucb:13:5";
    struct lb_gpu_MetalDevice* _lb_ret15 = lb_state;
    (void)(lb_x_gpu_23objc_autoreleasePoolPop(lb_pool));
    return ((lb_r_gpu_MetalDevice_0p){ .value = _lb_ret15, .failed = false });
    (void)(lb_x_gpu_23objc_autoreleasePoolPop(lb_pool));
    lb_trap("unreachable");
}
void lb_gpu_20metal_device_destroy(struct lb_gpu_MetalDevice* lb_state) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/gpu/metal/device.lucb:16:5";
    void* lb_pool __attribute__((unused)) = ({ void* _lb_fr = lb_x_gpu_24objc_autoreleasePoolPush(); if (!_lb_fr) lb_trap("null_foreign"); _lb_fr; });
    lb_pos = "src/std/gpu/metal/device.lucb:17:5";
    lb_pos = "src/std/gpu/metal/device.lucb:18:5";
    void* _lb_o16 = (lb_state)->queue;
    if (_lb_o16 != ((void*)0)) {
        void* lb_queue __attribute__((unused)) = _lb_o16;
        {
            lb_pos = "src/std/gpu/metal/device.lucb:19:9";
            (void)(({ void* _lb_sq17 __attribute__((unused)) = lb_queue; void* _lb_sq18 __attribute__((unused)) = lb_gpu_9metal_sel("release"); lb_c_gpu_10metal_void(_lb_sq17, _lb_sq18); }));
        }
    }
    lb_pos = "src/std/gpu/metal/device.lucb:20:5";
    void* _lb_o19 = (lb_state)->device;
    if (_lb_o19 != ((void*)0)) {
        void* lb_device __attribute__((unused)) = _lb_o19;
        {
            lb_pos = "src/std/gpu/metal/device.lucb:21:9";
            (void)(({ void* _lb_sq20 __attribute__((unused)) = lb_device; void* _lb_sq21 __attribute__((unused)) = lb_gpu_9metal_sel("release"); lb_c_gpu_10metal_void(_lb_sq20, _lb_sq21); }));
        }
    }
    lb_pos = "src/std/gpu/metal/device.lucb:22:5";
    lb_release_call(lb_memory_heap, (lb_span){ (void*)(lb_state), sizeof(lb_gpu_MetalDevice) });
    (void)(lb_x_gpu_23objc_autoreleasePoolPop(lb_pool));
}
__attribute__((weak)) void lb_interop_Packet_0g1_str_init(lb_interop_Packet_0g1_str* self, lb_str lb_value, void* lb_storage, lb_fn_0F1_void_0p_unit lb_dispose) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
