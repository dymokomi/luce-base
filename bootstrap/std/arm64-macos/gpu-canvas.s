    ...
    .p2align 2
    .globl _lb_gpu_canvas_0init
_lb_gpu_canvas_0init:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    sub sp, sp, #16
    mov sp, x29
    ...
    .no_dead_strip _lb_gpu_Canvas_count
...
L1_1:
    ...
    .no_dead_strip _lb_gpu_Canvas_clear
_lb_gpu_Canvas_clear:
    ...
    .no_dead_strip _lb_gpu_Canvas_triangles
...
1:
    ...
    mov x24, x0
    sub x25, x29, #440
    adrp x26, _lb_memory_heap@PAGE
    add x26, x26, _lb_memory_heap@PAGEOFF
    sub x27, x29, #488
    movz x10, #512, lsl #48
    cmp x24, x10
    b.ls L3_61
...
1:
    ...
    mov x26, x0
    sub x27, x29, #544
    adrp x28, _lb_memory_heap@PAGE
    add x28, x28, _lb_memory_heap@PAGEOFF
    sub x20, x29, #592
    movz x10, #9362
...
1:
    ...
    .p2align 2
    .globl _lb_gpu_Canvas_destroy
    .no_dead_strip _lb_gpu_Canvas_destroy
_lb_gpu_Canvas_destroy:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    sub sp, sp, #176
    str x19, [sp, #152]
    ...
    b.ls L4_2
L4_1:
    adrp x12, _lb_memory_heap@PAGE
    add x12, x12, _lb_memory_heap@PAGEOFF
    sub x13, x29, #64
    ldr x20, [x14]
    mov x9, x15
    movz x10, #4
...
L4_13:
    ...
    .no_dead_strip _lb_gpu_10canvas_min
...
L5_4:
    ...
    .no_dead_strip _lb_gpu_10canvas_max
...
L6_4:
    ...
    .no_dead_strip _lb_memory_copy_0g1_gpu_Vertex
...
L7_8:
    ...
    .no_dead_strip _lb_memory_copy_0g1_gpu_Draw
