    ...
    .p2align 2
    .globl _lb_net_9http_body_0init
_lb_net_9http_body_0init:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    sub sp, sp, #16
    mov sp, x29
    ...
    .p2align 2
    .globl _lb_net_HttpBodyDecoder_create
    .no_dead_strip _lb_net_HttpBodyDecoder_create
_lb_net_HttpBodyDecoder_create:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    movz x16, #25024
    sub sp, sp, x16
...
L1_21:
    ...
    .p2align 2
    .globl _lb_net_HttpBodyDecoder_finished
    .no_dead_strip _lb_net_HttpBodyDecoder_finished
_lb_net_HttpBodyDecoder_finished:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    sub sp, sp, #32
    sub x16, x29, #24
...
L2_3:
    ...
    .p2align 2
    .globl _lb_net_HttpBodyDecoder_consume
    .no_dead_strip _lb_net_HttpBodyDecoder_consume
_lb_net_HttpBodyDecoder_consume:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    sub sp, sp, #400
    sub x16, x29, #24
...
L3_3:
    ...
    ldr x2, [x9, #8]
    sub x8, x29, #400
    bl _lb_net_HttpBodyDecoder_advance
    sub x15, x29, #400
    add x14, x15, #96
    ldrb w14, [x14]
    cbnz w14, L3_8
...
L3_10:
    ...
    .p2align 2
    .globl _lb_net_HttpBodyDecoder_finish
    .no_dead_strip _lb_net_HttpBodyDecoder_finish
_lb_net_HttpBodyDecoder_finish:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    sub sp, sp, #112
    sub x16, x29, #24
...
L4_8:
    ...
    movz x10, #8276
    add x15, x12, x10
    adrp x13, _lb_io_14unexpected_eof@PAGE
    add x13, x13, _lb_io_14unexpected_eof@PAGEOFF
    ldr w19, [x13]
    str w19, [x15]
    sub x19, x29, #64
    ldr w15, [x13]
...
L4_10:
    ...
    .p2align 2
    .globl _lb_net_HttpBodyDecoder_advance
_lb_net_HttpBodyDecoder_advance:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    sub sp, sp, #1984
    sub x16, x29, #24
    ...
    ldr x9, [sp, #136]
    add x25, x9, #8
    adrp x9, _lb_net_12http_invalid@PAGE
    add x9, x9, _lb_net_12http_invalid@PAGEOFF
    str x9, [sp, #128]
    ...
    ldr x9, [sp, #184]
    add x27, x9, #8
    adrp x9, _lb_net_10http_limit@PAGE
    add x9, x9, _lb_net_10http_limit@PAGEOFF
    str x9, [sp, #176]
    adrp x9, l_text_42@PAGE
    add x9, x9, l_text_42@PAGEOFF
    str x9, [sp, #168]
    sub x26, x29, #1016
    add x9, x26, #8
    str x9, [sp, #160]
...
L5_131:
    ...
    ldr x2, [sp, #216]
    sub x8, x29, #1064
    bl _lb_net_20http_chunk_extension
    ldr x9, [sp, #88]
    ldrb w14, [x9]
    cbnz w14, L5_134
    b L5_133
...
L5_3:
    ...
    .p2align 2
    .globl _lb_net_8http_hex
    .no_dead_strip _lb_net_8http_hex
_lb_net_8http_hex:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    sub sp, sp, #64
...
L6_29:
    ...
    .p2align 2
    .globl _lb_net_13http_skip_ows
_lb_net_13http_skip_ows:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    sub sp, sp, #64
    str x19, [sp, #40]
...
L7_3:
    ...
    .p2align 2
    .globl _lb_net_20http_chunk_extension
_lb_net_20http_chunk_extension:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    sub sp, sp, #368
    sub x16, x29, #24
