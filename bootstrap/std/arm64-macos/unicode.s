...
_lb_unicode_0init:
    ...
    movz x9, #49944
    str x9, [x14]
    adrp x14, _lb_unicode_18canonical_mappings@PAGE
    ...
    movk x9, #2, lsl #16
    str x9, [x14]
    adrp x14, _lb_unicode_22compatibility_mappings@PAGE
    ...
    movz x9, #37920
    str x9, [x14]
    adrp x14, _lb_unicode_14upper_mappings@PAGE
    ...
    movz x9, #35712
    str x9, [x14]
    adrp x14, _lb_unicode_14lower_mappings@PAGE
    ...
    movz x9, #38040
    str x9, [x14]
    adrp x14, _lb_unicode_13fold_mappings@PAGE
    ...
    movz x9, #48
    str x9, [x14]
    adrp x14, _lb_unicode_15turkic_mappings@PAGE
    ...
    movk x9, #1, lsl #16
    str x9, [x14]
    adrp x14, _lb_unicode_15mapping_scalars@PAGE
    ...
    movz x9, #23064
    str x9, [x14]
    adrp x14, _lb_unicode_20composition_mappings@PAGE
    ...
    movz x9, #3792
    str x9, [x14]
    adrp x14, _lb_unicode_12cased_ranges@PAGE
    ...
    movz x9, #11136
    str x9, [x14]
    adrp x14, _lb_unicode_21case_ignorable_ranges@PAGE
    ...
    movz x9, #33264
    str x9, [x14]
    adrp x14, _lb_unicode_15grapheme_ranges@PAGE
    ...
    movz x9, #3744
    str x9, [x14]
    adrp x14, _lb_unicode_19pictographic_ranges@PAGE
    ...
    movz x9, #11352
    str x9, [x14]
    adrp x14, _lb_unicode_12indic_ranges@PAGE
...
1:
    ...
    adrp x0, l_text_19@PAGE
    add x0, x0, l_text_19@PAGEOFF
    adrp x1, l_text_53@PAGE
    add x1, x1, l_text_53@PAGEOFF
    bl _lb_core_7trap_at
1:
    add x22, x22, x19
    ldrb w22, [x22]
...
L10_13:
    ...
    movk x9, #3178, lsl #16
    str w9, [x14]
    adrp x15, l_text_51@PAGE
    add x15, x15, l_text_51@PAGEOFF
    add x20, x14, #8
    str x15, [x20]
    add x14, x14, #16
    movz x9, #16
...
L11_42:
    ...
    .p2align 2
    .globl _lb_unicode_12case_mapping
_lb_unicode_12case_mapping:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    sub sp, sp, #720
    sub x16, x29, #24
...
L12_16:
    ...
    sub x24, x29, #696
    add x25, x27, #8
    adrp x26, _lb_unicode_21case_ignorable_ranges@PAGE
    add x26, x26, _lb_unicode_21case_ignorable_ranges@PAGEOFF
L12_37:
    ldr x9, [sp, #0]
    ldr x14, [x9]
    cmp x20, x14
...
_lb_unicode_15canonical_order:
    ...
    add x9, x9, #8
    str x9, [sp, #32]
    adrp x21, _lb_unicode_16combining_ranges@PAGE
    add x21, x21, _lb_unicode_16combining_ranges@PAGEOFF
    mov x9, #0
    mov x22, x9
    mov x9, #0
    mov x23, x9
...
L15_34:
    ...
    ldp x12, x13, [x10, #0]
    stp x12, x13, [x11, #0]
    adrp x27, _lb_unicode_16combining_ranges@PAGE
    add x27, x27, _lb_unicode_16combining_ranges@PAGEOFF
    add x23, x24, #1
    sub x25, x29, #256
    add x9, x25, #8
    str x9, [sp, #16]
...
1:
    ...
    sub x10, x29, #144
    str w21, [x10]
    adrp x9, _lb_unicode_16combining_ranges@PAGE
    add x9, x9, _lb_unicode_16combining_ranges@PAGEOFF
    str x9, [sp, #152]
    ldr x9, [sp, #152]
    ldr x0, [x9]
    ldr x1, [x9, #8]
...
L17_24:
    sub x27, x29, #120
    adrp x9, _lb_unicode_20composition_mappings@PAGE
    add x9, x9, _lb_unicode_20composition_mappings@PAGEOFF
    str x9, [sp, #96]
    ldr x9, [sp, #96]
    add x9, x9, #8
    str x9, [sp, #88]
...
L18_9:
    ...
    ldr w15, [x15]
    str w15, [x14]
    adrp x15, l_text_128@PAGE
    add x15, x15, l_text_128@PAGEOFF
    sub x20, x29, #256
    str x15, [x20]
    add x15, x20, #8
    movz x9, #35
...
L18_25:
    ...
    b L18_28
L18_28:
    adrp x0, l_text_130@PAGE
    add x0, x0, l_text_130@PAGEOFF
    adrp x1, l_text_49@PAGE
    add x1, x1, l_text_49@PAGEOFF
    bl _lb_core_7trap_at
L18_27:
...
L18_41:
    ...
    movz x9, #50
    str x9, [x14]
    adrp x14, l_text_131@PAGE
    add x14, x14, l_text_131@PAGEOFF
    mov x0, x14
    mov x9, x15
    ldr x1, [x9]
    ldr x2, [x9, #8]
...
L18_45:
    ...
    .p2align 2
    .globl _lb_unicode_GraphemeIterator_over
_lb_unicode_GraphemeIterator_over:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    sub sp, sp, #160
    sub x16, x29, #24
...
L19_5:
    ...
    .p2align 2
    .globl _lb_unicode_GraphemeIterator_next
_lb_unicode_GraphemeIterator_next:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    sub sp, sp, #432
    sub x16, x29, #24
...
L20_7:
    ...
    sub x10, x29, #384
    str w26, [x10]
    adrp x9, _lb_unicode_15grapheme_ranges@PAGE
    add x9, x9, _lb_unicode_15grapheme_ranges@PAGEOFF
    str x9, [sp, #8]
    ldr x9, [sp, #8]
    ldr x0, [x9]
    ldr x1, [x9, #8]
...
L20_22:
    ...
    mov x1, x26
    mov x2, x14
    bl _lb_unicode_GraphemeState_accept
    ldr x15, [x19]
    add x24, x23, #8
    ldr x24, [x24]
    mov x9, x15
...
L20_24:
    ...
    mov x1, x23
    mov x2, x26
    bl _lb_unicode_GraphemeState_12break_before
    mov w15, w0
    cbnz w15, L20_14
    b L20_15
L20_14:
...
L20_20:
    ...
    .p2align 2
    .globl _lb_unicode_GraphemeIterator_11byte_offset
_lb_unicode_GraphemeIterator_11byte_offset:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    sub sp, sp, #32
    sub x16, x29, #24
...
L21_1:
    ...
    .p2align 2
    .globl _lb_unicode_GraphemeState_12break_before
_lb_unicode_GraphemeState_12break_before:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    sub sp, sp, #160
    str x19, [sp, #136]
...
L22_3:
    mov x0, x14
    bl _lb_unicode_16grapheme_control
    mov w15, w0
    cbnz w15, L22_83
    b L22_10
L22_83:
...
L22_32:
    ...
    sub x10, x29, #152
    str w14, [x10]
    adrp x15, _lb_unicode_12indic_ranges@PAGE
    add x15, x15, _lb_unicode_12indic_ranges@PAGEOFF
    mov x9, x15
    ldr x0, [x9]
    ldr x1, [x9, #8]
    mov x2, x14
    ...
    b L22_81
L22_80:
    adrp x0, l_text_146@PAGE
    add x0, x0, l_text_146@PAGEOFF
    adrp x1, l_text_16@PAGE
    add x1, x1, l_text_16@PAGEOFF
    bl _lb_core_7trap_at
L22_81:
...
L22_51:
    ...
    .p2align 2
    .globl _lb_unicode_GraphemeState_accept
_lb_unicode_GraphemeState_accept:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    sub sp, sp, #112
    str x19, [sp, #88]
...
L23_11:
    ...
    sub x10, x29, #104
    str w22, [x10]
    adrp x21, _lb_unicode_12indic_ranges@PAGE
    add x21, x21, _lb_unicode_12indic_ranges@PAGEOFF
    mov x9, x21
    ldr x0, [x9]
    ldr x1, [x9, #8]
    mov x2, x22
...
L23_14:
    ...
    .p2align 2
    .globl _lb_unicode_16grapheme_control
_lb_unicode_16grapheme_control:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    sub sp, sp, #48
    str x19, [sp, #24]
