...
lb_r_void_0p lb_gpu_20backend_surface_open(struct lb_gpu_DeviceState* lb_device, lb_window_Presentation lb_host) {
    ...
    {
        lb_pos = "src/std/gpu/presentation.lucb:7:9";
        if (!!(((lb_device)->backend == ((uint8_t)1u)))) 
        {
            lb_pos = "src/std/gpu/presentation.lucb:8:13";
            void* _lb_ret7 = ((void*)((({ lb_r_gpu_MetalSurface_0p _lb_r8 = lb_gpu_18metal_surface_open(((struct lb_gpu_MetalDevice*)((lb_device)->native)), lb_host); if (_lb_r8.failed) {
                return ((lb_r_void_0p){ .error = _lb_r8.error, .failed = true });
            } _lb_r8.value; }))));
            return ((lb_r_void_0p){ .value = _lb_ret7, .failed = false });
        }
    }
    lb_pos = "src/std/gpu/presentation.lucb:9:5";
    lb_r_void_0p _lb_err9 = ((lb_r_void_0p){ .error = { .code = (int32_t)(lb_gpu_unsupported), .message = ((lb_str){"the GPU backend is not implemented", 34}) }, .failed = true });
    return _lb_err9;
    lb_trap("unreachable");
}
lb_r_gpu_PresentResult lb_gpu_21backend_clear_present(struct lb_gpu_DeviceState* lb_device, lb_window_Presentation lb_host, void* lb_native, lb_gpu_Color lb_color) {
    ...
    {
        lb_pos = "src/std/gpu/presentation.lucb:15:9";
        if (!!(((lb_device)->backend == ((uint8_t)1u)))) 
        {
            lb_pos = "src/std/gpu/presentation.lucb:16:13";
            uint8_t _lb_ret10 = (({ lb_r_gpu_PresentResult _lb_r11 = lb_gpu_19metal_clear_present(((struct lb_gpu_MetalDevice*)((lb_device)->native)), lb_host, ((struct lb_gpu_MetalSurface*)(lb_native)), lb_color); if (_lb_r11.failed) {
                return ((lb_r_gpu_PresentResult){ .error = _lb_r11.error, .failed = true });
            } _lb_r11.value; }));
            return ((lb_r_gpu_PresentResult){ .value = _lb_ret10, .failed = false });
        }
    }
    lb_pos = "src/std/gpu/presentation.lucb:17:5";
    lb_r_gpu_PresentResult _lb_err12 = ((lb_r_gpu_PresentResult){ .error = { .code = (int32_t)(lb_gpu_unsupported), .message = ((lb_str){"the GPU backend is not implemented", 34}) }, .failed = true });
    return _lb_err12;
    lb_trap("unreachable");
}
lb_r_unit lb_gpu_20backend_surface_wait(struct lb_gpu_DeviceState* lb_device, void* lb_native) {
    ...
    {
        lb_pos = "src/std/gpu/presentation.lucb:24:9";
        if (!!(((lb_device)->backend == ((uint8_t)1u)))) 
        {
            lb_pos = "src/std/gpu/presentation.lucb:25:13";
            (void)((({ lb_r_unit _lb_r13 = lb_gpu_18metal_surface_wait(((struct lb_gpu_MetalSurface*)(lb_native))); if (_lb_r13.failed) {
                return ((lb_r_unit){ .error = _lb_r13.error, .failed = true });
            } (void)0; })));
            lb_pos = "src/std/gpu/presentation.lucb:26:13";
            return ((lb_r_unit){ .failed = false });
        }
    }
    lb_pos = "src/std/gpu/presentation.lucb:27:5";
    lb_r_unit _lb_err14 = ((lb_r_unit){ .error = { .code = (int32_t)(lb_gpu_unsupported), .message = ((lb_str){"the GPU backend is not implemented", 34}) }, .failed = true });
    return _lb_err14;
    return ((lb_r_unit){ .failed = false });
}
lb_r_gpu_PresentResult lb_gpu_14backend_render(struct lb_gpu_DeviceState* lb_device, lb_window_Presentation lb_host, void* lb_native, lb_gpu_Canvas lb_canvas, lb_gpu_Color lb_color) {
    ...
    {
        lb_pos = "src/std/gpu/presentation.lucb:33:9";
        if (!!(((lb_device)->backend == ((uint8_t)1u)))) 
        {
            lb_pos = "src/std/gpu/presentation.lucb:34:13";
            uint8_t _lb_ret15 = (({ lb_r_gpu_PresentResult _lb_r16 = lb_gpu_12metal_render(((struct lb_gpu_MetalDevice*)((lb_device)->native)), lb_host, ((struct lb_gpu_MetalSurface*)(lb_native)), lb_canvas, lb_color); if (_lb_r16.failed) {
                return ((lb_r_gpu_PresentResult){ .error = _lb_r16.error, .failed = true });
            } _lb_r16.value; }));
            return ((lb_r_gpu_PresentResult){ .value = _lb_ret15, .failed = false });
        }
    }
    lb_pos = "src/std/gpu/presentation.lucb:35:5";
    lb_r_gpu_PresentResult _lb_err17 = ((lb_r_gpu_PresentResult){ .error = { .code = (int32_t)(lb_gpu_unsupported), .message = ((lb_str){"the GPU backend is not implemented", 34}) }, .failed = true });
    return _lb_err17;
    lb_trap("unreachable");
}
void lb_gpu_23backend_surface_destroy(struct lb_gpu_DeviceState* lb_device, lb_window_Presentation lb_host, void* lb_native) {
    ...
    {
        lb_pos = "src/std/gpu/presentation.lucb:42:9";
        if (!!(((lb_device)->backend == ((uint8_t)1u)))) 
        {
            lb_pos = "src/std/gpu/presentation.lucb:43:13";
            (void)(lb_gpu_21metal_surface_destroy(((struct lb_gpu_MetalSurface*)(lb_native)), lb_host));
            lb_pos = "src/std/gpu/presentation.lucb:44:13";
            return;
        }
    }
    lb_pos = "src/std/gpu/presentation.lucb:45:5";
    (void)(lb_trap_text(((lb_str){"invalid GPU backend during surface destruction", 46})));
}
__attribute__((weak)) void lb_interop_Packet_0g1_str_init(lb_interop_Packet_0g1_str* self, lb_str lb_value, void* lb_storage, lb_fn_0F1_void_0p_unit lb_dispose) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
