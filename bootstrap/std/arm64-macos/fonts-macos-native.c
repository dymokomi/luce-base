...
typedef struct lb_a_u16_0a2 { uint16_t d[2]; } lb_a_u16_0a2;
...
lb_r_unit lb_fonts_10mac_raster(lb_fonts_Face lb_face, lb_str lb_text, double lb_scale, struct lb_fonts_Bitmap* lb_bitmap) {
    ...
    void* lb_font __attribute__((unused)) = ({ void* _lb_o21 = ({ void* _lb_sq22 __attribute__((unused)) = ({ void* _lb_o23 = lb_face.native; if (_lb_o23 == ((void*)0)) {
        ...
        return _lb_err24;
    } _lb_o23; }); double _lb_sq25 __attribute__((unused)) = (lb_face.size * lb_scale); void* _lb_sq26 __attribute__((unused)) = ((void*)0); void* _lb_sq27 __attribute__((unused)) = ((void*)0); lb_x_fonts_CTFontCreateCopyWithAttributes(_lb_sq22, _lb_sq25, _lb_sq26, _lb_sq27); }); if (_lb_o21 == ((void*)0)) {
...
lb_r_void_0p lb_fonts_10mac_string(lb_str lb_text) {
    ...
    return ((lb_r_void_0p){ .value = _lb_ret46, .failed = false });
    lb_trap("unreachable");
}
