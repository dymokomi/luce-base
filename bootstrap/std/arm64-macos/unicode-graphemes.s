    ...
    .p2align 2
    .globl _lb_unicode_graphemes_0init
_lb_unicode_graphemes_0init:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    sub sp, sp, #16
    mov sp, x29
    ...
    .no_dead_strip _lb_unicode_GraphemeIterator_over
...
L1_5:
    ...
    .no_dead_strip _lb_unicode_GraphemeIterator_next
...
L2_20:
    ...
    .no_dead_strip _lb_unicode_GraphemeIterator_11byte_offset
...
L6_5:
    ...
    .p2align 3
    .quad _lb_unicode_graphemes_0init
