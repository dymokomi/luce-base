...
L1_36:
    ...
    sub x14, x29, x16
    str x20, [x14]
    adrp x12, _lb_vt_files_File_Reader@PAGE
    add x12, x12, _lb_vt_files_File_Reader@PAGEOFF
    add x13, x14, #8
    str x12, [x13]
    add x12, x21, #8
    movz x16, #5208
    sub x13, x29, x16
    str x12, [x13]
    adrp x12, _lb_vt_files_TemporaryFile_Writer@PAGE
    add x12, x12, _lb_vt_files_TemporaryFile_Writer@PAGEOFF
    add x24, x13, #8
    str x12, [x24]
    movz x16, #5224
    sub x12, x29, x16
