...
extern void* NSPasteboardTypeString;
#if defined(__clang__) && !defined(__wasm__)
...
lb_r_interop_Owned_0g1_str lb_clipboard_8mac_read(void);
lb_r_unit lb_clipboard_9mac_write(lb_str lb_text);
...
lb_r_void_0p lb_clipboard_9mac_board(void);
...
lb_r_interop_Owned_0g1_str lb_clipboard_8mac_read(void) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/clipboard/macos/native.lucb:21:5";
    void* lb_pool __attribute__((unused)) = ({ void* _lb_fr = lb_x_clipboard_24objc_autoreleasePoolPush(); if (!_lb_fr) lb_trap("null_foreign"); _lb_fr; });
    lb_pos = "src/std/clipboard/macos/native.lucb:22:5";
    lb_pos = "src/std/clipboard/macos/native.lucb:23:5";
    void* lb_board __attribute__((unused)) = (({ lb_r_void_0p _lb_r7 = lb_clipboard_9mac_board(); if (_lb_r7.failed) {
        (void)(lb_x_clipboard_23objc_autoreleasePoolPop(lb_pool));
        return ((lb_r_interop_Owned_0g1_str){ .error = _lb_r7.error, .failed = true });
    } _lb_r7.value; }));
    lb_pos = "src/std/clipboard/macos/native.lucb:24:5";
    void* lb_value __attribute__((unused)) = ({ void* _lb_o8 = ({ void* _lb_sq9 __attribute__((unused)) = lb_board; void* _lb_sq10 __attribute__((unused)) = ({ void* _lb_fr = lb_x_clipboard_16sel_registerName("stringForType:"); if (!_lb_fr) lb_trap("null_foreign"); _lb_fr; }); void* _lb_sq11 __attribute__((unused)) = NSPasteboardTypeString; lb_c_clipboard_9msg_typed(_lb_sq9, _lb_sq10, _lb_sq11); }); if (_lb_o8 == ((void*)0)) {
    ...
    lb_pos = "src/std/clipboard/macos/native.lucb:25:5";
    size_t lb_length __attribute__((unused)) = ({ void* _lb_sq14 __attribute__((unused)) = lb_value; void* _lb_sq15 __attribute__((unused)) = ({ void* _lb_fr = lb_x_clipboard_16sel_registerName("lengthOfBytesUsingEncoding:"); if (!_lb_fr) lb_trap("null_foreign"); _lb_fr; }); uint64_t _lb_sq16 __attribute__((unused)) = 4ULL; lb_c_clipboard_8msg_size(_lb_sq14, _lb_sq15, _lb_sq16); });
    lb_pos = "src/std/clipboard/macos/native.lucb:26:5";
    if (!!((((size_t)(lb_length)) > ((size_t)(lb_clipboard_10text_limit))))) 
    {
        lb_pos = "src/std/clipboard/macos/native.lucb:27:9";
        lb_r_interop_Owned_0g1_str _lb_err17 = ((lb_r_interop_Owned_0g1_str){ .error = { .code = (int32_t)(lb_clipboard_failed), .message = ((lb_str){"clipboard text exceeds 1 MiB", 28}) }, .failed = true });
        (void)(lb_x_clipboard_23objc_autoreleasePoolPop(lb_pool));
        return _lb_err17;
    }
    lb_pos = "src/std/clipboard/macos/native.lucb:28:5";
    void* lb_bytes __attribute__((unused)) = ({ void* _lb_o18 = ({ void* _lb_sq19 __attribute__((unused)) = lb_value; void* _lb_sq20 __attribute__((unused)) = ({ void* _lb_fr = lb_x_clipboard_16sel_registerName("UTF8String"); if (!_lb_fr) lb_trap("null_foreign"); _lb_fr; }); lb_c_clipboard_10msg_object(_lb_sq19, _lb_sq20); }); if (_lb_o18 == ((void*)0)) {
        lb_r_interop_Owned_0g1_str _lb_err21 = ((lb_r_interop_Owned_0g1_str){ .error = { .code = (int32_t)(lb_clipboard_failed), .message = ((lb_str){"clipboard text is not UTF-8", 27}) }, .failed = true });
        (void)(lb_x_clipboard_23objc_autoreleasePoolPop(lb_pool));
        return _lb_err21;
    } _lb_o18; });
    lb_pos = "src/std/clipboard/macos/native.lucb:29:5";
    lb_interop_Owned_0g1_str _lb_ret22 = (({ lb_r_interop_Owned_0g1_str _lb_r23 = lb_interop_9copy_text(({ lb_span _lb_sc24 = ((lb_span){(void*)(((uint8_t*)(lb_bytes))), (size_t)(lb_length)}); const char* _lb_sb24 = (const char*)_lb_sc24.data; size_t _lb_sl24 = _lb_sc24.length; (lb_str){ _lb_sb24, _lb_sl24 }; })); if (_lb_r23.failed) {
        (void)(lb_x_clipboard_23objc_autoreleasePoolPop(lb_pool));
        return ((lb_r_interop_Owned_0g1_str){ .error = _lb_r23.error, .failed = true });
    } _lb_r23.value; }));
    (void)(lb_x_clipboard_23objc_autoreleasePoolPop(lb_pool));
    return ((lb_r_interop_Owned_0g1_str){ .value = _lb_ret22, .failed = false });
    (void)(lb_x_clipboard_23objc_autoreleasePoolPop(lb_pool));
    lb_trap("unreachable");
}
lb_r_unit lb_clipboard_9mac_write(lb_str lb_text) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/clipboard/macos/native.lucb:32:5";
    void* lb_pool __attribute__((unused)) = ({ void* _lb_fr = lb_x_clipboard_24objc_autoreleasePoolPush(); if (!_lb_fr) lb_trap("null_foreign"); _lb_fr; });
    lb_pos = "src/std/clipboard/macos/native.lucb:33:5";
    lb_pos = "src/std/clipboard/macos/native.lucb:34:5";
    void* lb_board __attribute__((unused)) = (({ lb_r_void_0p _lb_r25 = lb_clipboard_9mac_board(); if (_lb_r25.failed) {
        (void)(lb_x_clipboard_23objc_autoreleasePoolPop(lb_pool));
        return ((lb_r_unit){ .error = _lb_r25.error, .failed = true });
    } _lb_r25.value; }));
    lb_pos = "src/std/clipboard/macos/native.lucb:35:5";
    void* lb_native_type __attribute__((unused)) = ({ void* _lb_o26 = lb_x_clipboard_13objc_getClass("NSString"); if (_lb_o26 == ((void*)0)) {
        lb_r_unit _lb_err27 = ((lb_r_unit){ .error = { .code = (int32_t)(lb_clipboard_failed), .message = ((lb_str){"Foundation strings are unavailable", 34}) }, .failed = true });
        (void)(lb_x_clipboard_23objc_autoreleasePoolPop(lb_pool));
        return _lb_err27;
    } _lb_o26; });
    lb_pos = "src/std/clipboard/macos/native.lucb:36:5";
    void* lb_allocated __attribute__((unused)) = ({ void* _lb_o28 = ({ void* _lb_sq29 __attribute__((unused)) = lb_native_type; void* _lb_sq30 __attribute__((unused)) = ({ void* _lb_fr = lb_x_clipboard_16sel_registerName("alloc"); if (!_lb_fr) lb_trap("null_foreign"); _lb_fr; }); lb_c_clipboard_10msg_object(_lb_sq29, _lb_sq30); }); if (_lb_o28 == ((void*)0)) {
        lb_r_unit _lb_err31 = ((lb_r_unit){ .error = { .code = (int32_t)(lb_clipboard_failed), .message = ((lb_str){"could not allocate clipboard text", 33}) }, .failed = true });
        (void)(lb_x_clipboard_23objc_autoreleasePoolPop(lb_pool));
        return _lb_err31;
    } _lb_o28; });
    lb_pos = "src/std/clipboard/macos/native.lucb:37:5";
    void* lb_value __attribute__((unused)) = ({ void* _lb_o32 = ({ void* _lb_sq33 __attribute__((unused)) = lb_allocated; void* _lb_sq34 __attribute__((unused)) = ({ void* _lb_fr = lb_x_clipboard_16sel_registerName("initWithBytes:length:encoding:"); if (!_lb_fr) lb_trap("null_foreign"); _lb_fr; }); const uint8_t* _lb_sq35 __attribute__((unused)) = ((const uint8_t*)(((lb_cspan){(void*)(lb_text.data), lb_text.length}).data)); size_t _lb_sq36 __attribute__((unused)) = (lb_text.length); uint64_t _lb_sq37 __attribute__((unused)) = 4ULL; lb_c_clipboard_8msg_init(_lb_sq33, _lb_sq34, _lb_sq35, _lb_sq36, _lb_sq37); }); if (_lb_o32 == ((void*)0)) {
        lb_r_unit _lb_err38 = ((lb_r_unit){ .error = { .code = (int32_t)(lb_clipboard_failed), .message = ((lb_str){"could not create clipboard text", 31}) }, .failed = true });
        (void)(lb_x_clipboard_23objc_autoreleasePoolPop(lb_pool));
        return _lb_err38;
    } _lb_o32; });
    lb_pos = "src/std/clipboard/macos/native.lucb:38:5";
    lb_pos = "src/std/clipboard/macos/native.lucb:39:5";
    (void)(((void)(({ void* _lb_sq39 __attribute__((unused)) = lb_board; void* _lb_sq40 __attribute__((unused)) = ({ void* _lb_fr = lb_x_clipboard_16sel_registerName("clearContents"); if (!_lb_fr) lb_trap("null_foreign"); _lb_fr; }); lb_c_clipboard_9msg_count(_lb_sq39, _lb_sq40); }))));
    lb_pos = "src/std/clipboard/macos/native.lucb:40:5";
    if (!!((!({ void* _lb_sq41 __attribute__((unused)) = lb_board; void* _lb_sq42 __attribute__((unused)) = ({ void* _lb_fr = lb_x_clipboard_16sel_registerName("setString:forType:"); if (!_lb_fr) lb_trap("null_foreign"); _lb_fr; }); void* _lb_sq43 __attribute__((unused)) = lb_value; void* _lb_sq44 __attribute__((unused)) = NSPasteboardTypeString; lb_c_clipboard_9msg_write(_lb_sq41, _lb_sq42, _lb_sq43, _lb_sq44); })))) 
    {
        lb_pos = "src/std/clipboard/macos/native.lucb:41:9";
        lb_r_unit _lb_err45 = ((lb_r_unit){ .error = { .code = (int32_t)(lb_clipboard_failed), .message = ((lb_str){"could not publish clipboard text", 32}) }, .failed = true });
        (void)(({ void* _lb_sq46 __attribute__((unused)) = lb_value; void* _lb_sq47 __attribute__((unused)) = ({ void* _lb_fr = lb_x_clipboard_16sel_registerName("release"); if (!_lb_fr) lb_trap("null_foreign"); _lb_fr; }); lb_c_clipboard_11msg_release(_lb_sq46, _lb_sq47); }));
        (void)(lb_x_clipboard_23objc_autoreleasePoolPop(lb_pool));
        return _lb_err45;
    }
    (void)(({ void* _lb_sq48 __attribute__((unused)) = lb_value; void* _lb_sq49 __attribute__((unused)) = ({ void* _lb_fr = lb_x_clipboard_16sel_registerName("release"); if (!_lb_fr) lb_trap("null_foreign"); _lb_fr; }); lb_c_clipboard_11msg_release(_lb_sq48, _lb_sq49); }));
    (void)(lb_x_clipboard_23objc_autoreleasePoolPop(lb_pool));
...
lb_r_void_0p lb_clipboard_9mac_board(void) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/clipboard/macos/native.lucb:17:5";
    void* lb_native_type __attribute__((unused)) = ({ void* _lb_o54 = lb_x_clipboard_13objc_getClass("NSPasteboard"); if (_lb_o54 == ((void*)0)) {
        lb_r_void_0p _lb_err55 = ((lb_r_void_0p){ .error = { .code = (int32_t)(lb_clipboard_failed), .message = ((lb_str){"AppKit pasteboard is unavailable", 32}) }, .failed = true });
        return _lb_err55;
    } _lb_o54; });
    lb_pos = "src/std/clipboard/macos/native.lucb:18:5";
    void* _lb_ret56 = ({ void* _lb_o57 = ({ void* _lb_sq58 __attribute__((unused)) = lb_native_type; void* _lb_sq59 __attribute__((unused)) = ({ void* _lb_fr = lb_x_clipboard_16sel_registerName("generalPasteboard"); if (!_lb_fr) lb_trap("null_foreign"); _lb_fr; }); lb_c_clipboard_10msg_object(_lb_sq58, _lb_sq59); }); if (_lb_o57 == ((void*)0)) {
        lb_r_void_0p _lb_err60 = ((lb_r_void_0p){ .error = { .code = (int32_t)(lb_clipboard_failed), .message = ((lb_str){"the clipboard is unavailable", 28}) }, .failed = true });
        return _lb_err60;
    } _lb_o57; });
    return ((lb_r_void_0p){ .value = _lb_ret56, .failed = false });
    lb_trap("unreachable");
}
__attribute__((weak)) lb_interop_Owned_0g1_str lb_interop_Owned_0g1_str_clone(const lb_interop_Owned_0g1_str* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/clipboard/windows/native.lucb:356:1";
    struct lb_ownership_Object* _lb_o61 = self->owner;
    if (_lb_o61 != ((void*)0)) {
        struct lb_ownership_Object* lb_owner __attribute__((unused)) = _lb_o61;
        {
    ...
    lb_interop_Owned_0g1_str _lb_ret62 = (*self);
    return _lb_ret62;
    lb_trap("unreachable");
}
__attribute__((weak)) void lb_interop_Owned_0g1_str_release(const lb_interop_Owned_0g1_str* self) {
...
__attribute__((weak)) void lb_interop_Owned_0g1_str_trace(const lb_interop_Owned_0g1_str* self, lb_fn_0F2_ownership_Object_0p_void_0p_unit lb_visit, void* lb_context) {
    ...
    struct lb_ownership_Object* _lb_o64 = self->owner;
    if (_lb_o64 != ((void*)0)) {
        struct lb_ownership_Object* lb_owner __attribute__((unused)) = _lb_o64;
        {
