...
uint32_t lb_window_unsupported = ((uint32_t)(208273493ULL));
uint32_t lb_window_12wrong_thread = ((uint32_t)(208273494ULL));
uint32_t lb_window_15invalid_options = ((uint32_t)(208273495ULL));
uint32_t lb_window_failed = ((uint32_t)(208273496ULL));
uint32_t lb_window_closed = ((uint32_t)(208273497ULL));
uint32_t lb_window_19presentation_in_use = ((uint32_t)(208273498ULL));
...
lb_r_window_Window lb_window_Window_open(lb_window_Options lb_options) {
    ...
    {
        lb_pos = "src/std/window/module.lucb:51:13";
        lb_window_Window _lb_ret11 = ({ struct lb_window_State* _lb_sq12 __attribute__((unused)) = (({ lb_r_window_State_0p _lb_r13 = lb_window_8mac_open(lb_options); if (_lb_r13.failed) {
            return ((lb_r_window_Window){ .error = _lb_r13.error, .failed = true });
        } _lb_r13.value; })); ((lb_window_Window){.state = _lb_sq12}); });
        return ((lb_r_window_Window){ .value = _lb_ret11, .failed = false });
    }
    lb_trap("unreachable");
}
lb_r_unit lb_window_Window_show(const lb_window_Window* self) {
    ...
    {
        lb_pos = "src/std/window/module.lucb:59:13";
        (void)(lb_window_8mac_show(lb_state));
    }
    {
    }
...
lb_r_window_Size lb_window_Window_size(const lb_window_Window* self) {
    ...
    struct lb_window_State* lb_state __attribute__((unused)) = (({ lb_r_window_State_0p _lb_r15 = lb_window_Window_checked(self); if (_lb_r15.failed) {
        return ((lb_r_window_Size){ .error = _lb_r15.error, .failed = true });
    } _lb_r15.value; }));
    {
        lb_pos = "src/std/window/module.lucb:66:13";
        lb_window_Size _lb_ret16 = lb_window_8mac_size(lb_state);
        return ((lb_r_window_Size){ .value = _lb_ret16, .failed = false });
    }
    lb_trap("unreachable");
}
lb_r_unit lb_window_Window_resize(const lb_window_Window* self, uint32_t lb_width, uint32_t lb_height) {
    ...
    (void)((({ lb_r_unit _lb_r18 = lb_window_12check_extent(lb_width, lb_height); if (_lb_r18.failed) {
        return ((lb_r_unit){ .error = _lb_r18.error, .failed = true });
    } (void)0; })));
    {
        lb_pos = "src/std/window/module.lucb:75:13";
        (void)(lb_window_10mac_resize(lb_state, lb_width, lb_height));
    }
    {
    }
    return ((lb_r_unit){ .failed = false });
...
lb_r_unit lb_window_Window_14set_text_input(const lb_window_Window* self, bool lb_enabled) {
    ...
    {
        lb_pos = "src/std/window/module.lucb:88:13";
        if (!!((!lb_enabled))) 
        {
            lb_pos = "src/std/window/module.lucb:89:17";
            (void)(lb_window_21mac_cancel_text_input(lb_state));
        }
    }
    return ((lb_r_unit){ .failed = false });
}
lb_r_unit lb_window_Window_10set_cursor(const lb_window_Window* self, uint8_t lb_cursor) {
    ...
    struct lb_window_State* lb_state __attribute__((unused)) = (({ lb_r_window_State_0p _lb_r20 = lb_window_Window_checked(self); if (_lb_r20.failed) {
    ...
    if (!!((((uint8_t)(((uint8_t)(lb_cursor)))) > ((uint8_t)(((uint8_t)(((uint8_t)7u)))))))) 
    {
        ...
        lb_r_unit _lb_err21 = ((lb_r_unit){ .error = { .code = (int32_t)(lb_window_15invalid_options), .message = ((lb_str){"unknown system cursor", 21}) }, .failed = true });
        return _lb_err21;
    }
    {
        lb_pos = "src/std/window/module.lucb:98:13";
        (void)((({ lb_r_unit _lb_r22 = lb_window_14mac_set_cursor(lb_state, lb_cursor); if (_lb_r22.failed) {
...
lb_r_input_Cursor lb_window_Window_cursor(const lb_window_Window* self) {
    ...
    uint8_t _lb_ret23 = (((({ lb_r_window_State_0p _lb_r24 = lb_window_Window_checked(self); if (_lb_r24.failed) {
        return ((lb_r_input_Cursor){ .error = _lb_r24.error, .failed = true });
    } _lb_r24.value; }))))->cursor;
    return ((lb_r_input_Cursor){ .value = _lb_ret23, .failed = false });
    lb_trap("unreachable");
}
lb_r_window_Presentation lb_window_Window_20acquire_presentation(const lb_window_Window* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/window/module.lucb:108:9";
    struct lb_window_State* lb_state __attribute__((unused)) = (({ lb_r_window_State_0p _lb_r25 = lb_window_Window_checked(self); if (_lb_r25.failed) {
        return ((lb_r_window_Presentation){ .error = _lb_r25.error, .failed = true });
    } _lb_r25.value; }));
    lb_pos = "src/std/window/module.lucb:109:9";
    if (!!((lb_state)->presentation_held)) 
    {
        lb_pos = "src/std/window/module.lucb:110:13";
        lb_r_window_Presentation _lb_err26 = ((lb_r_window_Presentation){ .error = { .code = (int32_t)(lb_window_19presentation_in_use), .message = ((lb_str){"the window already has a presentation surface", 45}) }, .failed = true });
        return _lb_err26;
    }
    lb_pos = "src/std/window/module.lucb:111:9";
    (lb_state)->presentation_held = true;
    lb_pos = "src/std/window/module.lucb:112:9";
    lb_window_Presentation _lb_ret27 = ((lb_window_Presentation){.state = lb_state});
    return ((lb_r_window_Presentation){ .value = _lb_ret27, .failed = false });
    lb_trap("unreachable");
}
lb_r_unit lb_window_Window_13request_close(const lb_window_Window* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
...
lb_r_input_Event_0o lb_window_Window_poll(const lb_window_Window* self) {
    ...
    struct lb_window_State* lb_state __attribute__((unused)) = (({ lb_r_window_State_0p _lb_r29 = lb_window_Window_checked(self); if (_lb_r29.failed) {
        return ((lb_r_input_Event_0o){ .error = _lb_r29.error, .failed = true });
    } _lb_r29.value; }));
    lb_pos = "src/std/window/module.lucb:126:9";
    lb_o_input_Event _lb_o30 = lb_window_9pop_event(lb_state);
    if (_lb_o30.present) {
        lb_input_Event lb_event __attribute__((unused)) = _lb_o30.value;
        {
            lb_pos = "src/std/window/module.lucb:127:13";
            lb_o_input_Event _lb_ret31 = ((lb_o_input_Event){ .value = lb_event, .present = true });
            return ((lb_r_input_Event_0o){ .value = _lb_ret31, .failed = false });
        }
    }
    {
        lb_pos = "src/std/window/module.lucb:129:13";
        (void)(lb_window_8mac_pump(lb_state));
    }
    {
    }
    lb_pos = "src/std/window/module.lucb:132:9";
    lb_o_input_Event _lb_ret32 = lb_window_9pop_event(lb_state);
    return ((lb_r_input_Event_0o){ .value = _lb_ret32, .failed = false });
    lb_trap("unreachable");
}
void lb_window_Window_destroy(lb_window_Window* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/window/module.lucb:137:9";
    struct lb_window_State* lb_state __attribute__((unused)) = ({ struct lb_window_State* _lb_o33 = self->state; if (_lb_o33 == ((void*)0)) {
        return;
    } _lb_o33; });
    lb_pos = "src/std/window/module.lucb:141:9";
    (void)(({ lb_error _lb_fe34 __attribute__((unused)); int32_t _lb_v34 __attribute__((unused)) = 0; (void)(({ lb_r_unit _lb_r35 = lb_window_12check_thread(); if (_lb_r35.failed) {
    ...
    self->state = ((void*)0);
    {
        lb_pos = "src/std/window/module.lucb:143:13";
...
lb_r_unit lb_window_12check_thread(void) {
    ...
    if (!!((!lb_window_supported()))) 
    {
        ...
        lb_r_unit _lb_err36 = ((lb_r_unit){ .error = { .code = (int32_t)(lb_window_unsupported), .message = ((lb_str){"native windows are not implemented for this target", 50}) }, .failed = true });
        return _lb_err36;
    }
    {
        lb_pos = "src/std/window/module.lucb:155:9";
        if (!!(({ int32_t _lb_sq37 __attribute__((unused)) = lb_x_window_15pthread_main_np(); int32_t _lb_sq38 __attribute__((unused)) = 0LL; (_lb_sq37 == _lb_sq38); }))) 
        {
            lb_pos = "src/std/window/module.lucb:156:13";
            lb_r_unit _lb_err39 = ((lb_r_unit){ .error = { .code = (int32_t)(lb_window_12wrong_thread), .message = ((lb_str){"window operations require the main thread", 41}) }, .failed = true });
            return _lb_err39;
        }
    }
    {
...
lb_r_unit lb_window_12check_extent(uint32_t lb_width, uint32_t lb_height) {
    ...
    if (!!(((((lb_width == 0ULL) || (lb_height == 0ULL)) || (((uint32_t)(lb_width)) > ((uint32_t)(10000ULL)))) || (((uint32_t)(lb_height)) > ((uint32_t)(10000ULL)))))) 
    {
        ...
        lb_r_unit _lb_err44 = ((lb_r_unit){ .error = { .code = (int32_t)(lb_window_15invalid_options), .message = ((lb_str){"window dimensions must be between 1 and 10000 points", 52}) }, .failed = true });
        return _lb_err44;
    }
    return ((lb_r_unit){ .failed = false });
}
lb_r_window_State_0p lb_window_Window_checked(const lb_window_Window* self) {
    ...
    (void)((({ lb_r_unit _lb_r45 = lb_window_12check_thread(); if (_lb_r45.failed) {
        return ((lb_r_window_State_0p){ .error = _lb_r45.error, .failed = true });
    } (void)0; })));
    lb_pos = "src/std/window/module.lucb:149:9";
    struct lb_window_State* _lb_ret46 = ({ struct lb_window_State* _lb_o47 = self->state; if (_lb_o47 == ((void*)0)) {
        lb_r_window_State_0p _lb_err48 = ((lb_r_window_State_0p){ .error = { .code = (int32_t)(lb_window_closed), .message = ((lb_str){"the window is closed", 20}) }, .failed = true });
        return _lb_err48;
    } _lb_o47; });
    return ((lb_r_window_State_0p){ .value = _lb_ret46, .failed = false });
    lb_trap("unreachable");
}
