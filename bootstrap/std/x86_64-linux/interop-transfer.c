...
LB_RES(struct lb_interop_PacketBytes*, lb_r_interop_PacketBytes_0p);
...
lb_r_interop_Packet_0g1_str lb_interop_PacketBytes_text(lb_str lb_value);
...
lb_r_interop_Packet_0g1_u8_0c lb_interop_PacketBytes_copy(lb_cspan lb_value);
...
void lb_interop_Connection_init(lb_interop_Connection* self, struct lb_ownership_Object* lb_state, uint64_t lb_identifier, lb_fn_0F2_ownership_Object_0p_u64_unit lb_remove, lb_fn_0F2_ownership_Object_0p_u64_bool lb_contains);
void lb_interop_Connection_disconnect(lb_interop_Connection* self);
bool lb_interop_Connection_12is_connected(const lb_interop_Connection* self);
struct lb_net_Cancellation* lb_interop_19worker_cancellation(void);
...
void lb_interop_PacketBytes_drop(void* lb_raw);
...
lb_interop_Transfer_0g1_str lb_interop_13text_transfer = {.copy = lb_interop_PacketBytes_text};
lb_interop_Transfer_0g1_u8_0c lb_interop_14bytes_transfer = {.copy = lb_interop_PacketBytes_copy};
...
__attribute__((weak)) lb_interop_Transfer_0g1_str lb_interop_Transfer_0g1_str_plain(void) {
    ...
    lb_pos = "src/std/interop/transfer.lucb:26:9";
...
__attribute__((weak)) lb_r_interop_Packet_0g1_str lb_interop_Transfer_0g1_str_10copy_plain(lb_str lb_value) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/interop/transfer.lucb:29:9";
...
lb_r_interop_Packet_0g1_str lb_interop_PacketBytes_text(lb_str lb_value) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/interop/transfer.lucb:47:9";
    lb_interop_Packet_0g1_u8_0c lb_packet __attribute__((unused)) = (({ lb_r_interop_Packet_0g1_u8_0c _lb_r4 = lb_interop_PacketBytes_copy(((lb_cspan){(void*)(lb_value.data), lb_value.length})); if (_lb_r4.failed) {
        return ((lb_r_interop_Packet_0g1_str){ .error = _lb_r4.error, .failed = true });
    } _lb_r4.value; }));
    lb_pos = "src/std/interop/transfer.lucb:48:9";
    lb_interop_Packet_0g1_str _lb_ret5 = ({ lb_interop_Packet_0g1_str _lb_iv6 = {}; lb_interop_Packet_0g1_str_init(&_lb_iv6, ({ lb_span _lb_sc7 = lb_packet.value; const char* _lb_sb7 = (const char*)_lb_sc7.data; size_t _lb_sl7 = _lb_sc7.length; (lb_str){ _lb_sb7, _lb_sl7 }; }), lb_packet.storage, lb_packet.dispose); _lb_iv6; });
    return ((lb_r_interop_Packet_0g1_str){ .value = _lb_ret5, .failed = false });
    lb_trap("unreachable");
}
__attribute__((weak)) lb_interop_Transfer_0g1_u8_0c lb_interop_Transfer_0g1_u8_0c_plain(void) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/interop/transfer.lucb:26:9";
    lb_interop_Transfer_0g1_u8_0c _lb_ret8 = ((lb_interop_Transfer_0g1_u8_0c){.copy = lb_interop_Transfer_0g1_u8_0c_10copy_plain});
    return _lb_ret8;
    lb_trap("unreachable");
}
__attribute__((weak)) lb_r_interop_Packet_0g1_u8_0c lb_interop_Transfer_0g1_u8_0c_10copy_plain(lb_cspan lb_value) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/interop/transfer.lucb:29:9";
    lb_interop_Packet_0g1_u8_0c _lb_ret9 = ({ lb_interop_Packet_0g1_u8_0c _lb_iv10 = {}; lb_interop_Packet_0g1_u8_0c_init(&_lb_iv10, lb_value, ((void*)0), ((void*)0)); _lb_iv10; });
    return ((lb_r_interop_Packet_0g1_u8_0c){ .value = _lb_ret9, .failed = false });
    lb_trap("unreachable");
}
lb_r_interop_Packet_0g1_u8_0c lb_interop_PacketBytes_copy(lb_cspan lb_value) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/interop/transfer.lucb:40:9";
    lb_span lb_bytes __attribute__((unused)) = (({ lb_r_u8_0s _lb_r11 = ({ lb_iface _lb_a12 = lb_memory_heap; size_t _lb_n12 = (size_t)((lb_value.length)); lb_r_u8_0s _lb_r12; if (_lb_n12 > UINT64_C(4611686018427387904)) { _lb_r12 = ((lb_r_u8_0s){ .error = { .code = 208273409, .message = (lb_str){"memory.exhausted", 16} }, .failed = true }); } else { size_t _lb_bytes12 = sizeof(uint8_t) * _lb_n12; lb_o_u8_0s _lb_ao12 = lb_alloc_call(_lb_a12, _lb_bytes12, _Alignof(uint8_t)); if (_lb_bytes12 != 0 && !_lb_ao12.present) { _lb_r12 = ((lb_r_u8_0s){ .error = { .code = 208273409, .message = (lb_str){"memory.exhausted", 16} }, .failed = true }); } else { _lb_r12.value.data = _lb_ao12.value.data; _lb_r12.value.length = _lb_n12; _lb_r12.failed = false; } } _lb_r12; }); if (_lb_r11.failed) {
        return ((lb_r_interop_Packet_0g1_u8_0c){ .error = _lb_r11.error, .failed = true });
    } _lb_r11.value; }));
    lb_pos = "src/std/interop/transfer.lucb:41:9";
    lb_pos = "src/std/interop/transfer.lucb:42:9";
    (void)(lb_memory_copy_0g1_u8(lb_bytes, lb_value, (lb_value.length)));
    lb_pos = "src/std/interop/transfer.lucb:43:9";
    struct lb_interop_PacketBytes* lb_storage __attribute__((unused)) = (({ lb_r_interop_PacketBytes_0p _lb_r13 = ({ lb_iface _lb_a14 = lb_memory_heap; lb_o_u8_0s _lb_ao14 = lb_alloc_call(_lb_a14, sizeof(lb_interop_PacketBytes), _Alignof(lb_interop_PacketBytes)); lb_r_interop_PacketBytes_0p _lb_r14; if (!_lb_ao14.present) { _lb_r14 = ((lb_r_interop_PacketBytes_0p){ .error = { .code = 208273409, .message = (lb_str){"memory.exhausted", 16} }, .failed = true }); } else { lb_interop_PacketBytes* _lb_p14 = (lb_interop_PacketBytes*)_lb_ao14.value.data; *_lb_p14 = ((lb_interop_PacketBytes){.bytes = lb_bytes}); _lb_r14.value = _lb_p14; _lb_r14.failed = false; } _lb_r14; }); if (_lb_r13.failed) {
        { lb_span _lb_s15 = lb_bytes; lb_release_call(lb_memory_heap, (lb_span){ (void*)(_lb_s15.data), lb_mul_u(_lb_s15.length, sizeof(uint8_t), 64) }); }
        return ((lb_r_interop_Packet_0g1_u8_0c){ .error = _lb_r13.error, .failed = true });
    } _lb_r13.value; }));
    lb_pos = "src/std/interop/transfer.lucb:44:9";
    lb_interop_Packet_0g1_u8_0c _lb_ret16 = ({ lb_interop_Packet_0g1_u8_0c _lb_iv17 = {}; lb_interop_Packet_0g1_u8_0c_init(&_lb_iv17, lb_bytes, ((void*)(lb_storage)), lb_interop_PacketBytes_drop); _lb_iv17; });
    return ((lb_r_interop_Packet_0g1_u8_0c){ .value = _lb_ret16, .failed = false });
    lb_trap("unreachable");
}
__attribute__((weak)) void lb_interop_Packet_0g1_str_init(lb_interop_Packet_0g1_str* self, lb_str lb_value, void* lb_storage, lb_fn_0F1_void_0p_unit lb_dispose) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/interop/transfer.lucb:10:9";
    self->value = lb_value;
    lb_pos = "src/std/interop/transfer.lucb:11:9";
    self->storage = lb_storage;
    lb_pos = "src/std/interop/transfer.lucb:12:9";
    self->dispose = lb_dispose;
}
__attribute__((weak)) void lb_interop_Packet_0g1_str_release(const lb_interop_Packet_0g1_str* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/interop/transfer.lucb:15:9";
    void* _lb_o18 = self->storage;
    if (_lb_o18 != ((void*)0)) {
        void* lb_storage __attribute__((unused)) = _lb_o18;
        {
            lb_pos = "src/std/interop/transfer.lucb:16:13";
...
__attribute__((weak)) void lb_memory_copy_0g1_u8(lb_span lb_target, lb_cspan lb_source, size_t lb_count) {
    ...
    if (!!((((size_t)(lb_count)) > ((size_t)(0ULL))))) 
    {
        ...
        (void)(((void)(({ void* _lb_sq22 __attribute__((unused)) = ((uint8_t*)(lb_target.data)); const void* _lb_sq23 __attribute__((unused)) = ((const uint8_t*)(lb_source.data)); size_t _lb_sq24 __attribute__((unused)) = ({ size_t _lb_sq25 __attribute__((unused)) = lb_count; size_t _lb_sq26 __attribute__((unused)) = ((size_t)sizeof(uint8_t)); (size_t)(lb_mul_u((uint64_t)(_lb_sq25), (uint64_t)(_lb_sq26), 64)); }); ({ void* _lb_fr = lb_x_memory_memcpy(_lb_sq22, _lb_sq23, _lb_sq24); if (!_lb_fr) lb_trap("null_foreign"); _lb_fr; }); }))));
    }
}
void lb_interop_PacketBytes_drop(void* lb_raw) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/interop/transfer.lucb:35:9";
    struct lb_interop_PacketBytes* lb_storage __attribute__((unused)) = ((struct lb_interop_PacketBytes*)(lb_raw));
    lb_pos = "src/std/interop/transfer.lucb:36:9";
    { lb_span _lb_s27 = (lb_storage)->bytes; lb_release_call(lb_memory_heap, (lb_span){ (void*)(_lb_s27.data), lb_mul_u(_lb_s27.length, sizeof(uint8_t), 64) }); }
    lb_pos = "src/std/interop/transfer.lucb:37:9";
    lb_release_call(lb_memory_heap, (lb_span){ (void*)(lb_storage), sizeof(lb_interop_PacketBytes) });
}
