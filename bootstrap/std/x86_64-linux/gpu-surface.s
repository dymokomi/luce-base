...
lb_gpu_Surface_open:
    ...
    movq %rbx, %rsi
    leaq -160(%rbp), %rdi
    call lb_gpu_Device_checked@PLT
    leaq -160(%rbp), %r12
    movq $32, %rcx
    movq %r12, %rbx
    addq %rcx, %rbx
...
.L1_1:
    ...
    movq %r13, %rsi
    leaq -208(%rbp), %rdi
    call lb_window_Window_20acquire_presentation@PLT
    leaq -208(%rbp), %r15
    movq $32, %rcx
    movq %r15, %r13
    addq %rcx, %r13
...
.L1_4:
    ...
    movq 0(%r10), %rdx
    leaq -248(%rbp), %rdi
    call lb_gpu_20backend_surface_open@PLT
    leaq -248(%rbp), %r13
    movq $32, %rcx
    movq %r13, %r12
    addq %rcx, %r12
...
.L1_8:
    ...
    movb %al, (%r10)
    movq -400(%rbp), %rdi
    call lb_window_Presentation_destroy@PLT
    movq %r12, %rsi
    movq -8(%rbp), %rdi
    movq $40, %rdx
    call memcpy@PLT
...
.L1_16:
    ...
    movq 0(%r10), %rsi
    movq -392(%rbp), %rdx
    call lb_gpu_23backend_surface_destroy@PLT
    movq -400(%rbp), %rdi
    call lb_window_Presentation_destroy@PLT
    movq %r12, %rsi
    movq -8(%rbp), %rdi
...
lb_gpu_Surface_size:
    ...
    movq %rbx, %rsi
    leaq -160(%rbp), %rdi
    call lb_gpu_Surface_checked@PLT
    leaq -160(%rbp), %r12
    movq $32, %rcx
    movq %r12, %rbx
    addq %rcx, %rbx
...
.L2_1:
    ...
    movq %rbx, %rsi
    leaq -232(%rbp), %rdi
    call lb_window_Presentation_size@PLT
    leaq -232(%rbp), %r13
    movq $64, %rcx
    movq %r13, %rbx
    addq %rcx, %rbx
...
.L3_12:
    ...
    movq %r15, %rcx
    leaq -320(%rbp), %rdi
    call lb_gpu_21backend_clear_present@PLT
    addq $32, %rsp
    leaq -320(%rbp), %r15
    movq $32, %rcx
    movq %r15, %r14
...
.L4_12:
    ...
    movq %r15, %rcx
    leaq -392(%rbp), %rdi
    call lb_gpu_14backend_render@PLT
    addq $96, %rsp
    leaq -392(%rbp), %r15
    movq $32, %rcx
    movq %r15, %r14
...
.L5_20:
    ...
    movq 8(%r10), %rcx
    leaq -440(%rbp), %rdi
    call lb_interop_Reference_0g1_gpu_Frame_adopt@PLT
    addq $48, %rsp
    leaq -440(%rbp), %r14
    movq $32, %rcx
    movq %r14, %r13
...
.L5_26:
    ...
    movq %rbx, %r12
    addq %rcx, %r12
    movq lb_gpu_19check_surface_frame@GOTPCREL(%rip), %r14
    movq %r12, %r10
    movq %r14, (%r10)
    movq $128, %rcx
    movq %rbx, %r12
    addq %rcx, %r12
    movq lb_gpu_20submit_surface_frame@GOTPCREL(%rip), %r14
    movq %r12, %r10
    movq %r14, (%r10)
    movq $136, %rcx
    addq %rcx, %rbx
    movq lb_gpu_21release_surface_frame@GOTPCREL(%rip), %r12
    movq %rbx, %r10
    movq %r12, (%r10)
    movq -488(%rbp), %rax
    movq $24, %rcx
...
.L6_1:
    ...
    movq %rbx, %rdx
    leaq -144(%rbp), %rdi
    call lb_gpu_20backend_surface_wait@PLT
    leaq -144(%rbp), %r13
    movq $24, %rcx
    movq %r13, %rbx
    addq %rcx, %rbx
...
.L7_4:
.L7_3:
    call lb_gpu_14require_thread@PLT
    movq $0, %rax
    movq %rbx, %r10
    movq %rax, (%r10)
    movq $32, %rcx
    ...
    movb %al, (%r10)
    movq %r12, %rdi
    call lb_gpu_15release_surface@PLT
    movq -8(%rbp), %rbx
    movq -16(%rbp), %r12
    movq -24(%rbp), %r13
    movq %rbp, %rsp
...
lb_gpu_Surface_checked:
    ...
    movq (%r10), %r12
    leaq -120(%rbp), %rdi
    call lb_gpu_12check_thread@PLT
    leaq -120(%rbp), %r13
    movq $24, %rcx
    movq %r13, %rbx
    addq %rcx, %rbx
...
.L9_1:
    ...
    movq (%r10), %r12
    movq %r12, %rdi
    call lb_gpu_14release_device@PLT
...
.L13_3:
    ...
    movq -352(%rbp), %rsi
    leaq -272(%rbp), %rdi
    call lb_interop_Reservation_0g1_gpu_Frame_init@PLT
    addq $48, %rsp
    leaq -272(%rbp), %r14
    leaq -312(%rbp), %rbx
    movq $8, %rcx
...
.L13_5:
    ...
    movq 0(%r10), %rdx
    movq 8(%r10), %rcx
    call lb_interop_Reservation_0g1_gpu_Frame_publish@PLT
    leaq -336(%rbp), %r10
    movq %rax, 0(%r10)
    leaq -336(%rbp), %rbx
    leaq -88(%rbp), %r14
...
.L16_3:
    ...
    movq %r15, %r10
    movq %rax, (%r10)
    movq lb_interop_Owner_0g1_gpu_Frame_12finish_owner@GOTPCREL(%rip), %r15
    movq $24, %rcx
    movq %r14, %r13
    addq %rcx, %r13
    movq %r13, %r10
    movq %r15, (%r10)
    movq lb_interop_Owner_0g1_gpu_Frame_10drop_owner@GOTPCREL(%rip), %r13
    movq $32, %rcx
    movq %r14, %r15
    addq %rcx, %r15
    movq %r15, %r10
    movq %r13, (%r10)
    movq lb_interop_Owner_0g1_gpu_Frame_11trace_owner@GOTPCREL(%rip), %r13
    movq $40, %rcx
    movq %r14, %r15
    addq %rcx, %r15
    movq %r15, %r10
...
lb_interop_Owner_0g1_gpu_Frame_12finish_owner:
    ...
    movq (%r10), %rbx
    movq %rbx, %rdi
    call lb_interop_11close_owner_0g1_gpu_Frame@PLT
    movq -8(%rbp), %rbx
    movq %rbp, %rsp
    popq %rbp
    ret
...
.L23_5:
    movq %rbx, %rdi
    call lb_interop_13dispose_owner_0g1_gpu_Frame@PLT
    jmp .L23_7
.L23_6:
.L23_7:
    movq -8(%rbp), %rbx
