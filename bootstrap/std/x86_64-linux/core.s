...
.L21_13:
    ...
    .type lb_core_22free_windows_arguments, @function
...
.L22_4:
    ...
    .p2align 4
    .globl lb_core_17windows_arguments
    .type lb_core_17windows_arguments, @function
lb_core_17windows_arguments:
    pushq %rbp
    movq %rsp, %rbp
    subq $48, %rsp
    movq %rbx, -8(%rbp)
...
lb_core_9show_next:
    ...
    .type lb_core_23windows_argument_vector, @object
    .p2align 3
