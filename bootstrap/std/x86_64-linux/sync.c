...
typedef struct lb_t_0T2_bool_u32 { bool a0; uint32_t a1; } lb_t_0T2_bool_u32;
...
bool lb_sync_Mutex_8try_lock(lb_sync_Mutex* self);
void lb_sync_Condition_wait(lb_sync_Condition* self, struct lb_sync_Mutex* lb_mutex);
void lb_sync_Condition_signal(lb_sync_Condition* self);
void lb_sync_Condition_broadcast(lb_sync_Condition* self);
void lb_sync_Once_run(lb_sync_Once* self, lb_fn_0F0_unit lb_function);
void lb_sync_Semaphore_acquire(lb_sync_Semaphore* self);
void lb_sync_Semaphore_release(lb_sync_Semaphore* self);
...
void lb_sync_8sleep_on(void* lb_address, uint32_t lb_value);
void lb_sync_8wake_one(void* lb_address);
void lb_sync_10wake_every(void* lb_address);
...
uint32_t lb_sync_16compare_and_wait = 1ULL;
uint32_t lb_sync_8wake_all = 256ULL;
int64_t lb_sync_12futex_number = ((int64_t)202ULL);
int32_t lb_sync_18futex_wait_private = 128LL;
int32_t lb_sync_18futex_wake_private = 129LL;
...
__attribute__((weak)) lb_interop_Transfer_0g1_str lb_interop_Transfer_0g1_str_plain(void) {
    ...
    lb_pos = "src/std/sync.lucb:812:1";
...
__attribute__((weak)) lb_r_interop_Packet_0g1_str lb_interop_Transfer_0g1_str_10copy_plain(lb_str lb_value) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/sync.lucb:815:1";
...
void lb_sync_Mutex_lock(lb_sync_Mutex* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/sync.lucb:52:9";
    lb_t_0T2_bool_u32 _lb_tu7 __attribute__((unused)) = ({ uint32_t _lb_ce8 = (uint32_t)(0ULL); bool _lb_co8; if (0) { _lb_co8 = atomic_compare_exchange_weak_explicit(&(self->state), &_lb_ce8, (uint32_t)(1ULL), memory_order_acquire, memory_order_relaxed); } else { _lb_co8 = atomic_compare_exchange_strong_explicit(&(self->state), &_lb_ce8, (uint32_t)(1ULL), memory_order_acquire, memory_order_relaxed); } (lb_t_0T2_bool_u32){ _lb_co8, _lb_ce8 }; });
    bool lb_taken __attribute__((unused)) = _lb_tu7.a0;
    uint32_t lb_seen __attribute__((unused)) = _lb_tu7.a1;
    lb_pos = "src/std/sync.lucb:53:9";
    if (!!(lb_taken)) 
    {
        lb_pos = "src/std/sync.lucb:54:13";
        return;
    }
    lb_pos = "src/std/sync.lucb:55:9";
    uint32_t lb_current __attribute__((unused)) = lb_seen;
    lb_pos = "src/std/sync.lucb:56:9";
    if (!!((!(lb_current == 2ULL)))) 
    {
        lb_pos = "src/std/sync.lucb:57:13";
        lb_current = ((uint32_t)atomic_exchange_explicit(&(self->state), (uint32_t)(2ULL), memory_order_acquire));
    }
    lb_pos = "src/std/sync.lucb:58:9";
    for (;;) {
        lb_pos = "src/std/sync.lucb:58:9";
        if (!((!(lb_current == 0ULL)))) break;
        {
            lb_pos = "src/std/sync.lucb:59:13";
            (void)(lb_sync_8sleep_on(((void*)(&(self->state))), 2ULL));
            lb_pos = "src/std/sync.lucb:60:13";
            lb_current = ((uint32_t)atomic_exchange_explicit(&(self->state), (uint32_t)(2ULL), memory_order_acquire));
        }
    }
}
void lb_sync_Mutex_unlock(lb_sync_Mutex* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/sync.lucb:63:9";
    if (!!(({ uint32_t _lb_sq11 __attribute__((unused)) = ((uint32_t)atomic_exchange_explicit(&(self->state), (uint32_t)(0ULL), memory_order_release)); uint32_t _lb_sq13 __attribute__((unused)) = 2ULL; (_lb_sq11 == _lb_sq13); }))) 
    {
        lb_pos = "src/std/sync.lucb:64:13";
        (void)(lb_sync_8wake_one(((void*)(&(self->state)))));
    }
}
bool lb_sync_Mutex_8try_lock(lb_sync_Mutex* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/sync.lucb:67:9";
    lb_t_0T2_bool_u32 _lb_tu14 __attribute__((unused)) = ({ uint32_t _lb_ce15 = (uint32_t)(0ULL); bool _lb_co15; if (0) { _lb_co15 = atomic_compare_exchange_weak_explicit(&(self->state), &_lb_ce15, (uint32_t)(1ULL), memory_order_acquire, memory_order_relaxed); } else { _lb_co15 = atomic_compare_exchange_strong_explicit(&(self->state), &_lb_ce15, (uint32_t)(1ULL), memory_order_acquire, memory_order_relaxed); } (lb_t_0T2_bool_u32){ _lb_co15, _lb_ce15 }; });
    bool lb_taken __attribute__((unused)) = _lb_tu14.a0;
    uint32_t lb_seen __attribute__((unused)) = _lb_tu14.a1;
    lb_pos = "src/std/sync.lucb:68:9";
    (void)(((void)(lb_seen)));
    lb_pos = "src/std/sync.lucb:69:9";
    bool _lb_ret16 = lb_taken;
    return _lb_ret16;
    lb_trap("unreachable");
}
void lb_sync_Condition_wait(lb_sync_Condition* self, struct lb_sync_Mutex* lb_mutex) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/sync.lucb:76:9";
    uint32_t lb_seen __attribute__((unused)) = ((uint32_t)atomic_load_explicit(&(self->sequence), memory_order_acquire));
    lb_pos = "src/std/sync.lucb:77:9";
    (void)(lb_sync_Mutex_unlock(lb_mutex));
    lb_pos = "src/std/sync.lucb:78:9";
    (void)(lb_sync_8sleep_on(((void*)(&(self->sequence))), lb_seen));
    lb_pos = "src/std/sync.lucb:79:9";
    (void)(lb_sync_Mutex_lock(lb_mutex));
}
void lb_sync_Condition_signal(lb_sync_Condition* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/sync.lucb:82:9";
    (void)(((void)(((uint32_t)atomic_fetch_add_explicit(&(self->sequence), (uint32_t)(1ULL), memory_order_release)))));
    lb_pos = "src/std/sync.lucb:83:9";
    (void)(lb_sync_8wake_one(((void*)(&(self->sequence)))));
}
void lb_sync_Condition_broadcast(lb_sync_Condition* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/sync.lucb:86:9";
    (void)(((void)(((uint32_t)atomic_fetch_add_explicit(&(self->sequence), (uint32_t)(1ULL), memory_order_release)))));
    lb_pos = "src/std/sync.lucb:87:9";
    (void)(lb_sync_10wake_every(((void*)(&(self->sequence)))));
}
void lb_sync_Once_run(lb_sync_Once* self, lb_fn_0F0_unit lb_function) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/sync.lucb:94:9";
    lb_t_0T2_bool_u32 _lb_tu20 __attribute__((unused)) = ({ uint32_t _lb_ce21 = (uint32_t)(0ULL); bool _lb_co21; if (0) { _lb_co21 = atomic_compare_exchange_weak_explicit(&(self->state), &_lb_ce21, (uint32_t)(1ULL), memory_order_acq_rel, memory_order_acquire); } else { _lb_co21 = atomic_compare_exchange_strong_explicit(&(self->state), &_lb_ce21, (uint32_t)(1ULL), memory_order_acq_rel, memory_order_acquire); } (lb_t_0T2_bool_u32){ _lb_co21, _lb_ce21 }; });
    bool lb_first __attribute__((unused)) = _lb_tu20.a0;
    uint32_t lb_seen __attribute__((unused)) = _lb_tu20.a1;
    lb_pos = "src/std/sync.lucb:95:9";
    (void)(((void)(lb_seen)));
    lb_pos = "src/std/sync.lucb:96:9";
    if (!!(lb_first)) 
    {
        lb_pos = "src/std/sync.lucb:97:13";
        (void)((lb_function)());
        lb_pos = "src/std/sync.lucb:98:13";
        (void)((atomic_store_explicit(&(self->state), (uint32_t)(2ULL), memory_order_release), (void)0));
        lb_pos = "src/std/sync.lucb:99:13";
        (void)(lb_sync_10wake_every(((void*)(&(self->state)))));
        lb_pos = "src/std/sync.lucb:100:13";
        return;
    }
    lb_pos = "src/std/sync.lucb:101:9";
    for (;;) {
        lb_pos = "src/std/sync.lucb:101:9";
        if (!(({ uint32_t _lb_sq23 __attribute__((unused)) = ((uint32_t)atomic_load_explicit(&(self->state), memory_order_acquire)); uint32_t _lb_sq25 __attribute__((unused)) = 2ULL; (!(_lb_sq23 == _lb_sq25)); }))) break;
        {
            lb_pos = "src/std/sync.lucb:102:13";
            (void)(lb_sync_8sleep_on(((void*)(&(self->state))), 1ULL));
        }
    }
}
void lb_sync_Semaphore_acquire(lb_sync_Semaphore* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/sync.lucb:109:9";
    for (;;) {
        lb_pos = "src/std/sync.lucb:109:9";
        if (!(true)) break;
        {
            lb_pos = "src/std/sync.lucb:110:13";
            uint32_t lb_n __attribute__((unused)) = ((uint32_t)atomic_load_explicit(&(self->count), memory_order_acquire));
            lb_pos = "src/std/sync.lucb:111:13";
            if (!!((((uint32_t)(lb_n)) > ((uint32_t)(0ULL))))) 
            {
                lb_pos = "src/std/sync.lucb:112:17";
                lb_t_0T2_bool_u32 _lb_tu27 __attribute__((unused)) = ({ uint32_t _lb_ce28 = (uint32_t)(lb_n); bool _lb_co28; if (0) { _lb_co28 = atomic_compare_exchange_weak_explicit(&(self->count), &_lb_ce28, (uint32_t)((uint32_t)(lb_sub_u((uint64_t)(lb_n), (uint64_t)(1ULL), 32))), memory_order_acq_rel, memory_order_relaxed); } else { _lb_co28 = atomic_compare_exchange_strong_explicit(&(self->count), &_lb_ce28, (uint32_t)((uint32_t)(lb_sub_u((uint64_t)(lb_n), (uint64_t)(1ULL), 32))), memory_order_acq_rel, memory_order_relaxed); } (lb_t_0T2_bool_u32){ _lb_co28, _lb_ce28 }; });
                bool lb_taken __attribute__((unused)) = _lb_tu27.a0;
                uint32_t lb_seen __attribute__((unused)) = _lb_tu27.a1;
                lb_pos = "src/std/sync.lucb:113:17";
                (void)(((void)(lb_seen)));
                lb_pos = "src/std/sync.lucb:114:17";
                if (!!(lb_taken)) 
                {
                    lb_pos = "src/std/sync.lucb:115:21";
                    return;
                }
            }
            else 
            {
                lb_pos = "src/std/sync.lucb:117:17";
                (void)(lb_sync_8sleep_on(((void*)(&(self->count))), 0ULL));
            }
        }
    }
}
void lb_sync_Semaphore_release(lb_sync_Semaphore* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/sync.lucb:120:9";
    (void)(((void)(((uint32_t)atomic_fetch_add_explicit(&(self->count), (uint32_t)(1ULL), memory_order_release)))));
    lb_pos = "src/std/sync.lucb:121:9";
    (void)(lb_sync_8wake_one(((void*)(&(self->count)))));
}
__attribute__((weak)) void lb_interop_Packet_0g1_str_init(lb_interop_Packet_0g1_str* self, lb_str lb_value, void* lb_storage, lb_fn_0F1_void_0p_unit lb_dispose) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/sync.lucb:796:1";
    self->value = lb_value;
    lb_pos = "src/std/sync.lucb:797:1";
    self->storage = lb_storage;
    lb_pos = "src/std/sync.lucb:798:1";
    self->dispose = lb_dispose;
}
__attribute__((weak)) void lb_interop_Packet_0g1_str_release(const lb_interop_Packet_0g1_str* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/sync.lucb:801:1";
    void* _lb_o30 = self->storage;
    if (_lb_o30 != ((void*)0)) {
        void* lb_storage __attribute__((unused)) = _lb_o30;
        {
            lb_pos = "src/std/sync.lucb:802:1";
...
void lb_sync_8sleep_on(void* lb_address, uint32_t lb_value) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    {
        lb_pos = "src/std/sync.lucb:27:9";
        void* lb_no_timeout __attribute__((unused)) = ((void*)0);
        lb_pos = "src/std/sync.lucb:28:9";
        (void)(((void)(lb_x_sync_syscall(lb_sync_12futex_number, lb_address, lb_sync_18futex_wait_private, lb_value, lb_no_timeout))));
    }
}
void lb_sync_8wake_one(void* lb_address) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    {
        lb_pos = "src/std/sync.lucb:36:9";
        (void)(((void)(lb_x_sync_syscall(lb_sync_12futex_number, lb_address, lb_sync_18futex_wake_private, 1LL))));
    }
}
void lb_sync_10wake_every(void* lb_address) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    {
        lb_pos = "src/std/sync.lucb:44:9";
        (void)(((void)(lb_x_sync_syscall(lb_sync_12futex_number, lb_address, lb_sync_18futex_wake_private, 2147483647LL))));
    }
}
