...
__attribute__((weak)) lb_interop_Transfer_0g1_str lb_interop_Transfer_0g1_str_plain(void) {
    ...
    lb_pos = "src/std/windows_text.lucb:812:1";
...
__attribute__((weak)) lb_r_interop_Packet_0g1_str lb_interop_Transfer_0g1_str_10copy_plain(lb_str lb_value) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/windows_text.lucb:815:1";
...
lb_r_u16_0s lb_12windows_text_wide(char* lb_text, uint32_t lb_invalid) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/windows_text.lucb:8:5";
    int32_t lb_count __attribute__((unused)) = lb_x_11windows_abi_MultiByteToWideChar(lb_11windows_abi_9utf8_page, lb_11windows_abi_19reject_invalid_utf8, lb_text, ((int32_t)(-1LL)), ((void*)0), 0LL);
    lb_pos = "src/std/windows_text.lucb:9:5";
    if (!!((((int32_t)(lb_count)) <= ((int32_t)(0LL))))) 
    {
        lb_pos = "src/std/windows_text.lucb:10:9";
        lb_r_u16_0s _lb_err7 = ((lb_r_u16_0s){ .error = { .code = (int32_t)(lb_invalid), .message = ((lb_str){"OS text is not valid UTF-8", 26}) }, .failed = true });
        return _lb_err7;
    }
    lb_pos = "src/std/windows_text.lucb:11:5";
    lb_span lb_result __attribute__((unused)) = (({ lb_r_u16_0s _lb_r8 = ({ lb_iface _lb_a9 = lb_memory_allocator; size_t _lb_n9 = (size_t)(((size_t)lb_conv_s((int64_t)(lb_count), 32, 1, 64, 0, 1))); lb_r_u16_0s _lb_r9; if (_lb_n9 > UINT64_C(2305843009213693952)) { _lb_r9 = ((lb_r_u16_0s){ .error = { .code = 208273409, .message = (lb_str){"memory.exhausted", 16} }, .failed = true }); } else { size_t _lb_bytes9 = sizeof(uint16_t) * _lb_n9; lb_o_u8_0s _lb_ao9 = lb_alloc_call(_lb_a9, _lb_bytes9, _Alignof(uint16_t)); if (_lb_bytes9 != 0 && !_lb_ao9.present) { _lb_r9 = ((lb_r_u16_0s){ .error = { .code = 208273409, .message = (lb_str){"memory.exhausted", 16} }, .failed = true }); } else { _lb_r9.value.data = _lb_ao9.value.data; _lb_r9.value.length = _lb_n9; _lb_r9.failed = false; } } _lb_r9; }); if (_lb_r8.failed) {
        return ((lb_r_u16_0s){ .error = _lb_r8.error, .failed = true });
    } _lb_r8.value; }));
    lb_pos = "src/std/windows_text.lucb:12:5";
    if (!!(({ int32_t _lb_sq10 __attribute__((unused)) = lb_x_11windows_abi_MultiByteToWideChar(lb_11windows_abi_9utf8_page, lb_11windows_abi_19reject_invalid_utf8, lb_text, ((int32_t)(-1LL)), ((uint16_t*)(lb_result.data)), lb_count); int32_t _lb_sq11 __attribute__((unused)) = lb_count; (!(_lb_sq10 == _lb_sq11)); }))) 
    {
        lb_pos = "src/std/windows_text.lucb:13:9";
        { lb_span _lb_s12 = lb_result; lb_release_call(lb_memory_allocator, (lb_span){ (void*)(_lb_s12.data), lb_mul_u(_lb_s12.length, sizeof(uint16_t), 64) }); }
        lb_pos = "src/std/windows_text.lucb:14:9";
        lb_r_u16_0s _lb_err13 = ((lb_r_u16_0s){ .error = { .code = (int32_t)(lb_invalid), .message = ((lb_str){"OS text could not be converted to UTF-16", 40}) }, .failed = true });
        return _lb_err13;
    }
    lb_pos = "src/std/windows_text.lucb:15:5";
    lb_span _lb_ret14 = lb_result;
    return ((lb_r_u16_0s){ .value = _lb_ret14, .failed = false });
    lb_trap("unreachable");
}
lb_r_str lb_12windows_text_narrow(lb_cspan lb_text, uint32_t lb_invalid) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/windows_text.lucb:18:5";
    if (!!((((size_t)((lb_text.length))) > ((size_t)(2147483647ULL))))) 
    {
        lb_pos = "src/std/windows_text.lucb:19:9";
        lb_r_str _lb_err15 = ((lb_r_str){ .error = { .code = (int32_t)(lb_invalid), .message = ((lb_str){"OS text exceeds the conversion limit", 36}) }, .failed = true });
        return _lb_err15;
    }
    lb_pos = "src/std/windows_text.lucb:20:5";
    int32_t lb_count __attribute__((unused)) = lb_x_11windows_abi_WideCharToMultiByte(lb_11windows_abi_9utf8_page, lb_11windows_abi_20reject_invalid_utf16, ((const uint16_t*)(lb_text.data)), ((int32_t)lb_conv_u((uint64_t)((lb_text.length)), 64, 0, 32, 1, 1)), ((void*)0), 0LL, ((void*)0), ((void*)0));
    lb_pos = "src/std/windows_text.lucb:21:5";
    if (!!(((lb_count == 0LL) && (((size_t)((lb_text.length))) > ((size_t)(0ULL)))))) 
    {
        lb_pos = "src/std/windows_text.lucb:22:9";
        lb_r_str _lb_err16 = ((lb_r_str){ .error = { .code = (int32_t)(lb_invalid), .message = ((lb_str){"OS text is not valid UTF-16", 27}) }, .failed = true });
        return _lb_err16;
    }
    lb_pos = "src/std/windows_text.lucb:23:5";
    lb_span lb_result __attribute__((unused)) = (({ lb_r_u8_0s _lb_r17 = ({ lb_iface _lb_a18 = lb_memory_allocator; size_t _lb_n18 = (size_t)((size_t)(lb_add_u((uint64_t)(((size_t)lb_conv_s((int64_t)(lb_count), 32, 1, 64, 0, 1))), (uint64_t)(1ULL), 64))); lb_r_u8_0s _lb_r18; if (_lb_n18 > UINT64_C(4611686018427387904)) { _lb_r18 = ((lb_r_u8_0s){ .error = { .code = 208273409, .message = (lb_str){"memory.exhausted", 16} }, .failed = true }); } else { size_t _lb_bytes18 = sizeof(uint8_t) * _lb_n18; lb_o_u8_0s _lb_ao18 = lb_alloc_call(_lb_a18, _lb_bytes18, _Alignof(uint8_t)); if (_lb_bytes18 != 0 && !_lb_ao18.present) { _lb_r18 = ((lb_r_u8_0s){ .error = { .code = 208273409, .message = (lb_str){"memory.exhausted", 16} }, .failed = true }); } else { _lb_r18.value.data = _lb_ao18.value.data; _lb_r18.value.length = _lb_n18; _lb_r18.failed = false; } } _lb_r18; }); if (_lb_r17.failed) {
        return ((lb_r_str){ .error = _lb_r17.error, .failed = true });
    } _lb_r17.value; }));
    lb_pos = "src/std/windows_text.lucb:24:5";
    if (!!(((((int32_t)(lb_count)) > ((int32_t)(0LL))) && ({ int32_t _lb_sq19 __attribute__((unused)) = lb_x_11windows_abi_WideCharToMultiByte(lb_11windows_abi_9utf8_page, lb_11windows_abi_20reject_invalid_utf16, ((const uint16_t*)(lb_text.data)), ((int32_t)lb_conv_u((uint64_t)((lb_text.length)), 64, 0, 32, 1, 1)), ((uint8_t*)(lb_result.data)), lb_count, ((void*)0), ((void*)0)); int32_t _lb_sq20 __attribute__((unused)) = lb_count; (!(_lb_sq19 == _lb_sq20)); })))) 
    {
        lb_pos = "src/std/windows_text.lucb:25:9";
        { lb_span _lb_s21 = lb_result; lb_release_call(lb_memory_allocator, (lb_span){ (void*)(_lb_s21.data), lb_mul_u(_lb_s21.length, sizeof(uint8_t), 64) }); }
        lb_pos = "src/std/windows_text.lucb:26:9";
        lb_r_str _lb_err22 = ((lb_r_str){ .error = { .code = (int32_t)(lb_invalid), .message = ((lb_str){"OS text could not be converted to UTF-8", 39}) }, .failed = true });
        return _lb_err22;
    }
    lb_pos = "src/std/windows_text.lucb:27:5";
    (*({ lb_span _lb_ix23 = lb_result; &((uint8_t*)_lb_ix23.data)[lb_at((uint64_t)(((size_t)lb_conv_s((int64_t)(lb_count), 32, 1, 64, 0, 1))), _lb_ix23.length)]; })) = 0ULL;
    lb_pos = "src/std/windows_text.lucb:28:5";
    lb_str _lb_ret24 = ({ lb_span _lb_sc25 = ({ lb_span _lb_sv26 = lb_result; size_t _lb_sn26 = _lb_sv26.length; uint8_t* _lb_sd26 = (uint8_t*)_lb_sv26.data; size_t _lb_ss26 = 0; size_t _lb_se26 = (size_t)(((size_t)lb_conv_s((int64_t)(lb_count), 32, 1, 64, 0, 1))); lb_check_index(_lb_ss26, _lb_sn26 + 1); lb_check_index(_lb_se26, _lb_sn26 + 1); if (_lb_ss26 > _lb_se26) lb_trap("index out of bounds"); (lb_span){ (void*)(_lb_sd26 + _lb_ss26), _lb_se26 - _lb_ss26 }; }); const char* _lb_sb25 = (const char*)_lb_sc25.data; size_t _lb_sl25 = _lb_sc25.length; (lb_str){ _lb_sb25, _lb_sl25 }; });
    return ((lb_r_str){ .value = _lb_ret24, .failed = false });
    lb_trap("unreachable");
}
__attribute__((weak)) void lb_interop_Packet_0g1_str_init(lb_interop_Packet_0g1_str* self, lb_str lb_value, void* lb_storage, lb_fn_0F1_void_0p_unit lb_dispose) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/windows_text.lucb:796:1";
    self->value = lb_value;
    lb_pos = "src/std/windows_text.lucb:797:1";
    self->storage = lb_storage;
    lb_pos = "src/std/windows_text.lucb:798:1";
    self->dispose = lb_dispose;
}
__attribute__((weak)) void lb_interop_Packet_0g1_str_release(const lb_interop_Packet_0g1_str* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/windows_text.lucb:801:1";
    void* _lb_o27 = self->storage;
    if (_lb_o27 != ((void*)0)) {
        void* lb_storage __attribute__((unused)) = _lb_o27;
        {
            lb_pos = "src/std/windows_text.lucb:802:1";
