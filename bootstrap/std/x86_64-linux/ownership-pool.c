...
LB_RES(lb_span, lb_r_ownership_Pending_0s);
...
_Thread_local lb_span lb_ownership_pending = {};
...
_Thread_local size_t lb_ownership_13pending_count = 0ULL;
...
size_t lb_ownership_mark(void) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/ownership/pool.lucb:13:5";
    size_t _lb_ret7 = lb_ownership_13pending_count;
    return _lb_ret7;
    lb_trap("unreachable");
}
void lb_ownership_12push_pending(lb_ownership_Pending lb_p) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/ownership/pool.lucb:16:5";
    if (!!((lb_ownership_13pending_count == (lb_ownership_pending.length)))) 
    {
        lb_pos = "src/std/ownership/pool.lucb:17:9";
        lb_span lb_grown __attribute__((unused)) = ({ lb_error _lb_fe8 __attribute__((unused)); lb_span _lb_v8 __attribute__((unused)) = {}; _lb_v8 = ({ lb_r_ownership_Pending_0s _lb_r9 = ({ lb_iface _lb_a10 = lb_memory_heap; size_t _lb_n10 = (size_t)(((((size_t)((lb_ownership_pending.length))) > ((size_t)(0ULL))) ? (size_t)(lb_mul_u((uint64_t)((lb_ownership_pending.length)), (uint64_t)(2ULL), 64)) : 64ULL)); lb_r_ownership_Pending_0s _lb_r10; if (_lb_n10 > UINT64_C(144115188075855872)) { _lb_r10 = ((lb_r_ownership_Pending_0s){ .error = { .code = 208273409, .message = (lb_str){"memory.exhausted", 16} }, .failed = true }); } else { size_t _lb_bytes10 = sizeof(lb_ownership_Pending) * _lb_n10; lb_o_u8_0s _lb_ao10 = lb_alloc_call(_lb_a10, _lb_bytes10, _Alignof(lb_ownership_Pending)); if (_lb_bytes10 != 0 && !_lb_ao10.present) { _lb_r10 = ((lb_r_ownership_Pending_0s){ .error = { .code = 208273409, .message = (lb_str){"memory.exhausted", 16} }, .failed = true }); } else { _lb_r10.value.data = _lb_ao10.value.data; _lb_r10.value.length = _lb_n10; _lb_r10.failed = false; } } _lb_r10; }); if (_lb_r9.failed) {
            _lb_fe8 = _lb_r9.error;
            goto _lb_fh8;
        } _lb_r9.value; }); goto _lb_cd8; _lb_fh8: { 
            lb_error lb_failure __attribute__((unused)) = _lb_fe8;
            {
                lb_pos = "src/std/ownership/pool.lucb:18:13";
                (void)(lb_trap_text(((lb_str){"out of memory", 13})));
            }
        } _lb_cd8: __attribute__((unused)); _lb_v8; });
        lb_pos = "src/std/ownership/pool.lucb:19:9";
        size_t lb_i __attribute__((unused)) = 0ULL;
        lb_pos = "src/std/ownership/pool.lucb:20:9";
        for (;;) {
            lb_pos = "src/std/ownership/pool.lucb:20:9";
            if (!((((size_t)(lb_i)) < ((size_t)(lb_ownership_13pending_count))))) break;
            {
                lb_pos = "src/std/ownership/pool.lucb:21:13";
                (*({ lb_span _lb_ix11 = lb_grown; &((lb_ownership_Pending*)_lb_ix11.data)[lb_at((uint64_t)(lb_i), _lb_ix11.length)]; })) = (*({ lb_span _lb_ix12 = lb_ownership_pending; &((lb_ownership_Pending*)_lb_ix12.data)[lb_at((uint64_t)(lb_i), _lb_ix12.length)]; }));
                lb_pos = "src/std/ownership/pool.lucb:22:13";
                { size_t* lb__cell13 = &(lb_i);
                (*(lb__cell13)) = (size_t)(lb_add_u((uint64_t)((*(lb__cell13))), (uint64_t)(1ULL), 64)); }
            }
        }
        lb_pos = "src/std/ownership/pool.lucb:23:9";
        if (!!((((size_t)((lb_ownership_pending.length))) > ((size_t)(0ULL))))) 
        {
            lb_pos = "src/std/ownership/pool.lucb:24:13";
            { lb_span _lb_s14 = lb_ownership_pending; lb_release_call(lb_memory_heap, (lb_span){ (void*)(_lb_s14.data), lb_mul_u(_lb_s14.length, sizeof(lb_ownership_Pending), 64) }); }
        }
        lb_pos = "src/std/ownership/pool.lucb:25:9";
        lb_ownership_pending = lb_grown;
    }
    lb_pos = "src/std/ownership/pool.lucb:26:5";
    (*({ lb_span _lb_ix15 = lb_ownership_pending; &((lb_ownership_Pending*)_lb_ix15.data)[lb_at((uint64_t)(lb_ownership_13pending_count), _lb_ix15.length)]; })) = lb_p;
    lb_pos = "src/std/ownership/pool.lucb:27:5";
    { size_t* lb__cell16 = &(lb_ownership_13pending_count);
    (*(lb__cell16)) = (size_t)(lb_add_u((uint64_t)((*(lb__cell16))), (uint64_t)(1ULL), 64)); }
}
struct lb_ownership_Object* lb_ownership_11pool_object(struct lb_ownership_Object* lb_o) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/ownership/pool.lucb:31:5";
    (void)(lb_ownership_12push_pending(((lb_ownership_Pending){.object = lb_o, .cell = ((void*)0), .drop = ((void*)0), .size = 0ULL})));
    lb_pos = "src/std/ownership/pool.lucb:32:5";
    struct lb_ownership_Object* _lb_ret17 = lb_o;
    return _lb_ret17;
    lb_trap("unreachable");
}
void lb_ownership_drain(size_t lb_since) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/ownership/pool.lucb:44:5";
    if (!!((((size_t)(lb_ownership_13pending_count)) <= ((size_t)(lb_since))))) 
    {
        lb_pos = "src/std/ownership/pool.lucb:45:9";
        return;
    }
    lb_pos = "src/std/ownership/pool.lucb:46:5";
    size_t lb_count __attribute__((unused)) = lb_ownership_13pending_count;
    lb_pos = "src/std/ownership/pool.lucb:47:5";
    size_t lb_i __attribute__((unused)) = lb_since;
    lb_pos = "src/std/ownership/pool.lucb:48:5";
    for (;;) {
        lb_pos = "src/std/ownership/pool.lucb:48:5";
        if (!((((size_t)(lb_i)) < ((size_t)(lb_count))))) break;
        {
            lb_pos = "src/std/ownership/pool.lucb:49:9";
            lb_ownership_Pending lb_p __attribute__((unused)) = (*({ lb_span _lb_ix18 = lb_ownership_pending; &((lb_ownership_Pending*)_lb_ix18.data)[lb_at((uint64_t)(lb_i), _lb_ix18.length)]; }));
            lb_pos = "src/std/ownership/pool.lucb:50:9";
            struct lb_ownership_Object* _lb_o19 = lb_p.object;
            if (_lb_o19 != ((void*)0)) {
                struct lb_ownership_Object* lb_o __attribute__((unused)) = _lb_o19;
                {
                    lb_pos = "src/std/ownership/pool.lucb:51:13";
                    (void)(lb_ownership_release(lb_o));
                }
            }
            else {
                lb_pos = "src/std/ownership/pool.lucb:52:9";
                void* _lb_o20 = lb_p.cell;
                if (_lb_o20 != ((void*)0)) {
                    void* lb_cell __attribute__((unused)) = _lb_o20;
                    {
                        lb_pos = "src/std/ownership/pool.lucb:53:13";
                        lb_fn_0F1_void_0p_unit _lb_o21 = lb_p.drop;
                        if (_lb_o21 != ((void*)0)) {
                            lb_fn_0F1_void_0p_unit lb_d __attribute__((unused)) = _lb_o21;
                            {
                                lb_pos = "src/std/ownership/pool.lucb:54:17";
                                (void)((lb_d)(lb_cell));
                            }
                        }
                        lb_pos = "src/std/ownership/pool.lucb:55:13";
                        { lb_span _lb_s22 = ((lb_span){(void*)(((uint8_t*)(lb_cell))), (size_t)(lb_p.size)}); lb_release_call(lb_memory_heap, (lb_span){ (void*)(_lb_s22.data), lb_mul_u(_lb_s22.length, sizeof(uint8_t), 64) }); }
                    }
                }
            }
            lb_pos = "src/std/ownership/pool.lucb:56:9";
            { size_t* lb__cell23 = &(lb_i);
            (*(lb__cell23)) = (size_t)(lb_add_u((uint64_t)((*(lb__cell23))), (uint64_t)(1ULL), 64)); }
        }
    }
    lb_pos = "src/std/ownership/pool.lucb:58:5";
    lb_ownership_13pending_count = lb_since;
}
__attribute__((weak)) void lb_interop_Packet_0g1_str_init(lb_interop_Packet_0g1_str* self, lb_str lb_value, void* lb_storage, lb_fn_0F1_void_0p_unit lb_dispose) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
