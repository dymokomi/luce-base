...
lb_o_usize lb_utf8_14invalid_offset(lb_cspan lb_data);
...
lb_o_usize lb_utf8_14encoded_length(uint32_t lb_scalar) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/utf8/scalars.lucb:8:5";
    if (!!(((((uint32_t)(lb_scalar)) > ((uint32_t)(1114111ULL))) || (((((uint32_t)(lb_scalar)) >= ((uint32_t)(55296ULL))) && (((uint32_t)(lb_scalar)) <= ((uint32_t)(57343ULL)))))))) 
    {
        lb_pos = "src/std/utf8/scalars.lucb:9:9";
        lb_o_usize _lb_ret7 = ((lb_o_usize){ .present = false });
        return _lb_ret7;
    }
    lb_pos = "src/std/utf8/scalars.lucb:10:5";
    if (!!((((uint32_t)(lb_scalar)) < ((uint32_t)(128ULL))))) 
    {
        lb_pos = "src/std/utf8/scalars.lucb:11:9";
        lb_o_usize _lb_ret8 = ((lb_o_usize){ .value = 1ULL, .present = true });
        return _lb_ret8;
    }
    lb_pos = "src/std/utf8/scalars.lucb:12:5";
    if (!!((((uint32_t)(lb_scalar)) < ((uint32_t)(2048ULL))))) 
    {
        lb_pos = "src/std/utf8/scalars.lucb:13:9";
        lb_o_usize _lb_ret9 = ((lb_o_usize){ .value = 2ULL, .present = true });
        return _lb_ret9;
    }
    lb_pos = "src/std/utf8/scalars.lucb:14:5";
    lb_o_usize _lb_ret10 = ((lb_o_usize){ .value = ((((uint32_t)(lb_scalar)) < ((uint32_t)(65536ULL))) ? 3ULL : 4ULL), .present = true });
    return _lb_ret10;
    lb_trap("unreachable");
}
lb_o_utf8_Decoded lb_utf8_decode(lb_cspan lb_data, size_t lb_offset) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/utf8/scalars.lucb:20:5";
    if (!!((((size_t)(lb_offset)) >= ((size_t)((lb_data.length)))))) 
    {
        lb_pos = "src/std/utf8/scalars.lucb:21:9";
        lb_o_utf8_Decoded _lb_ret11 = ((lb_o_utf8_Decoded){ .present = false });
        return _lb_ret11;
    }
    lb_pos = "src/std/utf8/scalars.lucb:22:5";
    uint8_t lb_lead __attribute__((unused)) = (*({ lb_cspan _lb_ix12 = lb_data; &((uint8_t*)_lb_ix12.data)[lb_at((uint64_t)(lb_offset), _lb_ix12.length)]; }));
    lb_pos = "src/std/utf8/scalars.lucb:23:5";
    if (!!((((uint8_t)(lb_lead)) < ((uint8_t)(128ULL))))) 
    {
        lb_pos = "src/std/utf8/scalars.lucb:24:9";
        lb_o_utf8_Decoded _lb_ret13 = ((lb_o_utf8_Decoded){ .value = ({ uint32_t _lb_sq14 __attribute__((unused)) = ((uint32_t)lb_to_char(lb_conv_u((uint64_t)(lb_lead), 8, 0, 32, 0, 0), 0)); size_t _lb_sq15 __attribute__((unused)) = 1ULL; ((lb_utf8_Decoded){.scalar = _lb_sq14, .width = _lb_sq15}); }), .present = true });
        return _lb_ret13;
    }
    lb_pos = "src/std/utf8/scalars.lucb:25:5";
    size_t lb_width __attribute__((unused)) = 0ULL;
    lb_pos = "src/std/utf8/scalars.lucb:26:5";
    uint32_t lb_scalar __attribute__((unused)) = 0ULL;
    lb_pos = "src/std/utf8/scalars.lucb:27:5";
    if (!!(((((uint8_t)(lb_lead)) >= ((uint8_t)(194ULL))) && (((uint8_t)(lb_lead)) <= ((uint8_t)(223ULL)))))) 
    {
        lb_pos = "src/std/utf8/scalars.lucb:28:9";
        lb_width = 2ULL;
        lb_pos = "src/std/utf8/scalars.lucb:29:9";
        lb_scalar = ((uint32_t)lb_conv_u((uint64_t)((((uint8_t)(lb_lead & 31ULL)))), 8, 0, 32, 0, 1));
    }
    else {
        lb_pos = "src/std/utf8/scalars.lucb:30:5";
        if (!!(((((uint8_t)(lb_lead)) >= ((uint8_t)(224ULL))) && (((uint8_t)(lb_lead)) <= ((uint8_t)(239ULL)))))) 
        {
            lb_pos = "src/std/utf8/scalars.lucb:31:9";
            lb_width = 3ULL;
            lb_pos = "src/std/utf8/scalars.lucb:32:9";
            lb_scalar = ((uint32_t)lb_conv_u((uint64_t)((((uint8_t)(lb_lead & 15ULL)))), 8, 0, 32, 0, 1));
        }
        else {
            lb_pos = "src/std/utf8/scalars.lucb:33:5";
            if (!!(((((uint8_t)(lb_lead)) >= ((uint8_t)(240ULL))) && (((uint8_t)(lb_lead)) <= ((uint8_t)(244ULL)))))) 
            {
                lb_pos = "src/std/utf8/scalars.lucb:34:9";
                lb_width = 4ULL;
                lb_pos = "src/std/utf8/scalars.lucb:35:9";
                lb_scalar = ((uint32_t)lb_conv_u((uint64_t)((((uint8_t)(lb_lead & 7ULL)))), 8, 0, 32, 0, 1));
            }
            else 
            {
                lb_pos = "src/std/utf8/scalars.lucb:37:9";
                lb_o_utf8_Decoded _lb_ret16 = ((lb_o_utf8_Decoded){ .present = false });
                return _lb_ret16;
            }
        }
    }
    lb_pos = "src/std/utf8/scalars.lucb:38:5";
    if (!!((((size_t)(lb_width)) > ((size_t)((size_t)(lb_sub_u((uint64_t)((lb_data.length)), (uint64_t)(lb_offset), 64))))))) 
    {
        lb_pos = "src/std/utf8/scalars.lucb:39:9";
        lb_o_utf8_Decoded _lb_ret17 = ((lb_o_utf8_Decoded){ .present = false });
        return _lb_ret17;
    }
    lb_pos = "src/std/utf8/scalars.lucb:40:5";
    size_t lb_i __attribute__((unused)) = 1ULL;
    lb_pos = "src/std/utf8/scalars.lucb:41:5";
    for (;;) {
        lb_pos = "src/std/utf8/scalars.lucb:41:5";
        if (!((((size_t)(lb_i)) < ((size_t)(lb_width))))) break;
        {
            lb_pos = "src/std/utf8/scalars.lucb:42:9";
            uint8_t lb_byte __attribute__((unused)) = (*({ lb_cspan _lb_ix18 = lb_data; &((uint8_t*)_lb_ix18.data)[lb_at((uint64_t)((size_t)(lb_add_u((uint64_t)(lb_offset), (uint64_t)(lb_i), 64))), _lb_ix18.length)]; }));
            lb_pos = "src/std/utf8/scalars.lucb:43:9";
            if (!!((!((((uint8_t)(lb_byte & 192ULL))) == 128ULL)))) 
            {
                lb_pos = "src/std/utf8/scalars.lucb:44:13";
                lb_o_utf8_Decoded _lb_ret19 = ((lb_o_utf8_Decoded){ .present = false });
                return _lb_ret19;
            }
            lb_pos = "src/std/utf8/scalars.lucb:45:9";
            lb_scalar = ((uint32_t)(((uint32_t)(lb_shl_u((uint64_t)(lb_scalar), (uint64_t)((uint32_t)(6LL)), 32))) | ((uint32_t)lb_conv_u((uint64_t)((((uint8_t)(lb_byte & 63ULL)))), 8, 0, 32, 0, 1))));
            lb_pos = "src/std/utf8/scalars.lucb:46:9";
            { size_t* lb__cell20 = &(lb_i);
            (*(lb__cell20)) = (size_t)(lb_add_u((uint64_t)((*(lb__cell20))), (uint64_t)(1ULL), 64)); }
        }
    }
    lb_pos = "src/std/utf8/scalars.lucb:47:5";
    size_t lb_shortest __attribute__((unused)) = ({ lb_o_usize _lb_o21 = lb_utf8_14encoded_length(lb_scalar); if (!_lb_o21.present) {
        lb_o_utf8_Decoded _lb_ret22 = ((lb_o_utf8_Decoded){ .present = false });
        return _lb_ret22;
    } _lb_o21.value; });
    lb_pos = "src/std/utf8/scalars.lucb:48:5";
    if (!!((!(lb_shortest == lb_width)))) 
    {
        lb_pos = "src/std/utf8/scalars.lucb:49:9";
        lb_o_utf8_Decoded _lb_ret23 = ((lb_o_utf8_Decoded){ .present = false });
        return _lb_ret23;
    }
    lb_pos = "src/std/utf8/scalars.lucb:50:5";
    lb_o_utf8_Decoded _lb_ret24 = ((lb_o_utf8_Decoded){ .value = ({ uint32_t _lb_sq25 __attribute__((unused)) = ((uint32_t)lb_to_char(lb_conv_u((uint64_t)(lb_scalar), 32, 0, 32, 0, 0), 0)); size_t _lb_sq26 __attribute__((unused)) = lb_width; ((lb_utf8_Decoded){.scalar = _lb_sq25, .width = _lb_sq26}); }), .present = true });
    return _lb_ret24;
    lb_trap("unreachable");
}
lb_o_usize lb_utf8_14invalid_offset(lb_cspan lb_data) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/utf8/scalars.lucb:55:5";
    size_t lb_offset __attribute__((unused)) = 0ULL;
    lb_pos = "src/std/utf8/scalars.lucb:56:5";
    for (;;) {
        lb_pos = "src/std/utf8/scalars.lucb:56:5";
        if (!((((size_t)(lb_offset)) < ((size_t)((lb_data.length)))))) break;
        {
            lb_pos = "src/std/utf8/scalars.lucb:57:9";
            lb_utf8_Decoded lb_decoded __attribute__((unused)) = ({ lb_o_utf8_Decoded _lb_o27 = lb_utf8_decode(lb_data, lb_offset); if (!_lb_o27.present) {
                lb_o_usize _lb_ret28 = ((lb_o_usize){ .value = lb_offset, .present = true });
                return _lb_ret28;
            } _lb_o27.value; });
            lb_pos = "src/std/utf8/scalars.lucb:58:9";
            { size_t* lb__cell29 = &(lb_offset);
            (*(lb__cell29)) = (size_t)(lb_add_u((uint64_t)((*(lb__cell29))), (uint64_t)(lb_decoded.width), 64)); }
        }
    }
    lb_pos = "src/std/utf8/scalars.lucb:59:5";
    lb_o_usize _lb_ret30 = ((lb_o_usize){ .present = false });
    return _lb_ret30;
    lb_trap("unreachable");
}
bool lb_utf8_valid(lb_cspan lb_data) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/utf8/scalars.lucb:63:5";
    bool _lb_ret31 = ({ lb_o_usize _lb_sq32 __attribute__((unused)) = lb_utf8_14invalid_offset(lb_data); lb_o_usize _lb_sq33 __attribute__((unused)) = ((lb_o_usize){ .present = false }); ({ lb_o_usize _lb_on34 = _lb_sq32; !_lb_on34.present; }); });
    return _lb_ret31;
    lb_trap("unreachable");
}
lb_o_usize lb_utf8_encode(uint32_t lb_scalar, lb_span lb_buffer) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/utf8/scalars.lucb:69:5";
    size_t lb_width __attribute__((unused)) = ({ lb_o_usize _lb_o35 = lb_utf8_14encoded_length(lb_scalar); if (!_lb_o35.present) {
        lb_o_usize _lb_ret36 = ((lb_o_usize){ .present = false });
        return _lb_ret36;
    } _lb_o35.value; });
    lb_pos = "src/std/utf8/scalars.lucb:70:5";
    if (!!((((size_t)(lb_width)) > ((size_t)((lb_buffer.length)))))) 
    {
        lb_pos = "src/std/utf8/scalars.lucb:71:9";
        lb_o_usize _lb_ret37 = ((lb_o_usize){ .present = false });
        return _lb_ret37;
    }
    lb_pos = "src/std/utf8/scalars.lucb:72:5";
    if (!!((lb_width == 1ULL))) 
    {
        lb_pos = "src/std/utf8/scalars.lucb:73:9";
        (*({ lb_span _lb_ix38 = lb_buffer; &((uint8_t*)_lb_ix38.data)[lb_at((uint64_t)(0ULL), _lb_ix38.length)]; })) = ((uint8_t)lb_conv_u((uint64_t)(lb_scalar), 32, 0, 8, 0, 1));
        lb_pos = "src/std/utf8/scalars.lucb:74:9";
        lb_o_usize _lb_ret39 = ((lb_o_usize){ .value = 1ULL, .present = true });
        return _lb_ret39;
    }
    lb_pos = "src/std/utf8/scalars.lucb:75:5";
    uint32_t lb_remaining __attribute__((unused)) = lb_scalar;
    lb_pos = "src/std/utf8/scalars.lucb:76:5";
    size_t lb_i __attribute__((unused)) = lb_width;
    lb_pos = "src/std/utf8/scalars.lucb:77:5";
    for (;;) {
        lb_pos = "src/std/utf8/scalars.lucb:77:5";
        if (!((((size_t)(lb_i)) > ((size_t)(1ULL))))) break;
        {
            lb_pos = "src/std/utf8/scalars.lucb:78:9";
            { size_t* lb__cell40 = &(lb_i);
            (*(lb__cell40)) = (size_t)(lb_sub_u((uint64_t)((*(lb__cell40))), (uint64_t)(1ULL), 64)); }
            lb_pos = "src/std/utf8/scalars.lucb:79:9";
            (*({ lb_span _lb_ix41 = lb_buffer; &((uint8_t*)_lb_ix41.data)[lb_at((uint64_t)(lb_i), _lb_ix41.length)]; })) = ((uint8_t)(128ULL | ((uint8_t)lb_conv_u((uint64_t)((((uint32_t)(lb_remaining & 63ULL)))), 32, 0, 8, 0, 1))));
            lb_pos = "src/std/utf8/scalars.lucb:80:9";
            { uint32_t* lb__cell42 = &(lb_remaining);
            (*(lb__cell42)) = (uint32_t)(lb_shr_u((uint64_t)((*(lb__cell42))), (uint64_t)(6ULL), 32)); }
        }
    }
    lb_pos = "src/std/utf8/scalars.lucb:81:5";
    uint8_t lb_prefix __attribute__((unused)) = ((lb_width == 2ULL) ? 192ULL : (((lb_width == 3ULL) ? 224ULL : 240ULL)));
    lb_pos = "src/std/utf8/scalars.lucb:82:5";
    (*({ lb_span _lb_ix43 = lb_buffer; &((uint8_t*)_lb_ix43.data)[lb_at((uint64_t)(0ULL), _lb_ix43.length)]; })) = ((uint8_t)(lb_prefix | ((uint8_t)lb_conv_u((uint64_t)(lb_remaining), 32, 0, 8, 0, 1))));
    lb_pos = "src/std/utf8/scalars.lucb:83:5";
    lb_o_usize _lb_ret44 = ((lb_o_usize){ .value = lb_width, .present = true });
    return _lb_ret44;
    lb_trap("unreachable");
}
__attribute__((weak)) void lb_interop_Packet_0g1_str_init(lb_interop_Packet_0g1_str* self, lb_str lb_value, void* lb_storage, lb_fn_0F1_void_0p_unit lb_dispose) {
