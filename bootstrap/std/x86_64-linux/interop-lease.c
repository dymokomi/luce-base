...
#endif
void lb_interop_10drop_lease(struct lb_ownership_Object* lb_object);
void lb_interop_11trace_lease(struct lb_ownership_Object* lb_object, lb_fn_0F2_ownership_Object_0p_void_0p_unit lb_visit, void* lb_context);
...
void lb_interop_Lease_alive(const lb_interop_Lease* self);
...
void lb_interop_10drop_lease(struct lb_ownership_Object* lb_object) {
    ...
    lb_pos = "src/std/interop/lease.lucb:12:5";
    struct lb_interop_LeaseState* lb_state __attribute__((unused)) = ((struct lb_interop_LeaseState*)(lb_object));
    lb_pos = "src/std/interop/lease.lucb:13:5";
    (void)(lb_ownership_release((lb_state)->owner));
}
void lb_interop_11trace_lease(struct lb_ownership_Object* lb_object, lb_fn_0F2_ownership_Object_0p_void_0p_unit lb_visit, void* lb_context) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/interop/lease.lucb:16:5";
    (void)((lb_visit)(((((struct lb_interop_LeaseState*)(lb_object))))->owner, lb_context));
}
__attribute__((weak)) lb_interop_Transfer_0g1_str lb_interop_Transfer_0g1_str_plain(void) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
...
lb_r_unit lb_interop_Lease_init(lb_interop_Lease* self, struct lb_ownership_Object* lb_owner, lb_fn_0F1_ownership_Object_0p_bool lb_open, lb_fn_0F1_ownership_Object_0p_unit lb_begin, lb_fn_0F1_ownership_Object_0p_unit lb_end) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/interop/lease.lucb:27:9";
    (void)(lb_ownership_11check_alive(lb_owner));
    lb_pos = "src/std/interop/lease.lucb:28:9";
    struct lb_interop_LeaseState* lb_state __attribute__((unused)) = ((struct lb_interop_LeaseState*)((({ lb_r_ownership_Object_0p _lb_r7 = ({ struct lb_ownership_Info* _lb_sq8 __attribute__((unused)) = &(lb_interop_10lease_info); size_t _lb_sq9 __attribute__((unused)) = ((size_t)sizeof(lb_interop_LeaseState)); lb_ownership_reserve(_lb_sq8, _lb_sq9, ((lb_iface){ ((void*)0), ((void*)0) })); }); if (_lb_r7.failed) {
        return ((lb_r_unit){ .error = _lb_r7.error, .failed = true });
    } _lb_r7.value; }))));
    lb_pos = "src/std/interop/lease.lucb:29:9";
    (lb_state)->owner = lb_ownership_retain(lb_owner);
    lb_pos = "src/std/interop/lease.lucb:30:9";
    (lb_state)->open = lb_open;
    lb_pos = "src/std/interop/lease.lucb:31:9";
    (lb_state)->begin = lb_begin;
    lb_pos = "src/std/interop/lease.lucb:32:9";
    (lb_state)->end = lb_end;
    lb_pos = "src/std/interop/lease.lucb:33:9";
    (lb_state)->valid = true;
    lb_pos = "src/std/interop/lease.lucb:34:9";
    self->state = lb_state;
    lb_pos = "src/std/interop/lease.lucb:35:9";
    self->generation = (lb_state)->header.generation;
    return ((lb_r_unit){ .failed = false });
}
lb_interop_Lease lb_interop_Lease_clone(const lb_interop_Lease* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/interop/lease.lucb:43:9";
    (void)(lb_interop_Lease_alive(self));
    lb_pos = "src/std/interop/lease.lucb:44:9";
    (void)(((void)(lb_ownership_retain(&((self->state)->header)))));
    lb_pos = "src/std/interop/lease.lucb:45:9";
    lb_interop_Lease _lb_ret10 = (*self);
    return _lb_ret10;
    lb_trap("unreachable");
}
void lb_interop_Lease_release(const lb_interop_Lease* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/interop/lease.lucb:48:9";
    (void)(lb_interop_Lease_alive(self));
    lb_pos = "src/std/interop/lease.lucb:49:9";
    (void)(lb_ownership_release(&((self->state)->header)));
}
void lb_interop_Lease_invalidate(const lb_interop_Lease* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/interop/lease.lucb:52:9";
    (void)(lb_interop_Lease_alive(self));
    lb_pos = "src/std/interop/lease.lucb:53:9";
    (self->state)->valid = false;
}
bool lb_interop_Lease_8is_valid(const lb_interop_Lease* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/interop/lease.lucb:56:9";
    (void)(lb_interop_Lease_alive(self));
    lb_pos = "src/std/interop/lease.lucb:57:9";
    bool _lb_ret11 = ((self->state)->valid && ((self->state)->open)((self->state)->owner));
    return _lb_ret11;
    lb_trap("unreachable");
}
lb_r_unit lb_interop_Lease_check(const lb_interop_Lease* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/interop/lease.lucb:60:9";
    if (!!((!lb_interop_Lease_8is_valid(self)))) 
    {
        lb_pos = "src/std/interop/lease.lucb:61:13";
        lb_r_unit _lb_err12 = ((lb_r_unit){ .error = { .code = (int32_t)(lb_interop_expired), .message = ((lb_str){"a native view has expired", 25}) }, .failed = true });
        return _lb_err12;
    }
    return ((lb_r_unit){ .failed = false });
}
lb_r_unit lb_interop_Lease_enter(const lb_interop_Lease* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/interop/lease.lucb:66:9";
    (void)((({ lb_r_unit _lb_r13 = lb_interop_Lease_check(self); if (_lb_r13.failed) {
        return ((lb_r_unit){ .error = _lb_r13.error, .failed = true });
    } (void)0; })));
    lb_pos = "src/std/interop/lease.lucb:67:9";
    (void)(((void)(lb_ownership_retain(&((self->state)->header)))));
    lb_pos = "src/std/interop/lease.lucb:68:9";
    (void)(((self->state)->begin)((self->state)->owner));
    return ((lb_r_unit){ .failed = false });
}
void lb_interop_Lease_leave(const lb_interop_Lease* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/interop/lease.lucb:71:9";
    (void)(lb_interop_Lease_alive(self));
    lb_pos = "src/std/interop/lease.lucb:72:9";
    (void)(((self->state)->end)((self->state)->owner));
    lb_pos = "src/std/interop/lease.lucb:73:9";
    (void)(lb_ownership_release(&((self->state)->header)));
}
void lb_interop_Lease_trace(const lb_interop_Lease* self, lb_fn_0F2_ownership_Object_0p_void_0p_unit lb_visit, void* lb_context) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/interop/lease.lucb:76:9";
    (void)(lb_ownership_12check_thread(&((self->state)->header)));
    lb_pos = "src/std/interop/lease.lucb:77:9";
    (void)((lb_visit)(&((self->state)->header), lb_context));
}
__attribute__((weak)) void lb_interop_Packet_0g1_str_init(lb_interop_Packet_0g1_str* self, lb_str lb_value, void* lb_storage, lb_fn_0F1_void_0p_unit lb_dispose) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
...
void lb_interop_Lease_alive(const lb_interop_Lease* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/interop/lease.lucb:38:9";
    (void)(lb_ownership_11check_alive(&((self->state)->header)));
    lb_pos = "src/std/interop/lease.lucb:39:9";
    if (!!((!(self->generation == (self->state)->header.generation)))) 
    {
        lb_pos = "src/std/interop/lease.lucb:40:13";
        (void)(lb_trap_text(((lb_str){"a native lease has a stale generation", 37})));
    }
}
