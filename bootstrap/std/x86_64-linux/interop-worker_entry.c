...
_Thread_local struct lb_net_Cancellation* lb_interop_26active_worker_cancellation = ((void*)0);
...
struct lb_net_Cancellation* lb_interop_19worker_cancellation(void) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/interop/worker_entry.lucb:24:5";
    struct lb_net_Cancellation* _lb_ret7 = ({ struct lb_net_Cancellation* _lb_o8 = lb_interop_26active_worker_cancellation; if (_lb_o8 == ((void*)0)) {
        (void)(lb_trap_text(((lb_str){"this operation requires an application worker", 45})));
    } _lb_o8; });
    return _lb_ret7;
    lb_trap("unreachable");
}
