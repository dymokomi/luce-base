...
void lb_testing_begin(uint64_t lb_index);
void lb_testing_end(void);
uint64_t lb_testing_seed(void);
uint64_t lb_testing_random(void);
void lb_testing_expect(bool lb_condition, lb_str lb_message);
void lb_testing_12expect_equal(int64_t lb_actual, int64_t lb_expected, lb_str lb_message);
void lb_testing_11expect_text(lb_str lb_actual, lb_str lb_expected, lb_str lb_message);
...
lb_a_u8_0a1048576 lb_testing_11arena_bytes = {};
lb_memory_FixedBuffer lb_testing_arena = {};
lb_iface lb_testing_saved = {};
uint64_t lb_testing_12current_seed = 1ULL;
...
__attribute__((weak)) lb_interop_Transfer_0g1_str lb_interop_Transfer_0g1_str_plain(void) {
    ...
    lb_pos = "src/std/testing.lucb:812:1";
...
__attribute__((weak)) lb_r_interop_Packet_0g1_str lb_interop_Transfer_0g1_str_10copy_plain(lb_str lb_value) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/testing.lucb:815:1";
...
void lb_testing_begin(uint64_t lb_index) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/testing.lucb:14:5";
    lb_testing_arena = lb_memory_FixedBuffer_over(((lb_span){(void*)(lb_testing_11arena_bytes.d), 1048576ULL}));
    lb_pos = "src/std/testing.lucb:15:5";
    lb_testing_saved = lb_memory_allocator;
    lb_pos = "src/std/testing.lucb:16:5";
    lb_memory_allocator = ((lb_iface){ (void*)(&(lb_testing_arena)), &lb_vt_memory_FixedBuffer_Allocator });
    lb_pos = "src/std/testing.lucb:17:5";
    lb_testing_12current_seed = (uint64_t)(lb_add_u((uint64_t)((uint64_t)(lb_mul_u((uint64_t)(lb_index), (uint64_t)(2654435761ULL), 64))), (uint64_t)(1ULL), 64));
}
void lb_testing_end(void) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/testing.lucb:21:5";
    lb_memory_allocator = lb_testing_saved;
}
uint64_t lb_testing_seed(void) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/testing.lucb:25:5";
    uint64_t _lb_ret7 = lb_testing_12current_seed;
    return _lb_ret7;
    lb_trap("unreachable");
}
uint64_t lb_testing_random(void) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/testing.lucb:29:5";
    uint64_t lb_x __attribute__((unused)) = lb_testing_12current_seed;
    lb_pos = "src/std/testing.lucb:30:5";
    lb_x = ((uint64_t)(lb_x ^ ((uint64_t)(lb_shl_u((uint64_t)(lb_x), (uint64_t)((uint64_t)(13LL)), 64)))));
    lb_pos = "src/std/testing.lucb:31:5";
    lb_x = ((uint64_t)(lb_x ^ ((uint64_t)(lb_shr_u((uint64_t)(lb_x), (uint64_t)((uint64_t)(7LL)), 64)))));
    lb_pos = "src/std/testing.lucb:32:5";
    lb_x = ((uint64_t)(lb_x ^ ((uint64_t)(lb_shl_u((uint64_t)(lb_x), (uint64_t)((uint64_t)(17LL)), 64)))));
    lb_pos = "src/std/testing.lucb:33:5";
    lb_testing_12current_seed = lb_x;
    lb_pos = "src/std/testing.lucb:34:5";
    uint64_t _lb_ret8 = lb_x;
    return _lb_ret8;
    lb_trap("unreachable");
}
void lb_testing_expect(bool lb_condition, lb_str lb_message) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/testing.lucb:37:5";
    if (!!((!lb_condition))) 
    {
        lb_pos = "src/std/testing.lucb:38:9";
        (void)(lb_trap_text(lb_message));
    }
}
void lb_testing_12expect_equal(int64_t lb_actual, int64_t lb_expected, lb_str lb_message) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/testing.lucb:41:5";
    if (!!((!(lb_actual == lb_expected)))) 
    {
        lb_pos = "src/std/testing.lucb:42:9";
        (void)(({ fwrite("expected ", 1, 9, stdout); fprintf(stdout, "%lld", (long long)(lb_expected)); fwrite(", got ", 1, 6, stdout); fprintf(stdout, "%lld", (long long)(lb_actual)); fwrite(": ", 1, 2, stdout); { lb_str _lb_ps9 = lb_message; fwrite(_lb_ps9.data, 1, _lb_ps9.length, stdout); } fputc('\n', stdout); (void)0; }));
        lb_pos = "src/std/testing.lucb:43:9";
        (void)(lb_trap_text(lb_message));
    }
}
void lb_testing_11expect_text(lb_str lb_actual, lb_str lb_expected, lb_str lb_message) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/testing.lucb:46:5";
    if (!!((!({ lb_str _lb_sa10 = lb_actual; lb_str _lb_sb10 = lb_expected; (_lb_sa10.length == _lb_sb10.length && (_lb_sa10.length == 0 || memcmp(_lb_sa10.data, _lb_sb10.data, _lb_sa10.length) == 0)); })))) 
    {
        lb_pos = "src/std/testing.lucb:47:9";
        (void)(({ fwrite("expected `", 1, 10, stdout); { lb_str _lb_ps11 = lb_expected; fwrite(_lb_ps11.data, 1, _lb_ps11.length, stdout); } fwrite("`, got `", 1, 8, stdout); { lb_str _lb_ps12 = lb_actual; fwrite(_lb_ps12.data, 1, _lb_ps12.length, stdout); } fwrite("`: ", 1, 3, stdout); { lb_str _lb_ps13 = lb_message; fwrite(_lb_ps13.data, 1, _lb_ps13.length, stdout); } fputc('\n', stdout); (void)0; }));
        lb_pos = "src/std/testing.lucb:48:9";
        (void)(lb_trap_text(lb_message));
    }
}
__attribute__((weak)) void lb_interop_Packet_0g1_str_init(lb_interop_Packet_0g1_str* self, lb_str lb_value, void* lb_storage, lb_fn_0F1_void_0p_unit lb_dispose) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/testing.lucb:796:1";
    self->value = lb_value;
    lb_pos = "src/std/testing.lucb:797:1";
    self->storage = lb_storage;
    lb_pos = "src/std/testing.lucb:798:1";
    self->dispose = lb_dispose;
}
__attribute__((weak)) void lb_interop_Packet_0g1_str_release(const lb_interop_Packet_0g1_str* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/testing.lucb:801:1";
    void* _lb_o14 = self->storage;
    if (_lb_o14 != ((void*)0)) {
        void* lb_storage __attribute__((unused)) = _lb_o14;
        {
            lb_pos = "src/std/testing.lucb:802:1";
