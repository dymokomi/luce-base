...
typedef struct lb_interop_Reference_0g1_json_Value lb_interop_Reference_0g1_json_Value;
typedef struct lb_interop_Owner_0g1_json_Value lb_interop_Owner_0g1_json_Value;
typedef struct lb_interop_Reservation_0g1_json_Value lb_interop_Reservation_0g1_json_Value;
...
typedef struct lb_interop_Reference_0g1_json_Value {
    struct lb_interop_Owner_0g1_json_Value* owner;
} lb_interop_Reference_0g1_json_Value;
LB_RES(lb_interop_Reference_0g1_json_Value, lb_r_interop_Reference_0g1_json_Value);
LB_RES(struct lb_json_Value*, lb_r_json_Value_0p);
...
typedef struct lb_interop_Owner_0g1_json_Value {
    lb_ownership_Object header;
    lb_ownership_Info information;
    lb_interop_Type_0g1_json_Value declaration;
    struct lb_json_Value* native;
    lb_iface native_allocator;
    bool closed;
    bool disposed;
    size_t active;
} lb_interop_Owner_0g1_json_Value;
typedef struct lb_interop_Reservation_0g1_json_Value {
    struct lb_interop_Owner_0g1_json_Value* owner;
} lb_interop_Reservation_0g1_json_Value;
LB_RES(lb_interop_Reservation_0g1_json_Value, lb_r_interop_Reservation_0g1_json_Value);
LB_RES(lb_interop_Lease, lb_r_interop_Lease);
LB_OPT(uint32_t, lb_o_char);
LB_RES(lb_o_char, lb_r_char_0o);
typedef struct lb_a_u8_0a2 { uint8_t d[2]; } lb_a_u8_0a2;
typedef struct lb_a_u8_0a6 { uint8_t d[6]; } lb_a_u8_0a6;
...
uint32_t lb_json_invalid = ((uint32_t)(208273518ULL));
uint32_t lb_json_14limit_exceeded = ((uint32_t)(208273519ULL));
lb_interop_Type_0g1_json_Value lb_json_10value_type = {.name = {"JSON value", 10}, .dispose = lb_json_Value_close, .trace = ((void*)0), .closeable = true, .main_thread = false};
...
lb_r_interop_Reference_0g1_json_Value lb_json_Value_array(size_t lb_maximum_bytes) {
    ...
    return ((lb_r_interop_Reference_0g1_json_Value){ .value = _lb_ret13, .failed = false });
    lb_trap("unreachable");
}
lb_r_interop_Reference_0g1_json_Value lb_json_Value_text(lb_str lb_value) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    ...
    (void)(lb_json_Bytes_close(&(lb_bytes)));
    return ((lb_r_interop_Reference_0g1_json_Value){ .value = _lb_ret16, .failed = false });
    (void)(lb_json_Bytes_close(&(lb_bytes)));
    lb_trap("unreachable");
}
lb_r_interop_Reference_0g1_json_Value lb_json_Value_integer(int64_t lb_value) {
    ...
    lb_interop_Reference_0g1_json_Value _lb_ret19 = (({ lb_r_interop_Reference_0g1_json_Value _lb_r20 = lb_json_Value_scalar((({ lb_r_str _lb_r21 = ({ lb_span _lb_ds22 = ((lb_span){(void*)(lb_buffer.d), 32ULL}); lb_fmtbuf _lb_fb22 = { (char*)_lb_ds22.data, _lb_ds22.length, 0 }; (void)lb_fmtbuf_i64(&_lb_fb22, (int64_t)(lb_value)); lb_r_str _lb_out22; if (_lb_fb22.used > _lb_fb22.cap) { _lb_out22 = ((lb_r_str){ .error = { .code = 208273409, .message = (lb_str){"memory.exhausted: the formatted text does not fit its buffer", 60} }, .failed = true }); } else { _lb_out22 = ((lb_r_str){ .value = lb_fmtbuf_finish(&_lb_fb22), .failed = false }); } _lb_out22; }); if (_lb_r21.failed) {
        ...
        return ((lb_r_interop_Reference_0g1_json_Value){ .error = _lb_r20.error, .failed = true });
    } _lb_r20.value; }));
    return ((lb_r_interop_Reference_0g1_json_Value){ .value = _lb_ret19, .failed = false });
    lb_trap("unreachable");
}
lb_r_interop_Reference_0g1_json_Value lb_json_Value_number(double lb_value) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    ...
    lb_interop_Reference_0g1_json_Value _lb_ret24 = (({ lb_r_interop_Reference_0g1_json_Value _lb_r25 = lb_json_Value_scalar((({ lb_r_str _lb_r26 = lb_strings_10format_f64(lb_value, ((lb_span){(void*)(lb_buffer.d), 64ULL})); if (_lb_r26.failed) {
        ...
        return ((lb_r_interop_Reference_0g1_json_Value){ .error = _lb_r25.error, .failed = true });
    } _lb_r25.value; }));
    return ((lb_r_interop_Reference_0g1_json_Value){ .value = _lb_ret24, .failed = false });
    lb_trap("unreachable");
}
lb_r_interop_Reference_0g1_json_Value lb_json_Value_boolean(bool lb_value) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    ...
    return ((lb_r_interop_Reference_0g1_json_Value){ .value = _lb_ret27, .failed = false });
    lb_trap("unreachable");
}
lb_r_interop_Reference_0g1_json_Value lb_json_Value_null(void) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    ...
    return ((lb_r_interop_Reference_0g1_json_Value){ .value = _lb_ret29, .failed = false });
    lb_trap("unreachable");
}
lb_str lb_json_Value_encode(const lb_json_Value* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
...
__attribute__((weak)) lb_r_json_Value_0p lb_interop_Reference_0g1_json_Value_get(const lb_interop_Reference_0g1_json_Value* self) {
    ...
    return ((lb_r_json_Value_0p){ .value = _lb_ret68, .failed = false });
    lb_trap("unreachable");
}
__attribute__((weak)) struct lb_json_Value* lb_interop_Reference_0g1_json_Value_value(const lb_interop_Reference_0g1_json_Value* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
...
__attribute__((weak)) lb_r_interop_Lease lb_interop_Reference_0g1_json_Value_lease(const lb_interop_Reference_0g1_json_Value* self) {
    ...
    return ((lb_r_interop_Lease){ .value = _lb_ret76, .failed = false });
    lb_trap("unreachable");
}
__attribute__((weak)) lb_r_unit lb_interop_Reference_0g1_json_Value_18validate_interface(struct lb_ownership_Object* lb_object) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
...
lb_r_interop_Reference_0g1_json_Value lb_json_Value_own(struct lb_json_Value* lb_native) {
    ...
    return ((lb_r_interop_Reference_0g1_json_Value){ .value = _lb_ret81, .failed = false });
    lb_trap("unreachable");
}
lb_r_unit lb_json_quoted(lb_str lb_value, struct lb_json_Bytes* lb_output, size_t lb_maximum) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
...
lb_r_interop_Reference_0g1_json_Value lb_json_Value_scalar(lb_str lb_data) {
    ...
    return ((lb_r_interop_Reference_0g1_json_Value){ .value = _lb_ret99, .failed = false });
    lb_trap("unreachable");
}
lb_cspan lb_json_Bytes_view(const lb_json_Bytes* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
