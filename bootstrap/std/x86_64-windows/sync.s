...
lb_sync_Mutex_8try_lock:
    .seh_proc lb_sync_Mutex_8try_lock
    pushq %rbp
    .seh_pushreg %rbp
    subq $224, %rsp
    .seh_stackalloc 224
...
lb_sync_Condition_wait:
    .seh_proc lb_sync_Condition_wait
    pushq %rbp
    .seh_pushreg %rbp
    subq $272, %rsp
    .seh_stackalloc 272
...
lb_sync_Condition_signal:
    .seh_proc lb_sync_Condition_signal
    pushq %rbp
    .seh_pushreg %rbp
    subq $224, %rsp
    .seh_stackalloc 224
...
lb_sync_Condition_broadcast:
    .seh_proc lb_sync_Condition_broadcast
    pushq %rbp
    .seh_pushreg %rbp
    subq $224, %rsp
    .seh_stackalloc 224
...
lb_sync_Semaphore_acquire:
    .seh_proc lb_sync_Semaphore_acquire
    pushq %rbp
    .seh_pushreg %rbp
    subq $288, %rsp
    .seh_stackalloc 288
...
lb_sync_Semaphore_release:
    .seh_proc lb_sync_Semaphore_release
    pushq %rbp
    .seh_pushreg %rbp
    subq $224, %rsp
    .seh_stackalloc 224
...
.Ltext_3:
    ...
    .section .data$lb_sync_16compare_and_wait,"dw"
    .globl lb_sync_16compare_and_wait
    .p2align 2
lb_sync_16compare_and_wait:
    .zero 4

    .section .data$lb_sync_8wake_all,"dw"
    .globl lb_sync_8wake_all
    .p2align 2
lb_sync_8wake_all:
    .zero 4

    .section .data$lb_sync_12futex_number,"dw"
    .globl lb_sync_12futex_number
    .p2align 3
lb_sync_12futex_number:
    .zero 8

    .section .data$lb_sync_18futex_wait_private,"dw"
    .globl lb_sync_18futex_wait_private
    .p2align 2
lb_sync_18futex_wait_private:
    .zero 4

    .section .data$lb_sync_18futex_wake_private,"dw"
