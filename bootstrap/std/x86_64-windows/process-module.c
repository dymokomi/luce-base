...
lb_r_0T3_i32_str_str lb_process_14run_controlled(char* lb_program, lb_cspan lb_arguments, char* lb_directory, lb_o_5c_str_0c lb_environment, struct lb_process_CommandState* lb_control) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    {
        lb_pos = "src/std/process/module.lucb:91:9";
        lb_t_0T3_i32_str_str _lb_ret9 = (({ lb_r_0T3_i32_str_str _lb_r10 = lb_process_11run_windows(lb_program, lb_arguments, lb_directory, lb_environment, lb_control); if (_lb_r10.failed) {
            return ((lb_r_0T3_i32_str_str){ .error = _lb_r10.error, .failed = true });
        } _lb_r10.value; }));
        return ((lb_r_0T3_i32_str_str){ .value = _lb_ret9, .failed = false });
    }
    lb_trap("unreachable");
}
void lb_process_release(lb_str lb_text) {
