...
lb_r_gpu_VulkanSurface_0p lb_gpu_19vulkan_surface_open(struct lb_gpu_VulkanDevice* lb_device, lb_window_Presentation lb_host) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/gpu/vulkan/surface.lucb:29:5";
    struct lb_gpu_VulkanSurface* lb_state __attribute__((unused)) = (({ lb_r_gpu_VulkanSurface_0p _lb_r7 = ({ lb_iface _lb_a8 = lb_memory_heap; lb_o_u8_0s _lb_ao8 = lb_alloc_call(_lb_a8, sizeof(lb_gpu_VulkanSurface), _Alignof(lb_gpu_VulkanSurface)); lb_r_gpu_VulkanSurface_0p _lb_r8; if (!_lb_ao8.present) { _lb_r8 = ((lb_r_gpu_VulkanSurface_0p){ .error = { .code = 208273409, .message = (lb_str){"memory.exhausted", 16} }, .failed = true }); } else { lb_gpu_VulkanSurface* _lb_p8 = (lb_gpu_VulkanSurface*)_lb_ao8.value.data; *_lb_p8 = ((lb_gpu_VulkanSurface){.dirty = true}); _lb_r8.value = _lb_p8; _lb_r8.failed = false; } _lb_r8; }); if (_lb_r7.failed) {
        return ((lb_r_gpu_VulkanSurface_0p){ .error = _lb_r7.error, .failed = true });
    } _lb_r7.value; }));
    lb_pos = "src/std/gpu/vulkan/surface.lucb:30:5";
    lb_pos = "src/std/gpu/vulkan/surface.lucb:31:5";
    (lb_state)->surface = (({ lb_r_u64 _lb_r9 = lb_gpu_27vulkan_presentation_surface((lb_device)->instance, lb_host); if (_lb_r9.failed) {
        (void)(lb_gpu_22vulkan_surface_destroy(lb_device, lb_state));
        return ((lb_r_gpu_VulkanSurface_0p){ .error = _lb_r9.error, .failed = true });
    } _lb_r9.value; }));
    lb_pos = "src/std/gpu/vulkan/surface.lucb:32:5";
    uint32_t lb_can_present __attribute__((unused)) = 0ULL;
    lb_pos = "src/std/gpu/vulkan/surface.lucb:33:5";
    (void)((({ lb_r_unit _lb_r10 = ({ int32_t _lb_sq11 __attribute__((unused)) = lb_x_gpu_vkGetPhysicalDeviceSurfaceSupportKHR((lb_device)->physical, (lb_device)->family, (lb_state)->surface, &(lb_can_present)); lb_str _lb_sq12 __attribute__((unused)) = ((lb_str){"Vulkan presentation support could not be checked", 48}); lb_gpu_12vulkan_check(_lb_sq11, _lb_sq12); }); if (_lb_r10.failed) {
        (void)(lb_gpu_22vulkan_surface_destroy(lb_device, lb_state));
        return ((lb_r_gpu_VulkanSurface_0p){ .error = _lb_r10.error, .failed = true });
    } (void)0; })));
    lb_pos = "src/std/gpu/vulkan/surface.lucb:34:5";
    if (!!((lb_can_present == 0ULL))) 
    {
        lb_pos = "src/std/gpu/vulkan/surface.lucb:35:9";
        lb_r_gpu_VulkanSurface_0p _lb_err13 = ((lb_r_gpu_VulkanSurface_0p){ .error = { .code = (int32_t)(lb_gpu_unavailable), .message = ((lb_str){"the Vulkan queue cannot present to this window", 46}) }, .failed = true });
        (void)(lb_gpu_22vulkan_surface_destroy(lb_device, lb_state));
        return _lb_err13;
    }
    lb_pos = "src/std/gpu/vulkan/surface.lucb:36:5";
    VkCommandPoolCreateInfo lb_pool_info __attribute__((unused)) = ((VkCommandPoolCreateInfo){.sType = lb_gpu_42VK_STRUCTURE_TYPE_COMMAND_POOL_CREATE_INFO, .queueFamilyIndex = (lb_device)->family});
    lb_pos = "src/std/gpu/vulkan/surface.lucb:37:5";
    (void)((({ lb_r_unit _lb_r14 = ({ int32_t _lb_sq15 __attribute__((unused)) = lb_x_gpu_vkCreateCommandPool((lb_device)->device, &(lb_pool_info), ((void*)0), &((lb_state)->pool)); lb_str _lb_sq16 __attribute__((unused)) = ((lb_str){"the Vulkan command pool could not be created", 44}); lb_gpu_12vulkan_check(_lb_sq15, _lb_sq16); }); if (_lb_r14.failed) {
        (void)(lb_gpu_22vulkan_surface_destroy(lb_device, lb_state));
        return ((lb_r_gpu_VulkanSurface_0p){ .error = _lb_r14.error, .failed = true });
    } (void)0; })));
    lb_pos = "src/std/gpu/vulkan/surface.lucb:38:5";
    VkCommandBufferAllocateInfo lb_command_info __attribute__((unused)) = ((VkCommandBufferAllocateInfo){.sType = lb_gpu_46VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO, .commandPool = (lb_state)->pool, .commandBufferCount = 1ULL});
    lb_pos = "src/std/gpu/vulkan/surface.lucb:39:5";
    (void)((({ lb_r_unit _lb_r17 = ({ int32_t _lb_sq18 __attribute__((unused)) = lb_x_gpu_vkAllocateCommandBuffers((lb_device)->device, &(lb_command_info), &((lb_state)->command)); lb_str _lb_sq19 __attribute__((unused)) = ((lb_str){"the Vulkan command buffer could not be allocated", 48}); lb_gpu_12vulkan_check(_lb_sq18, _lb_sq19); }); if (_lb_r17.failed) {
        (void)(lb_gpu_22vulkan_surface_destroy(lb_device, lb_state));
        return ((lb_r_gpu_VulkanSurface_0p){ .error = _lb_r17.error, .failed = true });
    } (void)0; })));
    lb_pos = "src/std/gpu/vulkan/surface.lucb:40:5";
    ...
    lb_pos = "src/std/gpu/vulkan/surface.lucb:41:5";
    (void)((({ lb_r_unit _lb_r20 = ({ int32_t _lb_sq21 __attribute__((unused)) = lb_x_gpu_vkCreateSemaphore((lb_device)->device, &(lb_semaphore_info), ((void*)0), &((lb_state)->acquired)); lb_str _lb_sq22 __attribute__((unused)) = ((lb_str){"the Vulkan acquisition semaphore could not be created", 53}); lb_gpu_12vulkan_check(_lb_sq21, _lb_sq22); }); if (_lb_r20.failed) {
        (void)(lb_gpu_22vulkan_surface_destroy(lb_device, lb_state));
        return ((lb_r_gpu_VulkanSurface_0p){ .error = _lb_r20.error, .failed = true });
    } (void)0; })));
    lb_pos = "src/std/gpu/vulkan/surface.lucb:42:5";
    struct lb_gpu_VulkanSurface* _lb_ret23 = lb_state;
    return ((lb_r_gpu_VulkanSurface_0p){ .value = _lb_ret23, .failed = false });
    lb_trap("unreachable");
}
lb_r_unit lb_gpu_16vulkan_swapchain(struct lb_gpu_VulkanDevice* lb_device, struct lb_gpu_VulkanSurface* lb_state, uint32_t lb_width, uint32_t lb_height) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/gpu/vulkan/surface.lucb:52:5";
    (void)((({ lb_r_unit _lb_r24 = ({ int32_t _lb_sq25 __attribute__((unused)) = lb_x_gpu_vkDeviceWaitIdle((lb_device)->device); lb_str _lb_sq26 __attribute__((unused)) = ((lb_str){"Vulkan could not finish before resizing", 39}); lb_gpu_12vulkan_check(_lb_sq25, _lb_sq26); }); if (_lb_r24.failed) {
    ...
    (void)((({ lb_r_unit _lb_r27 = ({ int32_t _lb_sq28 __attribute__((unused)) = lb_x_gpu_vkGetPhysicalDeviceSurfaceCapabilitiesKHR((lb_device)->physical, (lb_state)->surface, &(lb_capabilities)); lb_str _lb_sq29 __attribute__((unused)) = ((lb_str){"Vulkan surface capabilities are unavailable", 43}); lb_gpu_12vulkan_check(_lb_sq28, _lb_sq29); }); if (_lb_r27.failed) {
        (void)(lb_gpu_24vulkan_swapchain_destroy(lb_device, lb_state));
    ...
    if (!!((lb_extent.width == 4294967295ULL))) 
    {
        ...
        lb_extent.width = ((uint32_t)lb_conv_u((uint64_t)(({ size_t _lb_sq30 __attribute__((unused)) = ((size_t)lb_conv_u((uint64_t)(lb_capabilities.minImageExtent.width), 32, 0, 64, 0, 1)); size_t _lb_sq31 __attribute__((unused)) = lb_gpu_10canvas_min(((size_t)lb_conv_u((uint64_t)(lb_width), 32, 0, 64, 0, 1)), ((size_t)lb_conv_u((uint64_t)(lb_capabilities.maxImageExtent.width), 32, 0, 64, 0, 1))); lb_gpu_10canvas_max(_lb_sq30, _lb_sq31); })), 64, 0, 32, 0, 1));
        lb_pos = "src/std/gpu/vulkan/surface.lucb:60:9";
        lb_extent.height = ((uint32_t)lb_conv_u((uint64_t)(({ size_t _lb_sq32 __attribute__((unused)) = ((size_t)lb_conv_u((uint64_t)(lb_capabilities.minImageExtent.height), 32, 0, 64, 0, 1)); size_t _lb_sq33 __attribute__((unused)) = lb_gpu_10canvas_min(((size_t)lb_conv_u((uint64_t)(lb_height), 32, 0, 64, 0, 1)), ((size_t)lb_conv_u((uint64_t)(lb_capabilities.maxImageExtent.height), 32, 0, 64, 0, 1))); lb_gpu_10canvas_max(_lb_sq32, _lb_sq33); })), 64, 0, 32, 0, 1));
    }
    ...
    if (!!(((((uint32_t)(lb_extent.width)) > ((uint32_t)(16384ULL))) || (((uint32_t)(lb_extent.height)) > ((uint32_t)(16384ULL)))))) 
    {
        ...
        lb_r_unit _lb_err34 = ((lb_r_unit){ .error = { .code = (int32_t)(lb_gpu_17surface_too_large), .message = ((lb_str){"Vulkan presentation supports at most 16384 pixels per dimension", 63}) }, .failed = true });
        (void)(lb_gpu_24vulkan_swapchain_destroy(lb_device, lb_state));
        return _lb_err34;
    }
    ...
    if (!!((((((uint32_t)(lb_capabilities.supportedUsageFlags & lb_gpu_35VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT))) == 0ULL) || ((((uint32_t)(lb_capabilities.supportedCompositeAlpha & lb_gpu_33VK_COMPOSITE_ALPHA_OPAQUE_BIT_KHR))) == 0ULL)))) 
    {
        ...
        lb_r_unit _lb_err35 = ((lb_r_unit){ .error = { .code = (int32_t)(lb_gpu_unavailable), .message = ((lb_str){"the Vulkan surface cannot provide opaque color attachments", 58}) }, .failed = true });
        (void)(lb_gpu_24vulkan_swapchain_destroy(lb_device, lb_state));
        return _lb_err35;
    }
    ...
    (void)((({ lb_r_unit _lb_r36 = ({ int32_t _lb_sq37 __attribute__((unused)) = lb_x_gpu_vkGetPhysicalDeviceSurfaceFormatsKHR((lb_device)->physical, (lb_state)->surface, &(lb_count), ((void*)0)); lb_str _lb_sq38 __attribute__((unused)) = ((lb_str){"Vulkan surface formats are unavailable", 38}); lb_gpu_12vulkan_check(_lb_sq37, _lb_sq38); }); if (_lb_r36.failed) {
        (void)(lb_gpu_24vulkan_swapchain_destroy(lb_device, lb_state));
        return ((lb_r_unit){ .error = _lb_r36.error, .failed = true });
    } (void)0; })));
    lb_pos = "src/std/gpu/vulkan/surface.lucb:69:5";
    lb_span lb_formats __attribute__((unused)) = (({ lb_r_gpu_VkSurfaceFormatKHR_0s _lb_r39 = ({ lb_iface _lb_a40 = lb_memory_allocator; size_t _lb_n40 = (size_t)(((size_t)lb_conv_u((uint64_t)(lb_count), 32, 0, 64, 0, 1))); lb_r_gpu_VkSurfaceFormatKHR_0s _lb_r40; if (_lb_n40 > UINT64_C(576460752303423488)) { _lb_r40 = ((lb_r_gpu_VkSurfaceFormatKHR_0s){ .error = { .code = 208273409, .message = (lb_str){"memory.exhausted", 16} }, .failed = true }); } else { size_t _lb_bytes40 = sizeof(VkSurfaceFormatKHR) * _lb_n40; lb_o_u8_0s _lb_ao40 = lb_alloc_call(_lb_a40, _lb_bytes40, _Alignof(VkSurfaceFormatKHR)); if (_lb_bytes40 != 0 && !_lb_ao40.present) { _lb_r40 = ((lb_r_gpu_VkSurfaceFormatKHR_0s){ .error = { .code = 208273409, .message = (lb_str){"memory.exhausted", 16} }, .failed = true }); } else { _lb_r40.value.data = _lb_ao40.value.data; _lb_r40.value.length = _lb_n40; _lb_r40.failed = false; } } _lb_r40; }); if (_lb_r39.failed) {
        (void)(lb_gpu_24vulkan_swapchain_destroy(lb_device, lb_state));
    ...
    (void)((({ lb_r_unit _lb_r41 = ({ int32_t _lb_sq42 __attribute__((unused)) = lb_x_gpu_vkGetPhysicalDeviceSurfaceFormatsKHR((lb_device)->physical, (lb_state)->surface, &(lb_count), ((struct VkSurfaceFormatKHR*)(lb_formats.data))); lb_str _lb_sq43 __attribute__((unused)) = ((lb_str){"Vulkan surface formats changed", 30}); lb_gpu_12vulkan_check(_lb_sq42, _lb_sq43); }); if (_lb_r41.failed) {
        { lb_span _lb_s44 = lb_formats; lb_release_call(lb_memory_allocator, (lb_span){ (void*)(_lb_s44.data), lb_mul_u(_lb_s44.length, sizeof(VkSurfaceFormatKHR), 64) }); }
        (void)(lb_gpu_24vulkan_swapchain_destroy(lb_device, lb_state));
    ...
    for (size_t lb_index __attribute__((unused)) = (size_t)(0ULL); lb_index < (size_t)(((size_t)lb_conv_u((uint64_t)(lb_count), 32, 0, 64, 0, 1))); lb_index++) {
        {
            ...
            if (!!(((*({ lb_span _lb_ix46 = lb_formats; &((VkSurfaceFormatKHR*)_lb_ix46.data)[lb_at((uint64_t)(lb_index), _lb_ix46.length)]; })).colorSpace == lb_gpu_33VK_COLOR_SPACE_SRGB_NONLINEAR_KHR))) 
            {
                lb_pos = "src/std/gpu/vulkan/surface.lucb:75:13";
                if (!!((((*({ lb_span _lb_ix47 = lb_formats; &((VkSurfaceFormatKHR*)_lb_ix47.data)[lb_at((uint64_t)(lb_index), _lb_ix47.length)]; })).format == lb_gpu_23VK_FORMAT_B8G8R8A8_SRGB) || ((*({ lb_span _lb_ix48 = lb_formats; &((VkSurfaceFormatKHR*)_lb_ix48.data)[lb_at((uint64_t)(lb_index), _lb_ix48.length)]; })).format == lb_gpu_23VK_FORMAT_R8G8B8A8_SRGB)))) 
                {
                    lb_pos = "src/std/gpu/vulkan/surface.lucb:76:17";
                    lb_format = (*({ lb_span _lb_ix49 = lb_formats; &((VkSurfaceFormatKHR*)_lb_ix49.data)[lb_at((uint64_t)(lb_index), _lb_ix49.length)]; })).format;
                    lb_pos = "src/std/gpu/vulkan/surface.lucb:77:17";
                    break;
                }
                lb_pos = "src/std/gpu/vulkan/surface.lucb:78:13";
                if (!!(((*({ lb_span _lb_ix50 = lb_formats; &((VkSurfaceFormatKHR*)_lb_ix50.data)[lb_at((uint64_t)(lb_index), _lb_ix50.length)]; })).format == lb_gpu_19VK_FORMAT_UNDEFINED))) 
                {
    ...
    if (!!((lb_format == 0ULL))) 
    {
        ...
        lb_r_unit _lb_err51 = ((lb_r_unit){ .error = { .code = (int32_t)(lb_gpu_unavailable), .message = ((lb_str){"the Vulkan surface has no sRGB render target", 44}) }, .failed = true });
        { lb_span _lb_s52 = lb_formats; lb_release_call(lb_memory_allocator, (lb_span){ (void*)(_lb_s52.data), lb_mul_u(_lb_s52.length, sizeof(VkSurfaceFormatKHR), 64) }); }
        (void)(lb_gpu_24vulkan_swapchain_destroy(lb_device, lb_state));
        return _lb_err51;
    }
    ...
    (void)((({ lb_r_unit _lb_r53 = ({ int32_t _lb_sq54 __attribute__((unused)) = lb_x_gpu_vkCreateSwapchainKHR((lb_device)->device, &(lb_info), ((void*)0), &((lb_state)->swapchain)); lb_str _lb_sq55 __attribute__((unused)) = ((lb_str){"the Vulkan swapchain could not be created", 41}); lb_gpu_12vulkan_check(_lb_sq54, _lb_sq55); }); if (_lb_r53.failed) {
        { lb_span _lb_s56 = lb_formats; lb_release_call(lb_memory_allocator, (lb_span){ (void*)(_lb_s56.data), lb_mul_u(_lb_s56.length, sizeof(VkSurfaceFormatKHR), 64) }); }
        (void)(lb_gpu_24vulkan_swapchain_destroy(lb_device, lb_state));
        return ((lb_r_unit){ .error = _lb_r53.error, .failed = true });
    } (void)0; })));
    ...
    (void)((({ lb_r_unit _lb_r57 = lb_gpu_12vulkan_depth(lb_device, lb_state); if (_lb_r57.failed) {
        { lb_span _lb_s58 = lb_formats; lb_release_call(lb_memory_allocator, (lb_span){ (void*)(_lb_s58.data), lb_mul_u(_lb_s58.length, sizeof(VkSurfaceFormatKHR), 64) }); }
        (void)(lb_gpu_24vulkan_swapchain_destroy(lb_device, lb_state));
        return ((lb_r_unit){ .error = _lb_r57.error, .failed = true });
    } (void)0; })));
    lb_pos = "src/std/gpu/vulkan/surface.lucb:94:5";
    (void)((({ lb_r_unit _lb_r59 = lb_gpu_15vulkan_pipeline(lb_device, lb_state); if (_lb_r59.failed) {
        { lb_span _lb_s60 = lb_formats; lb_release_call(lb_memory_allocator, (lb_span){ (void*)(_lb_s60.data), lb_mul_u(_lb_s60.length, sizeof(VkSurfaceFormatKHR), 64) }); }
        (void)(lb_gpu_24vulkan_swapchain_destroy(lb_device, lb_state));
    ...
    (void)((({ lb_r_unit _lb_r61 = ({ int32_t _lb_sq62 __attribute__((unused)) = lb_x_gpu_vkGetSwapchainImagesKHR((lb_device)->device, (lb_state)->swapchain, &(lb_count), ((void*)0)); lb_str _lb_sq63 __attribute__((unused)) = ((lb_str){"Vulkan swapchain images are unavailable", 39}); lb_gpu_12vulkan_check(_lb_sq62, _lb_sq63); }); if (_lb_r61.failed) {
        { lb_span _lb_s64 = lb_formats; lb_release_call(lb_memory_allocator, (lb_span){ (void*)(_lb_s64.data), lb_mul_u(_lb_s64.length, sizeof(VkSurfaceFormatKHR), 64) }); }
        (void)(lb_gpu_24vulkan_swapchain_destroy(lb_device, lb_state));
        return ((lb_r_unit){ .error = _lb_r61.error, .failed = true });
    } (void)0; })));
    lb_pos = "src/std/gpu/vulkan/surface.lucb:97:5";
    lb_span lb_images __attribute__((unused)) = (({ lb_r_u64_0s _lb_r65 = ({ lb_iface _lb_a66 = lb_memory_allocator; size_t _lb_n66 = (size_t)(((size_t)lb_conv_u((uint64_t)(lb_count), 32, 0, 64, 0, 1))); lb_r_u64_0s _lb_r66; if (_lb_n66 > UINT64_C(576460752303423488)) { _lb_r66 = ((lb_r_u64_0s){ .error = { .code = 208273409, .message = (lb_str){"memory.exhausted", 16} }, .failed = true }); } else { size_t _lb_bytes66 = sizeof(uint64_t) * _lb_n66; lb_o_u8_0s _lb_ao66 = lb_alloc_call(_lb_a66, _lb_bytes66, _Alignof(uint64_t)); if (_lb_bytes66 != 0 && !_lb_ao66.present) { _lb_r66 = ((lb_r_u64_0s){ .error = { .code = 208273409, .message = (lb_str){"memory.exhausted", 16} }, .failed = true }); } else { _lb_r66.value.data = _lb_ao66.value.data; _lb_r66.value.length = _lb_n66; _lb_r66.failed = false; } } _lb_r66; }); if (_lb_r65.failed) {
    ...
    (void)((({ lb_r_unit _lb_r68 = ({ int32_t _lb_sq69 __attribute__((unused)) = lb_x_gpu_vkGetSwapchainImagesKHR((lb_device)->device, (lb_state)->swapchain, &(lb_count), ((uint64_t*)(lb_images.data))); lb_str _lb_sq70 __attribute__((unused)) = ((lb_str){"Vulkan swapchain images changed", 31}); lb_gpu_12vulkan_check(_lb_sq69, _lb_sq70); }); if (_lb_r68.failed) {
        { lb_span _lb_s71 = lb_images; lb_release_call(lb_memory_allocator, (lb_span){ (void*)(_lb_s71.data), lb_mul_u(_lb_s71.length, sizeof(uint64_t), 64) }); }
        { lb_span _lb_s72 = lb_formats; lb_release_call(lb_memory_allocator, (lb_span){ (void*)(_lb_s72.data), lb_mul_u(_lb_s72.length, sizeof(VkSurfaceFormatKHR), 64) }); }
        (void)(lb_gpu_24vulkan_swapchain_destroy(lb_device, lb_state));
        return ((lb_r_unit){ .error = _lb_r68.error, .failed = true });
    } (void)0; })));
    lb_pos = "src/std/gpu/vulkan/surface.lucb:100:5";
    (lb_state)->images = (({ lb_r_gpu_VulkanImage_0s _lb_r73 = ({ lb_iface _lb_a74 = lb_memory_heap; size_t _lb_n74 = (size_t)(((size_t)lb_conv_u((uint64_t)(lb_count), 32, 0, 64, 0, 1))); lb_r_gpu_VulkanImage_0s _lb_r74; if (_lb_n74 > UINT64_C(144115188075855872)) { _lb_r74 = ((lb_r_gpu_VulkanImage_0s){ .error = { .code = 208273409, .message = (lb_str){"memory.exhausted", 16} }, .failed = true }); } else { size_t _lb_bytes74 = sizeof(lb_gpu_VulkanImage) * _lb_n74; lb_o_u8_0s _lb_ao74 = lb_alloc_call(_lb_a74, _lb_bytes74, _Alignof(lb_gpu_VulkanImage)); if (_lb_bytes74 != 0 && !_lb_ao74.present) { _lb_r74 = ((lb_r_gpu_VulkanImage_0s){ .error = { .code = 208273409, .message = (lb_str){"memory.exhausted", 16} }, .failed = true }); } else { _lb_r74.value.data = _lb_ao74.value.data; _lb_r74.value.length = _lb_n74; _lb_r74.failed = false; } } _lb_r74; }); if (_lb_r73.failed) {
        { lb_span _lb_s75 = lb_images; lb_release_call(lb_memory_allocator, (lb_span){ (void*)(_lb_s75.data), lb_mul_u(_lb_s75.length, sizeof(uint64_t), 64) }); }
        { lb_span _lb_s76 = lb_formats; lb_release_call(lb_memory_allocator, (lb_span){ (void*)(_lb_s76.data), lb_mul_u(_lb_s76.length, sizeof(VkSurfaceFormatKHR), 64) }); }
        (void)(lb_gpu_24vulkan_swapchain_destroy(lb_device, lb_state));
    ...
    for (size_t lb_index __attribute__((unused)) = (size_t)(0ULL); lb_index < (size_t)(((size_t)lb_conv_u((uint64_t)(lb_count), 32, 0, 64, 0, 1))); lb_index++) {
        {
            ...
            (*({ lb_span _lb_ix78 = (lb_state)->images; &((lb_gpu_VulkanImage*)_lb_ix78.data)[lb_at((uint64_t)(lb_index), _lb_ix78.length)]; })).image = (*({ lb_span _lb_ix79 = lb_images; &((uint64_t*)_lb_ix79.data)[lb_at((uint64_t)(lb_index), _lb_ix79.length)]; }));
            lb_pos = "src/std/gpu/vulkan/surface.lucb:103:9";
            (*({ lb_span _lb_ix80 = (lb_state)->images; &((lb_gpu_VulkanImage*)_lb_ix80.data)[lb_at((uint64_t)(lb_index), _lb_ix80.length)]; })).view = (({ lb_r_u64 _lb_r81 = lb_gpu_17vulkan_image_view(lb_device, (*({ lb_span _lb_ix82 = lb_images; &((uint64_t*)_lb_ix82.data)[lb_at((uint64_t)(lb_index), _lb_ix82.length)]; })), lb_format, lb_gpu_25VK_IMAGE_ASPECT_COLOR_BIT); if (_lb_r81.failed) {
                { lb_span _lb_s83 = lb_images; lb_release_call(lb_memory_allocator, (lb_span){ (void*)(_lb_s83.data), lb_mul_u(_lb_s83.length, sizeof(uint64_t), 64) }); }
                { lb_span _lb_s84 = lb_formats; lb_release_call(lb_memory_allocator, (lb_span){ (void*)(_lb_s84.data), lb_mul_u(_lb_s84.length, sizeof(VkSurfaceFormatKHR), 64) }); }
                (void)(lb_gpu_24vulkan_swapchain_destroy(lb_device, lb_state));
                return ((lb_r_unit){ .error = _lb_r81.error, .failed = true });
            } _lb_r81.value; }));
            lb_pos = "src/std/gpu/vulkan/surface.lucb:104:9";
            lb_a_u64_0a2 lb_attachments __attribute__((unused)) = ((lb_a_u64_0a2){{(*({ lb_span _lb_ix85 = (lb_state)->images; &((lb_gpu_VulkanImage*)_lb_ix85.data)[lb_at((uint64_t)(lb_index), _lb_ix85.length)]; })).view, (lb_state)->depth_view}});
            ...
            (void)((({ lb_r_unit _lb_r86 = ({ int32_t _lb_sq87 __attribute__((unused)) = lb_x_gpu_vkCreateFramebuffer((lb_device)->device, &(lb_framebuffer_info), ((void*)0), &((*({ lb_span _lb_ix88 = (lb_state)->images; &((lb_gpu_VulkanImage*)_lb_ix88.data)[lb_at((uint64_t)(lb_index), _lb_ix88.length)]; })).framebuffer)); lb_str _lb_sq89 __attribute__((unused)) = ((lb_str){"a Vulkan framebuffer could not be created", 41}); lb_gpu_12vulkan_check(_lb_sq87, _lb_sq89); }); if (_lb_r86.failed) {
                { lb_span _lb_s90 = lb_images; lb_release_call(lb_memory_allocator, (lb_span){ (void*)(_lb_s90.data), lb_mul_u(_lb_s90.length, sizeof(uint64_t), 64) }); }
                { lb_span _lb_s91 = lb_formats; lb_release_call(lb_memory_allocator, (lb_span){ (void*)(_lb_s91.data), lb_mul_u(_lb_s91.length, sizeof(VkSurfaceFormatKHR), 64) }); }
                (void)(lb_gpu_24vulkan_swapchain_destroy(lb_device, lb_state));
            ...
            (void)((({ lb_r_unit _lb_r92 = ({ int32_t _lb_sq93 __attribute__((unused)) = lb_x_gpu_vkCreateSemaphore((lb_device)->device, &(lb_semaphore_info), ((void*)0), &((*({ lb_span _lb_ix94 = (lb_state)->images; &((lb_gpu_VulkanImage*)_lb_ix94.data)[lb_at((uint64_t)(lb_index), _lb_ix94.length)]; })).presented)); lb_str _lb_sq95 __attribute__((unused)) = ((lb_str){"a Vulkan presentation semaphore could not be created", 52}); lb_gpu_12vulkan_check(_lb_sq93, _lb_sq95); }); if (_lb_r92.failed) {
                { lb_span _lb_s96 = lb_images; lb_release_call(lb_memory_allocator, (lb_span){ (void*)(_lb_s96.data), lb_mul_u(_lb_s96.length, sizeof(uint64_t), 64) }); }
                { lb_span _lb_s97 = lb_formats; lb_release_call(lb_memory_allocator, (lb_span){ (void*)(_lb_s97.data), lb_mul_u(_lb_s97.length, sizeof(VkSurfaceFormatKHR), 64) }); }
                (void)(lb_gpu_24vulkan_swapchain_destroy(lb_device, lb_state));
    ...
    { lb_span _lb_s98 = lb_images; lb_release_call(lb_memory_allocator, (lb_span){ (void*)(_lb_s98.data), lb_mul_u(_lb_s98.length, sizeof(uint64_t), 64) }); }
    { lb_span _lb_s99 = lb_formats; lb_release_call(lb_memory_allocator, (lb_span){ (void*)(_lb_s99.data), lb_mul_u(_lb_s99.length, sizeof(VkSurfaceFormatKHR), 64) }); }
    return ((lb_r_unit){ .failed = false });
}
void lb_gpu_22vulkan_surface_destroy(struct lb_gpu_VulkanDevice* lb_device, struct lb_gpu_VulkanSurface* lb_state) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/gpu/vulkan/surface.lucb:158:5";
    (void)(((void)(lb_x_gpu_vkDeviceWaitIdle((lb_device)->device))));
    lb_pos = "src/std/gpu/vulkan/surface.lucb:159:5";
    (void)(lb_gpu_24vulkan_swapchain_destroy(lb_device, lb_state));
    lb_pos = "src/std/gpu/vulkan/surface.lucb:160:5";
    if (!!((!((lb_state)->acquired == 0ULL)))) 
    {
        lb_pos = "src/std/gpu/vulkan/surface.lucb:160:5";
        (void)(lb_x_gpu_vkDestroySemaphore((lb_device)->device, (lb_state)->acquired, ((void*)0)));
    }
    lb_pos = "src/std/gpu/vulkan/surface.lucb:161:5";
    if (!!((!((lb_state)->pool == 0ULL)))) 
    {
        lb_pos = "src/std/gpu/vulkan/surface.lucb:161:5";
        (void)(lb_x_gpu_vkDestroyCommandPool((lb_device)->device, (lb_state)->pool, ((void*)0)));
    }
    lb_pos = "src/std/gpu/vulkan/surface.lucb:162:5";
    if (!!((!((lb_state)->surface == 0ULL)))) 
    {
        lb_pos = "src/std/gpu/vulkan/surface.lucb:162:5";
        (void)(lb_x_gpu_vkDestroySurfaceKHR((lb_device)->instance, (lb_state)->surface, ((void*)0)));
    }
    lb_pos = "src/std/gpu/vulkan/surface.lucb:163:5";
    lb_release_call(lb_memory_heap, (lb_span){ (void*)(lb_state), sizeof(lb_gpu_VulkanSurface) });
}
__attribute__((weak)) void lb_interop_Packet_0g1_str_init(lb_interop_Packet_0g1_str* self, lb_str lb_value, void* lb_storage, lb_fn_0F1_void_0p_unit lb_dispose) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
...
__attribute__((weak)) void lb_interop_Packet_0g1_str_release(const lb_interop_Packet_0g1_str* self) {
    ...
    void* _lb_o100 = self->storage;
    if (_lb_o100 != ((void*)0)) {
        void* lb_storage __attribute__((unused)) = _lb_o100;
        {
            lb_pos = "src/std/gpu/metal/drawing.lucb:53:5";
            (void)(((({ lb_fn_0F1_void_0p_unit _lb_o101 = self->dispose; if (_lb_o101 == ((void*)0)) {
...
__attribute__((weak)) void lb_interop_Packet_0g1_u8_0c_release(const lb_interop_Packet_0g1_u8_0c* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/gpu/metal/drawing.lucb:52:1";
    void* _lb_o102 = self->storage;
    if (_lb_o102 != ((void*)0)) {
        void* lb_storage __attribute__((unused)) = _lb_o102;
        {
            lb_pos = "src/std/gpu/metal/drawing.lucb:53:5";
            (void)(((({ lb_fn_0F1_void_0p_unit _lb_o103 = self->dispose; if (_lb_o103 == ((void*)0)) {
                (void)(lb_trap_text(((lb_str){"a packet has storage without a disposer", 39})));
            } _lb_o103; })))(lb_storage));
        }
    }
...
void lb_gpu_24vulkan_swapchain_destroy(struct lb_gpu_VulkanDevice* lb_device, struct lb_gpu_VulkanSurface* lb_state) {
    ...
    lb_span _lb_seq104 = (lb_state)->images;
    for (size_t _lb_i104 = 0; _lb_i104 < _lb_seq104.length; _lb_i104++) {
        lb_gpu_VulkanImage lb_image __attribute__((unused)) = ((lb_gpu_VulkanImage*)_lb_seq104.data)[_lb_i104];
        {
    ...
    if (!!((((size_t)(((lb_state)->images.length))) > ((size_t)(0ULL))))) 
    {
        ...
        { lb_span _lb_s105 = (lb_state)->images; lb_release_call(lb_memory_heap, (lb_span){ (void*)(_lb_s105.data), lb_mul_u(_lb_s105.length, sizeof(lb_gpu_VulkanImage), 64) }); }
    }
...
lb_r_unit lb_gpu_12vulkan_depth(struct lb_gpu_VulkanDevice* lb_device, struct lb_gpu_VulkanSurface* lb_state) {
    ...
    if (!!(((((uint32_t)(lb_properties.optimalTilingFeatures & lb_gpu_46VK_FORMAT_FEATURE_DEPTH_STENCIL_ATTACHMENT_BIT))) == 0ULL))) 
    {
        ...
        lb_r_unit _lb_err106 = ((lb_r_unit){ .error = { .code = (int32_t)(lb_gpu_unavailable), .message = ((lb_str){"the Vulkan device has no 32-bit depth attachment support", 56}) }, .failed = true });
        return _lb_err106;
    }
    lb_pos = "src/std/gpu/vulkan/surface.lucb:117:5";
    VkImageCreateInfo lb_info __attribute__((unused)) = ({ uint32_t _lb_sq107 __attribute__((unused)) = lb_gpu_35VK_STRUCTURE_TYPE_IMAGE_CREATE_INFO; uint32_t _lb_sq108 __attribute__((unused)) = lb_gpu_16VK_IMAGE_TYPE_2D; uint32_t _lb_sq109 __attribute__((unused)) = lb_gpu_20VK_FORMAT_D32_SFLOAT; VkExtent3D _lb_sq110 __attribute__((unused)) = ((VkExtent3D){.width = (lb_state)->width, .height = (lb_state)->height, .depth = 1ULL}); uint32_t _lb_sq111 __attribute__((unused)) = 1ULL; uint32_t _lb_sq112 __attribute__((unused)) = 1ULL; uint32_t _lb_sq113 __attribute__((unused)) = lb_gpu_21VK_SAMPLE_COUNT_1_BIT; uint32_t _lb_sq114 __attribute__((unused)) = lb_gpu_43VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT; ((VkImageCreateInfo){.sType = _lb_sq107, .imageType = _lb_sq108, .format = _lb_sq109, .extent = _lb_sq110, .mipLevels = _lb_sq111, .arrayLayers = _lb_sq112, .samples = _lb_sq113, .usage = _lb_sq114}); });
    lb_pos = "src/std/gpu/vulkan/surface.lucb:119:5";
    (void)((({ lb_r_unit _lb_r115 = ({ int32_t _lb_sq116 __attribute__((unused)) = lb_x_gpu_vkCreateImage((lb_device)->device, &(lb_info), ((void*)0), &((lb_state)->depth_image)); lb_str _lb_sq117 __attribute__((unused)) = ((lb_str){"the Vulkan depth image could not be created", 43}); lb_gpu_12vulkan_check(_lb_sq116, _lb_sq117); }); if (_lb_r115.failed) {
    ...
    (lb_state)->depth_memory = (({ lb_r_u64 _lb_r118 = lb_gpu_13vulkan_memory(lb_device, lb_requirements, lb_gpu_35VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT); if (_lb_r118.failed) {
        return ((lb_r_unit){ .error = _lb_r118.error, .failed = true });
    } _lb_r118.value; }));
    lb_pos = "src/std/gpu/vulkan/surface.lucb:123:5";
    (void)((({ lb_r_unit _lb_r119 = ({ int32_t _lb_sq120 __attribute__((unused)) = lb_x_gpu_vkBindImageMemory((lb_device)->device, (lb_state)->depth_image, (lb_state)->depth_memory, 0ULL); lb_str _lb_sq121 __attribute__((unused)) = ((lb_str){"Vulkan depth memory could not be bound", 38}); lb_gpu_12vulkan_check(_lb_sq120, _lb_sq121); }); if (_lb_r119.failed) {
        return ((lb_r_unit){ .error = _lb_r119.error, .failed = true });
    } (void)0; })));
    lb_pos = "src/std/gpu/vulkan/surface.lucb:124:5";
    (lb_state)->depth_view = (({ lb_r_u64 _lb_r122 = lb_gpu_17vulkan_image_view(lb_device, (lb_state)->depth_image, lb_gpu_20VK_FORMAT_D32_SFLOAT, lb_gpu_25VK_IMAGE_ASPECT_DEPTH_BIT); if (_lb_r122.failed) {
...
lb_r_u64 lb_gpu_17vulkan_image_view(struct lb_gpu_VulkanDevice* lb_device, uint64_t lb_image, uint32_t lb_format, uint32_t lb_aspect) {
    ...
    VkImageViewCreateInfo lb_info __attribute__((unused)) = ({ uint32_t _lb_sq123 __attribute__((unused)) = lb_gpu_40VK_STRUCTURE_TYPE_IMAGE_VIEW_CREATE_INFO; uint64_t _lb_sq124 __attribute__((unused)) = lb_image; uint32_t _lb_sq125 __attribute__((unused)) = lb_gpu_21VK_IMAGE_VIEW_TYPE_2D; uint32_t _lb_sq126 __attribute__((unused)) = lb_format; VkImageSubresourceRange _lb_sq127 __attribute__((unused)) = ((VkImageSubresourceRange){.aspectMask = lb_aspect, .levelCount = 1ULL, .layerCount = 1ULL}); ((VkImageViewCreateInfo){.sType = _lb_sq123, .image = _lb_sq124, .viewType = _lb_sq125, .format = _lb_sq126, .subresourceRange = _lb_sq127}); });
    ...
    (void)((({ lb_r_unit _lb_r128 = ({ int32_t _lb_sq129 __attribute__((unused)) = lb_x_gpu_vkCreateImageView((lb_device)->device, &(lb_info), ((void*)0), &(lb_view)); lb_str _lb_sq130 __attribute__((unused)) = ((lb_str){"a Vulkan image view could not be created", 40}); lb_gpu_12vulkan_check(_lb_sq129, _lb_sq130); }); if (_lb_r128.failed) {
        return ((lb_r_u64){ .error = _lb_r128.error, .failed = true });
    } (void)0; })));
    lb_pos = "src/std/gpu/vulkan/surface.lucb:49:5";
    uint64_t _lb_ret131 = lb_view;
    return ((lb_r_u64){ .value = _lb_ret131, .failed = false });
    lb_trap("unreachable");
}
