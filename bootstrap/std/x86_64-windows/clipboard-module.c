...
lb_r_interop_Owned_0g1_str lb_clipboard_9read_text(void) {
    ...
    {
        lb_pos = "src/std/clipboard/module.lucb:20:9";
        lb_interop_Owned_0g1_str _lb_ret8 = (({ lb_r_interop_Owned_0g1_str _lb_r9 = lb_clipboard_8win_read(); if (_lb_r9.failed) {
...
lb_r_unit lb_clipboard_10write_text(lb_str lb_text) {
    ...
    {
        lb_pos = "src/std/clipboard/module.lucb:34:9";
        (void)((({ lb_r_unit _lb_r14 = lb_clipboard_9win_write(lb_text); if (_lb_r14.failed) {
            return ((lb_r_unit){ .error = _lb_r14.error, .failed = true });
        } (void)0; })));
        lb_pos = "src/std/clipboard/module.lucb:35:9";
