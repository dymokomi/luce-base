...
lb_gpu_27vulkan_presentation_windows_0init:
    .seh_proc lb_gpu_27vulkan_presentation_windows_0init
    pushq %rbp
    .seh_pushreg %rbp
    subq $224, %rsp
    .seh_stackalloc 224
    ...
    .p2align 4
    .globl lb_gpu_22vulkan_windows_support
lb_gpu_22vulkan_windows_support:
    .seh_proc lb_gpu_22vulkan_windows_support
    pushq %rbp
    .seh_pushreg %rbp
    subq $224, %rsp
    .seh_stackalloc 224
...
.L1_1:
    ...
    .p2align 4
    .globl lb_gpu_22vulkan_windows_surface
lb_gpu_22vulkan_windows_surface:
    .seh_proc lb_gpu_22vulkan_windows_surface
    pushq %rbp
    .seh_pushreg %rbp
    subq $528, %rsp
    .seh_stackalloc 528
...
.L2_1:
    ...
    movq 0(%rsp), %rcx
    movq 8(%rsp), %rdx
    call lb_window_Presentation_14windows_handle
    addq $32, %rsp
    leaq 112(%rbp), %r15
    movq $32, %rcx
    movq %r15, %r14
...
.Ltext_5:
    ...
    .section .data$lb_gpu_25vulkan_windows_extensions,"dw"
