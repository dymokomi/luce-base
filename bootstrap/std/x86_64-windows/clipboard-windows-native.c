...
lb_r_interop_Owned_0g1_str lb_clipboard_8win_read(void);
lb_r_unit lb_clipboard_9win_write(lb_str lb_text);
...
void lb_clipboard_16free_unpublished(void* lb_storage, bool* lb_published);
...
uint32_t lb_clipboard_12unicode_text = 13ULL;
...
lb_r_interop_Owned_0g1_str lb_clipboard_8win_read(void) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/clipboard/windows/native.lucb:18:5";
    if (!!(({ int32_t _lb_sq7 __attribute__((unused)) = lb_x_clipboard_OpenClipboard(lb_x_clipboard_GetActiveWindow()); int32_t _lb_sq8 __attribute__((unused)) = 0LL; (_lb_sq7 == _lb_sq8); }))) 
    {
        lb_pos = "src/std/clipboard/windows/native.lucb:19:9";
        lb_r_interop_Owned_0g1_str _lb_err9 = ((lb_r_interop_Owned_0g1_str){ .error = { .code = (int32_t)(lb_clipboard_failed), .message = ((lb_str){"the clipboard is busy", 21}) }, .failed = true });
        return _lb_err9;
    }
    lb_pos = "src/std/clipboard/windows/native.lucb:20:5";
    lb_pos = "src/std/clipboard/windows/native.lucb:21:5";
    if (!!(({ int32_t _lb_sq10 __attribute__((unused)) = lb_x_clipboard_IsClipboardFormatAvailable(lb_clipboard_12unicode_text); int32_t _lb_sq11 __attribute__((unused)) = 0LL; (_lb_sq10 == _lb_sq11); }))) 
    {
        lb_pos = "src/std/clipboard/windows/native.lucb:22:9";
        lb_interop_Owned_0g1_str _lb_ret12 = (({ lb_r_interop_Owned_0g1_str _lb_r13 = lb_interop_9copy_text(((lb_str){"", 0})); if (_lb_r13.failed) {
            (void)(((void)(lb_x_clipboard_CloseClipboard())));
    ...
    lb_pos = "src/std/clipboard/windows/native.lucb:23:5";
    void* lb_storage __attribute__((unused)) = ({ void* _lb_o14 = lb_x_clipboard_GetClipboardData(lb_clipboard_12unicode_text); if (_lb_o14 == ((void*)0)) {
        lb_r_interop_Owned_0g1_str _lb_err15 = ((lb_r_interop_Owned_0g1_str){ .error = { .code = (int32_t)(lb_clipboard_failed), .message = ((lb_str){"clipboard text is unavailable", 29}) }, .failed = true });
        (void)(((void)(lb_x_clipboard_CloseClipboard())));
        return _lb_err15;
    } _lb_o14; });
    lb_pos = "src/std/clipboard/windows/native.lucb:24:5";
    size_t lb_capacity __attribute__((unused)) = ({ size_t _lb_sq16 __attribute__((unused)) = lb_x_clipboard_GlobalSize(lb_storage); size_t _lb_sq17 __attribute__((unused)) = 2ULL; (size_t)(lb_div_u((uint64_t)(_lb_sq16), (uint64_t)(_lb_sq17), 64)); });
    lb_pos = "src/std/clipboard/windows/native.lucb:25:5";
    void* lb_address __attribute__((unused)) = ({ void* _lb_o18 = lb_x_clipboard_GlobalLock(lb_storage); if (_lb_o18 == ((void*)0)) {
        lb_r_interop_Owned_0g1_str _lb_err19 = ((lb_r_interop_Owned_0g1_str){ .error = { .code = (int32_t)(lb_clipboard_failed), .message = ((lb_str){"clipboard text cannot be read", 29}) }, .failed = true });
        (void)(((void)(lb_x_clipboard_CloseClipboard())));
        return _lb_err19;
    } _lb_o18; });
    lb_pos = "src/std/clipboard/windows/native.lucb:26:5";
    lb_pos = "src/std/clipboard/windows/native.lucb:27:5";
    uint16_t* lb_wide __attribute__((unused)) = ((uint16_t*)(lb_address));
    lb_pos = "src/std/clipboard/windows/native.lucb:28:5";
    size_t lb_length __attribute__((unused)) = 0ULL;
    lb_pos = "src/std/clipboard/windows/native.lucb:29:5";
    for (;;) {
        lb_pos = "src/std/clipboard/windows/native.lucb:29:5";
        if (!((((((size_t)(lb_length)) < ((size_t)(lb_capacity))) && (((size_t)(lb_length)) <= ((size_t)(lb_clipboard_10text_limit)))) && (!(((lb_wide)[lb_length]) == 0ULL))))) break;
        {
            lb_pos = "src/std/clipboard/windows/native.lucb:30:9";
            { size_t* lb__cell20 = &(lb_length);
            (*(lb__cell20)) = (size_t)(lb_add_u((uint64_t)((*(lb__cell20))), (uint64_t)(1ULL), 64)); }
        }
    }
    lb_pos = "src/std/clipboard/windows/native.lucb:31:5";
    if (!!(((lb_length == lb_capacity) || (((size_t)(lb_length)) > ((size_t)(lb_clipboard_10text_limit)))))) 
    {
        lb_pos = "src/std/clipboard/windows/native.lucb:32:9";
        lb_r_interop_Owned_0g1_str _lb_err21 = ((lb_r_interop_Owned_0g1_str){ .error = { .code = (int32_t)(lb_clipboard_failed), .message = ((lb_str){"clipboard text is unterminated or exceeds the limit", 51}) }, .failed = true });
        (void)(((void)(lb_x_clipboard_GlobalUnlock(lb_storage))));
        (void)(((void)(lb_x_clipboard_CloseClipboard())));
        return _lb_err21;
    }
    lb_pos = "src/std/clipboard/windows/native.lucb:33:5";
    {
        lb_iface _lb_as22 = lb_memory_allocator;
        lb_memory_allocator = lb_memory_heap;
        {
            lb_pos = "src/std/clipboard/windows/native.lucb:34:9";
            lb_str lb_value __attribute__((unused)) = (({ lb_r_str _lb_r23 = lb_12windows_text_narrow(((lb_span){(void*)(lb_wide), (size_t)(lb_length)}), lb_clipboard_failed); if (_lb_r23.failed) {
                lb_memory_allocator = _lb_as22;
                (void)(((void)(lb_x_clipboard_GlobalUnlock(lb_storage))));
                (void)(((void)(lb_x_clipboard_CloseClipboard())));
                return ((lb_r_interop_Owned_0g1_str){ .error = _lb_r23.error, .failed = true });
            } _lb_r23.value; }));
            lb_pos = "src/std/clipboard/windows/native.lucb:35:9";
            lb_pos = "src/std/clipboard/windows/native.lucb:36:9";
            if (!!((((size_t)((lb_value.length))) > ((size_t)(lb_clipboard_10text_limit))))) 
            {
                lb_pos = "src/std/clipboard/windows/native.lucb:37:13";
                lb_r_interop_Owned_0g1_str _lb_err24 = ((lb_r_interop_Owned_0g1_str){ .error = { .code = (int32_t)(lb_clipboard_failed), .message = ((lb_str){"clipboard text exceeds 1 MiB", 28}) }, .failed = true });
                { lb_span _lb_s25 = ((lb_span){(void*)(((uint8_t*)(((const uint8_t*)(((lb_cspan){(void*)(lb_value.data), lb_value.length}).data))))), (size_t)((size_t)(lb_add_u((uint64_t)((lb_value.length)), (uint64_t)(1ULL), 64)))}); lb_release_call(lb_memory_allocator, (lb_span){ (void*)(_lb_s25.data), lb_mul_u(_lb_s25.length, sizeof(uint8_t), 64) }); }
                lb_memory_allocator = _lb_as22;
                (void)(((void)(lb_x_clipboard_GlobalUnlock(lb_storage))));
                (void)(((void)(lb_x_clipboard_CloseClipboard())));
                return _lb_err24;
            }
            lb_pos = "src/std/clipboard/windows/native.lucb:38:9";
            lb_interop_Owned_0g1_str _lb_ret26 = (({ lb_r_interop_Owned_0g1_str _lb_r27 = lb_interop_9copy_text(lb_value); if (_lb_r27.failed) {
                { lb_span _lb_s28 = ((lb_span){(void*)(((uint8_t*)(((const uint8_t*)(((lb_cspan){(void*)(lb_value.data), lb_value.length}).data))))), (size_t)((size_t)(lb_add_u((uint64_t)((lb_value.length)), (uint64_t)(1ULL), 64)))}); lb_release_call(lb_memory_allocator, (lb_span){ (void*)(_lb_s28.data), lb_mul_u(_lb_s28.length, sizeof(uint8_t), 64) }); }
                lb_memory_allocator = _lb_as22;
                (void)(((void)(lb_x_clipboard_GlobalUnlock(lb_storage))));
                (void)(((void)(lb_x_clipboard_CloseClipboard())));
                return ((lb_r_interop_Owned_0g1_str){ .error = _lb_r27.error, .failed = true });
            } _lb_r27.value; }));
            { lb_span _lb_s29 = ((lb_span){(void*)(((uint8_t*)(((const uint8_t*)(((lb_cspan){(void*)(lb_value.data), lb_value.length}).data))))), (size_t)((size_t)(lb_add_u((uint64_t)((lb_value.length)), (uint64_t)(1ULL), 64)))}); lb_release_call(lb_memory_allocator, (lb_span){ (void*)(_lb_s29.data), lb_mul_u(_lb_s29.length, sizeof(uint8_t), 64) }); }
            lb_memory_allocator = _lb_as22;
            (void)(((void)(lb_x_clipboard_GlobalUnlock(lb_storage))));
            (void)(((void)(lb_x_clipboard_CloseClipboard())));
            return ((lb_r_interop_Owned_0g1_str){ .value = _lb_ret26, .failed = false });
            { lb_span _lb_s30 = ((lb_span){(void*)(((uint8_t*)(((const uint8_t*)(((lb_cspan){(void*)(lb_value.data), lb_value.length}).data))))), (size_t)((size_t)(lb_add_u((uint64_t)((lb_value.length)), (uint64_t)(1ULL), 64)))}); lb_release_call(lb_memory_allocator, (lb_span){ (void*)(_lb_s30.data), lb_mul_u(_lb_s30.length, sizeof(uint8_t), 64) }); }
        }
        lb_memory_allocator = _lb_as22;
    }
    (void)(((void)(lb_x_clipboard_GlobalUnlock(lb_storage))));
...
lb_r_unit lb_clipboard_9win_write(lb_str lb_text) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/clipboard/windows/native.lucb:41:5";
    void* lb_owner __attribute__((unused)) = ({ void* _lb_o31 = lb_x_clipboard_GetActiveWindow(); if (_lb_o31 == ((void*)0)) {
        lb_r_unit _lb_err32 = ((lb_r_unit){ .error = { .code = (int32_t)(lb_clipboard_failed), .message = ((lb_str){"clipboard writing requires an active application window", 55}) }, .failed = true });
        return _lb_err32;
    } _lb_o31; });
    lb_pos = "src/std/clipboard/windows/native.lucb:42:5";
    {
        lb_iface _lb_as33 = lb_memory_allocator;
        lb_memory_allocator = lb_memory_heap;
        {
            lb_pos = "src/std/clipboard/windows/native.lucb:43:9";
            lb_strings_Builder lb_terminated __attribute__((unused)) = (({ lb_r_strings_Builder _lb_r34 = lb_strings_Builder_create((lb_text.length)); if (_lb_r34.failed) {
                lb_memory_allocator = _lb_as33;
                return ((lb_r_unit){ .error = _lb_r34.error, .failed = true });
            } _lb_r34.value; }));
            lb_pos = "src/std/clipboard/windows/native.lucb:44:9";
            lb_pos = "src/std/clipboard/windows/native.lucb:45:9";
            (void)((({ lb_r_unit _lb_r35 = lb_strings_Builder_put(&(lb_terminated), lb_text); if (_lb_r35.failed) {
                (void)(lb_strings_Builder_destroy(&(lb_terminated)));
                lb_memory_allocator = _lb_as33;
                return ((lb_r_unit){ .error = _lb_r35.error, .failed = true });
            } (void)0; })));
            lb_pos = "src/std/clipboard/windows/native.lucb:46:9";
            lb_span lb_wide __attribute__((unused)) = (({ lb_r_u16_0s _lb_r36 = ({ char* _lb_sq37 __attribute__((unused)) = lb_cstr_of(lb_strings_Builder_view(&(lb_terminated))); uint32_t _lb_sq38 __attribute__((unused)) = lb_clipboard_failed; lb_12windows_text_wide(_lb_sq37, _lb_sq38); }); if (_lb_r36.failed) {
                (void)(lb_strings_Builder_destroy(&(lb_terminated)));
                lb_memory_allocator = _lb_as33;
                return ((lb_r_unit){ .error = _lb_r36.error, .failed = true });
            } _lb_r36.value; }));
            lb_pos = "src/std/clipboard/windows/native.lucb:47:9";
            lb_pos = "src/std/clipboard/windows/native.lucb:48:9";
            void* lb_storage __attribute__((unused)) = ({ void* _lb_o39 = lb_x_clipboard_GlobalAlloc(2ULL, (size_t)(lb_mul_u((uint64_t)((lb_wide.length)), (uint64_t)(2ULL), 64))); if (_lb_o39 == ((void*)0)) {
                lb_r_unit _lb_err40 = ((lb_r_unit){ .error = { .code = (int32_t)(lb_clipboard_failed), .message = ((lb_str){"could not allocate clipboard storage", 36}) }, .failed = true });
            ...
            lb_pos = "src/std/clipboard/windows/native.lucb:49:9";
            bool lb_published __attribute__((unused)) = false;
            lb_pos = "src/std/clipboard/windows/native.lucb:50:9";
            lb_pos = "src/std/clipboard/windows/native.lucb:51:9";
            void* lb_address __attribute__((unused)) = ({ void* _lb_o42 = lb_x_clipboard_GlobalLock(lb_storage); if (_lb_o42 == ((void*)0)) {
                lb_r_unit _lb_err43 = ((lb_r_unit){ .error = { .code = (int32_t)(lb_clipboard_failed), .message = ((lb_str){"could not lock clipboard storage", 32}) }, .failed = true });
                (void)(lb_clipboard_16free_unpublished(lb_storage, &(lb_published)));
                { lb_span _lb_s44 = lb_wide; lb_release_call(lb_memory_allocator, (lb_span){ (void*)(_lb_s44.data), lb_mul_u(_lb_s44.length, sizeof(uint16_t), 64) }); }
                (void)(lb_strings_Builder_destroy(&(lb_terminated)));
                lb_memory_allocator = _lb_as33;
                return _lb_err43;
            } _lb_o42; });
            lb_pos = "src/std/clipboard/windows/native.lucb:52:9";
            (void)(lb_memory_copy_0g1_u8(((lb_span){(void*)(((uint8_t*)(lb_address))), (size_t)((size_t)(lb_mul_u((uint64_t)((lb_wide.length)), (uint64_t)(2ULL), 64)))}), ((lb_span){(void*)(((uint8_t*)(((uint16_t*)(lb_wide.data))))), (size_t)((size_t)(lb_mul_u((uint64_t)((lb_wide.length)), (uint64_t)(2ULL), 64)))}), (size_t)(lb_mul_u((uint64_t)((lb_wide.length)), (uint64_t)(2ULL), 64))));
            lb_pos = "src/std/clipboard/windows/native.lucb:53:9";
            (void)(((void)(lb_x_clipboard_GlobalUnlock(lb_storage))));
            lb_pos = "src/std/clipboard/windows/native.lucb:54:9";
            if (!!(({ int32_t _lb_sq45 __attribute__((unused)) = lb_x_clipboard_OpenClipboard(lb_owner); int32_t _lb_sq46 __attribute__((unused)) = 0LL; (_lb_sq45 == _lb_sq46); }))) 
            {
                lb_pos = "src/std/clipboard/windows/native.lucb:55:13";
                lb_r_unit _lb_err47 = ((lb_r_unit){ .error = { .code = (int32_t)(lb_clipboard_failed), .message = ((lb_str){"the clipboard is busy", 21}) }, .failed = true });
                (void)(lb_clipboard_16free_unpublished(lb_storage, &(lb_published)));
            ...
            lb_pos = "src/std/clipboard/windows/native.lucb:56:9";
            lb_pos = "src/std/clipboard/windows/native.lucb:57:9";
            if (!!((({ int32_t _lb_sq49 __attribute__((unused)) = lb_x_clipboard_EmptyClipboard(); int32_t _lb_sq50 __attribute__((unused)) = 0LL; (_lb_sq49 == _lb_sq50); }) || ({ void* _lb_sq51 __attribute__((unused)) = lb_x_clipboard_SetClipboardData(lb_clipboard_12unicode_text, lb_storage); void* _lb_sq52 __attribute__((unused)) = ((void*)0); (_lb_sq51 == ((void*)0)); })))) 
            {
                lb_pos = "src/std/clipboard/windows/native.lucb:58:13";
                lb_r_unit _lb_err53 = ((lb_r_unit){ .error = { .code = (int32_t)(lb_clipboard_failed), .message = ((lb_str){"could not publish clipboard text", 32}) }, .failed = true });
                (void)(((void)(lb_x_clipboard_CloseClipboard())));
                (void)(lb_clipboard_16free_unpublished(lb_storage, &(lb_published)));
                { lb_span _lb_s54 = lb_wide; lb_release_call(lb_memory_allocator, (lb_span){ (void*)(_lb_s54.data), lb_mul_u(_lb_s54.length, sizeof(uint16_t), 64) }); }
                (void)(lb_strings_Builder_destroy(&(lb_terminated)));
                lb_memory_allocator = _lb_as33;
                return _lb_err53;
            }
            lb_pos = "src/std/clipboard/windows/native.lucb:59:9";
            lb_published = true;
            (void)(((void)(lb_x_clipboard_CloseClipboard())));
            (void)(lb_clipboard_16free_unpublished(lb_storage, &(lb_published)));
...
__attribute__((weak)) lb_interop_Owned_0g1_str lb_interop_Owned_0g1_str_clone(const lb_interop_Owned_0g1_str* self) {
    ...
    struct lb_ownership_Object* _lb_o60 = self->owner;
    if (_lb_o60 != ((void*)0)) {
        struct lb_ownership_Object* lb_owner __attribute__((unused)) = _lb_o60;
        {
    ...
    lb_interop_Owned_0g1_str _lb_ret61 = (*self);
    return _lb_ret61;
    lb_trap("unreachable");
}
__attribute__((weak)) void lb_interop_Owned_0g1_str_release(const lb_interop_Owned_0g1_str* self) {
    ...
    struct lb_ownership_Object* _lb_o62 = self->owner;
    if (_lb_o62 != ((void*)0)) {
        struct lb_ownership_Object* lb_owner __attribute__((unused)) = _lb_o62;
        {
...
__attribute__((weak)) void lb_interop_Owned_0g1_str_trace(const lb_interop_Owned_0g1_str* self, lb_fn_0F2_ownership_Object_0p_void_0p_unit lb_visit, void* lb_context) {
    ...
    struct lb_ownership_Object* _lb_o63 = self->owner;
    if (_lb_o63 != ((void*)0)) {
        struct lb_ownership_Object* lb_owner __attribute__((unused)) = _lb_o63;
        {
...
void lb_clipboard_16free_unpublished(void* lb_storage, bool* lb_published) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/clipboard/windows/native.lucb:62:5";
    if (!!((!(*(lb_published))))) 
    {
        lb_pos = "src/std/clipboard/windows/native.lucb:63:9";
        (void)(((void)(lb_x_clipboard_GlobalFree(lb_storage))));
    }
}
__attribute__((weak)) void lb_memory_copy_0g1_u8(lb_span lb_target, lb_cspan lb_source, size_t lb_count) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    ...
    if (!!((((size_t)(lb_count)) > ((size_t)(0ULL))))) 
    {
        ...
        (void)(((void)(({ void* _lb_sq64 __attribute__((unused)) = ((uint8_t*)(lb_target.data)); const void* _lb_sq65 __attribute__((unused)) = ((const uint8_t*)(lb_source.data)); size_t _lb_sq66 __attribute__((unused)) = ({ size_t _lb_sq67 __attribute__((unused)) = lb_count; size_t _lb_sq68 __attribute__((unused)) = ((size_t)sizeof(uint8_t)); (size_t)(lb_mul_u((uint64_t)(_lb_sq67), (uint64_t)(_lb_sq68), 64)); }); ({ void* _lb_fr = lb_x_memory_memcpy(_lb_sq64, _lb_sq65, _lb_sq66); if (!_lb_fr) lb_trap("null_foreign"); _lb_fr; }); }))));
    }
}
