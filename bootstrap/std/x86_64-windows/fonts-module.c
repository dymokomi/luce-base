...
lb_r_fonts_Bitmap lb_fonts_Face_rasterize(const lb_fonts_Face* self, lb_str lb_text, double lb_scale) {
    ...
    {
        lb_pos = "src/std/fonts/module.lucb:76:13";
        (void)((({ lb_r_unit _lb_r29 = lb_fonts_10win_raster((*self), lb_text, lb_scale, &(lb_bitmap)); if (_lb_r29.failed) {
...
void lb_fonts_Face_close(lb_fonts_Face* self) {
    ...
    if (_lb_o31 != ((void*)0)) {
        ...
        {
            {
                lb_pos = "src/std/fonts/module.lucb:88:17";
                (void)(lb_fonts_9win_close(lb_native, self->auxiliary));
            }
...
lb_r_fonts_NativeFace lb_fonts_9load_face(double lb_size, lb_str lb_family) {
    ...
    {
        lb_pos = "src/std/fonts/module.lucb:124:9";
        lb_fonts_NativeFace _lb_ret41 = (({ lb_r_fonts_NativeFace _lb_r42 = lb_fonts_8win_face(lb_size, lb_family); if (_lb_r42.failed) {
