...
lb_net_11http_syntax_0init:
    .seh_proc lb_net_11http_syntax_0init
    pushq %rbp
    .seh_pushreg %rbp
    subq $176, %rsp
    .seh_stackalloc 176
...
lb_net_14http_list_next:
    .seh_proc lb_net_14http_list_next
    pushq %rbp
    .seh_pushreg %rbp
    subq $400, %rsp
    .seh_stackalloc 400
...
lb_net_16http_field_valid:
    .seh_proc lb_net_16http_field_valid
    pushq %rbp
    .seh_pushreg %rbp
    subq $256, %rsp
    .seh_stackalloc 256
...
lb_net_13http_head_end:
    .seh_proc lb_net_13http_head_end
    pushq %rbp
    .seh_pushreg %rbp
    subq $304, %rsp
    .seh_stackalloc 304
...
lb_net_15http_uri_letter:
    .seh_proc lb_net_15http_uri_letter
    pushq %rbp
    .seh_pushreg %rbp
    subq $224, %rsp
    .seh_stackalloc 224
...
lb_net_13http_uri_name:
    .seh_proc lb_net_13http_uri_name
    pushq %rbp
    .seh_pushreg %rbp
    subq $224, %rsp
    .seh_stackalloc 224
...
lb_net_25http_request_target_valid:
    .seh_proc lb_net_25http_request_target_valid
    pushq %rbp
    .seh_pushreg %rbp
    subq $512, %rsp
    .seh_stackalloc 512
...
lb_net_15http_host_valid:
    .seh_proc lb_net_15http_host_valid
    pushq %rbp
    .seh_pushreg %rbp
    subq $496, %rsp
    .seh_stackalloc 496
