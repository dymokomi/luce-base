...
.Ltext_0:
    .asciz "unreachable"
.Ltext_1:
    .asciz "src/std/thread.lucb:31:9"
.Ltext_2:
...
.Ltext_32:
    .asciz "src/std/thread.lucb:124:9"
.Ltext_33:
    .asciz "x86_64"
.Ltext_34:
    .asciz "pause\n"
...
.Ltext_39:
    ...
    .section .data$lb_thread_failed,"dw"
    .globl lb_thread_failed
    .p2align 2
lb_thread_failed:
    .zero 4

    .section .data$lb_thread_11least_stack,"dw"
    .globl lb_thread_11least_stack
    .p2align 3
lb_thread_11least_stack:
    .zero 8

    .section .data$lb_thread_9name_room,"dw"
