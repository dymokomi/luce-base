...
typedef struct lb_a_u8_0a131073 { uint8_t d[131073]; } lb_a_u8_0a131073;
...
lb_o_str lb_os_11windows_env(char* lb_variable);
lb_r_str lb_os_11windows_cwd(void);
lb_r_str lb_os_18windows_executable(void);
int32_t lb_os_18windows_parent_pid(void);
...
_Thread_local lb_a_u16_0a32768 lb_os_16environment_wide = {};
_Thread_local lb_a_u8_0a131073 lb_os_16environment_utf8 = {};
_Thread_local lb_a_u16_0a32768 lb_os_15environment_key = {};
...
lb_o_str lb_os_11windows_env(char* lb_variable) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/os/windows.lucb:30:5";
    if (!!(({ int32_t _lb_sq7 __attribute__((unused)) = lb_x_11windows_abi_MultiByteToWideChar(65001ULL, 8ULL, lb_variable, ((int32_t)(-1LL)), &(((lb_os_15environment_key).d[0])), 32768LL); int32_t _lb_sq8 __attribute__((unused)) = 0LL; (_lb_sq7 == _lb_sq8); }))) 
    {
        lb_pos = "src/std/os/windows.lucb:31:9";
        lb_o_str _lb_ret9 = ((lb_o_str){ .present = false });
        return _lb_ret9;
    }
    lb_pos = "src/std/os/windows.lucb:32:5";
    (void)(lb_x_11windows_abi_SetLastError(0ULL));
    lb_pos = "src/std/os/windows.lucb:33:5";
    uint32_t lb_count __attribute__((unused)) = lb_x_11windows_abi_GetEnvironmentVariableW(&(((lb_os_15environment_key).d[0])), &(((lb_os_16environment_wide).d[0])), 32768ULL);
    lb_pos = "src/std/os/windows.lucb:34:5";
    if (!!(((((uint32_t)(lb_count)) >= ((uint32_t)(32768ULL))) || (((lb_count == 0ULL) && ({ uint32_t _lb_sq10 __attribute__((unused)) = lb_x_11windows_abi_GetLastError(); uint32_t _lb_sq11 __attribute__((unused)) = 0ULL; (!(_lb_sq10 == _lb_sq11)); })))))) 
    {
        lb_pos = "src/std/os/windows.lucb:35:9";
        lb_o_str _lb_ret12 = ((lb_o_str){ .present = false });
        return _lb_ret12;
    }
    lb_pos = "src/std/os/windows.lucb:36:5";
    int32_t lb_size __attribute__((unused)) = 0LL;
    lb_pos = "src/std/os/windows.lucb:37:5";
    if (!!((((uint32_t)(lb_count)) > ((uint32_t)(0ULL))))) 
    {
        lb_pos = "src/std/os/windows.lucb:38:9";
        lb_size = lb_x_11windows_abi_WideCharToMultiByte(65001ULL, 128ULL, &(((lb_os_16environment_wide).d[0])), ((int32_t)lb_conv_u((uint64_t)(lb_count), 32, 0, 32, 1, 1)), &(((lb_os_16environment_utf8).d[0])), 131072LL, ((void*)0), ((void*)0));
        lb_pos = "src/std/os/windows.lucb:39:9";
        if (!!((lb_size == 0LL))) 
        {
            lb_pos = "src/std/os/windows.lucb:40:13";
            lb_o_str _lb_ret13 = ((lb_o_str){ .present = false });
            return _lb_ret13;
        }
    }
    lb_pos = "src/std/os/windows.lucb:41:5";
    ((lb_os_16environment_utf8).d[lb_at((uint64_t)(((size_t)lb_conv_s((int64_t)(lb_size), 32, 1, 64, 0, 1))), 131073ULL)]) = 0ULL;
    lb_pos = "src/std/os/windows.lucb:42:5";
    lb_o_str _lb_ret14 = ((lb_o_str){ .value = ({ lb_span _lb_sc15 = ({ const lb_a_u8_0a131073* _lb_sp16 = &(lb_os_16environment_utf8); size_t _lb_sn16 = 131073ULL; uint8_t* _lb_sd16 = (uint8_t*)(_lb_sp16->d); size_t _lb_ss16 = 0; size_t _lb_se16 = (size_t)(((size_t)lb_conv_s((int64_t)(lb_size), 32, 1, 64, 0, 1))); lb_check_index(_lb_ss16, _lb_sn16 + 1); lb_check_index(_lb_se16, _lb_sn16 + 1); if (_lb_ss16 > _lb_se16) lb_trap("index out of bounds"); (lb_span){ (void*)(_lb_sd16 + _lb_ss16), _lb_se16 - _lb_ss16 }; }); const char* _lb_sb15 = (const char*)_lb_sc15.data; size_t _lb_sl15 = _lb_sc15.length; (lb_str){ _lb_sb15, _lb_sl15 }; }), .present = true });
    return _lb_ret14;
    lb_trap("unreachable");
}
lb_r_str lb_os_11windows_cwd(void) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/os/windows.lucb:45:5";
    size_t lb_attempt __attribute__((unused)) = 0ULL;
    lb_pos = "src/std/os/windows.lucb:46:5";
    for (;;) {
        lb_pos = "src/std/os/windows.lucb:46:5";
        if (!((((size_t)(lb_attempt)) < ((size_t)(8ULL))))) break;
        {
            lb_pos = "src/std/os/windows.lucb:47:9";
            uint32_t lb_capacity __attribute__((unused)) = lb_x_11windows_abi_GetCurrentDirectoryW(0ULL, ((void*)0));
            lb_pos = "src/std/os/windows.lucb:48:9";
            if (!!((lb_capacity == 0ULL))) 
            {
                lb_pos = "src/std/os/windows.lucb:49:13";
                break;
            }
            lb_pos = "src/std/os/windows.lucb:50:9";
            lb_span lb_text __attribute__((unused)) = (({ lb_r_u16_0s _lb_r17 = ({ lb_iface _lb_a18 = lb_memory_allocator; size_t _lb_n18 = (size_t)(((size_t)lb_conv_u((uint64_t)(lb_capacity), 32, 0, 64, 0, 1))); lb_r_u16_0s _lb_r18; if (_lb_n18 > UINT64_C(2305843009213693952)) { _lb_r18 = ((lb_r_u16_0s){ .error = { .code = 208273409, .message = (lb_str){"memory.exhausted", 16} }, .failed = true }); } else { size_t _lb_bytes18 = sizeof(uint16_t) * _lb_n18; lb_o_u8_0s _lb_ao18 = lb_alloc_call(_lb_a18, _lb_bytes18, _Alignof(uint16_t)); if (_lb_bytes18 != 0 && !_lb_ao18.present) { _lb_r18 = ((lb_r_u16_0s){ .error = { .code = 208273409, .message = (lb_str){"memory.exhausted", 16} }, .failed = true }); } else { _lb_r18.value.data = _lb_ao18.value.data; _lb_r18.value.length = _lb_n18; _lb_r18.failed = false; } } _lb_r18; }); if (_lb_r17.failed) {
                return ((lb_r_str){ .error = _lb_r17.error, .failed = true });
            } _lb_r17.value; }));
            lb_pos = "src/std/os/windows.lucb:51:9";
            lb_pos = "src/std/os/windows.lucb:52:9";
            uint32_t lb_count __attribute__((unused)) = lb_x_11windows_abi_GetCurrentDirectoryW(lb_capacity, ((uint16_t*)(lb_text.data)));
            lb_pos = "src/std/os/windows.lucb:53:9";
            if (!!((lb_count == 0ULL))) 
            {
                lb_pos = "src/std/os/windows.lucb:54:13";
            ...
            lb_pos = "src/std/os/windows.lucb:55:9";
            if (!!((((uint32_t)(lb_count)) < ((uint32_t)(lb_capacity))))) 
            {
                lb_pos = "src/std/os/windows.lucb:56:13";
                lb_str _lb_ret20 = (({ lb_r_str _lb_r21 = lb_12windows_text_narrow(({ lb_span _lb_sv22 = lb_text; size_t _lb_sn22 = _lb_sv22.length; uint16_t* _lb_sd22 = (uint16_t*)_lb_sv22.data; size_t _lb_ss22 = 0; size_t _lb_se22 = (size_t)(((size_t)lb_conv_u((uint64_t)(lb_count), 32, 0, 64, 0, 1))); lb_check_index(_lb_ss22, _lb_sn22 + 1); lb_check_index(_lb_se22, _lb_sn22 + 1); if (_lb_ss22 > _lb_se22) lb_trap("index out of bounds"); (lb_span){ (void*)(_lb_sd22 + _lb_ss22), _lb_se22 - _lb_ss22 }; }), lb_os_failed); if (_lb_r21.failed) {
                    { lb_span _lb_s23 = lb_text; lb_release_call(lb_memory_allocator, (lb_span){ (void*)(_lb_s23.data), lb_mul_u(_lb_s23.length, sizeof(uint16_t), 64) }); }
                    return ((lb_r_str){ .error = _lb_r21.error, .failed = true });
                } _lb_r21.value; }));
                { lb_span _lb_s24 = lb_text; lb_release_call(lb_memory_allocator, (lb_span){ (void*)(_lb_s24.data), lb_mul_u(_lb_s24.length, sizeof(uint16_t), 64) }); }
                return ((lb_r_str){ .value = _lb_ret20, .failed = false });
            }
            lb_pos = "src/std/os/windows.lucb:57:9";
            { size_t* lb__cell25 = &(lb_attempt);
    ...
    lb_pos = "src/std/os/windows.lucb:58:5";
    lb_r_str _lb_err27 = ((lb_r_str){ .error = { .code = (int32_t)(lb_os_failed), .message = ((lb_str){"the working directory cannot be read", 36}) }, .failed = true });
    return _lb_err27;
    lb_trap("unreachable");
}
lb_r_str lb_os_18windows_executable(void) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/os/windows.lucb:63:5";
    size_t lb_capacity __attribute__((unused)) = 260ULL;
    lb_pos = "src/std/os/windows.lucb:64:5";
    for (;;) {
        lb_pos = "src/std/os/windows.lucb:64:5";
        if (!((((size_t)(lb_capacity)) <= ((size_t)(32768ULL))))) break;
        {
            lb_pos = "src/std/os/windows.lucb:65:9";
            lb_span lb_text __attribute__((unused)) = (({ lb_r_u16_0s _lb_r28 = ({ lb_iface _lb_a29 = lb_memory_allocator; size_t _lb_n29 = (size_t)(lb_capacity); lb_r_u16_0s _lb_r29; if (_lb_n29 > UINT64_C(2305843009213693952)) { _lb_r29 = ((lb_r_u16_0s){ .error = { .code = 208273409, .message = (lb_str){"memory.exhausted", 16} }, .failed = true }); } else { size_t _lb_bytes29 = sizeof(uint16_t) * _lb_n29; lb_o_u8_0s _lb_ao29 = lb_alloc_call(_lb_a29, _lb_bytes29, _Alignof(uint16_t)); if (_lb_bytes29 != 0 && !_lb_ao29.present) { _lb_r29 = ((lb_r_u16_0s){ .error = { .code = 208273409, .message = (lb_str){"memory.exhausted", 16} }, .failed = true }); } else { _lb_r29.value.data = _lb_ao29.value.data; _lb_r29.value.length = _lb_n29; _lb_r29.failed = false; } } _lb_r29; }); if (_lb_r28.failed) {
                return ((lb_r_str){ .error = _lb_r28.error, .failed = true });
            } _lb_r28.value; }));
            lb_pos = "src/std/os/windows.lucb:66:9";
            lb_pos = "src/std/os/windows.lucb:67:9";
            uint32_t lb_count __attribute__((unused)) = lb_x_os_GetModuleFileNameW(((void*)0), ((uint16_t*)(lb_text.data)), ((uint32_t)lb_conv_u((uint64_t)(lb_capacity), 64, 0, 32, 0, 1)));
            lb_pos = "src/std/os/windows.lucb:68:9";
            if (!!((lb_count == 0ULL))) 
            {
                lb_pos = "src/std/os/windows.lucb:69:13";
                { lb_span _lb_s30 = lb_text; lb_release_call(lb_memory_allocator, (lb_span){ (void*)(_lb_s30.data), lb_mul_u(_lb_s30.length, sizeof(uint16_t), 64) }); }
                break;
            }
            lb_pos = "src/std/os/windows.lucb:70:9";
            if (!!((((size_t)(((size_t)lb_conv_u((uint64_t)(lb_count), 32, 0, 64, 0, 1)))) < ((size_t)(lb_capacity))))) 
            {
                lb_pos = "src/std/os/windows.lucb:71:13";
                lb_str _lb_ret31 = (({ lb_r_str _lb_r32 = lb_12windows_text_narrow(({ lb_span _lb_sv33 = lb_text; size_t _lb_sn33 = _lb_sv33.length; uint16_t* _lb_sd33 = (uint16_t*)_lb_sv33.data; size_t _lb_ss33 = 0; size_t _lb_se33 = (size_t)(((size_t)lb_conv_u((uint64_t)(lb_count), 32, 0, 64, 0, 1))); lb_check_index(_lb_ss33, _lb_sn33 + 1); lb_check_index(_lb_se33, _lb_sn33 + 1); if (_lb_ss33 > _lb_se33) lb_trap("index out of bounds"); (lb_span){ (void*)(_lb_sd33 + _lb_ss33), _lb_se33 - _lb_ss33 }; }), lb_os_failed); if (_lb_r32.failed) {
                    ...
                    return ((lb_r_str){ .error = _lb_r32.error, .failed = true });
                } _lb_r32.value; }));
                { lb_span _lb_s35 = lb_text; lb_release_call(lb_memory_allocator, (lb_span){ (void*)(_lb_s35.data), lb_mul_u(_lb_s35.length, sizeof(uint16_t), 64) }); }
                return ((lb_r_str){ .value = _lb_ret31, .failed = false });
            }
            lb_pos = "src/std/os/windows.lucb:72:9";
            { size_t* lb__cell36 = &(lb_capacity);
            (*(lb__cell36)) = (size_t)(lb_mul_u((uint64_t)((*(lb__cell36))), (uint64_t)(4ULL), 64)); }
            { lb_span _lb_s37 = lb_text; lb_release_call(lb_memory_allocator, (lb_span){ (void*)(_lb_s37.data), lb_mul_u(_lb_s37.length, sizeof(uint16_t), 64) }); }
        }
    }
    lb_pos = "src/std/os/windows.lucb:73:5";
    lb_r_str _lb_err38 = ((lb_r_str){ .error = { .code = (int32_t)(lb_os_failed), .message = ((lb_str){"the executable path cannot be read", 34}) }, .failed = true });
    return _lb_err38;
    lb_trap("unreachable");
}
int32_t lb_os_18windows_parent_pid(void) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/os/windows.lucb:76:5";
    void* lb_snapshot __attribute__((unused)) = ({ void* _lb_fr = lb_x_os_CreateToolhelp32Snapshot(2ULL, 0ULL); if (!_lb_fr) lb_trap("null_foreign"); _lb_fr; });
    lb_pos = "src/std/os/windows.lucb:77:5";
    if (!!((((size_t)(lb_snapshot)) == 18446744073709551615ULL))) 
    {
        lb_pos = "src/std/os/windows.lucb:78:9";
        int32_t _lb_ret39 = 0LL;
        return _lb_ret39;
    }
    lb_pos = "src/std/os/windows.lucb:79:5";
    lb_pos = "src/std/os/windows.lucb:80:5";
    WinProcessEntry lb_entry __attribute__((unused)) = {};
    lb_pos = "src/std/os/windows.lucb:81:5";
    lb_entry.size = ((uint32_t)lb_conv_u((uint64_t)(((size_t)sizeof(WinProcessEntry))), 64, 0, 32, 0, 1));
    lb_pos = "src/std/os/windows.lucb:82:5";
    int32_t lb_found __attribute__((unused)) = lb_x_os_Process32FirstW(lb_snapshot, &(lb_entry));
    lb_pos = "src/std/os/windows.lucb:83:5";
    uint32_t lb_current __attribute__((unused)) = lb_x_11windows_abi_GetCurrentProcessId();
    lb_pos = "src/std/os/windows.lucb:84:5";
    for (;;) {
        lb_pos = "src/std/os/windows.lucb:84:5";
        if (!((!(lb_found == 0LL)))) break;
        {
            lb_pos = "src/std/os/windows.lucb:85:9";
            if (!!((lb_entry.pid == lb_current))) 
            {
                lb_pos = "src/std/os/windows.lucb:86:13";
                int32_t _lb_ret40 = ((int32_t)lb_conv_u((uint64_t)(lb_entry.parent), 32, 0, 32, 1, 1));
                (void)(((void)(lb_x_11windows_abi_CloseHandle(lb_snapshot))));
                return _lb_ret40;
            }
            lb_pos = "src/std/os/windows.lucb:87:9";
            lb_found = lb_x_os_Process32NextW(lb_snapshot, &(lb_entry));
        }
    }
    lb_pos = "src/std/os/windows.lucb:88:5";
    int32_t _lb_ret41 = 0LL;
    (void)(((void)(lb_x_11windows_abi_CloseHandle(lb_snapshot))));
    return _lb_ret41;
    (void)(((void)(lb_x_11windows_abi_CloseHandle(lb_snapshot))));
    lb_trap("unreachable");
