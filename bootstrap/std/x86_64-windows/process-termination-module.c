...
lb_r_unit lb_process_19termination_install(void) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    {
        lb_pos = "src/std/process/termination/module.lucb:54:9";
        (void)((({ lb_r_unit _lb_r29 = lb_process_27termination_windows_install(); if (_lb_r29.failed) {
...
void lb_process_19termination_restore(void) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    {
        lb_pos = "src/std/process/termination/module.lucb:60:9";
        (void)(lb_process_27termination_windows_restore());
    }
}
