...
lb_r_5c_str_0c lb_gpu_30vulkan_presentation_extensions(void) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    {
        lb_pos = "src/std/gpu/vulkan/presentation/module.lucb:6:9";
        lb_cspan _lb_ret7 = ((lb_cspan){(void*)(lb_gpu_25vulkan_windows_extensions.d), 2ULL});
        return ((lb_r_5c_str_0c){ .value = _lb_ret7, .failed = false });
    }
    lb_trap("unreachable");
}
bool lb_gpu_27vulkan_presentation_support(uint64_t lb_physical, uint32_t lb_family) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    {
        lb_pos = "src/std/gpu/vulkan/presentation/module.lucb:11:9";
        bool _lb_ret8 = lb_gpu_22vulkan_windows_support(lb_physical, lb_family);
        return _lb_ret8;
    }
    lb_trap("unreachable");
}
lb_r_u64 lb_gpu_27vulkan_presentation_surface(uint64_t lb_instance, lb_window_Presentation lb_host) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    {
        lb_pos = "src/std/gpu/vulkan/presentation/module.lucb:16:9";
        uint64_t _lb_ret9 = (({ lb_r_u64 _lb_r10 = lb_gpu_22vulkan_windows_surface(lb_instance, lb_host); if (_lb_r10.failed) {
            return ((lb_r_u64){ .error = _lb_r10.error, .failed = true });
        } _lb_r10.value; }));
        return ((lb_r_u64){ .value = _lb_ret9, .failed = false });
    }
    lb_trap("unreachable");
}
__attribute__((weak)) void lb_interop_Packet_0g1_str_init(lb_interop_Packet_0g1_str* self, lb_str lb_value, void* lb_storage, lb_fn_0F1_void_0p_unit lb_dispose) {
