...
int32_t lb_files_create = ((int32_t)256ULL);
int32_t lb_files_truncate = ((int32_t)512ULL);
int32_t lb_files_13close_on_exec = ((int32_t)128ULL);
int32_t lb_files_11append_flag = ((int32_t)8ULL);
int32_t lb_files_14exclusive_flag = ((int32_t)1024ULL);
...
intptr_t lb_files_6c_read(int32_t lb_descriptor, void* lb_buffer, size_t lb_count) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    {
        lb_pos = "src/std/files/module.lucb:19:9";
        intptr_t _lb_ret7 = ((intptr_t)lb_conv_s((int64_t)(lb_c_files_8win_read(lb_descriptor, lb_buffer, ((uint32_t)lb_conv_u((uint64_t)((((((size_t)(lb_count)) < ((size_t)(2147483647ULL))) ? lb_count : 2147483647ULL))), 64, 0, 32, 0, 1)))), 32, 1, 64, 1, 1));
        return _lb_ret7;
    }
    lb_trap("unreachable");
}
intptr_t lb_files_7c_write(int32_t lb_descriptor, const void* lb_buffer, size_t lb_count) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    {
        lb_pos = "src/std/files/module.lucb:24:9";
        intptr_t _lb_ret8 = ((intptr_t)lb_conv_s((int64_t)(lb_c_files_9win_write(lb_descriptor, lb_buffer, ((uint32_t)lb_conv_u((uint64_t)((((((size_t)(lb_count)) < ((size_t)(2147483647ULL))) ? lb_count : 2147483647ULL))), 64, 0, 32, 0, 1)))), 32, 1, 64, 1, 1));
        return _lb_ret8;
    }
    lb_trap("unreachable");
}
int64_t lb_files_lseek(int32_t lb_descriptor, int64_t lb_offset, int32_t lb_whence) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    {
        lb_pos = "src/std/files/module.lucb:35:5";
        int64_t _lb_ret9 = lb_c_files_13windows_lseek(lb_descriptor, lb_offset, lb_whence);
        return _lb_ret9;
    }
    lb_trap("unreachable");
}
int32_t lb_files_fsync(int32_t lb_descriptor) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    {
        lb_pos = "src/std/files/module.lucb:39:5";
        int32_t _lb_ret10 = lb_c_files_13windows_fsync(lb_descriptor);
        return _lb_ret10;
    }
    lb_trap("unreachable");
}
int32_t lb_files_ftruncate(int32_t lb_descriptor, int64_t lb_length) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    {
        lb_pos = "src/std/files/module.lucb:44:9";
        int32_t lb_result __attribute__((unused)) = lb_c_files_17windows_ftruncate(lb_descriptor, lb_length);
        lb_pos = "src/std/files/module.lucb:45:9";
        if (!!((!(lb_result == 0LL)))) 
        {
            lb_pos = "src/std/files/module.lucb:46:13";
            (void)(lb_c_9set_errno(lb_result));
            lb_pos = "src/std/files/module.lucb:47:13";
            int32_t _lb_ret11 = ((int32_t)(-1LL));
            return _lb_ret11;
        }
        lb_pos = "src/std/files/module.lucb:48:9";
        int32_t _lb_ret12 = 0LL;
        return _lb_ret12;
    }
    lb_trap("unreachable");
}
lb_r_str_0o lb_files_10next_entry(void* lb_directory) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    {
        lb_pos = "src/std/files/module.lucb:98:9";
        lb_o_str _lb_ret13 = (({ lb_r_str_0o _lb_r14 = lb_files_12windows_next(((struct lb_files_WinDirectory*)(lb_directory))); if (_lb_r14.failed) {
            return ((lb_r_str_0o){ .error = _lb_r14.error, .failed = true });
        } _lb_r14.value; }));
