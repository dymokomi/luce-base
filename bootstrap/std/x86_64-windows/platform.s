...
.Ltext_0:
    ...
    .section .data$lb_platform_name,"dw"
    .globl lb_platform_name
    .p2align 3
lb_platform_name:
    .zero 16

    .section .data$lb_platform_macos,"dw"
    .globl lb_platform_macos
    .p2align 0
lb_platform_macos:
    .zero 1

    .section .data$lb_platform_linux,"dw"
    .globl lb_platform_linux
    .p2align 0
lb_platform_linux:
    .zero 1

    .section .data$lb_platform_windows,"dw"
    .globl lb_platform_windows
    .p2align 0
lb_platform_windows:
    .zero 1

    .section .data$lb_platform_posix,"dw"
    .globl lb_platform_posix
    .p2align 0
lb_platform_posix:
    .zero 1

    .section .data$lb_platform_arm64,"dw"
    .globl lb_platform_arm64
    .p2align 0
lb_platform_arm64:
    .zero 1

    .section .data$lb_platform_6x86_64,"dw"
    .globl lb_platform_6x86_64
    .p2align 0
lb_platform_6x86_64:
    .zero 1

    .section .data$lb_platform_12pointer_bits,"dw"
    .globl lb_platform_12pointer_bits
    .p2align 2
lb_platform_12pointer_bits:
    .zero 4

    .section .data$lb_platform_9cpu_level,"dw"
