...
lb_files_handles_0init:
    .seh_proc lb_files_handles_0init
    pushq %rbp
    .seh_pushreg %rbp
    subq $176, %rsp
    .seh_stackalloc 176
...
.L1_1:
    ...
    movq 16(%rsp), %r8
    movq 24(%rsp), %r9
    call lb_files_15open_descriptor
    addq $32, %rsp
    leaq 120(%rbp), %rbx
    movq $32, %rcx
    movq %rbx, %r15
...
lb_files_File_descriptor:
    .seh_proc lb_files_File_descriptor
    pushq %rbp
    .seh_pushreg %rbp
    subq $208, %rsp
    .seh_stackalloc 208
...
lb_files_File_metadata:
    .seh_proc lb_files_File_metadata
    pushq %rbp
    .seh_pushreg %rbp
    subq $560, %rsp
    .seh_stackalloc 560
...
lb_files_File_truncate:
    .seh_proc lb_files_File_truncate
    pushq %rbp
    .seh_pushreg %rbp
    subq $336, %rsp
    .seh_stackalloc 336
...
lb_files_File_15set_permissions:
    .seh_proc lb_files_File_15set_permissions
    pushq %rbp
    .seh_pushreg %rbp
    subq $336, %rsp
    .seh_stackalloc 336
...
.L5_7:
    ...
    movq 8(%rsp), %rdx
    movq 16(%rsp), %r8
    call lb_files_19windows_permissions
    addq $32, %rsp
    leaq 0(%rbp), %r14
    movq $24, %rcx
    movq %r14, %r13
...
lb_files_File_9set_times:
    .seh_proc lb_files_File_9set_times
    pushq %rbp
    .seh_pushreg %rbp
    subq $352, %rsp
    .seh_stackalloc 352
...
.L6_7:
    ...
    movq 16(%rsp), %r8
    movq 24(%rsp), %r9
    call lb_files_17windows_set_times
    addq $64, %rsp
    leaq 0(%rbp), %r14
    movq $24, %rcx
    movq %r14, %r13
...
lb_files_File_destroy:
    .seh_proc lb_files_File_destroy
    pushq %rbp
    .seh_pushreg %rbp
    subq $256, %rsp
    .seh_stackalloc 256
...
lb_files_14classify_error:
    .seh_proc lb_files_14classify_error
    pushq %rbp
    .seh_pushreg %rbp
    subq $224, %rsp
    .seh_stackalloc 224
...
.L13_68:
    ...
    .p2align 4
    .globl lb_files_15open_descriptor
lb_files_15open_descriptor:
    .seh_proc lb_files_15open_descriptor
    pushq %rbp
    .seh_pushreg %rbp
    subq $352, %rsp
    .seh_stackalloc 352
