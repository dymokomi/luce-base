...
lb_ownership_module_0init:
    .seh_proc lb_ownership_module_0init
    pushq %rbp
    .seh_pushreg %rbp
    subq $192, %rsp
    .seh_stackalloc 192
...
lb_ownership_8color_of:
    .seh_proc lb_ownership_8color_of
    pushq %rbp
    .seh_pushreg %rbp
    subq $208, %rsp
    .seh_stackalloc 208
...
lb_ownership_9set_color:
    .seh_proc lb_ownership_9set_color
    pushq %rbp
    .seh_pushreg %rbp
    subq $240, %rsp
    .seh_stackalloc 240
...
lb_ownership_allocate:
    ...
    movq 0(%rsp), %rcx
    movq 8(%rsp), %rdx
    call lb_ownership_14allocate_sized
    addq $32, %rsp
    movq %rax, %rbx
    movq %rbx, %rax
    movq 200(%rbp), %rdi
...
lb_ownership_14allocate_sized:
    .seh_proc lb_ownership_14allocate_sized
    pushq %rbp
    .seh_pushreg %rbp
    subq $336, %rsp
    .seh_stackalloc 336
...
.Ltext_37:
    ...
    .section .data$lb_ownership_black,"dw"
    .globl lb_ownership_black
    .p2align 0
lb_ownership_black:
    .zero 1

    .section .data$lb_ownership_gray,"dw"
    .globl lb_ownership_gray
    .p2align 0
lb_ownership_gray:
    .zero 1

    .section .data$lb_ownership_white,"dw"
    .globl lb_ownership_white
    .p2align 0
lb_ownership_white:
    .zero 1

    .section .data$lb_ownership_purple,"dw"
    .globl lb_ownership_purple
    .p2align 0
lb_ownership_purple:
    .zero 1

    .section .data$lb_ownership_10color_mask,"dw"
    .globl lb_ownership_10color_mask
    .p2align 0
lb_ownership_10color_mask:
    .zero 1

    .section .data$lb_ownership_buffered,"dw"
    .globl lb_ownership_buffered
    .p2align 0
lb_ownership_buffered:
    .zero 1

    .section .data$lb_ownership_dead,"dw"
    .globl lb_ownership_dead
    .p2align 0
lb_ownership_dead:
    .zero 1

    .section .data$lb_ownership_collecting,"dw"
    .globl lb_ownership_collecting
    .p2align 0
lb_ownership_collecting:
    .zero 1

    .section .data$lb_ownership_immortal,"dw"
