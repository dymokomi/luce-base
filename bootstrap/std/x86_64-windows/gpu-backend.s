...
lb_gpu_14select_backend:
    .seh_proc lb_gpu_14select_backend
    pushq %rbp
    .seh_pushreg %rbp
    subq $288, %rsp
    .seh_stackalloc 288
...
lb_gpu_19backend_device_open:
    .seh_proc lb_gpu_19backend_device_open
    pushq %rbp
    .seh_pushreg %rbp
    subq $336, %rsp
    .seh_stackalloc 336
...
.L2_1:
    ...
    movq %rax, (%rsp)
    movq 0(%rsp), %rcx
    call lb_gpu_18vulkan_device_open
    addq $32, %rsp
    leaq 24(%rbp), %r12
    movq $32, %rcx
    movq %r12, %rbx
...
lb_gpu_22backend_device_destroy:
    .seh_proc lb_gpu_22backend_device_destroy
    pushq %rbp
    .seh_pushreg %rbp
    subq $240, %rsp
    .seh_stackalloc 240
