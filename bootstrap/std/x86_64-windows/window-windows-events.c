...
lb_r_unit lb_window_14win_set_cursor(struct lb_window_State* lb_state, uint8_t lb_cursor);
...
lb_input_Modifiers lb_window_13win_modifiers(void);
uint16_t lb_window_7win_key(intptr_t lb_value);
int32_t lb_window_11signed_half(intptr_t lb_value);
...
lb_a_u16_0a64 lb_window_13win_scan_keys = ((lb_a_u16_0a64){{0ULL, 41ULL, 30ULL, 31ULL, 32ULL, 33ULL, 34ULL, 35ULL, 36ULL, 37ULL, 38ULL, 39ULL, 45ULL, 46ULL, 42ULL, 43ULL, 20ULL, 26ULL, 8ULL, 21ULL, 23ULL, 28ULL, 24ULL, 12ULL, 18ULL, 19ULL, 47ULL, 48ULL, 40ULL, 224ULL, 4ULL, 22ULL, 7ULL, 9ULL, 10ULL, 11ULL, 13ULL, 14ULL, 15ULL, 51ULL, 52ULL, 53ULL, 225ULL, 49ULL, 29ULL, 27ULL, 6ULL, 25ULL, 5ULL, 17ULL, 16ULL, 54ULL, 55ULL, 56ULL, 229ULL, 0ULL, 226ULL, 44ULL, 57ULL, 58ULL, 59ULL, 60ULL, 61ULL, 62ULL}});
...
intptr_t lb_window_12win_callback(void* lb_native, uint32_t lb_message, size_t lb_word, intptr_t lb_value) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/window/windows/events.lucb:58:5";
    if (!!((lb_message == 129ULL))) 
    {
        lb_pos = "src/std/window/windows/events.lucb:60:9";
        struct lb_window_State* lb_state __attribute__((unused)) = (*(((struct lb_window_State**)(((void*)(lb_value))))));
        lb_pos = "src/std/window/windows/events.lucb:61:9";
        (lb_state)->native = lb_native;
        lb_pos = "src/std/window/windows/events.lucb:62:9";
        (void)(((void)(lb_x_window_SetWindowLongPtrW(lb_native, ((int32_t)(-21LL)), ((intptr_t)(((void*)(lb_state))))))));
        lb_pos = "src/std/window/windows/events.lucb:63:9";
        intptr_t _lb_ret7 = lb_x_window_DefWindowProcW(lb_native, lb_message, lb_word, lb_value);
        return _lb_ret7;
    }
    lb_pos = "src/std/window/windows/events.lucb:64:5";
    intptr_t lb_stored __attribute__((unused)) = lb_x_window_GetWindowLongPtrW(lb_native, ((int32_t)(-21LL)));
    lb_pos = "src/std/window/windows/events.lucb:65:5";
    if (!!((lb_stored == 0LL))) 
    {
        lb_pos = "src/std/window/windows/events.lucb:66:9";
        intptr_t _lb_ret8 = lb_x_window_DefWindowProcW(lb_native, lb_message, lb_word, lb_value);
        return _lb_ret8;
    }
    lb_pos = "src/std/window/windows/events.lucb:67:5";
    struct lb_window_State* lb_state __attribute__((unused)) = ((struct lb_window_State*)(((void*)(lb_stored))));
    lb_pos = "src/std/window/windows/events.lucb:68:5";
    if (!!((lb_state)->destroyed)) 
    {
        lb_pos = "src/std/window/windows/events.lucb:69:9";
        intptr_t _lb_ret9 = lb_x_window_DefWindowProcW(lb_native, lb_message, lb_word, lb_value);
        return _lb_ret9;
    }
    lb_pos = "src/std/window/windows/events.lucb:70:5";
    if (!!(((lb_message == 32ULL) && ((((intptr_t)(lb_value & 65535LL))) == 1LL)))) 
    {
        lb_pos = "src/std/window/windows/events.lucb:71:9";
        (void)(((void)(lb_x_window_SetCursor((lb_state)->native_cursor))));
        lb_pos = "src/std/window/windows/events.lucb:72:9";
        intptr_t _lb_ret10 = 1LL;
        return _lb_ret10;
    }
    lb_pos = "src/std/window/windows/events.lucb:73:5";
    if (!!((lb_message == 16ULL))) 
    {
        lb_pos = "src/std/window/windows/events.lucb:74:9";
        (lb_state)->close_requested = true;
        lb_pos = "src/std/window/windows/events.lucb:75:9";
        intptr_t _lb_ret11 = 0LL;
        return _lb_ret11;
    }
    lb_pos = "src/std/window/windows/events.lucb:76:5";
    if (!!((lb_message == 5ULL))) 
    {
        lb_pos = "src/std/window/windows/events.lucb:77:9";
        (void)(({ struct lb_window_State* _lb_sq12 __attribute__((unused)) = lb_state; lb_input_Event _lb_sq13 __attribute__((unused)) = ((lb_input_Event){.kind = ((uint8_t)2u)}); lb_window_10push_event(_lb_sq12, _lb_sq13); }));
    }
    else {
        lb_pos = "src/std/window/windows/events.lucb:78:5";
        if (!!(((lb_message == 7ULL) || (lb_message == 8ULL)))) 
        {
            lb_pos = "src/std/window/windows/events.lucb:79:9";
            (lb_state)->pending_surrogate = 0ULL;
            lb_pos = "src/std/window/windows/events.lucb:80:9";
            (void)(({ struct lb_window_State* _lb_sq14 __attribute__((unused)) = lb_state; lb_input_Event _lb_sq15 __attribute__((unused)) = ((lb_input_Event){.kind = ((lb_message == 7ULL) ? ((uint8_t)3u) : ((uint8_t)4u))}); lb_window_10push_event(_lb_sq14, _lb_sq15); }));
        }
        else {
            lb_pos = "src/std/window/windows/events.lucb:81:5";
            if (!!((lb_message == 258ULL))) 
            {
                lb_pos = "src/std/window/windows/events.lucb:83:9";
                if (!!((lb_state)->text_input)) 
                {
                    lb_pos = "src/std/window/windows/events.lucb:84:13";
                    (void)(lb_window_10push_utf16(lb_state, ((uint16_t)lb_conv_u((uint64_t)(lb_word), 64, 0, 16, 0, 1))));
                }
                lb_pos = "src/std/window/windows/events.lucb:85:9";
                intptr_t _lb_ret16 = 0LL;
                return _lb_ret16;
            }
            else {
                lb_pos = "src/std/window/windows/events.lucb:86:5";
                if (!!((lb_message == 265ULL))) 
                {
                    lb_pos = "src/std/window/windows/events.lucb:88:9";
                    if (!!((lb_word == 65535ULL))) 
                    {
                        lb_pos = "src/std/window/windows/events.lucb:89:13";
                        intptr_t _lb_ret17 = 1LL;
                        return _lb_ret17;
                    }
                    lb_pos = "src/std/window/windows/events.lucb:90:9";
                    if (!!(((lb_state)->text_input && (((size_t)(lb_word)) <= ((size_t)(1114111ULL)))))) 
                    {
                        lb_pos = "src/std/window/windows/events.lucb:91:13";
                        (void)(lb_window_11push_scalar(lb_state, ((uint32_t)lb_conv_u((uint64_t)(lb_word), 64, 0, 32, 0, 1))));
                    }
                    lb_pos = "src/std/window/windows/events.lucb:92:9";
                    intptr_t _lb_ret18 = 0LL;
                    return _lb_ret18;
                }
                else {
                    lb_pos = "src/std/window/windows/events.lucb:93:5";
                    if (!!((lb_message == 736ULL))) 
                    {
                        lb_pos = "src/std/window/windows/events.lucb:94:9";
                        struct WinRect* lb_rect __attribute__((unused)) = ((struct WinRect*)(((void*)(lb_value))));
                        lb_pos = "src/std/window/windows/events.lucb:95:9";
                        (void)(((void)(lb_x_window_SetWindowPos(lb_native, ((void*)0), (lb_rect)->left, (lb_rect)->top, (int32_t)(lb_sub_s((int64_t)((lb_rect)->right), (int64_t)((lb_rect)->left), 32)), (int32_t)(lb_sub_s((int64_t)((lb_rect)->bottom), (int64_t)((lb_rect)->top), 32)), 20ULL))));
                        lb_pos = "src/std/window/windows/events.lucb:96:9";
                        (void)(({ struct lb_window_State* _lb_sq19 __attribute__((unused)) = lb_state; lb_input_Event _lb_sq20 __attribute__((unused)) = ((lb_input_Event){.kind = ((uint8_t)2u)}); lb_window_10push_event(_lb_sq19, _lb_sq20); }));
                        lb_pos = "src/std/window/windows/events.lucb:97:9";
                        intptr_t _lb_ret21 = 0LL;
                        return _lb_ret21;
                    }
                    else {
                        lb_pos = "src/std/window/windows/events.lucb:98:5";
                        if (!!(((((lb_message == 256ULL) || (lb_message == 257ULL)) || (lb_message == 260ULL)) || (lb_message == 261ULL)))) 
                        {
                            lb_pos = "src/std/window/windows/events.lucb:99:9";
                            lb_input_Modifiers lb_key_modifiers __attribute__((unused)) = lb_window_13win_modifiers();
                            lb_pos = "src/std/window/windows/events.lucb:100:9";
                            ...
                            {
                                lb_pos = "src/std/window/windows/events.lucb:105:13";
                                (void)(({ struct lb_window_State* _lb_sq24 __attribute__((unused)) = lb_state; lb_input_Event _lb_sq25 __attribute__((unused)) = ((lb_input_Event){.kind = ((uint8_t)7u), .modifiers = lb_key_modifiers}); lb_window_10push_event(_lb_sq24, _lb_sq25); }));
                            }
                        }
                        else {
                            lb_pos = "src/std/window/windows/events.lucb:107:5";
                            if (!!((lb_message == 675ULL))) 
                            {
                                lb_pos = "src/std/window/windows/events.lucb:109:9";
                                (lb_state)->pointer_tracking = false;
                                lb_pos = "src/std/window/windows/events.lucb:110:9";
                                (void)(({ struct lb_window_State* _lb_sq26 __attribute__((unused)) = lb_state; lb_input_Event _lb_sq27 __attribute__((unused)) = ((lb_input_Event){.kind = ((uint8_t)15u)}); lb_window_10push_event(_lb_sq26, _lb_sq27); }));
                                lb_pos = "src/std/window/windows/events.lucb:111:9";
                                intptr_t _lb_ret28 = 0LL;
                                return _lb_ret28;
                            }
                            else {
                                lb_pos = "src/std/window/windows/events.lucb:112:5";
                                if (!!(((((uint32_t)(lb_message)) >= ((uint32_t)(512ULL))) && (((uint32_t)(lb_message)) <= ((uint32_t)(526ULL)))))) 
                                {
                                    lb_pos = "src/std/window/windows/events.lucb:113:9";
                                    WinPoint lb_point __attribute__((unused)) = ({ int32_t _lb_sq29 __attribute__((unused)) = lb_window_11signed_half(lb_value); int32_t _lb_sq30 __attribute__((unused)) = lb_window_11signed_half((intptr_t)(lb_shr_s((int64_t)(lb_value), (int64_t)((intptr_t)(16LL)), 64))); ((WinPoint){.x = _lb_sq29, .y = _lb_sq30}); });
                                    lb_pos = "src/std/window/windows/events.lucb:114:9";
                                    bool lb_scrolling __attribute__((unused)) = ((lb_message == 522ULL) || (lb_message == 526ULL));
                                    lb_pos = "src/std/window/windows/events.lucb:115:9";
                                    if (!!(lb_scrolling)) 
                                    {
                                        lb_pos = "src/std/window/windows/events.lucb:116:13";
                                        (void)(((void)(lb_x_window_ScreenToClient(lb_native, &(lb_point)))));
                                    }
                                    lb_pos = "src/std/window/windows/events.lucb:117:9";
                                    uint32_t lb_dpi __attribute__((unused)) = lb_x_window_GetDpiForWindow(lb_native);
                                    lb_pos = "src/std/window/windows/events.lucb:118:9";
                                    ...
                                    lb_pos = "src/std/window/windows/events.lucb:119:9";
                                    lb_input_Event lb_event __attribute__((unused)) = ({ uint8_t _lb_sq31 __attribute__((unused)) = ((uint8_t)8u); lb_input_Modifiers _lb_sq32 __attribute__((unused)) = lb_window_13win_modifiers(); double _lb_sq33 __attribute__((unused)) = (lb_to_f((int64_t)(lb_point.x), 1) / lb_scale); double _lb_sq34 __attribute__((unused)) = (lb_to_f((int64_t)(lb_point.y), 1) / lb_scale); ((lb_input_Event){.kind = _lb_sq31, .modifiers = _lb_sq32, .x = _lb_sq33, .y = _lb_sq34}); });
                                    lb_pos = "src/std/window/windows/events.lucb:120:9";
                                    if (!!(((lb_message == 512ULL) && (!(lb_state)->pointer_tracking)))) 
                                    {
                                        lb_pos = "src/std/window/windows/events.lucb:121:13";
                                        lb_window_WinMouseTracking lb_tracking __attribute__((unused)) = ({ uint32_t _lb_sq35 __attribute__((unused)) = ((uint32_t)lb_conv_u((uint64_t)(((size_t)sizeof(lb_window_WinMouseTracking))), 64, 0, 32, 0, 1)); uint32_t _lb_sq36 __attribute__((unused)) = 2ULL; void* _lb_sq37 __attribute__((unused)) = lb_native; ((lb_window_WinMouseTracking){.size = _lb_sq35, .flags = _lb_sq36, .window = _lb_sq37}); });
                                        lb_pos = "src/std/window/windows/events.lucb:122:13";
                                        (lb_state)->pointer_tracking = ({ int32_t _lb_sq38 __attribute__((unused)) = lb_x_window_TrackMouseEvent(&(lb_tracking)); int32_t _lb_sq39 __attribute__((unused)) = 0LL; (!(_lb_sq38 == _lb_sq39)); });
                                        lb_pos = "src/std/window/windows/events.lucb:123:13";
                                        lb_input_Event lb_entered __attribute__((unused)) = lb_event;
                                        lb_pos = "src/std/window/windows/events.lucb:124:13";
                                        lb_entered.kind = ((uint8_t)14u);
                                        lb_pos = "src/std/window/windows/events.lucb:125:13";
                                        (void)(lb_window_10push_event(lb_state, lb_entered));
                                    }
                                    lb_pos = "src/std/window/windows/events.lucb:126:9";
                                    if (!!(lb_scrolling)) 
                                    {
                                        lb_pos = "src/std/window/windows/events.lucb:127:13";
                                        lb_event.kind = ((uint8_t)11u);
                                        lb_pos = "src/std/window/windows/events.lucb:128:13";
                                        double lb_delta __attribute__((unused)) = ({ double _lb_sq40 __attribute__((unused)) = lb_to_f((int64_t)(lb_window_11signed_half(((intptr_t)lb_conv_u((uint64_t)(((size_t)(lb_shr_u((uint64_t)(lb_word), (uint64_t)((size_t)(16LL)), 64)))), 64, 0, 64, 1, 1)))), 1); double _lb_sq41 __attribute__((unused)) = 0x1.e000000000000p+6; (_lb_sq40 / _lb_sq41); });
                                        lb_pos = "src/std/window/windows/events.lucb:131:13";
                                        lb_event.scroll_x = ((lb_message == 526ULL) ? (-(lb_delta)) : 0x0p+0);
                                        lb_pos = "src/std/window/windows/events.lucb:132:13";
                                        lb_event.scroll_y = ((lb_message == 522ULL) ? lb_delta : 0x0p+0);
                                        lb_pos = "src/std/window/windows/events.lucb:133:13";
                                        lb_event.scroll_unit = ((uint8_t)0u);
                                    }
                                    else {
                                        lb_pos = "src/std/window/windows/events.lucb:134:9";
                                        if (!!((!(lb_message == 512ULL)))) 
                                        {
                                            lb_pos = "src/std/window/windows/events.lucb:135:13";
                                            bool lb_down __attribute__((unused)) = ((((lb_message == 513ULL) || (lb_message == 516ULL)) || (lb_message == 519ULL)) || (lb_message == 523ULL));
                                            lb_pos = "src/std/window/windows/events.lucb:136:13";
                                            bool lb_up __attribute__((unused)) = ((((lb_message == 514ULL) || (lb_message == 517ULL)) || (lb_message == 520ULL)) || (lb_message == 524ULL));
                                            lb_pos = "src/std/window/windows/events.lucb:137:13";
                                            if (!!(((!lb_down) && (!lb_up)))) 
                                            {
                                                lb_pos = "src/std/window/windows/events.lucb:138:17";
                                                intptr_t _lb_ret42 = lb_x_window_DefWindowProcW(lb_native, lb_message, lb_word, lb_value);
                                                return _lb_ret42;
                                            }
                                            lb_pos = "src/std/window/windows/events.lucb:139:13";
                                            lb_event.kind = (lb_down ? ((uint8_t)9u) : ((uint8_t)10u));
                                            lb_pos = "src/std/window/windows/events.lucb:140:13";
                                            lb_event.button = ((((uint32_t)(lb_message)) <= ((uint32_t)(514ULL))) ? 0ULL : (((((uint32_t)(lb_message)) <= ((uint32_t)(517ULL))) ? 1ULL : (((((uint32_t)(lb_message)) <= ((uint32_t)(520ULL))) ? 2ULL : (uint32_t)(lb_add_u((uint64_t)(((uint32_t)lb_conv_u((uint64_t)(((size_t)(lb_shr_u((uint64_t)(lb_word), (uint64_t)((size_t)(16LL)), 64)))), 64, 0, 32, 0, 1))), (uint64_t)(2ULL), 32)))))));
                                            lb_pos = "src/std/window/windows/events.lucb:141:13";
                                            if (!!(lb_down)) 
                                            {
                                                lb_pos = "src/std/window/windows/events.lucb:142:17";
                                                (void)(((void)(lb_x_window_SetCapture(lb_native))));
                                            }
                                            else {
                                                lb_pos = "src/std/window/windows/events.lucb:143:13";
                                                if (!!(((((size_t)(lb_word & 115ULL))) == 0ULL))) 
                                                {
                                                    lb_pos = "src/std/window/windows/events.lucb:144:17";
                                                    (void)(((void)(lb_x_window_ReleaseCapture())));
                                                }
                                            }
                                        }
                                    }
                                    lb_pos = "src/std/window/windows/events.lucb:145:9";
                                    (void)(lb_window_10push_event(lb_state, lb_event));
                                    lb_pos = "src/std/window/windows/events.lucb:146:9";
                                    intptr_t _lb_ret43 = 0LL;
                                    return _lb_ret43;
                                }
                            }
                        }
    ...
    lb_pos = "src/std/window/windows/events.lucb:147:5";
    intptr_t _lb_ret44 = lb_x_window_DefWindowProcW(lb_native, lb_message, lb_word, lb_value);
    return _lb_ret44;
    lb_trap("unreachable");
}
__attribute__((weak)) void lb_interop_Packet_0g1_str_init(lb_interop_Packet_0g1_str* self, lb_str lb_value, void* lb_storage, lb_fn_0F1_void_0p_unit lb_dispose) {
...
lb_input_Modifiers lb_window_13win_modifiers(void) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/window/windows/events.lucb:16:5";
    lb_input_Modifiers _lb_ret49 = ({ bool _lb_sq50 __attribute__((unused)) = ({ int16_t _lb_sq51 __attribute__((unused)) = lb_x_window_GetKeyState(16LL); int16_t _lb_sq52 __attribute__((unused)) = 0LL; (((int16_t)(_lb_sq51)) < ((int16_t)(_lb_sq52))); }); bool _lb_sq53 __attribute__((unused)) = ({ int16_t _lb_sq54 __attribute__((unused)) = lb_x_window_GetKeyState(17LL); int16_t _lb_sq55 __attribute__((unused)) = 0LL; (((int16_t)(_lb_sq54)) < ((int16_t)(_lb_sq55))); }); bool _lb_sq56 __attribute__((unused)) = ({ int16_t _lb_sq57 __attribute__((unused)) = lb_x_window_GetKeyState(18LL); int16_t _lb_sq58 __attribute__((unused)) = 0LL; (((int16_t)(_lb_sq57)) < ((int16_t)(_lb_sq58))); }); bool _lb_sq59 __attribute__((unused)) = (({ int16_t _lb_sq60 __attribute__((unused)) = lb_x_window_GetKeyState(91LL); int16_t _lb_sq61 __attribute__((unused)) = 0LL; (((int16_t)(_lb_sq60)) < ((int16_t)(_lb_sq61))); }) || ({ int16_t _lb_sq62 __attribute__((unused)) = lb_x_window_GetKeyState(92LL); int16_t _lb_sq63 __attribute__((unused)) = 0LL; (((int16_t)(_lb_sq62)) < ((int16_t)(_lb_sq63))); })); bool _lb_sq64 __attribute__((unused)) = ({ int16_t _lb_sq65 __attribute__((unused)) = (({ int16_t _lb_sq66 __attribute__((unused)) = lb_x_window_GetKeyState(20LL); int16_t _lb_sq67 __attribute__((unused)) = 1LL; ((int16_t)(_lb_sq66 & _lb_sq67)); })); int16_t _lb_sq68 __attribute__((unused)) = 0LL; (!(_lb_sq65 == _lb_sq68)); }); ((lb_input_Modifiers){.shift = _lb_sq50, .control = _lb_sq53, .alt = _lb_sq56, .super = _lb_sq59, .caps_lock = _lb_sq64}); });
    return _lb_ret49;
    lb_trap("unreachable");
}
uint16_t lb_window_7win_key(intptr_t lb_value) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/window/windows/events.lucb:31:5";
    size_t lb_scan __attribute__((unused)) = ((size_t)lb_conv_s((int64_t)((((intptr_t)(((intptr_t)(lb_shr_s((int64_t)(lb_value), (int64_t)((intptr_t)(16LL)), 64))) & 255LL)))), 64, 1, 64, 0, 1));
    lb_pos = "src/std/window/windows/events.lucb:32:5";
    bool lb_extended __attribute__((unused)) = (!((((intptr_t)(lb_value & 16777216LL))) == 0LL));
    lb_pos = "src/std/window/windows/events.lucb:33:5";
    if (!!(lb_extended)) 
    {
        lb_pos = "src/std/window/windows/events.lucb:34:9";
        size_t _lb_m69 __attribute__((unused)) = lb_scan;
        switch ((int64_t)(_lb_m69)) {
            case 29ULL:
            {
                {
                    lb_pos = "src/std/window/windows/events.lucb:35:13";
                    uint16_t _lb_ret70 = ((uint16_t)228u);
                    return _lb_ret70;
                }
                break;
            }
            ...
            {
                {
                    lb_pos = "src/std/window/windows/events.lucb:36:13";
                    uint16_t _lb_ret71 = ((uint16_t)230u);
                    return _lb_ret71;
                }
                break;
            }
            ...
            {
                {
                    lb_pos = "src/std/window/windows/events.lucb:37:13";
                    uint16_t _lb_ret72 = ((uint16_t)74u);
                    return _lb_ret72;
                }
                break;
            }
            ...
            {
                {
                    lb_pos = "src/std/window/windows/events.lucb:38:13";
                    uint16_t _lb_ret73 = ((uint16_t)82u);
                    return _lb_ret73;
                }
                break;
            }
            ...
            {
                {
                    lb_pos = "src/std/window/windows/events.lucb:39:13";
                    uint16_t _lb_ret74 = ((uint16_t)75u);
                    return _lb_ret74;
                }
                break;
            }
            ...
            {
                {
                    lb_pos = "src/std/window/windows/events.lucb:40:13";
                    uint16_t _lb_ret75 = ((uint16_t)80u);
                    return _lb_ret75;
                }
                break;
            }
            ...
            {
                {
                    lb_pos = "src/std/window/windows/events.lucb:41:13";
                    uint16_t _lb_ret76 = ((uint16_t)79u);
                    return _lb_ret76;
                }
                break;
            }
            ...
            {
                {
                    lb_pos = "src/std/window/windows/events.lucb:42:13";
                    uint16_t _lb_ret77 = ((uint16_t)77u);
                    return _lb_ret77;
                }
                break;
            }
            ...
            {
                {
                    lb_pos = "src/std/window/windows/events.lucb:43:13";
                    uint16_t _lb_ret78 = ((uint16_t)81u);
                    return _lb_ret78;
                }
                break;
            }
            ...
            {
                {
                    lb_pos = "src/std/window/windows/events.lucb:44:13";
                    uint16_t _lb_ret79 = ((uint16_t)78u);
                    return _lb_ret79;
                }
                break;
            }
            ...
            {
                {
                    lb_pos = "src/std/window/windows/events.lucb:45:13";
                    uint16_t _lb_ret80 = ((uint16_t)76u);
                    return _lb_ret80;
                }
                break;
            }
            ...
            {
                {
                    lb_pos = "src/std/window/windows/events.lucb:46:13";
                    uint16_t _lb_ret81 = ((uint16_t)227u);
                    return _lb_ret81;
                }
                break;
            }
            ...
            {
                {
                    lb_pos = "src/std/window/windows/events.lucb:47:13";
                    uint16_t _lb_ret82 = ((uint16_t)231u);
                    return _lb_ret82;
                }
                break;
            }
            ...
            {
                {
                    lb_pos = "src/std/window/windows/events.lucb:48:13";
                    uint16_t _lb_ret83 = ((uint16_t)0u);
                    return _lb_ret83;
                }
                break;
            }
    ...
    lb_pos = "src/std/window/windows/events.lucb:49:5";
    if (!!((((size_t)(lb_scan)) < ((size_t)(64ULL))))) 
    {
        lb_pos = "src/std/window/windows/events.lucb:50:9";
        uint16_t _lb_ret84 = ((uint16_t)(((lb_window_13win_scan_keys).d[lb_at((uint64_t)(lb_scan), 64ULL)])));
        return _lb_ret84;
    }
    lb_pos = "src/std/window/windows/events.lucb:51:5";
    if (!!(((((size_t)(lb_scan)) >= ((size_t)(64ULL))) && (((size_t)(lb_scan)) <= ((size_t)(68ULL)))))) 
    {
        lb_pos = "src/std/window/windows/events.lucb:52:9";
        uint16_t _lb_ret85 = ((uint16_t)(((uint16_t)lb_conv_u((uint64_t)(((size_t)(lb_add_u((uint64_t)((size_t)(lb_sub_u((uint64_t)(lb_scan), (uint64_t)(64ULL), 64))), (uint64_t)(63ULL), 64)))), 64, 0, 16, 0, 1))));
        return _lb_ret85;
    }
    lb_pos = "src/std/window/windows/events.lucb:53:5";
    if (!!((lb_scan == 87ULL))) 
    {
        lb_pos = "src/std/window/windows/events.lucb:53:5";
        uint16_t _lb_ret86 = ((uint16_t)68u);
        return _lb_ret86;
    }
    lb_pos = "src/std/window/windows/events.lucb:54:5";
    if (!!((lb_scan == 88ULL))) 
    {
        lb_pos = "src/std/window/windows/events.lucb:54:5";
        uint16_t _lb_ret87 = ((uint16_t)69u);
        return _lb_ret87;
    }
    lb_pos = "src/std/window/windows/events.lucb:55:5";
    uint16_t _lb_ret88 = ((uint16_t)0u);
    return _lb_ret88;
    lb_trap("unreachable");
}
int32_t lb_window_11signed_half(intptr_t lb_value) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/window/windows/events.lucb:21:5";
    int32_t lb_half __attribute__((unused)) = ((int32_t)lb_conv_s((int64_t)((((intptr_t)(lb_value & 65535LL)))), 64, 1, 32, 1, 1));
    lb_pos = "src/std/window/windows/events.lucb:22:5";
    int32_t _lb_ret89 = ((((int32_t)(lb_half)) >= ((int32_t)(32768LL))) ? (int32_t)(lb_sub_s((int64_t)(lb_half), (int64_t)(65536LL), 32)) : lb_half);
    return _lb_ret89;
    lb_trap("unreachable");
}
