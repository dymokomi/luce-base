...
.Ltext_6:
    ...
    .section .data$lb_gpu_unsupported,"dw"
    .globl lb_gpu_unsupported
    .p2align 2
lb_gpu_unsupported:
    .zero 4

    .section .data$lb_gpu_unavailable,"dw"
    .globl lb_gpu_unavailable
    .p2align 2
lb_gpu_unavailable:
    .zero 4

    .section .data$lb_gpu_12wrong_thread,"dw"
    .globl lb_gpu_12wrong_thread
    .p2align 2
lb_gpu_12wrong_thread:
    .zero 4

    .section .data$lb_gpu_closed,"dw"
    .globl lb_gpu_closed
    .p2align 2
lb_gpu_closed:
    .zero 4

    .section .data$lb_gpu_13invalid_color,"dw"
    .globl lb_gpu_13invalid_color
    .p2align 2
lb_gpu_13invalid_color:
    .zero 4

    .section .data$lb_gpu_failed,"dw"
    .globl lb_gpu_failed
    .p2align 2
lb_gpu_failed:
    .zero 4

    .section .data$lb_gpu_16execution_failed,"dw"
    .globl lb_gpu_16execution_failed
    .p2align 2
lb_gpu_16execution_failed:
    .zero 4

    .section .data$lb_gpu_17surface_too_large,"dw"
    .globl lb_gpu_17surface_too_large
    .p2align 2
lb_gpu_17surface_too_large:
    .zero 4

    .section .data$lb_gpu_16invalid_geometry,"dw"
    .globl lb_gpu_16invalid_geometry
    .p2align 2
lb_gpu_16invalid_geometry:
    .zero 4

    .section .data$lb_gpu_13command_limit,"dw"
    .globl lb_gpu_13command_limit
    .p2align 2
lb_gpu_13command_limit:
    .zero 4

    .section .data$lb_gpu_14frame_finished,"dw"
    .globl lb_gpu_14frame_finished
    .p2align 2
lb_gpu_14frame_finished:
    .zero 4

    .section .data$lb_gpu_12frame_in_use,"dw"
    .globl lb_gpu_12frame_in_use
    .p2align 2
lb_gpu_12frame_in_use:
    .zero 4

    .section .data$lb_gpu_13frame_resized,"dw"
