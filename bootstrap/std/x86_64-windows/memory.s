...
.Ltext_53:
    .asciz "src/std/memory.lucb:231:9"
.Ltext_54:
    .asciz "src/std/memory.lucb:236:9"
.Ltext_55:
    .asciz "memory: the "
.Ltext_56:
    .asciz " refused "
...
lb_vt_memory_CAllocator_Allocator:
    ...
    .section .data$lb_memory_17private_anonymous,"dw"
...
lb_memory_9held_next:
    ...
    .section .data$lb_memory_exhausted,"dw"
    .globl lb_memory_exhausted
    .p2align 2
lb_memory_exhausted:
    .zero 4

    .section .data$lb_memory_unset,"dw"
