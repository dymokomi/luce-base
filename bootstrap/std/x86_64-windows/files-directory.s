...
lb_files_directory_0init:
    .seh_proc lb_files_directory_0init
    pushq %rbp
    .seh_pushreg %rbp
    subq $176, %rsp
    .seh_stackalloc 176
...
lb_files_Directory_open:
    .seh_proc lb_files_Directory_open
    pushq %rbp
    .seh_pushreg %rbp
    subq $336, %rsp
    .seh_stackalloc 336
    ...
    movq 16(%rsp), %r8
    movq 24(%rsp), %r9
    call lb_files_17open_directory_at
    addq $32, %rsp
    leaq 8(%rbp), %r12
    movq $32, %rcx
    movq %r12, %rbx
...
lb_files_Directory_descriptor:
    .seh_proc lb_files_Directory_descriptor
    pushq %rbp
    .seh_pushreg %rbp
    subq $288, %rsp
    .seh_stackalloc 288
...
lb_files_Directory_metadata:
    .seh_proc lb_files_Directory_metadata
    pushq %rbp
    .seh_pushreg %rbp
    subq $592, %rsp
    .seh_stackalloc 592
    ...
    movq 0(%rsp), %rcx
    movq 8(%rsp), %rdx
    call lb_files_Directory_descriptor
    addq $32, %rsp
    leaq 168(%rbp), %r12
    movq $32, %rcx
    movq %r12, %rbx
...
.L3_1:
    ...
    movq 0(%rsp), %rcx
    movq 8(%rsp), %rdx
    call lb_files_19metadata_descriptor
    addq $32, %rsp
    leaq 8(%rbp), %r13
    movq $152, %rcx
    movq %r13, %rbx
...
lb_files_Directory_14entry_metadata:
    .seh_proc lb_files_Directory_14entry_metadata
    pushq %rbp
    .seh_pushreg %rbp
    subq $624, %rsp
    .seh_stackalloc 624
...
lb_files_Directory_14open_directory:
    .seh_proc lb_files_Directory_14open_directory
    pushq %rbp
    .seh_pushreg %rbp
    subq $384, %rsp
    .seh_stackalloc 384
...
lb_files_Directory_9open_file:
    .seh_proc lb_files_Directory_9open_file
    pushq %rbp
    .seh_pushreg %rbp
    subq $592, %rsp
    .seh_stackalloc 592
...
.L6_1:
    ...
    movq 8(%rsp), %rdx
    movq 16(%rsp), %r8
    call lb_files_15file_open_flags
    addq $32, %rsp
    leaq 160(%rbp), %r15
    movq $32, %rcx
    movq %r15, %r13
...
lb_files_Directory_next:
    .seh_proc lb_files_Directory_next
    pushq %rbp
    .seh_pushreg %rbp
    subq $560, %rsp
    .seh_stackalloc 560
...
lb_files_Directory_close:
    .seh_proc lb_files_Directory_close
    pushq %rbp
    .seh_pushreg %rbp
    subq $288, %rsp
    .seh_stackalloc 288
...
.L8_3:
    ...
    movq 0(%rsp), %rcx
    movq 8(%rsp), %rdx
    call lb_files_23windows_directory_close
    addq $32, %rsp
    leaq 0(%rbp), %r14
    movq $24, %rcx
    movq %r14, %r13
...
lb_files_Directory_destroy:
    .seh_proc lb_files_Directory_destroy
    pushq %rbp
    .seh_pushreg %rbp
    subq $256, %rsp
    .seh_stackalloc 256
...
lb_files_17open_directory_at:
    .seh_proc lb_files_17open_directory_at
    pushq %rbp
    .seh_pushreg %rbp
    subq $352, %rsp
    .seh_stackalloc 352
    ...
    movq 16(%rsp), %r8
    movq 24(%rsp), %r9
    call lb_files_22windows_directory_open
    addq $32, %rsp
    leaq 8(%rbp), %r12
    movq $32, %rcx
    movq %r12, %rbx
...
lb_files_list:
    ...
    movq %rcx, 1368(%rbp)
    movq %rdi, 1544(%rbp)
    .seh_savereg %rdi, 1544
    movq %rsi, 1536(%rbp)
    .seh_savereg %rsi, 1536
    movdqu %xmm6, 1520(%rbp)
    .seh_savexmm %xmm6, 1520
    movdqu %xmm7, 1504(%rbp)
    .seh_savexmm %xmm7, 1504
    movdqu %xmm8, 1488(%rbp)
    .seh_savexmm %xmm8, 1488
    movdqu %xmm9, 1472(%rbp)
    .seh_savexmm %xmm9, 1472
    movdqu %xmm10, 1456(%rbp)
    .seh_savexmm %xmm10, 1456
    movdqu %xmm11, 1440(%rbp)
    .seh_savexmm %xmm11, 1440
    movdqu %xmm12, 1424(%rbp)
    .seh_savexmm %xmm12, 1424
    movdqu %xmm13, 1408(%rbp)
    .seh_savexmm %xmm13, 1408
    movdqu %xmm14, 1392(%rbp)
    .seh_savexmm %xmm14, 1392
    movdqu %xmm15, 1376(%rbp)
    .seh_savexmm %xmm15, 1376
    movq %rbx, 1360(%rbp)
    .seh_savereg %rbx, 1360
    movq %r12, 1352(%rbp)
    .seh_savereg %r12, 1352
    movq %r13, 1344(%rbp)
    .seh_savereg %r13, 1344
    movq %r14, 1336(%rbp)
    .seh_savereg %r14, 1336
    movq %r15, 1328(%rbp)
    .seh_savereg %r15, 1328
    .seh_endprologue
    movq %rcx, 1568(%rbp)
    movq %rdx, 1576(%rbp)
    movq %r8, 1584(%rbp)
...
.L11_2:
    ...
    movq 1544(%rbp), %rdi
    movq 1536(%rbp), %rsi
    movdqu 1520(%rbp), %xmm6
    movdqu 1504(%rbp), %xmm7
    movdqu 1488(%rbp), %xmm8
    movdqu 1472(%rbp), %xmm9
    movdqu 1456(%rbp), %xmm10
    movdqu 1440(%rbp), %xmm11
    movdqu 1424(%rbp), %xmm12
    movdqu 1408(%rbp), %xmm13
    movdqu 1392(%rbp), %xmm14
    movdqu 1376(%rbp), %xmm15
    movq 1360(%rbp), %rbx
    movq 1352(%rbp), %r12
    movq 1344(%rbp), %r13
    movq 1336(%rbp), %r14
...
.L11_18:
    ...
    movq 0(%rsp), %rcx
    movq 8(%rsp), %rdx
    call lb_files_15release_entries
    addq $48, %rsp
    subq $32, %rsp
    movq 112(%rbp), %rax
    movq %rax, 8(%rsp)
...
lb_files_10sift_names:
    .seh_proc lb_files_10sift_names
    pushq %rbp
    .seh_pushreg %rbp
    subq $352, %rsp
    .seh_stackalloc 352
...
lb_files_12release_list:
    .seh_proc lb_files_12release_list
    pushq %rbp
    .seh_pushreg %rbp
    subq $208, %rsp
    .seh_stackalloc 208
...
lb_files_15release_entries:
    .seh_proc lb_files_15release_entries
    pushq %rbp
    .seh_pushreg %rbp
    subq $400, %rsp
    .seh_stackalloc 400
...
.L14_11:
    ...
    .section .text$lb_memory_copy_0g1_str,"xr"
    .p2align 4
    .globl lb_memory_copy_0g1_str
lb_memory_copy_0g1_str:
    .seh_proc lb_memory_copy_0g1_str
    pushq %rbp
    .seh_pushreg %rbp
    subq $288, %rsp
    .seh_stackalloc 288
...
.Ltext_3:
    .asciz "src/std/files/directory.lucb:15:13"
.Ltext_4:
...
.Ltext_7:
    .asciz "src/std/files/directory.lucb:48:13"
.Ltext_8:
    .asciz "."
.Ltext_9:
    .asciz ".."
...
.Ltext_11:
    .asciz "src/std/files/directory.lucb:89:9"
.Ltext_12:
