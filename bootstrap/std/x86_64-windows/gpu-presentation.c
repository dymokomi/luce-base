...
lb_r_void_0p lb_gpu_20backend_surface_open(struct lb_gpu_DeviceState* lb_device, lb_window_Presentation lb_host) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/gpu/presentation.lucb:4:5";
    if (!!((lb_platform_windows && ((lb_device)->backend == ((uint8_t)2u))))) 
    {
        lb_pos = "src/std/gpu/presentation.lucb:5:9";
        void* _lb_ret7 = ((void*)((({ lb_r_gpu_VulkanSurface_0p _lb_r8 = lb_gpu_19vulkan_surface_open(((struct lb_gpu_VulkanDevice*)((lb_device)->native)), lb_host); if (_lb_r8.failed) {
...
lb_r_gpu_PresentResult lb_gpu_21backend_clear_present(struct lb_gpu_DeviceState* lb_device, lb_window_Presentation lb_host, void* lb_native, lb_gpu_Color lb_color) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/gpu/presentation.lucb:12:5";
    if (!!((lb_platform_windows && ((lb_device)->backend == ((uint8_t)2u))))) 
    {
        lb_pos = "src/std/gpu/presentation.lucb:13:9";
        uint8_t _lb_ret10 = (({ lb_r_gpu_PresentResult _lb_r11 = ({ struct lb_gpu_VulkanDevice* _lb_sq12 __attribute__((unused)) = ((struct lb_gpu_VulkanDevice*)((lb_device)->native)); lb_window_Presentation _lb_sq13 __attribute__((unused)) = lb_host; struct lb_gpu_VulkanSurface* _lb_sq14 __attribute__((unused)) = ((struct lb_gpu_VulkanSurface*)(lb_native)); lb_gpu_Canvas _lb_sq15 __attribute__((unused)) = ((lb_gpu_Canvas){}); lb_gpu_Color _lb_sq16 __attribute__((unused)) = lb_color; lb_gpu_13vulkan_render(_lb_sq12, _lb_sq13, _lb_sq14, _lb_sq15, _lb_sq16); }); if (_lb_r11.failed) {
...
lb_r_unit lb_gpu_20backend_surface_wait(struct lb_gpu_DeviceState* lb_device, void* lb_native) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/gpu/presentation.lucb:20:5";
    if (!!((lb_platform_windows && ((lb_device)->backend == ((uint8_t)2u))))) 
    {
        lb_pos = "src/std/gpu/presentation.lucb:21:9";
        (void)((({ lb_r_unit _lb_r18 = ({ int32_t _lb_sq19 __attribute__((unused)) = lb_x_gpu_vkQueueWaitIdle(((((struct lb_gpu_VulkanDevice*)((lb_device)->native))))->queue); lb_str _lb_sq20 __attribute__((unused)) = ((lb_str){"Vulkan execution failed", 23}); lb_gpu_12vulkan_check(_lb_sq19, _lb_sq20); }); if (_lb_r18.failed) {
            return ((lb_r_unit){ .error = _lb_r18.error, .failed = true });
        } (void)0; })));
        lb_pos = "src/std/gpu/presentation.lucb:22:9";
        return ((lb_r_unit){ .failed = false });
    }
    {
    }
    lb_pos = "src/std/gpu/presentation.lucb:27:5";
    lb_r_unit _lb_err21 = ((lb_r_unit){ .error = { .code = (int32_t)(lb_gpu_unsupported), .message = ((lb_str){"the GPU backend is not implemented", 34}) }, .failed = true });
    return _lb_err21;
    return ((lb_r_unit){ .failed = false });
}
lb_r_gpu_PresentResult lb_gpu_14backend_render(struct lb_gpu_DeviceState* lb_device, lb_window_Presentation lb_host, void* lb_native, lb_gpu_Canvas lb_canvas, lb_gpu_Color lb_color) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/gpu/presentation.lucb:30:5";
    if (!!((lb_platform_windows && ((lb_device)->backend == ((uint8_t)2u))))) 
    {
        lb_pos = "src/std/gpu/presentation.lucb:31:9";
        uint8_t _lb_ret22 = (({ lb_r_gpu_PresentResult _lb_r23 = lb_gpu_13vulkan_render(((struct lb_gpu_VulkanDevice*)((lb_device)->native)), lb_host, ((struct lb_gpu_VulkanSurface*)(lb_native)), lb_canvas, lb_color); if (_lb_r23.failed) {
            return ((lb_r_gpu_PresentResult){ .error = _lb_r23.error, .failed = true });
        } _lb_r23.value; }));
        return ((lb_r_gpu_PresentResult){ .value = _lb_ret22, .failed = false });
    }
    {
    }
    lb_pos = "src/std/gpu/presentation.lucb:35:5";
    lb_r_gpu_PresentResult _lb_err24 = ((lb_r_gpu_PresentResult){ .error = { .code = (int32_t)(lb_gpu_unsupported), .message = ((lb_str){"the GPU backend is not implemented", 34}) }, .failed = true });
    return _lb_err24;
    lb_trap("unreachable");
}
void lb_gpu_23backend_surface_destroy(struct lb_gpu_DeviceState* lb_device, lb_window_Presentation lb_host, void* lb_native) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/gpu/presentation.lucb:38:5";
    if (!!((lb_platform_windows && ((lb_device)->backend == ((uint8_t)2u))))) 
    {
        lb_pos = "src/std/gpu/presentation.lucb:39:9";
        (void)(lb_gpu_22vulkan_surface_destroy(((struct lb_gpu_VulkanDevice*)((lb_device)->native)), ((struct lb_gpu_VulkanSurface*)(lb_native))));
        lb_pos = "src/std/gpu/presentation.lucb:40:9";
        return;
    }
    {
    }
