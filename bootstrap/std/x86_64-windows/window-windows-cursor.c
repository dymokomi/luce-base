...
lb_r_unit lb_window_14win_set_cursor(struct lb_window_State* lb_state, uint8_t lb_cursor) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/window/windows/cursor.lucb:22:5";
    if (!!(((!((lb_state)->native_cursor == ((void*)0))) && ((lb_state)->cursor == lb_cursor)))) 
    {
        lb_pos = "src/std/window/windows/cursor.lucb:22:5";
        return ((lb_r_unit){ .failed = false });
    }
    lb_pos = "src/std/window/windows/cursor.lucb:23:5";
    if (!!((((lb_state)->native_cursor == ((void*)0)) || (!((lb_state)->cursor == lb_cursor))))) 
    {
        lb_pos = "src/std/window/windows/cursor.lucb:24:9";
        (lb_state)->native_cursor = (({ lb_r_void_0p _lb_r11 = lb_window_10win_cursor(lb_cursor); if (_lb_r11.failed) {
            return ((lb_r_unit){ .error = _lb_r11.error, .failed = true });
        } _lb_r11.value; }));
        lb_pos = "src/std/window/windows/cursor.lucb:25:9";
        (lb_state)->cursor = lb_cursor;
    }
    lb_pos = "src/std/window/windows/cursor.lucb:26:5";
    void* lb_native __attribute__((unused)) = lb_window_required((lb_state)->native);
    lb_pos = "src/std/window/windows/cursor.lucb:27:5";
    WinPoint lb_point __attribute__((unused)) = {};
    lb_pos = "src/std/window/windows/cursor.lucb:28:5";
    if (!!(({ void* _lb_sq12 __attribute__((unused)) = lb_x_window_GetCapture(); void* _lb_sq13 __attribute__((unused)) = lb_native; (_lb_sq12 == _lb_sq13); }))) 
    {
        lb_pos = "src/std/window/windows/cursor.lucb:29:9";
        (void)(((void)(lb_x_window_SetCursor((lb_state)->native_cursor))));
    }
    else {
        lb_pos = "src/std/window/windows/cursor.lucb:30:5";
        if (!!((({ int32_t _lb_sq14 __attribute__((unused)) = lb_x_window_GetCursorPos(&(lb_point)); int32_t _lb_sq15 __attribute__((unused)) = 0LL; (!(_lb_sq14 == _lb_sq15)); }) && ({ void* _lb_sq16 __attribute__((unused)) = lb_x_window_WindowFromPoint(lb_point); void* _lb_sq17 __attribute__((unused)) = lb_native; (_lb_sq16 == _lb_sq17); })))) 
        {
            lb_pos = "src/std/window/windows/cursor.lucb:31:9";
            (void)(((void)(lb_x_window_ScreenToClient(lb_native, &(lb_point)))));
            lb_pos = "src/std/window/windows/cursor.lucb:32:9";
            WinRect lb_bounds __attribute__((unused)) = {};
            lb_pos = "src/std/window/windows/cursor.lucb:33:9";
            if (!!(((((({ int32_t _lb_sq18 __attribute__((unused)) = lb_x_window_GetClientRect(lb_native, &(lb_bounds)); int32_t _lb_sq19 __attribute__((unused)) = 0LL; (!(_lb_sq18 == _lb_sq19)); }) && (((int32_t)(lb_point.x)) >= ((int32_t)(0LL)))) && (((int32_t)(lb_point.y)) >= ((int32_t)(0LL)))) && (((int32_t)(lb_point.x)) < ((int32_t)(lb_bounds.right)))) && (((int32_t)(lb_point.y)) < ((int32_t)(lb_bounds.bottom)))))) 
            {
                lb_pos = "src/std/window/windows/cursor.lucb:34:13";
                (void)(((void)(lb_x_window_SetCursor((lb_state)->native_cursor))));
            }
        }
    }
