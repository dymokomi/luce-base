...
lb_files_text_0init:
    ...
    movups 0(%r10), %xmm8
    movups %xmm8, 0(%r11)
    leaq lb_files_Entries_close(%rip), %r12
    movq $16, %rcx
    movq %rbx, %r13
    addq %rcx, %r13
    movq %r13, %r10
...
lb_files_10write_text:
    .seh_proc lb_files_10write_text
    pushq %rbp
    .seh_pushreg %rbp
    subq $1168, %rsp
    .seh_stackalloc 1168
...
lb_files_13absolute_path:
    .seh_proc lb_files_13absolute_path
    pushq %rbp
    .seh_pushreg %rbp
    subq $496, %rsp
    .seh_stackalloc 496
...
lb_files_Entries_init:
    .seh_proc lb_files_Entries_init
    pushq %rbp
    .seh_pushreg %rbp
    subq $544, %rsp
    .seh_stackalloc 544
...
lb_files_Entries_count:
    .seh_proc lb_files_Entries_count
    pushq %rbp
    .seh_pushreg %rbp
    subq $192, %rsp
    .seh_stackalloc 192
...
lb_files_Entries_name:
    .seh_proc lb_files_Entries_name
    pushq %rbp
    .seh_pushreg %rbp
    subq $416, %rsp
    .seh_stackalloc 416
...
lb_files_Entries_close:
    .seh_proc lb_files_Entries_close
    pushq %rbp
    .seh_pushreg %rbp
    subq $256, %rsp
    .seh_stackalloc 256
...
lb_files_16ensure_directory:
    .seh_proc lb_files_16ensure_directory
    pushq %rbp
    .seh_pushreg %rbp
    subq $576, %rsp
    .seh_stackalloc 576
...
lb_files_14home_directory:
    .seh_proc lb_files_14home_directory
    pushq %rbp
    .seh_pushreg %rbp
    subq $416, %rsp
    .seh_stackalloc 416
...
lb_files_11create_text:
    .seh_proc lb_files_11create_text
    pushq %rbp
    .seh_pushreg %rbp
    subq $608, %rsp
    .seh_stackalloc 608
...
lb_files_14make_directory:
    .seh_proc lb_files_14make_directory
    pushq %rbp
    .seh_pushreg %rbp
    subq $368, %rsp
    .seh_stackalloc 368
...
lb_files_11delete_path:
    .seh_proc lb_files_11delete_path
    pushq %rbp
    .seh_pushreg %rbp
    subq $608, %rsp
    .seh_stackalloc 608
