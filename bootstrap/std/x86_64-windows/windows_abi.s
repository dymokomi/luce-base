...
lb_11windows_abi_0init:
    .seh_proc lb_11windows_abi_0init
    pushq %rbp
    .seh_pushreg %rbp
    subq $192, %rsp
    .seh_stackalloc 192
...
.Lvsign64:
    ...
    .section .data$lb_11windows_abi_9utf8_page,"dw"
    .globl lb_11windows_abi_9utf8_page
    .p2align 2
lb_11windows_abi_9utf8_page:
    .zero 4

    .section .data$lb_11windows_abi_19reject_invalid_utf8,"dw"
    .globl lb_11windows_abi_19reject_invalid_utf8
    .p2align 2
lb_11windows_abi_19reject_invalid_utf8:
    .zero 4

    .section .data$lb_11windows_abi_20reject_invalid_utf16,"dw"
