...
lb_r_str lb_process_16environment_name(char* lb_entry) {
    ...
    lb_str lb_text __attribute__((unused)) = ({ const char* _lb_sb7 = lb_entry; size_t _lb_sl7 = _lb_sb7 == NULL ? 0 : strlen(_lb_sb7); (lb_str){ _lb_sb7, _lb_sl7 }; });
    ...
    for (size_t lb_index __attribute__((unused)) = (size_t)(0ULL); lb_index < (size_t)((lb_text.length)); lb_index++) {
        {
            ...
            if (!!(((*({ lb_cspan _lb_ix9 = ((lb_cspan){(void*)(lb_text.data), lb_text.length}); &((uint8_t*)_lb_ix9.data)[lb_at((uint64_t)(lb_index), _lb_ix9.length)]; })) == 61u))) 
            {
                ...
                lb_str _lb_ret10 = ({ lb_span _lb_sc11 = ({ lb_span _lb_sv12 = ((lb_cspan){(void*)(lb_text.data), lb_text.length}); size_t _lb_sn12 = _lb_sv12.length; uint8_t* _lb_sd12 = (uint8_t*)_lb_sv12.data; size_t _lb_ss12 = 0; size_t _lb_se12 = (size_t)(lb_index); lb_check_index(_lb_ss12, _lb_sn12 + 1); lb_check_index(_lb_se12, _lb_sn12 + 1); if (_lb_ss12 > _lb_se12) lb_trap("index out of bounds"); (lb_cspan){ (void*)(_lb_sd12 + _lb_ss12), _lb_se12 - _lb_ss12 }; }); const char* _lb_sb11 = (const char*)_lb_sc11.data; size_t _lb_sl11 = _lb_sc11.length; (lb_str){ _lb_sb11, _lb_sl11 }; });
                return ((lb_r_str){ .value = _lb_ret10, .failed = false });
            }
        }
    }
    lb_pos = "src/std/process/environment/posix.lucb:19:5";
    lb_r_str _lb_err13 = ((lb_r_str){ .error = { .code = (int32_t)(lb_process_failed), .message = ((lb_str){"an environment override must be NAME=value with a nonempty name", 63}) }, .failed = true });
    return _lb_err13;
    lb_trap("unreachable");
}
__attribute__((weak)) void lb_interop_Packet_0g1_str_init(lb_interop_Packet_0g1_str* self, lb_str lb_value, void* lb_storage, lb_fn_0F1_void_0p_unit lb_dispose) {
