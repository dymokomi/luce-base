...
lb_a_5c_str_0a2 lb_gpu_25vulkan_windows_extensions = ((lb_a_5c_str_0a2){{("VK_KHR_surface"), ("VK_KHR_win32_surface")}});
...
bool lb_gpu_22vulkan_windows_support(uint64_t lb_physical, uint32_t lb_family) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/gpu/vulkan/presentation/windows.lucb:8:5";
    bool _lb_ret7 = ({ uint32_t _lb_sq8 __attribute__((unused)) = lb_x_gpu_vkGetPhysicalDeviceWin32PresentationSupportKHR(lb_physical, lb_family); uint32_t _lb_sq9 __attribute__((unused)) = lb_gpu_8VK_FALSE; (!(_lb_sq8 == _lb_sq9)); });
    return _lb_ret7;
    lb_trap("unreachable");
}
lb_r_u64 lb_gpu_22vulkan_windows_surface(uint64_t lb_instance, lb_window_Presentation lb_host) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/gpu/vulkan/presentation/windows.lucb:11:5";
    VkWin32SurfaceCreateInfoKHR lb_info __attribute__((unused)) = ({ uint32_t _lb_sq10 __attribute__((unused)) = lb_gpu_47VK_STRUCTURE_TYPE_WIN32_SURFACE_CREATE_INFO_KHR; void* _lb_sq11 __attribute__((unused)) = ({ void* _lb_fr = lb_x_11windows_abi_GetModuleHandleW(((void*)0)); if (!_lb_fr) lb_trap("null_foreign"); _lb_fr; }); void* _lb_sq12 __attribute__((unused)) = (({ lb_r_void_0p _lb_r13 = lb_window_Presentation_14windows_handle(&(lb_host)); if (_lb_r13.failed) {
        return ((lb_r_u64){ .error = _lb_r13.error, .failed = true });
    } _lb_r13.value; })); ((VkWin32SurfaceCreateInfoKHR){.sType = _lb_sq10, .hinstance = _lb_sq11, .hwnd = _lb_sq12}); });
    lb_pos = "src/std/gpu/vulkan/presentation/windows.lucb:13:5";
    uint64_t lb_surface __attribute__((unused)) = 0ULL;
    lb_pos = "src/std/gpu/vulkan/presentation/windows.lucb:14:5";
    (void)((({ lb_r_unit _lb_r14 = ({ int32_t _lb_sq15 __attribute__((unused)) = lb_x_gpu_vkCreateWin32SurfaceKHR(lb_instance, &(lb_info), ((void*)0), &(lb_surface)); lb_str _lb_sq16 __attribute__((unused)) = ((lb_str){"the Vulkan Windows surface could not be created", 47}); lb_gpu_12vulkan_check(_lb_sq15, _lb_sq16); }); if (_lb_r14.failed) {
        return ((lb_r_u64){ .error = _lb_r14.error, .failed = true });
    } (void)0; })));
    lb_pos = "src/std/gpu/vulkan/presentation/windows.lucb:15:5";
    uint64_t _lb_ret17 = lb_surface;
    return ((lb_r_u64){ .value = _lb_ret17, .failed = false });
    lb_trap("unreachable");
}
__attribute__((weak)) void lb_interop_Packet_0g1_str_init(lb_interop_Packet_0g1_str* self, lb_str lb_value, void* lb_storage, lb_fn_0F1_void_0p_unit lb_dispose) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
