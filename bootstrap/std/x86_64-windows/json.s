...
lb_json_0init:
    ...
    movups 0(%r10), %xmm8
    movups %xmm8, 0(%r11)
    leaq lb_json_Value_close(%rip), %r12
    movq $16, %rcx
    movq %rbx, %r13
    addq %rcx, %r13
    movq %r13, %r10
...
lb_json_Bytes_reserve:
    .seh_proc lb_json_Bytes_reserve
    pushq %rbp
    .seh_pushreg %rbp
    subq $480, %rsp
    .seh_stackalloc 480
...
lb_json_Value_own:
    ...
    movq 16(%rsp), %r8
    movq 24(%rsp), %r9
    call lb_interop_Reference_0g1_json_Value_adopt
    addq $96, %rsp
    leaq 8(%rbp), %r12
    movq $32, %rcx
    movq %r12, %rbx
...
lb_json_Value_integer:
    .seh_proc lb_json_Value_integer
    pushq %rbp
    .seh_pushreg %rbp
    subq $448, %rsp
    .seh_stackalloc 448
...
lb_json_Value_boolean:
    .seh_proc lb_json_Value_boolean
    pushq %rbp
    .seh_pushreg %rbp
    subq $368, %rsp
    .seh_stackalloc 368
...
lb_json_Value_set:
    ...
    movq 0(%rsp), %rcx
    movq 8(%rsp), %rdx
    call lb_interop_Reference_0g1_json_Value_get
    addq $32, %rsp
    leaq 32(%rbp), %r14
    movq $32, %rcx
    movq %r14, %r12
...
lb_json_Value_8set_text:
    .seh_proc lb_json_Value_8set_text
    pushq %rbp
    .seh_pushreg %rbp
    subq $384, %rsp
    .seh_stackalloc 384
...
lb_json_Value_11set_integer:
    .seh_proc lb_json_Value_11set_integer
    pushq %rbp
    .seh_pushreg %rbp
    subq $384, %rsp
    .seh_stackalloc 384
...
lb_json_Value_10set_number:
    .seh_proc lb_json_Value_10set_number
    pushq %rbp
    .seh_pushreg %rbp
    subq $384, %rsp
    .seh_stackalloc 384
...
lb_json_Value_11set_boolean:
    .seh_proc lb_json_Value_11set_boolean
    pushq %rbp
    .seh_pushreg %rbp
    subq $384, %rsp
    .seh_stackalloc 384
...
.L24_8:
    ...
    .section .text$lb_interop_Reference_0g1_json_Value_adopt,"xr"
    .p2align 4
    .globl lb_interop_Reference_0g1_json_Value_adopt
lb_interop_Reference_0g1_json_Value_adopt:
    .seh_proc lb_interop_Reference_0g1_json_Value_adopt
    pushq %rbp
    .seh_pushreg %rbp
    subq $560, %rsp
    .seh_stackalloc 560
...
.L25_3:
    ...
    movq 8(%rsp), %rdx
    movq 16(%rsp), %r8
    call lb_interop_Reservation_0g1_json_Value_init
    addq $80, %rsp
    leaq 112(%rbp), %r14
    leaq 72(%rbp), %rbx
    movq $8, %rcx
...
.L25_5:
    ...
    movq 8(%rsp), %rdx
    movq 16(%rsp), %r8
    call lb_interop_Reservation_0g1_json_Value_publish
    addq $48, %rsp
    leaq 48(%rbp), %r10
    movq %rax, 0(%r10)
    leaq 48(%rbp), %rbx
...
.L25_11:
    ...
    .section .text$lb_interop_Reference_0g1_json_Value_get,"xr"
    .p2align 4
    .globl lb_interop_Reference_0g1_json_Value_get
lb_interop_Reference_0g1_json_Value_get:
    .seh_proc lb_interop_Reference_0g1_json_Value_get
    pushq %rbp
    .seh_pushreg %rbp
    subq $304, %rsp
    .seh_stackalloc 304
...
.L26_8:
    ...
    .section .text$lb_interop_Reference_0g1_json_Value_release,"xr"
    .p2align 4
    .globl lb_interop_Reference_0g1_json_Value_release
lb_interop_Reference_0g1_json_Value_release:
    .seh_proc lb_interop_Reference_0g1_json_Value_release
    pushq %rbp
    .seh_pushreg %rbp
    subq $192, %rsp
    .seh_stackalloc 192
    ...
    .section .text$lb_interop_Reservation_0g1_json_Value_init,"xr"
    .p2align 4
    .globl lb_interop_Reservation_0g1_json_Value_init
lb_interop_Reservation_0g1_json_Value_init:
    .seh_proc lb_interop_Reservation_0g1_json_Value_init
    pushq %rbp
    .seh_pushreg %rbp
    subq $512, %rsp
    .seh_stackalloc 512
...
.L28_3:
    ...
    movq %r15, %r10
    movq %rax, (%r10)
    leaq lb_interop_Owner_0g1_json_Value_12finish_owner(%rip), %r15
    movq $24, %rcx
    movq %r14, %r13
    addq %rcx, %r13
    movq %r13, %r10
    movq %r15, (%r10)
    leaq lb_interop_Owner_0g1_json_Value_10drop_owner(%rip), %r13
    movq $32, %rcx
    movq %r14, %r15
    addq %rcx, %r15
    movq %r15, %r10
    movq %r13, (%r10)
    leaq lb_interop_Owner_0g1_json_Value_11trace_owner(%rip), %r13
    movq $40, %rcx
    movq %r14, %r15
    addq %rcx, %r15
    movq %r15, %r10
...
.L28_7:
    ...
    .section .text$lb_interop_Reservation_0g1_json_Value_publish,"xr"
    .p2align 4
    .globl lb_interop_Reservation_0g1_json_Value_publish
lb_interop_Reservation_0g1_json_Value_publish:
    .seh_proc lb_interop_Reservation_0g1_json_Value_publish
    pushq %rbp
    .seh_pushreg %rbp
    subq $320, %rsp
    .seh_stackalloc 320
...
.L29_7:
    ...
    .section .text$lb_interop_Owner_0g1_json_Value_12finish_owner,"xr"
    .p2align 4
    .globl lb_interop_Owner_0g1_json_Value_12finish_owner
lb_interop_Owner_0g1_json_Value_12finish_owner:
    .seh_proc lb_interop_Owner_0g1_json_Value_12finish_owner
    pushq %rbp
    .seh_pushreg %rbp
    subq $208, %rsp
    .seh_stackalloc 208
    ...
    movq %rax, 0(%rsp)
    movq 0(%rsp), %rcx
    call lb_interop_11close_owner_0g1_json_Value
    addq $32, %rsp
    movq 200(%rbp), %rdi
    movq 192(%rbp), %rsi
    movdqu 176(%rbp), %xmm6
    ...
    .section .text$lb_interop_Owner_0g1_json_Value_10drop_owner,"xr"
    .p2align 4
    .globl lb_interop_Owner_0g1_json_Value_10drop_owner
lb_interop_Owner_0g1_json_Value_10drop_owner:
    .seh_proc lb_interop_Owner_0g1_json_Value_10drop_owner
    pushq %rbp
    .seh_pushreg %rbp
    subq $320, %rsp
    .seh_stackalloc 320
...
.L31_3:
    ...
    .section .text$lb_interop_Owner_0g1_json_Value_11trace_owner,"xr"
    .p2align 4
    .globl lb_interop_Owner_0g1_json_Value_11trace_owner
lb_interop_Owner_0g1_json_Value_11trace_owner:
    .seh_proc lb_interop_Owner_0g1_json_Value_11trace_owner
    pushq %rbp
    .seh_pushreg %rbp
    subq $256, %rsp
    .seh_stackalloc 256
...
.L32_7:
    ...
    .section .text$lb_interop_Reference_0g1_json_Value_init,"xr"
    .p2align 4
    .globl lb_interop_Reference_0g1_json_Value_init
lb_interop_Reference_0g1_json_Value_init:
    .seh_proc lb_interop_Reference_0g1_json_Value_init
    pushq %rbp
    .seh_pushreg %rbp
    subq $224, %rsp
    .seh_stackalloc 224
    ...
    .section .text$lb_interop_11close_owner_0g1_json_Value,"xr"
    .p2align 4
    .globl lb_interop_11close_owner_0g1_json_Value
lb_interop_11close_owner_0g1_json_Value:
    .seh_proc lb_interop_11close_owner_0g1_json_Value
    pushq %rbp
    .seh_pushreg %rbp
    subq $224, %rsp
    .seh_stackalloc 224
...
.L34_5:
    ...
    movq %rax, 0(%rsp)
    movq 0(%rsp), %rcx
    call lb_interop_13dispose_owner_0g1_json_Value
    addq $32, %rsp
    jmp .L34_7
.L34_6:
.L34_7:
    ...
    .section .text$lb_interop_13dispose_owner_0g1_json_Value,"xr"
    .p2align 4
    .globl lb_interop_13dispose_owner_0g1_json_Value
lb_interop_13dispose_owner_0g1_json_Value:
    .seh_proc lb_interop_13dispose_owner_0g1_json_Value
    pushq %rbp
    .seh_pushreg %rbp
    subq $224, %rsp
    .seh_stackalloc 224
