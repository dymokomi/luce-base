...
lb_net_readiness_0init:
    .seh_proc lb_net_readiness_0init
    pushq %rbp
    .seh_pushreg %rbp
    subq $176, %rsp
    .seh_stackalloc 176
...
lb_net_Deadline_after:
    .seh_proc lb_net_Deadline_after
    pushq %rbp
    .seh_pushreg %rbp
    subq $400, %rsp
    .seh_stackalloc 400
...
lb_net_Cancellation_request:
    .seh_proc lb_net_Cancellation_request
    pushq %rbp
    .seh_pushreg %rbp
    subq $192, %rsp
    .seh_stackalloc 192
...
lb_net_Cancellation_12is_requested:
    .seh_proc lb_net_Cancellation_12is_requested
    pushq %rbp
    .seh_pushreg %rbp
    subq $192, %rsp
    .seh_stackalloc 192
...
lb_net_Poller_capacity:
    .seh_proc lb_net_Poller_capacity
    pushq %rbp
    .seh_pushreg %rbp
    subq $192, %rsp
    .seh_stackalloc 192
...
lb_net_Poller_watch:
    ...
    movq 8(%rsp), %rdx
    movq 16(%rsp), %r8
    call lb_net_Poller_10check_slot
    addq $32, %rsp
    leaq 136(%rbp), %r14
    movq $24, %rcx
    movq %r14, %r12
...
lb_net_Poller_disable:
    .seh_proc lb_net_Poller_disable
    pushq %rbp
    .seh_pushreg %rbp
    subq $320, %rsp
    .seh_stackalloc 320
...
lb_net_Poller_readiness:
    .seh_proc lb_net_Poller_readiness
    pushq %rbp
    .seh_pushreg %rbp
    subq $320, %rsp
    .seh_stackalloc 320
...
lb_net_Poller_destroy:
    .seh_proc lb_net_Poller_destroy
    pushq %rbp
    .seh_pushreg %rbp
    subq $352, %rsp
    .seh_stackalloc 352
...
lb_net_Poller_10check_slot:
    .seh_proc lb_net_Poller_10check_slot
    pushq %rbp
    .seh_pushreg %rbp
    subq $304, %rsp
    .seh_stackalloc 304
...
lb_net_13poll_interest:
    .seh_proc lb_net_13poll_interest
    pushq %rbp
    .seh_pushreg %rbp
    subq $288, %rsp
    .seh_stackalloc 288
...
lb_net_14poll_readiness:
    .seh_proc lb_net_14poll_readiness
    pushq %rbp
    .seh_pushreg %rbp
    subq $256, %rsp
    .seh_stackalloc 256
...
lb_net_18check_cancellation:
    .seh_proc lb_net_18check_cancellation
    pushq %rbp
    .seh_pushreg %rbp
    subq $272, %rsp
    .seh_stackalloc 272
...
.L16_1:
    ...
    movq %rax, 0(%rsp)
    movq 0(%rsp), %rcx
    call lb_net_Cancellation_12is_requested
    addq $32, %rsp
    movl %eax, %r12d
    testl %r12d, %r12d
    jne .L16_5
...
lb_net_21monotonic_nanoseconds:
    .seh_proc lb_net_21monotonic_nanoseconds
    pushq %rbp
    .seh_pushreg %rbp
    subq $400, %rsp
    .seh_stackalloc 400
...
lb_net_15check_operation:
    .seh_proc lb_net_15check_operation
    pushq %rbp
    .seh_pushreg %rbp
    subq $368, %rsp
    .seh_stackalloc 368
...
.Ltext_28:
    .asciz "src/std/net/readiness.lucb:137:9"
.Ltext_29:
    .asciz "src/std/net/readiness.lucb:148:9"
.Ltext_30:
