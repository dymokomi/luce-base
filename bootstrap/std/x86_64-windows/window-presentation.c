...
lb_r_window_Size lb_window_Presentation_size(const lb_window_Presentation* self) {
    ...
    {
        lb_pos = "src/std/window/presentation.lucb:13:13";
        lb_window_Size _lb_ret8 = lb_window_8win_size(lb_state);
...
lb_r_bool lb_window_Presentation_visible(const lb_window_Presentation* self) {
    ...
    {
        lb_pos = "src/std/window/presentation.lucb:24:13";
        void* lb_native __attribute__((unused)) = lb_window_required((lb_state)->native);
        lb_pos = "src/std/window/presentation.lucb:25:13";
        bool _lb_ret10 = (({ int32_t _lb_sq11 __attribute__((unused)) = lb_x_window_IsWindowVisible(lb_native); int32_t _lb_sq12 __attribute__((unused)) = 0LL; (!(_lb_sq11 == _lb_sq12)); }) && ({ int32_t _lb_sq13 __attribute__((unused)) = lb_x_window_IsIconic(lb_native); int32_t _lb_sq14 __attribute__((unused)) = 0LL; (_lb_sq13 == _lb_sq14); }));
...
lb_r_void_0p lb_window_Presentation_10macos_view(const lb_window_Presentation* self) {
    ...
    lb_r_void_0p _lb_err16 = ((lb_r_void_0p){ .error = { .code = (int32_t)(lb_window_unsupported), .message = ((lb_str){"this window has no macOS view", 29}) }, .failed = true });
    return _lb_err16;
    lb_trap("unreachable");
}
lb_r_void_0p lb_window_Presentation_14windows_handle(const lb_window_Presentation* self) {
    ...
    {
        lb_pos = "src/std/window/presentation.lucb:42:13";
        void* _lb_ret18 = lb_window_required((lb_state)->native);
        return ((lb_r_void_0p){ .value = _lb_ret18, .failed = false });
    }
    lb_trap("unreachable");
}
void lb_window_Presentation_destroy(lb_window_Presentation* self) {
    ...
    lb_pos = "src/std/window/presentation.lucb:55:9";
    if (!!((lb_platform_windows && (lb_state)->destroyed))) 
    {
        lb_pos = "src/std/window/presentation.lucb:56:13";
