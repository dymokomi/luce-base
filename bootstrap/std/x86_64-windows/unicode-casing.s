...
lb_unicode_casing_0init:
    .seh_proc lb_unicode_casing_0init
    pushq %rbp
    .seh_pushreg %rbp
    subq $176, %rsp
    .seh_stackalloc 176
...
lb_unicode_9case_pass:
    ...
    movq %rcx, 1624(%rbp)
    movq %rdi, 1800(%rbp)
    .seh_savereg %rdi, 1800
    movq %rsi, 1792(%rbp)
    .seh_savereg %rsi, 1792
    movdqu %xmm6, 1776(%rbp)
    .seh_savexmm %xmm6, 1776
    movdqu %xmm7, 1760(%rbp)
    .seh_savexmm %xmm7, 1760
    movdqu %xmm8, 1744(%rbp)
    .seh_savexmm %xmm8, 1744
    movdqu %xmm9, 1728(%rbp)
    .seh_savexmm %xmm9, 1728
    movdqu %xmm10, 1712(%rbp)
    .seh_savexmm %xmm10, 1712
    movdqu %xmm11, 1696(%rbp)
    .seh_savexmm %xmm11, 1696
    movdqu %xmm12, 1680(%rbp)
    .seh_savexmm %xmm12, 1680
    movdqu %xmm13, 1664(%rbp)
    .seh_savexmm %xmm13, 1664
    movdqu %xmm14, 1648(%rbp)
    .seh_savexmm %xmm14, 1648
    movdqu %xmm15, 1632(%rbp)
    .seh_savexmm %xmm15, 1632
    movq %rbx, 1616(%rbp)
    .seh_savereg %rbx, 1616
    movq %r12, 1608(%rbp)
    .seh_savereg %r12, 1608
    movq %r13, 1600(%rbp)
    .seh_savereg %r13, 1600
    movq %r14, 1592(%rbp)
    .seh_savereg %r14, 1592
    movq %r15, 1584(%rbp)
    .seh_savereg %r15, 1584
    .seh_endprologue
    movq %rcx, 1824(%rbp)
    movq %rdx, 1832(%rbp)
    movq %r8, 1840(%rbp)
...
.L5_5:
    ...
    movq 1800(%rbp), %rdi
    movq 1792(%rbp), %rsi
    movdqu 1776(%rbp), %xmm6
    movdqu 1760(%rbp), %xmm7
    movdqu 1744(%rbp), %xmm8
    movdqu 1728(%rbp), %xmm9
    movdqu 1712(%rbp), %xmm10
    movdqu 1696(%rbp), %xmm11
    movdqu 1680(%rbp), %xmm12
    movdqu 1664(%rbp), %xmm13
    movdqu 1648(%rbp), %xmm14
    movdqu 1632(%rbp), %xmm15
    movq 1616(%rbp), %rbx
    movq 1608(%rbp), %r12
    movq 1600(%rbp), %r13
    movq 1592(%rbp), %r14
...
.L5_47:
    ...
    movq 0(%rsp), %rcx
    movq 8(%rsp), %rdx
    call lb_unicode_16identity_mapping
    addq $32, %rsp
    movq 392(%rbp), %r10
    movq 384(%rbp), %r11
    movups 0(%r10), %xmm8
