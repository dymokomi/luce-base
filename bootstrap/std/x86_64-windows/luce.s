...
lb_luce_0init:
    ...
    movq %r13, %r10
    movq %rax, (%r10)
    leaq lb_luce_file(%rip), %r13
    movq %r12, %r10
    movq %r13, %r11
    movups 0(%r10), %xmm8
    movups %xmm8, 0(%r11)
    leaq lb_luce_line(%rip), %r12
    movl $0, %eax
    movq %r12, %r10
    movl %eax, (%r10)
    leaq 80(%rbp), %r12
...
.Ltext_0:
    ...
    .section .data$lb_luce_file,"dw"
    .globl lb_luce_file
    .p2align 3
lb_luce_file:
    .zero 16

    .section .data$lb_luce_line,"dw"
    .globl lb_luce_line
    .p2align 2
lb_luce_line:
    .zero 4

    .section .data$lb_luce_function,"dw"
    .globl lb_luce_function
    .p2align 3
lb_luce_function:
    .zero 16

    .section .data$lb_luce_location,"dw"
