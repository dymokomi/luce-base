...
lb_net_10ip_address_0init:
    .seh_proc lb_net_10ip_address_0init
    pushq %rbp
    .seh_pushreg %rbp
    subq $176, %rsp
    .seh_stackalloc 176
...
lb_net_IpAddress_9from_ipv4:
    .seh_proc lb_net_IpAddress_9from_ipv4
    pushq %rbp
    .seh_pushreg %rbp
    subq $304, %rsp
    .seh_stackalloc 304
...
lb_net_IpAddress_10from_bytes:
    .seh_proc lb_net_IpAddress_10from_bytes
    pushq %rbp
    .seh_pushreg %rbp
    subq $384, %rsp
    .seh_stackalloc 384
...
lb_net_IpAddress_parse:
    .seh_proc lb_net_IpAddress_parse
    pushq %rbp
    .seh_pushreg %rbp
    subq $416, %rsp
    .seh_stackalloc 416
...
.L3_31:
    ...
    movq %rax, 0(%rsp)
    movq 0(%rsp), %rcx
    call lb_net_17parse_ipv4_number
    addq $48, %rsp
    leaq 108(%rbp), %r10
    movq %rax, 0(%r10)
    leaq 108(%rbp), %r12
...
lb_net_IpAddress_version:
    .seh_proc lb_net_IpAddress_version
    pushq %rbp
    .seh_pushreg %rbp
    subq $192, %rsp
    .seh_stackalloc 192
...
lb_net_IpAddress_11ipv4_number:
    .seh_proc lb_net_IpAddress_11ipv4_number
    pushq %rbp
    .seh_pushreg %rbp
    subq $256, %rsp
    .seh_stackalloc 256
...
lb_net_IpAddress_14is_ipv4_mapped:
    .seh_proc lb_net_IpAddress_14is_ipv4_mapped
    pushq %rbp
    .seh_pushreg %rbp
    subq $224, %rsp
    .seh_stackalloc 224
...
lb_net_IpAddress_equals:
    .seh_proc lb_net_IpAddress_equals
    pushq %rbp
    .seh_pushreg %rbp
    subq $256, %rsp
    .seh_stackalloc 256
...
lb_net_IpAddress_12write_octets:
    .seh_proc lb_net_IpAddress_12write_octets
    pushq %rbp
    .seh_pushreg %rbp
    subq $320, %rsp
    .seh_stackalloc 320
...
lb_net_IpAddress_format:
    .seh_proc lb_net_IpAddress_format
    pushq %rbp
    .seh_pushreg %rbp
    subq $736, %rsp
    .seh_stackalloc 736
...
.L9_2:
    ...
    movq %rax, 0(%rsp)
    movq 0(%rsp), %rcx
    call lb_net_IpAddress_14is_ipv4_mapped
    addq $32, %rsp
    movl %eax, %r12d
    testl %r12d, %r12d
    jne .L9_6
...
lb_net_IpAddress_word:
    .seh_proc lb_net_IpAddress_word
    pushq %rbp
    .seh_pushreg %rbp
    subq $240, %rsp
    .seh_stackalloc 240
...
lb_net_17parse_ipv4_number:
    .seh_proc lb_net_17parse_ipv4_number
    pushq %rbp
    .seh_pushreg %rbp
    subq $384, %rsp
    .seh_stackalloc 384
