...
lb_span lb_core_13raw_arguments(int32_t lb_count, char** lb_vector) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    {
        lb_pos = "src/std/core.lucb:280:9";
...
lb_span lb_core_17windows_arguments(void) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    {
        ...
        for (size_t lb_index __attribute__((unused)) = (size_t)(0ULL); lb_index < (size_t)(((size_t)lb_conv_s((int64_t)(lb_count), 32, 1, 64, 0, 1))); lb_index++) {
            {
                lb_pos = "src/std/core.lucb:306:13";
                ...
                {
                    lb_pos = "src/std/core.lucb:310:17";
                    (void)(lb_core_trap("could not encode the command line as UTF-8"));
                }
                lb_pos = "src/std/core.lucb:311:13";
                ((lb_items)[lb_index]) = ((char*)(lb_text));
            }
        }
        lb_pos = "src/std/core.lucb:312:9";
        ...
        {
            lb_pos = "src/std/core.lucb:314:13";
            (void)(lb_core_trap("could not register command line cleanup"));
        }
        lb_pos = "src/std/core.lucb:315:9";
...
void lb_core_22free_windows_arguments(void) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/core.lucb:291:5";
    ...
    for (size_t _lb_i231 = 0; _lb_i231 < _lb_seq231.length; _lb_i231++) {
        ...
        {
            lb_pos = "src/std/core.lucb:292:9";
            (void)(lb_c_core_22release_argument_block(((void*)(lb_text))));
        }
    }
    lb_pos = "src/std/core.lucb:293:5";
