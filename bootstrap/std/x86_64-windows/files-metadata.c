...
lb_r_files_Metadata lb_files_metadata(char* lb_path, bool lb_follow_symlinks) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    {
        lb_pos = "src/std/files/metadata.lucb:195:9";
        void* lb_handle __attribute__((unused)) = (({ lb_r_void_0p _lb_r7 = lb_files_19windows_path_handle(lb_path, lb_follow_symlinks, false); if (_lb_r7.failed) {
            return ((lb_r_files_Metadata){ .error = _lb_r7.error, .failed = true });
        } _lb_r7.value; }));
        lb_pos = "src/std/files/metadata.lucb:196:9";
        lb_pos = "src/std/files/metadata.lucb:197:9";
        lb_files_Metadata _lb_ret8 = (({ lb_r_files_Metadata _lb_r9 = lb_files_16windows_metadata(lb_handle, lb_follow_symlinks); if (_lb_r9.failed) {
            (void)(((void)(lb_x_11windows_abi_CloseHandle(lb_handle))));
            return ((lb_r_files_Metadata){ .error = _lb_r9.error, .failed = true });
        } _lb_r9.value; }));
        (void)(((void)(lb_x_11windows_abi_CloseHandle(lb_handle))));
        return ((lb_r_files_Metadata){ .value = _lb_ret8, .failed = false });
        (void)(((void)(lb_x_11windows_abi_CloseHandle(lb_handle))));
    }
    lb_trap("unreachable");
}
lb_r_files_Metadata lb_files_19metadata_descriptor(int32_t lb_descriptor) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    {
        lb_pos = "src/std/files/metadata.lucb:233:9";
        lb_files_Metadata _lb_ret10 = (({ lb_r_files_Metadata _lb_r11 = ({ void* _lb_sq12 __attribute__((unused)) = ((void*)(lb_c_files_10win_handle(lb_descriptor))); bool _lb_sq13 __attribute__((unused)) = true; lb_files_16windows_metadata(_lb_sq12, _lb_sq13); }); if (_lb_r11.failed) {
            return ((lb_r_files_Metadata){ .error = _lb_r11.error, .failed = true });
        } _lb_r11.value; }));
        return ((lb_r_files_Metadata){ .value = _lb_ret10, .failed = false });
    }
    lb_trap("unreachable");
}
lb_r_files_Metadata lb_files_11metadata_at(int32_t lb_directory, char* lb_path, bool lb_follow_symlinks) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    {
        lb_pos = "src/std/files/metadata.lucb:265:9";
        ...
        lb_pos = "src/std/files/metadata.lucb:266:9";
        lb_pos = "src/std/files/metadata.lucb:267:9";
