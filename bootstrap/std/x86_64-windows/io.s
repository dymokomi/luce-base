...
lb_io_SliceReader_over:
    .seh_proc lb_io_SliceReader_over
    pushq %rbp
    .seh_pushreg %rbp
    subq $272, %rsp
    .seh_stackalloc 272
...
lb_io_SliceReader_remaining:
    .seh_proc lb_io_SliceReader_remaining
    pushq %rbp
    .seh_pushreg %rbp
    subq $208, %rsp
    .seh_stackalloc 208
...
lb_io_SliceReader_read:
    .seh_proc lb_io_SliceReader_read
    pushq %rbp
    .seh_pushreg %rbp
    subq $336, %rsp
    .seh_stackalloc 336
...
lb_io_SliceWriter_over:
    .seh_proc lb_io_SliceWriter_over
    pushq %rbp
    .seh_pushreg %rbp
    subq $272, %rsp
    .seh_stackalloc 272
...
lb_io_SliceWriter_written:
    .seh_proc lb_io_SliceWriter_written
    pushq %rbp
    .seh_pushreg %rbp
    subq $256, %rsp
    .seh_stackalloc 256
...
lb_io_SliceWriter_write:
    .seh_proc lb_io_SliceWriter_write
    pushq %rbp
    .seh_pushreg %rbp
    subq $352, %rsp
    .seh_stackalloc 352
...
lb_io_BufferedReader_over:
    .seh_proc lb_io_BufferedReader_over
    pushq %rbp
    .seh_pushreg %rbp
    subq $400, %rsp
    .seh_stackalloc 400
...
lb_io_BufferedReader_buffered:
    .seh_proc lb_io_BufferedReader_buffered
    pushq %rbp
    .seh_pushreg %rbp
    subq $208, %rsp
    .seh_stackalloc 208
...
lb_io_BufferedReader_read:
    .seh_proc lb_io_BufferedReader_read
    pushq %rbp
    .seh_pushreg %rbp
    subq $432, %rsp
    .seh_stackalloc 432
...
lb_io_BufferedWriter_over:
    .seh_proc lb_io_BufferedWriter_over
    pushq %rbp
    .seh_pushreg %rbp
    subq $384, %rsp
    .seh_stackalloc 384
...
lb_io_BufferedWriter_buffered:
    .seh_proc lb_io_BufferedWriter_buffered
    pushq %rbp
    .seh_pushreg %rbp
    subq $192, %rsp
    .seh_stackalloc 192
...
lb_io_BufferedWriter_flush:
    .seh_proc lb_io_BufferedWriter_flush
    pushq %rbp
    .seh_pushreg %rbp
    subq $448, %rsp
    .seh_stackalloc 448
...
lb_io_BufferedWriter_write:
    .seh_proc lb_io_BufferedWriter_write
    pushq %rbp
    .seh_pushreg %rbp
    subq $384, %rsp
    .seh_stackalloc 384
...
.L16_5:
    ...
    movq 0(%rsp), %rcx
    movq 8(%rsp), %rdx
    call lb_io_BufferedWriter_flush
    addq $32, %rsp
    leaq 64(%rbp), %r15
    movq $24, %rcx
    movq %r15, %r12
...
lb_io_StandardInput_read:
    .seh_proc lb_io_StandardInput_read
    pushq %rbp
    .seh_pushreg %rbp
    subq $416, %rsp
    .seh_stackalloc 416
...
lb_io_FormatSink_write:
    .seh_proc lb_io_FormatSink_write
    pushq %rbp
    .seh_pushreg %rbp
    subq $304, %rsp
    .seh_stackalloc 304
...
.Ltext_68:
    .asciz "."
.Ltext_69:
    .asciz "src/std/io.lucb:361:13"
.Ltext_70:
    .asciz "APPDATA"
.Ltext_71:
    .asciz "src/std/io.lucb:371:13"
.Ltext_72:
...
.Ltext_83:
    ...
    .section .rdata$lb_vt_io_File_Writer,"dr"
    .p2align 3
    .globl lb_vt_io_File_Writer
lb_vt_io_File_Writer:
    .quad lb_io_File_write

    .section .rdata$lb_vt_io_StandardInput_Reader,"dr"
    .p2align 3
