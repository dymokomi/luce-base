...
lb_net_listener_0init:
    .seh_proc lb_net_listener_0init
    pushq %rbp
    .seh_pushreg %rbp
    subq $176, %rsp
    .seh_stackalloc 176
...
lb_net_Listener_address:
    .seh_proc lb_net_Listener_address
    pushq %rbp
    .seh_pushreg %rbp
    subq $384, %rsp
    .seh_stackalloc 384
...
lb_net_Listener_accept:
    .seh_proc lb_net_Listener_accept
    pushq %rbp
    .seh_pushreg %rbp
    subq $528, %rsp
    .seh_stackalloc 528
...
.L3_13:
    ...
    movq 8(%rsp), %rdx
    movq 16(%rsp), %r8
    call lb_net_Connection_15set_nonblocking
    addq $32, %rsp
    leaq 32(%rbp), %r14
    movq $24, %rcx
    movq %r14, %rbx
...
.L3_17:
    ...
    movq %rax, 0(%rsp)
    movq 0(%rsp), %rcx
    call lb_net_Connection_destroy
    addq $32, %rsp
    movq %rbx, %rsi
    movq 344(%rbp), %rdi
    movq $64, %rdx
...
lb_net_Listener_15set_nonblocking:
    .seh_proc lb_net_Listener_15set_nonblocking
    pushq %rbp
    .seh_pushreg %rbp
    subq $352, %rsp
    .seh_stackalloc 352
...
lb_net_Listener_14is_nonblocking:
    .seh_proc lb_net_Listener_14is_nonblocking
    pushq %rbp
    .seh_pushreg %rbp
    subq $304, %rsp
    .seh_stackalloc 304
...
lb_net_Listener_18set_receive_buffer:
    .seh_proc lb_net_Listener_18set_receive_buffer
    pushq %rbp
    .seh_pushreg %rbp
    subq $352, %rsp
    .seh_stackalloc 352
...
lb_net_Listener_14receive_buffer:
    .seh_proc lb_net_Listener_14receive_buffer
    pushq %rbp
    .seh_pushreg %rbp
    subq $352, %rsp
    .seh_stackalloc 352
...
lb_net_Listener_15set_send_buffer:
    .seh_proc lb_net_Listener_15set_send_buffer
    pushq %rbp
    .seh_pushreg %rbp
    subq $352, %rsp
    .seh_stackalloc 352
...
lb_net_Listener_11send_buffer:
    .seh_proc lb_net_Listener_11send_buffer
    pushq %rbp
    .seh_pushreg %rbp
    subq $352, %rsp
    .seh_stackalloc 352
...
lb_net_Listener_descriptor:
    .seh_proc lb_net_Listener_descriptor
    pushq %rbp
    .seh_pushreg %rbp
    subq $224, %rsp
    .seh_stackalloc 224
...
lb_net_Listener_close:
    .seh_proc lb_net_Listener_close
    pushq %rbp
    .seh_pushreg %rbp
    subq $288, %rsp
    .seh_stackalloc 288
...
lb_net_Listener_destroy:
    .seh_proc lb_net_Listener_destroy
    pushq %rbp
    .seh_pushreg %rbp
    subq $192, %rsp
    .seh_stackalloc 192
...
.Ltext_9:
    .asciz "src/std/net/listener.lucb:64:13"
.Ltext_10:
