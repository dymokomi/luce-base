...
lb_r_str lb_strings_replace(lb_str lb_text, lb_str lb_needle, lb_str lb_replacement, size_t lb_max_replacements, lb_o_usize lb_max_bytes) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/strings/replace.lucb:8:5";
    if (!!(((lb_needle.length) == 0ULL))) 
    {
        lb_pos = "src/std/strings/replace.lucb:9:9";
        lb_r_str _lb_err7 = ((lb_r_str){ .error = { .code = (int32_t)(lb_strings_17invalid_separator), .message = ((lb_str){"replacement requires a nonempty needle", 38}) }, .failed = true });
        return _lb_err7;
    }
    lb_pos = "src/std/strings/replace.lucb:10:5";
    size_t lb_size __attribute__((unused)) = (lb_text.length);
    lb_pos = "src/std/strings/replace.lucb:11:5";
    size_t lb_count __attribute__((unused)) = 0ULL;
    lb_pos = "src/std/strings/replace.lucb:12:5";
    size_t lb_position __attribute__((unused)) = 0ULL;
    lb_pos = "src/std/strings/replace.lucb:13:5";
    for (;;) {
        lb_pos = "src/std/strings/replace.lucb:13:5";
        if (!(((lb_max_replacements == 0ULL) || (((size_t)(lb_count)) < ((size_t)(lb_max_replacements)))))) break;
        {
            lb_pos = "src/std/strings/replace.lucb:14:9";
            size_t lb_found __attribute__((unused)) = ({ lb_o_usize _lb_o8 = lb_strings_9find_from(lb_text, lb_needle, lb_position); if (!_lb_o8.present) {
                break;
            } _lb_o8.value; });
            lb_pos = "src/std/strings/replace.lucb:15:9";
            if (!!((((size_t)((lb_replacement.length))) >= ((size_t)((lb_needle.length)))))) 
            {
                lb_pos = "src/std/strings/replace.lucb:16:13";
                lb_size = ({ lb_o_usize _lb_o9 = ({ uint64_t _lb_qo10; lb_o_usize _lb_qr10; _lb_qr10.present = lb_qadd_u((uint64_t)(lb_size), (uint64_t)(((size_t)(lb_sub_u((uint64_t)((lb_replacement.length)), (uint64_t)((lb_needle.length)), 64)))), 64, &_lb_qo10); _lb_qr10.value = (size_t)(_lb_qo10); _lb_qr10; }); if (!_lb_o9.present) {
                    lb_r_str _lb_err11 = ((lb_r_str){ .error = { .code = (int32_t)(lb_memory_exhausted), .message = ((lb_str){"the replacement result is too large", 35}) }, .failed = true });
                    return _lb_err11;
                } _lb_o9.value; });
            }
            else 
            {
                lb_pos = "src/std/strings/replace.lucb:18:13";
                { size_t* lb__cell12 = &(lb_size);
                (*(lb__cell12)) = (size_t)(lb_sub_u((uint64_t)((*(lb__cell12))), (uint64_t)((size_t)(lb_sub_u((uint64_t)((lb_needle.length)), (uint64_t)((lb_replacement.length)), 64))), 64)); }
            }
            lb_pos = "src/std/strings/replace.lucb:19:9";
            lb_position = (size_t)(lb_add_u((uint64_t)(lb_found), (uint64_t)((lb_needle.length)), 64));
            lb_pos = "src/std/strings/replace.lucb:20:9";
            { size_t* lb__cell13 = &(lb_count);
            (*(lb__cell13)) = (size_t)(lb_add_u((uint64_t)((*(lb__cell13))), (uint64_t)(1ULL), 64)); }
        }
    }
    lb_pos = "src/std/strings/replace.lucb:21:5";
    lb_o_usize _lb_o14 = lb_max_bytes;
    if (_lb_o14.present) {
        size_t lb_maximum __attribute__((unused)) = _lb_o14.value;
        {
            lb_pos = "src/std/strings/replace.lucb:22:9";
            if (!!((((size_t)(lb_size)) > ((size_t)(lb_maximum))))) 
            {
                lb_pos = "src/std/strings/replace.lucb:23:13";
                lb_r_str _lb_err15 = ((lb_r_str){ .error = { .code = (int32_t)(lb_strings_16output_too_large), .message = ((lb_str){"the replacement result exceeds its byte limit", 45}) }, .failed = true });
                return _lb_err15;
            }
        }
    }
    lb_pos = "src/std/strings/replace.lucb:24:5";
    lb_span lb_output __attribute__((unused)) = (({ lb_r_u8_0s _lb_r16 = lb_strings_17terminated_buffer(lb_size); if (_lb_r16.failed) {
        return ((lb_r_str){ .error = _lb_r16.error, .failed = true });
    } _lb_r16.value; }));
    lb_pos = "src/std/strings/replace.lucb:25:5";
    size_t lb_used __attribute__((unused)) = 0ULL;
    lb_pos = "src/std/strings/replace.lucb:26:5";
    size_t lb_copied __attribute__((unused)) = 0ULL;
    lb_pos = "src/std/strings/replace.lucb:27:5";
    lb_position = 0ULL;
    lb_pos = "src/std/strings/replace.lucb:28:5";
    for (;;) {
        lb_pos = "src/std/strings/replace.lucb:28:5";
        if (!((((size_t)(lb_copied)) < ((size_t)(lb_count))))) break;
        {
            lb_pos = "src/std/strings/replace.lucb:29:9";
            size_t lb_found __attribute__((unused)) = ({ lb_o_usize _lb_o17 = lb_strings_9find_from(lb_text, lb_needle, lb_position); if (!_lb_o17.present) {
                (void)(lb_trap_text(((lb_str){"replacement input changed between scans", 39})));
            } _lb_o17.value; });
            lb_pos = "src/std/strings/replace.lucb:30:9";
            size_t lb_prefix __attribute__((unused)) = (size_t)(lb_sub_u((uint64_t)(lb_found), (uint64_t)(lb_position), 64));
            lb_pos = "src/std/strings/replace.lucb:31:9";
            (void)(lb_memory_copy_0g1_u8(({ lb_span _lb_sv18 = lb_output; size_t _lb_sn18 = _lb_sv18.length; uint8_t* _lb_sd18 = (uint8_t*)_lb_sv18.data; size_t _lb_ss18 = (size_t)(lb_used); size_t _lb_se18 = _lb_sn18; lb_check_index(_lb_ss18, _lb_sn18 + 1); lb_check_index(_lb_se18, _lb_sn18 + 1); if (_lb_ss18 > _lb_se18) lb_trap("index out of bounds"); (lb_span){ (void*)(_lb_sd18 + _lb_ss18), _lb_se18 - _lb_ss18 }; }), ({ lb_span _lb_sv19 = ((lb_cspan){(void*)(lb_text.data), lb_text.length}); size_t _lb_sn19 = _lb_sv19.length; uint8_t* _lb_sd19 = (uint8_t*)_lb_sv19.data; size_t _lb_ss19 = (size_t)(lb_position); size_t _lb_se19 = (size_t)(lb_found); lb_check_index(_lb_ss19, _lb_sn19 + 1); lb_check_index(_lb_se19, _lb_sn19 + 1); if (_lb_ss19 > _lb_se19) lb_trap("index out of bounds"); (lb_cspan){ (void*)(_lb_sd19 + _lb_ss19), _lb_se19 - _lb_ss19 }; }), lb_prefix));
            lb_pos = "src/std/strings/replace.lucb:32:9";
            { size_t* lb__cell20 = &(lb_used);
            (*(lb__cell20)) = (size_t)(lb_add_u((uint64_t)((*(lb__cell20))), (uint64_t)(lb_prefix), 64)); }
            lb_pos = "src/std/strings/replace.lucb:33:9";
            (void)(lb_memory_copy_0g1_u8(({ lb_span _lb_sv21 = lb_output; size_t _lb_sn21 = _lb_sv21.length; uint8_t* _lb_sd21 = (uint8_t*)_lb_sv21.data; size_t _lb_ss21 = (size_t)(lb_used); size_t _lb_se21 = _lb_sn21; lb_check_index(_lb_ss21, _lb_sn21 + 1); lb_check_index(_lb_se21, _lb_sn21 + 1); if (_lb_ss21 > _lb_se21) lb_trap("index out of bounds"); (lb_span){ (void*)(_lb_sd21 + _lb_ss21), _lb_se21 - _lb_ss21 }; }), ((lb_cspan){(void*)(lb_replacement.data), lb_replacement.length}), (lb_replacement.length)));
            lb_pos = "src/std/strings/replace.lucb:34:9";
            { size_t* lb__cell22 = &(lb_used);
            (*(lb__cell22)) = (size_t)(lb_add_u((uint64_t)((*(lb__cell22))), (uint64_t)((lb_replacement.length)), 64)); }
            lb_pos = "src/std/strings/replace.lucb:35:9";
            lb_position = (size_t)(lb_add_u((uint64_t)(lb_found), (uint64_t)((lb_needle.length)), 64));
            lb_pos = "src/std/strings/replace.lucb:36:9";
            { size_t* lb__cell23 = &(lb_copied);
            (*(lb__cell23)) = (size_t)(lb_add_u((uint64_t)((*(lb__cell23))), (uint64_t)(1ULL), 64)); }
        }
    }
    lb_pos = "src/std/strings/replace.lucb:37:5";
    size_t lb_tail __attribute__((unused)) = (size_t)(lb_sub_u((uint64_t)((lb_text.length)), (uint64_t)(lb_position), 64));
    lb_pos = "src/std/strings/replace.lucb:38:5";
    (void)(lb_memory_copy_0g1_u8(({ lb_span _lb_sv24 = lb_output; size_t _lb_sn24 = _lb_sv24.length; uint8_t* _lb_sd24 = (uint8_t*)_lb_sv24.data; size_t _lb_ss24 = (size_t)(lb_used); size_t _lb_se24 = _lb_sn24; lb_check_index(_lb_ss24, _lb_sn24 + 1); lb_check_index(_lb_se24, _lb_sn24 + 1); if (_lb_ss24 > _lb_se24) lb_trap("index out of bounds"); (lb_span){ (void*)(_lb_sd24 + _lb_ss24), _lb_se24 - _lb_ss24 }; }), ({ lb_span _lb_sv25 = ((lb_cspan){(void*)(lb_text.data), lb_text.length}); size_t _lb_sn25 = _lb_sv25.length; uint8_t* _lb_sd25 = (uint8_t*)_lb_sv25.data; size_t _lb_ss25 = (size_t)(lb_position); size_t _lb_se25 = _lb_sn25; lb_check_index(_lb_ss25, _lb_sn25 + 1); lb_check_index(_lb_se25, _lb_sn25 + 1); if (_lb_ss25 > _lb_se25) lb_trap("index out of bounds"); (lb_cspan){ (void*)(_lb_sd25 + _lb_ss25), _lb_se25 - _lb_ss25 }; }), lb_tail));
    lb_pos = "src/std/strings/replace.lucb:39:5";
    { size_t* lb__cell26 = &(lb_used);
    (*(lb__cell26)) = (size_t)(lb_add_u((uint64_t)((*(lb__cell26))), (uint64_t)(lb_tail), 64)); }
    lb_pos = "src/std/strings/replace.lucb:40:5";
    (*({ lb_span _lb_ix27 = lb_output; &((uint8_t*)_lb_ix27.data)[lb_at((uint64_t)(lb_used), _lb_ix27.length)]; })) = 0ULL;
    lb_pos = "src/std/strings/replace.lucb:41:5";
    lb_str _lb_ret28 = ({ lb_span _lb_sc29 = ({ lb_span _lb_sv30 = lb_output; size_t _lb_sn30 = _lb_sv30.length; uint8_t* _lb_sd30 = (uint8_t*)_lb_sv30.data; size_t _lb_ss30 = 0; size_t _lb_se30 = (size_t)(lb_used); lb_check_index(_lb_ss30, _lb_sn30 + 1); lb_check_index(_lb_se30, _lb_sn30 + 1); if (_lb_ss30 > _lb_se30) lb_trap("index out of bounds"); (lb_span){ (void*)(_lb_sd30 + _lb_ss30), _lb_se30 - _lb_ss30 }; }); const char* _lb_sb29 = (const char*)_lb_sc29.data; size_t _lb_sl29 = _lb_sc29.length; (lb_str){ _lb_sb29, _lb_sl29 }; });
    return ((lb_r_str){ .value = _lb_ret28, .failed = false });
    lb_trap("unreachable");
}
__attribute__((weak)) void lb_interop_Packet_0g1_str_init(lb_interop_Packet_0g1_str* self, lb_str lb_value, void* lb_storage, lb_fn_0F1_void_0p_unit lb_dispose) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
