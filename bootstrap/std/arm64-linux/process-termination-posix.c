...
void lb_process_20termination_received(int32_t lb_number);
bool lb_process_19termination_refused(lb_fn_0F1_i32_unit lb_handler);

extern _Atomic(uint64_t) lb_process_22termination_generation;
lb_fn_0F1_i32_unit lb_process_18previous_interrupt = ((void*)0);
lb_fn_0F1_i32_unit lb_process_18previous_terminate = ((void*)0);
...
int32_t lb_process_16interrupt_signal = 2LL;
int32_t lb_process_16terminate_signal = 15LL;
...
lb_r_unit lb_process_25termination_posix_install(void) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/process/termination/posix.lucb:19:5";
    lb_process_18previous_interrupt = lb_c_process_18termination_signal(lb_process_16interrupt_signal, lb_process_20termination_received);
    lb_pos = "src/std/process/termination/posix.lucb:20:5";
    if (!!(lb_process_19termination_refused(lb_process_18previous_interrupt))) 
    {
        lb_pos = "src/std/process/termination/posix.lucb:21:9";
        lb_r_unit _lb_err7 = ((lb_r_unit){ .error = { .code = (int32_t)(lb_process_failed), .message = ((lb_str){"SIGINT handler could not be installed", 37}) }, .failed = true });
        return _lb_err7;
    }
    lb_pos = "src/std/process/termination/posix.lucb:22:5";
    lb_process_18previous_terminate = lb_c_process_18termination_signal(lb_process_16terminate_signal, lb_process_20termination_received);
    lb_pos = "src/std/process/termination/posix.lucb:23:5";
    if (!!(lb_process_19termination_refused(lb_process_18previous_terminate))) 
    {
        lb_pos = "src/std/process/termination/posix.lucb:24:9";
        (void)(((void)(lb_c_process_18termination_signal(lb_process_16interrupt_signal, lb_process_18previous_interrupt))));
        lb_pos = "src/std/process/termination/posix.lucb:25:9";
        lb_r_unit _lb_err8 = ((lb_r_unit){ .error = { .code = (int32_t)(lb_process_failed), .message = ((lb_str){"SIGTERM handler could not be installed", 38}) }, .failed = true });
        return _lb_err8;
    }
...
void lb_process_25termination_posix_restore(void) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/process/termination/posix.lucb:28:5";
    (void)(((void)(lb_c_process_18termination_signal(lb_process_16interrupt_signal, lb_process_18previous_interrupt))));
    lb_pos = "src/std/process/termination/posix.lucb:29:5";
    (void)(((void)(lb_c_process_18termination_signal(lb_process_16terminate_signal, lb_process_18previous_terminate))));
}
__attribute__((weak)) void lb_interop_Packet_0g1_str_init(lb_interop_Packet_0g1_str* self, lb_str lb_value, void* lb_storage, lb_fn_0F1_void_0p_unit lb_dispose) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
...
void lb_process_20termination_received(int32_t lb_number) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/process/termination/posix.lucb:11:5";
    (void)(((void)(((uint64_t)atomic_fetch_add_explicit(&(lb_process_22termination_generation), (uint64_t)(1ULL), memory_order_release)))));
}
bool lb_process_19termination_refused(lb_fn_0F1_i32_unit lb_handler) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/process/termination/posix.lucb:14:5";
    lb_fn_0F1_i32_unit _lb_o14 = lb_handler;
    if (_lb_o14 != ((void*)0)) {
        lb_fn_0F1_i32_unit lb_function __attribute__((unused)) = _lb_o14;
        {
            lb_pos = "src/std/process/termination/posix.lucb:15:9";
            bool _lb_ret15 = (((size_t)(((void*)(lb_function)))) == ((size_t)lb_not_u((uint64_t)(((size_t)lb_conv_s((int64_t)(0LL), 64, 1, 64, 0, 1))), 64)));
            return _lb_ret15;
        }
    }
    lb_pos = "src/std/process/termination/posix.lucb:16:5";
