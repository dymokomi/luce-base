...
.L1_36:
    ...
    sub x14, x29, x16
    str x20, [x14]
    adrp x24, lb_vt_files_File_Reader
    add x24, x24, :lo12:lb_vt_files_File_Reader
    add x25, x14, #8
    str x24, [x25]
    add x24, x21, #8
    movz x16, #5208
    sub x25, x29, x16
    str x24, [x25]
    adrp x24, lb_vt_files_TemporaryFile_Writer
    add x24, x24, :lo12:lb_vt_files_TemporaryFile_Writer
    add x26, x25, #8
    str x24, [x26]
    movz x16, #5224
    sub x24, x29, x16
