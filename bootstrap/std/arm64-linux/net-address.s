...
lb_net_address_0init:
    ...
    .size lb_net_address_0init, .-lb_net_address_0init
...
.L1_5:
    ...
    .size lb_net_SocketAddress_loopback, .-lb_net_SocketAddress_loopback
...
.L2_1:
    ...
    .size lb_net_SocketAddress_any, .-lb_net_SocketAddress_any
...
.L3_27:
    ...
    movz x3, #10
    bl lb_net_21parse_endpoint_number
    sub x16, x29, #232
    str x0, [x16, #0]
    sub x13, x29, #232
    add x15, x13, #4
...
.L3_59:
    ...
    .size lb_net_SocketAddress_parse, .-lb_net_SocketAddress_parse
...
.L4_5:
    ...
    .size lb_net_SocketAddress_equals, .-lb_net_SocketAddress_equals
...
lb_net_SocketAddress_format:
    ...
    mov x0, x19
    sub x8, x29, #168
    bl lb_net_SocketAddress_validate
    sub x15, x29, #168
    add x14, x15, #24
    ldrb w14, [x14]
    cbnz w14, .L5_2
...
1:
    ...
    ldr x2, [x9, #8]
    mov x3, x21
    bl lb_net_22render_endpoint_number
    mov x15, x0
    b .L5_14
.L5_13:
    mov x15, x14
...
.L5_24:
    ...
    .size lb_net_SocketAddress_format, .-lb_net_SocketAddress_format
...
.L6_9:
    ...
    .size lb_net_SocketAddress_validate, .-lb_net_SocketAddress_validate
...
.L7_4:
    mov x0, x19
    bl lb_net_IpAddress_11ipv4_number
    sub x16, x29, #160
    str x0, [x16, #0]
    sub x15, x29, #160
    add x14, x15, #4
...
.L7_24:
    ...
    .size lb_net_SocketAddress_12write_native, .-lb_net_SocketAddress_12write_native
...
.L8_22:
    ...
    .size lb_net_14decode_address, .-lb_net_14decode_address
...
.L9_10:
    ...
    .size lb_net_21parse_endpoint_number, .-lb_net_21parse_endpoint_number
...
.L10_16:
    ...
    .size lb_net_22render_endpoint_number, .-lb_net_22render_endpoint_number
...
.L11_8:
    ...
    .size lb_net_swap32, .-lb_net_swap32
...
.L14_3:
    ...
    .size lb_memory_read_0g1_net_NativeIpv4Address, .-lb_memory_read_0g1_net_NativeIpv4Address
...
.L15_3:
    ...
    .size lb_memory_read_0g1_net_NativeIpv6Address, .-lb_memory_read_0g1_net_NativeIpv6Address
