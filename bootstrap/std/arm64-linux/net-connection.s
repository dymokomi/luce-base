...
lb_net_connection_0init:
    ...
    .size lb_net_connection_0init, .-lb_net_connection_0init
...
.L1_22:
    ...
    mov w14, w0
    adrp x21, lb_platform_windows
    add x21, x21, :lo12:lb_platform_windows
    ldrb w15, [x21]
    cbnz w15, .L1_25
    b .L1_26
.L1_25:
    ...
    b .L1_27
.L1_26:
    adrp x22, lb_platform_macos
    add x22, x22, :lo12:lb_platform_macos
    ldrb w22, [x22]
    cbnz w22, .L1_28
    b .L1_29
.L1_28:
...
.L1_69:
    ...
    .size lb_net_Connection_connect, .-lb_net_Connection_connect
...
.L2_4:
    ...
    .size lb_net_Connection_over, .-lb_net_Connection_over
...
.L3_7:
    ...
    .size lb_net_Connection_13local_address, .-lb_net_Connection_13local_address
...
.L4_7:
    ...
    .size lb_net_Connection_12peer_address, .-lb_net_Connection_12peer_address
...
.L5_19:
    ...
    .size lb_net_Connection_shutdown, .-lb_net_Connection_shutdown
...
.L6_9:
    ...
    .size lb_net_Connection_guard, .-lb_net_Connection_guard
...
.L7_28:
    ...
    .size lb_net_Connection_write, .-lb_net_Connection_write
...
.L8_5:
.L8_6:
    adrp x15, lb_net_14transfer_limit
    add x15, x15, :lo12:lb_net_14transfer_limit
    ldr x15, [x15]
    cmp x20, x15
    b.hs .L8_9
.L8_8:
...
.L8_10:
    ...
    bl lb_net_recv
    mov x15, x0
    adrp x22, lb_net_18socket_interrupted
    add x22, x22, :lo12:lb_net_18socket_interrupted
    mov x23, x15
.L8_11:
    mov x10, #0
    cmp x23, x10
...
.L8_20:
    ...
    .size lb_net_Connection_read, .-lb_net_Connection_read
...
.L9_7:
    ...
    .size lb_net_Connection_12set_no_delay, .-lb_net_Connection_12set_no_delay
...
.L10_7:
    ...
    .size lb_net_Connection_8no_delay, .-lb_net_Connection_8no_delay
...
.L11_1:
    ...
    ldrsw x19, [x19]
    adrp x20, lb_net_16keepalive_option
    add x20, x20, :lo12:lb_net_16keepalive_option
    ldrsw x20, [x20]
    sub x21, x29, #112
    ldrb w21, [x21]
    cbnz w21, .L11_4
...
.L11_7:
    ...
    .size lb_net_Connection_13set_keepalive, .-lb_net_Connection_13set_keepalive
...
.L12_7:
    ...
    .size lb_net_Connection_keepalive, .-lb_net_Connection_keepalive
...
.L13_7:
    ...
    .size lb_net_Connection_wait, .-lb_net_Connection_wait
...
.L14_4:
    ...
    .size lb_net_Connection_15set_nonblocking, .-lb_net_Connection_15set_nonblocking
...
.L15_7:
    ...
    .size lb_net_Connection_14is_nonblocking, .-lb_net_Connection_14is_nonblocking
...
.L16_4:
    ...
    .size lb_net_Connection_18set_receive_buffer, .-lb_net_Connection_18set_receive_buffer
...
.L17_7:
    ...
    .size lb_net_Connection_14receive_buffer, .-lb_net_Connection_14receive_buffer
...
.L18_4:
    ...
    .size lb_net_Connection_15set_send_buffer, .-lb_net_Connection_15set_send_buffer
...
.L19_7:
    ...
    .size lb_net_Connection_11send_buffer, .-lb_net_Connection_11send_buffer
...
.L20_1:
    ...
    .size lb_net_Connection_descriptor, .-lb_net_Connection_descriptor
...
.L21_1:
    ...
    .size lb_net_Connection_close, .-lb_net_Connection_close
...
lb_net_Connection_destroy:
    ...
    .size lb_net_Connection_destroy, .-lb_net_Connection_destroy
