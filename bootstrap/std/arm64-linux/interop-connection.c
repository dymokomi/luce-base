...
#endif
void lb_interop_Connection_destroy(lb_interop_Connection* self);
void lb_interop_Connection_trace(const lb_interop_Connection* self, lb_fn_0F2_ownership_Object_0p_void_0p_unit lb_visit, void* lb_context);
...
lb_interop_Type_0g1_interop_Connection lb_interop_15connection_type = {.name = {"Connection", 10}, .dispose = lb_interop_Connection_destroy, .trace = lb_interop_Connection_trace, .closeable = false, .main_thread = false};
...
void lb_interop_Connection_destroy(lb_interop_Connection* self) {
    ...
    lb_pos = "src/std/interop/connection.lucb:30:9";
    (void)(lb_interop_Connection_disconnect(self));
}
void lb_interop_Connection_trace(const lb_interop_Connection* self, lb_fn_0F2_ownership_Object_0p_void_0p_unit lb_visit, void* lb_context) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/interop/connection.lucb:33:9";
    struct lb_ownership_Object* _lb_o1 = self->state;
    if (_lb_o1 != ((void*)0)) {
        struct lb_ownership_Object* lb_state __attribute__((unused)) = _lb_o1;
        {
            lb_pos = "src/std/interop/connection.lucb:34:13";
            (void)(lb_ownership_12check_thread(lb_state));
            lb_pos = "src/std/interop/connection.lucb:35:13";
            (void)((lb_visit)(lb_state, lb_context));
        }
    }
}
__attribute__((weak)) lb_interop_Transfer_0g1_str lb_interop_Transfer_0g1_str_plain(void) {
    ...
    lb_interop_Transfer_0g1_str _lb_ret2 = ((lb_interop_Transfer_0g1_str){.copy = lb_interop_Transfer_0g1_str_10copy_plain});
    return _lb_ret2;
    lb_trap("unreachable");
}
__attribute__((weak)) lb_r_interop_Packet_0g1_str lb_interop_Transfer_0g1_str_10copy_plain(lb_str lb_value) {
    ...
    lb_interop_Packet_0g1_str _lb_ret3 = ({ lb_interop_Packet_0g1_str _lb_iv4 = {}; lb_interop_Packet_0g1_str_init(&_lb_iv4, lb_value, ((void*)0), ((void*)0)); _lb_iv4; });
    return ((lb_r_interop_Packet_0g1_str){ .value = _lb_ret3, .failed = false });
    lb_trap("unreachable");
}
__attribute__((weak)) lb_interop_Transfer_0g1_u8_0c lb_interop_Transfer_0g1_u8_0c_plain(void) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/interop/transfer.lucb:26:9";
    lb_interop_Transfer_0g1_u8_0c _lb_ret5 = ((lb_interop_Transfer_0g1_u8_0c){.copy = lb_interop_Transfer_0g1_u8_0c_10copy_plain});
    return _lb_ret5;
    lb_trap("unreachable");
}
__attribute__((weak)) lb_r_interop_Packet_0g1_u8_0c lb_interop_Transfer_0g1_u8_0c_10copy_plain(lb_cspan lb_value) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/interop/transfer.lucb:29:9";
    lb_interop_Packet_0g1_u8_0c _lb_ret6 = ({ lb_interop_Packet_0g1_u8_0c _lb_iv7 = {}; lb_interop_Packet_0g1_u8_0c_init(&_lb_iv7, lb_value, ((void*)0), ((void*)0)); _lb_iv7; });
    return ((lb_r_interop_Packet_0g1_u8_0c){ .value = _lb_ret6, .failed = false });
    lb_trap("unreachable");
}
void lb_interop_Connection_init(lb_interop_Connection* self, struct lb_ownership_Object* lb_state, uint64_t lb_identifier, lb_fn_0F2_ownership_Object_0p_u64_unit lb_remove, lb_fn_0F2_ownership_Object_0p_u64_bool lb_contains) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/interop/connection.lucb:12:9";
    self->state = lb_state;
    lb_pos = "src/std/interop/connection.lucb:13:9";
    self->identifier = lb_identifier;
    lb_pos = "src/std/interop/connection.lucb:14:9";
    self->remove = lb_remove;
    lb_pos = "src/std/interop/connection.lucb:15:9";
    self->contains = lb_contains;
    lb_pos = "src/std/interop/connection.lucb:16:9";
    (void)(((void)(lb_ownership_retain(lb_state))));
}
void lb_interop_Connection_disconnect(lb_interop_Connection* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/interop/connection.lucb:19:9";
    struct lb_ownership_Object* lb_state __attribute__((unused)) = ({ struct lb_ownership_Object* _lb_o8 = self->state; if (_lb_o8 == ((void*)0)) {
        return;
    } _lb_o8; });
    lb_pos = "src/std/interop/connection.lucb:20:9";
    self->state = ((void*)0);
    lb_pos = "src/std/interop/connection.lucb:21:9";
    (void)((self->remove)(lb_state, self->identifier));
    lb_pos = "src/std/interop/connection.lucb:22:9";
    (void)(lb_ownership_release(lb_state));
}
bool lb_interop_Connection_12is_connected(const lb_interop_Connection* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/interop/connection.lucb:25:9";
    struct lb_ownership_Object* lb_state __attribute__((unused)) = ({ struct lb_ownership_Object* _lb_o9 = self->state; if (_lb_o9 == ((void*)0)) {
        bool _lb_ret10 = false;
        return _lb_ret10;
    } _lb_o9; });
    lb_pos = "src/std/interop/connection.lucb:26:9";
    (void)(lb_ownership_11check_alive(lb_state));
    lb_pos = "src/std/interop/connection.lucb:27:9";
    bool _lb_ret11 = (self->contains)(lb_state, self->identifier);
    return _lb_ret11;
    lb_trap("unreachable");
}
__attribute__((weak)) void lb_interop_Packet_0g1_str_init(lb_interop_Packet_0g1_str* self, lb_str lb_value, void* lb_storage, lb_fn_0F1_void_0p_unit lb_dispose) {
