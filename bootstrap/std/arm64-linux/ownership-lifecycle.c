...
typedef struct lb_a_u8_0a96 { uint8_t d[96]; } lb_a_u8_0a96;
...
void lb_ownership_15release_buffers(void);
void lb_core_exit(int32_t lb_code);

extern _Thread_local lb_span lb_ownership_pending;
extern _Thread_local lb_span lb_ownership_roots;
extern _Thread_local lb_span lb_ownership_whites;
...
int32_t lb_ownership_10finish_run(int32_t lb_status) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/ownership/lifecycle.lucb:5:5";
    (void)(lb_ownership_drain(0ULL));
    lb_pos = "src/std/ownership/lifecycle.lucb:6:5";
    (void)(lb_ownership_collect());
    lb_pos = "src/std/ownership/lifecycle.lucb:7:5";
    if (!!((!(lb_ownership_live == 0ULL)))) 
    {
        lb_pos = "src/std/ownership/lifecycle.lucb:8:9";
        lb_a_u8_0a96 lb_room __attribute__((unused)) = {};
        lb_pos = "src/std/ownership/lifecycle.lucb:9:9";
        lb_str lb_text __attribute__((unused)) = ({ lb_error _lb_fe7 __attribute__((unused)); lb_str _lb_v7 __attribute__((unused)) = {}; _lb_v7 = ({ lb_r_str _lb_r8 = ({ lb_span _lb_ds9 = ((lb_span){(void*)(lb_room.d), 96ULL}); lb_fmtbuf _lb_fb9 = { (char*)_lb_ds9.data, _lb_ds9.length, 0 }; (void)lb_fmtbuf_put(&_lb_fb9, "runtime: ", 9); (void)lb_fmtbuf_u64(&_lb_fb9, (uint64_t)(lb_ownership_live)); (void)lb_fmtbuf_put(&_lb_fb9, " objects alive at exit\n", 23); lb_r_str _lb_out9; if (_lb_fb9.used > _lb_fb9.cap) { _lb_out9 = ((lb_r_str){ .error = { .code = 208273409, .message = (lb_str){"memory.exhausted: the formatted text does not fit its buffer", 60} }, .failed = true }); } else { _lb_out9 = ((lb_r_str){ .value = lb_fmtbuf_finish(&_lb_fb9), .failed = false }); } _lb_out9; }); if (_lb_r8.failed) {
            _lb_fe7 = _lb_r8.error;
            goto _lb_fh7;
        } _lb_r8.value; }); goto _lb_cd7; _lb_fh7: { 
            lb_error lb_failure __attribute__((unused)) = _lb_fe7;
            {
                lb_pos = "src/std/ownership/lifecycle.lucb:10:13";
                _lb_v7 = ((lb_str){"runtime: objects alive at exit\n", 31});
                goto _lb_cd7;
            }
        } _lb_cd7: __attribute__((unused)); _lb_v7; });
        lb_pos = "src/std/ownership/lifecycle.lucb:11:9";
        lb_iface lb_e __attribute__((unused)) = lb_io_stderr();
        lb_pos = "src/std/ownership/lifecycle.lucb:12:9";
        (void)(((void)(({ lb_error _lb_fe10 __attribute__((unused)); size_t _lb_v10 __attribute__((unused)) = 0; _lb_v10 = ({ lb_r_usize _lb_r11 = ({ lb_iface _lb_if12 = lb_e; ((lb_vt_Writer*)_lb_if12.vtable)->write(_lb_if12.data, ((lb_cspan){(void*)(lb_text.data), lb_text.length})); }); if (_lb_r11.failed) {
            _lb_fe10 = _lb_r11.error;
            goto _lb_fh10;
        } _lb_r11.value; }); goto _lb_cd10; _lb_fh10: { 
            lb_error lb_failure __attribute__((unused)) = _lb_fe10;
            {
                lb_pos = "src/std/ownership/lifecycle.lucb:12:9";
                _lb_v10 = 0ULL;
                goto _lb_cd10;
            }
        } _lb_cd10: __attribute__((unused)); _lb_v10; }))));
        lb_pos = "src/std/ownership/lifecycle.lucb:13:9";
        int32_t _lb_ret13 = 3LL;
        return _lb_ret13;
    }
    lb_pos = "src/std/ownership/lifecycle.lucb:14:5";
    (void)(lb_ownership_15release_buffers());
    lb_pos = "src/std/ownership/lifecycle.lucb:15:5";
    lb_ownership_13runtime_depth = 0ULL;
    lb_pos = "src/std/ownership/lifecycle.lucb:16:5";
    lb_ownership_14thread_context = 0ULL;
    lb_pos = "src/std/ownership/lifecycle.lucb:17:5";
    int32_t _lb_ret14 = lb_status;
    return _lb_ret14;
    lb_trap("unreachable");
}
void lb_ownership_11finish_task(void) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/ownership/lifecycle.lucb:22:5";
    (void)(lb_ownership_drain(0ULL));
    lb_pos = "src/std/ownership/lifecycle.lucb:23:5";
    (void)(lb_ownership_collect());
    lb_pos = "src/std/ownership/lifecycle.lucb:24:5";
    if (!!((!(lb_ownership_live == 0ULL)))) 
    {
        lb_pos = "src/std/ownership/lifecycle.lucb:25:9";
        lb_a_u8_0a96 lb_room __attribute__((unused)) = {};
        lb_pos = "src/std/ownership/lifecycle.lucb:26:9";
        lb_str lb_text __attribute__((unused)) = ({ lb_error _lb_fe15 __attribute__((unused)); lb_str _lb_v15 __attribute__((unused)) = {}; _lb_v15 = ({ lb_r_str _lb_r16 = ({ lb_span _lb_ds17 = ((lb_span){(void*)(lb_room.d), 96ULL}); lb_fmtbuf _lb_fb17 = { (char*)_lb_ds17.data, _lb_ds17.length, 0 }; (void)lb_fmtbuf_put(&_lb_fb17, "runtime: ", 9); (void)lb_fmtbuf_u64(&_lb_fb17, (uint64_t)(lb_ownership_live)); (void)lb_fmtbuf_put(&_lb_fb17, " objects alive when a task ended\n", 33); lb_r_str _lb_out17; if (_lb_fb17.used > _lb_fb17.cap) { _lb_out17 = ((lb_r_str){ .error = { .code = 208273409, .message = (lb_str){"memory.exhausted: the formatted text does not fit its buffer", 60} }, .failed = true }); } else { _lb_out17 = ((lb_r_str){ .value = lb_fmtbuf_finish(&_lb_fb17), .failed = false }); } _lb_out17; }); if (_lb_r16.failed) {
            _lb_fe15 = _lb_r16.error;
            goto _lb_fh15;
        } _lb_r16.value; }); goto _lb_cd15; _lb_fh15: { 
            lb_error lb_failure __attribute__((unused)) = _lb_fe15;
            {
                lb_pos = "src/std/ownership/lifecycle.lucb:27:13";
                _lb_v15 = ((lb_str){"runtime: objects alive when a task ended\n", 41});
                goto _lb_cd15;
            }
        } _lb_cd15: __attribute__((unused)); _lb_v15; });
        lb_pos = "src/std/ownership/lifecycle.lucb:28:9";
        lb_iface lb_e __attribute__((unused)) = lb_io_stderr();
        lb_pos = "src/std/ownership/lifecycle.lucb:29:9";
        (void)(((void)(({ lb_error _lb_fe18 __attribute__((unused)); size_t _lb_v18 __attribute__((unused)) = 0; _lb_v18 = ({ lb_r_usize _lb_r19 = ({ lb_iface _lb_if20 = lb_e; ((lb_vt_Writer*)_lb_if20.vtable)->write(_lb_if20.data, ((lb_cspan){(void*)(lb_text.data), lb_text.length})); }); if (_lb_r19.failed) {
            _lb_fe18 = _lb_r19.error;
            goto _lb_fh18;
        } _lb_r19.value; }); goto _lb_cd18; _lb_fh18: { 
        ...
        } _lb_cd18: __attribute__((unused)); _lb_v18; }))));
        lb_pos = "src/std/ownership/lifecycle.lucb:30:9";
        (void)(lb_core_exit(3LL));
    }
    lb_pos = "src/std/ownership/lifecycle.lucb:31:5";
    (void)(lb_ownership_15release_buffers());
    lb_pos = "src/std/ownership/lifecycle.lucb:32:5";
    lb_ownership_13runtime_depth = 0ULL;
    lb_pos = "src/std/ownership/lifecycle.lucb:33:5";
    lb_ownership_14thread_context = 0ULL;
}
__attribute__((weak)) void lb_interop_Packet_0g1_str_init(lb_interop_Packet_0g1_str* self, lb_str lb_value, void* lb_storage, lb_fn_0F1_void_0p_unit lb_dispose) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
...
void lb_ownership_15release_buffers(void) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/ownership/lifecycle.lucb:39:5";
    (void)(((void)(((((lb_ownership_13pending_count == 0ULL) && (lb_ownership_10root_count == 0ULL)) && (lb_ownership_11white_count == 0ULL))) ? 0 : (lb_trap("assert failed: " "pending_count == 0 and root_count == 0 and white_count == 0"), 0))));
    lb_pos = "src/std/ownership/lifecycle.lucb:40:5";
    if (!!((((size_t)((lb_ownership_pending.length))) > ((size_t)(0ULL))))) 
    {
        lb_pos = "src/std/ownership/lifecycle.lucb:41:9";
        { lb_span _lb_s25 = lb_ownership_pending; lb_release_call(lb_memory_heap, (lb_span){ (void*)(_lb_s25.data), lb_mul_u(_lb_s25.length, sizeof(lb_ownership_Pending), 64) }); }
    }
    lb_pos = "src/std/ownership/lifecycle.lucb:42:5";
    if (!!((((size_t)((lb_ownership_roots.length))) > ((size_t)(0ULL))))) 
    {
        lb_pos = "src/std/ownership/lifecycle.lucb:43:9";
        { lb_span _lb_s26 = lb_ownership_roots; lb_release_call(lb_memory_heap, (lb_span){ (void*)(_lb_s26.data), lb_mul_u(_lb_s26.length, sizeof(struct lb_ownership_Object*), 64) }); }
    }
    lb_pos = "src/std/ownership/lifecycle.lucb:44:5";
    if (!!((((size_t)((lb_ownership_whites.length))) > ((size_t)(0ULL))))) 
    {
        lb_pos = "src/std/ownership/lifecycle.lucb:45:9";
        { lb_span _lb_s27 = lb_ownership_whites; lb_release_call(lb_memory_heap, (lb_span){ (void*)(_lb_s27.data), lb_mul_u(_lb_s27.length, sizeof(struct lb_ownership_Object*), 64) }); }
    }
    lb_pos = "src/std/ownership/lifecycle.lucb:46:5";
    lb_span lb_empty_pending __attribute__((unused)) = {};
    lb_pos = "src/std/ownership/lifecycle.lucb:47:5";
    lb_span lb_empty_objects __attribute__((unused)) = {};
    lb_pos = "src/std/ownership/lifecycle.lucb:48:5";
    lb_ownership_pending = lb_empty_pending;
    lb_pos = "src/std/ownership/lifecycle.lucb:49:5";
    lb_ownership_roots = lb_empty_objects;
    lb_pos = "src/std/ownership/lifecycle.lucb:50:5";
    lb_ownership_whites = lb_empty_objects;
}
