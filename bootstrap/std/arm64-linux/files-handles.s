...
.L5_6:
.L5_7:
    adrp x21, lb_platform_macos
    add x21, x21, :lo12:lb_platform_macos
    mov w14, w20
    and w22, w14, #65535
...
.L13_34:
    ...
    b .L13_36
.L13_35:
    adrp x19, lb_platform_windows
    add x19, x19, :lo12:lb_platform_windows
    ldrb w19, [x19]
    cbnz w19, .L13_37
    b .L13_38
.L13_37:
...
.L13_55:
.L13_56:
    adrp x15, lb_files_17would_block_errno
    add x15, x15, :lo12:lb_files_17would_block_errno
    ldrsw x15, [x15]
    cmp w14, w15
    b.ne .L13_65
.L13_64:
...
.L14_3:
    ...
    b .L14_6
.L14_5:
    adrp x15, lb_files_14read_only_flag
    add x15, x15, :lo12:lb_files_14read_only_flag
    ldrsw x15, [x15]
    orr w15, w14, w15
    b .L14_7
.L14_6:
    ...
    b.ne .L14_9
.L14_8:
    adrp x15, lb_files_15read_write_flag
    add x15, x15, :lo12:lb_files_15read_write_flag
    ldrsw x15, [x15]
    orr w15, w14, w15
    b .L14_10
.L14_9:
    ...
    b.ne .L14_12
.L14_11:
    adrp x15, lb_files_10write_only
    add x15, x15, :lo12:lb_files_10write_only
    ldrsw x15, [x15]
...
.L14_14:
    ...
    add x19, x19, :lo12:lb_files_create
    ldrsw x19, [x19]
    adrp x20, lb_files_14exclusive_flag
    add x20, x20, :lo12:lb_files_14exclusive_flag
    ldrsw x20, [x20]
    orr w20, w19, w20
    movz x10, #5
    cmp w15, w10
