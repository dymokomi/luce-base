...
lb_files_temporary_0init:
    ...
    .size lb_files_temporary_0init, .-lb_files_temporary_0init
...
.L1_6:
    ...
    .size lb_files_TemporaryFile_create, .-lb_files_TemporaryFile_create
...
.L2_1:
    ...
    .size lb_files_TemporaryFile_path, .-lb_files_TemporaryFile_path
...
.L3_4:
    ...
    .size lb_files_TemporaryFile_read, .-lb_files_TemporaryFile_read
...
.L4_4:
    ...
    .size lb_files_TemporaryFile_write, .-lb_files_TemporaryFile_write
...
.L5_4:
    ...
    .size lb_files_TemporaryFile_seek, .-lb_files_TemporaryFile_seek
...
.L6_1:
    ...
    .size lb_files_TemporaryFile_sync, .-lb_files_TemporaryFile_sync
...
.L7_8:
    mov x0, x20
    bl lb_files_TemporaryFile_12release_name
    sub x14, x29, #72
    add x15, x14, #24
    mov x9, #0
    strb w9, [x15]
    ...
    .size lb_files_TemporaryFile_publish, .-lb_files_TemporaryFile_publish
...
.L8_3:
    ...
    .size lb_files_TemporaryFile_12release_name, .-lb_files_TemporaryFile_12release_name
...
.L9_6:
    ...
    .size lb_files_TemporaryFile_11remove_name, .-lb_files_TemporaryFile_11remove_name
...
.L10_1:
    mov x0, x19
    sub x8, x29, #192
    bl lb_files_TemporaryFile_11remove_name
    sub x15, x29, #192
    add x14, x15, #24
    ldrb w14, [x14]
    cbnz w14, .L10_8
...
.L10_10:
    ...
    .size lb_files_TemporaryFile_discard, .-lb_files_TemporaryFile_discard
...
lb_files_TemporaryFile_destroy:
    ...
    mov x0, x19
    sub x8, x29, #88
    bl lb_files_TemporaryFile_discard
    sub x15, x29, #88
    add x14, x15, #24
    ldrb w14, [x14]
    cbnz w14, .L11_4
...
.L11_2:
    ...
    .size lb_files_TemporaryFile_destroy, .-lb_files_TemporaryFile_destroy
...
.L12_11:
    ...
    .size lb_files_12write_atomic, .-lb_files_12write_atomic
...
.L13_6:
    ...
    mov x1, x15
    sub x8, x29, #464
    bl lb_files_TemporaryFile_create
    sub x15, x29, #464
    add x14, x15, #64
    ldrb w14, [x14]
    cbnz w14, .L13_11
...
.L13_13:
    ...
    .size lb_files_Replacement_prepare, .-lb_files_Replacement_prepare
...
.L14_3:
    ...
    mov x2, x12
    sub x8, x29, #200
    bl lb_files_TemporaryFile_publish
    sub x15, x29, #200
    add x14, x15, #24
    ldrb w14, [x14]
    cbnz w14, .L14_8
...
.L14_16:
    ...
    .size lb_files_Replacement_finish, .-lb_files_Replacement_finish
...
.L15_5:
    ...
    .size lb_files_Replacement_destroy, .-lb_files_Replacement_destroy
