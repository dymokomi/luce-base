...
lb_r_window_Size lb_window_Presentation_size(const lb_window_Presentation* self) {
    ...
    lb_pos = "src/std/window/presentation.lucb:14:9";
    lb_r_window_Size _lb_err8 = ((lb_r_window_Size){ .error = { .code = (int32_t)(lb_window_unsupported), .message = ((lb_str){"native windows are not implemented for this target", 50}) }, .failed = true });
    return _lb_err8;
    lb_trap("unreachable");
}
lb_r_bool lb_window_Presentation_visible(const lb_window_Presentation* self) {
    ...
    lb_pos = "src/std/window/presentation.lucb:26:9";
    lb_r_bool _lb_err10 = ((lb_r_bool){ .error = { .code = (int32_t)(lb_window_unsupported), .message = ((lb_str){"native windows are not implemented for this target", 50}) }, .failed = true });
    return _lb_err10;
    lb_trap("unreachable");
}
lb_r_void_0p lb_window_Presentation_10macos_view(const lb_window_Presentation* self) {
    ...
    struct lb_window_State* lb_state __attribute__((unused)) = (({ lb_r_window_State_0p _lb_r11 = lb_window_Presentation_checked(self); if (_lb_r11.failed) {
        return ((lb_r_void_0p){ .error = _lb_r11.error, .failed = true });
    } _lb_r11.value; }));
    {
    }
    lb_pos = "src/std/window/presentation.lucb:36:9";
    lb_r_void_0p _lb_err12 = ((lb_r_void_0p){ .error = { .code = (int32_t)(lb_window_unsupported), .message = ((lb_str){"this window has no macOS view", 29}) }, .failed = true });
    return _lb_err12;
    lb_trap("unreachable");
}
lb_r_void_0p lb_window_Presentation_14windows_handle(const lb_window_Presentation* self) {
    ...
    struct lb_window_State* lb_state __attribute__((unused)) = (({ lb_r_window_State_0p _lb_r13 = lb_window_Presentation_checked(self); if (_lb_r13.failed) {
        return ((lb_r_void_0p){ .error = _lb_r13.error, .failed = true });
    } _lb_r13.value; }));
    {
    }
    lb_pos = "src/std/window/presentation.lucb:43:9";
    lb_r_void_0p _lb_err14 = ((lb_r_void_0p){ .error = { .code = (int32_t)(lb_window_unsupported), .message = ((lb_str){"this window has no Windows handle", 33}) }, .failed = true });
    return _lb_err14;
    lb_trap("unreachable");
}
void lb_window_Presentation_destroy(lb_window_Presentation* self) {
    ...
    struct lb_window_State* lb_state __attribute__((unused)) = ({ struct lb_window_State* _lb_o15 = self->state; if (_lb_o15 == ((void*)0)) {
        return;
    } _lb_o15; });
    lb_pos = "src/std/window/presentation.lucb:50:9";
    (void)(({ lb_error _lb_fe16 __attribute__((unused)); int32_t _lb_v16 __attribute__((unused)) = 0; (void)(({ lb_r_unit _lb_r17 = lb_window_12check_thread(); if (_lb_r17.failed) {
        _lb_fe16 = _lb_r17.error;
        goto _lb_fh16;
    } (void)0; })); goto _lb_cd16; _lb_fh16: { 
    ...
    } _lb_cd16: __attribute__((unused)); (void)0; }));
    lb_pos = "src/std/window/presentation.lucb:50:9";
    self->state = ((void*)0);
...
lb_r_window_State_0p lb_window_Presentation_checked(const lb_window_Presentation* self) {
    ...
    (void)((({ lb_r_unit _lb_r22 = lb_window_12check_thread(); if (_lb_r22.failed) {
        return ((lb_r_window_State_0p){ .error = _lb_r22.error, .failed = true });
    } (void)0; })));
    lb_pos = "src/std/window/presentation.lucb:60:9";
    struct lb_window_State* lb_state __attribute__((unused)) = ({ struct lb_window_State* _lb_o23 = self->state; if (_lb_o23 == ((void*)0)) {
        lb_r_window_State_0p _lb_err24 = ((lb_r_window_State_0p){ .error = { .code = (int32_t)(lb_window_closed), .message = ((lb_str){"the presentation lease is closed", 32}) }, .failed = true });
        return _lb_err24;
    } _lb_o23; });
    ...
    if (!!((lb_state)->destroyed)) 
    {
        ...
        lb_r_window_State_0p _lb_err25 = ((lb_r_window_State_0p){ .error = { .code = (int32_t)(lb_window_closed), .message = ((lb_str){"the presentation window is closed", 33}) }, .failed = true });
        return _lb_err25;
    }
    lb_pos = "src/std/window/presentation.lucb:63:9";
    struct lb_window_State* _lb_ret26 = lb_state;
    return ((lb_r_window_State_0p){ .value = _lb_ret26, .failed = false });
    lb_trap("unreachable");
}
