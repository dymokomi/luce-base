...
#endif
void lb_interop_9drop_text(struct lb_ownership_Object* lb_object);
void lb_interop_10trace_text(struct lb_ownership_Object* lb_object, lb_fn_0F2_ownership_Object_0p_void_0p_unit lb_visit, void* lb_context);
...
uint32_t lb_interop_8no_error = ((uint32_t)(208273408ULL));
...
void lb_interop_9drop_text(struct lb_ownership_Object* lb_object) {
    ...
    lb_pos = "src/std/interop/result.lucb:63:5";
    (void)(((void)(lb_object)));
}
void lb_interop_10trace_text(struct lb_ownership_Object* lb_object, lb_fn_0F2_ownership_Object_0p_void_0p_unit lb_visit, void* lb_context) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/interop/result.lucb:66:5";
    (void)(((void)(lb_object)));
}
__attribute__((weak)) lb_interop_Transfer_0g1_str lb_interop_Transfer_0g1_str_plain(void) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
...
lb_r_interop_Owned_0g1_str lb_interop_9copy_text(lb_str lb_value) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/interop/result.lucb:73:5";
    size_t lb_size __attribute__((unused)) = ({ lb_o_usize _lb_o7 = ({ size_t _lb_sq8 __attribute__((unused)) = ((size_t)sizeof(lb_ownership_Object)); size_t _lb_sq9 __attribute__((unused)) = (lb_value.length); ({ uint64_t _lb_qo10; lb_o_usize _lb_qr10; _lb_qr10.present = lb_qadd_u((uint64_t)(_lb_sq8), (uint64_t)(_lb_sq9), 64, &_lb_qo10); _lb_qr10.value = (size_t)(_lb_qo10); _lb_qr10; }); }); if (!_lb_o7.present) {
        lb_r_interop_Owned_0g1_str _lb_err11 = ((lb_r_interop_Owned_0g1_str){ .error = { .code = (int32_t)(lb_memory_exhausted), .message = ((lb_str){"owned text is too large", 23}) }, .failed = true });
        return _lb_err11;
    } _lb_o7.value; });
    lb_pos = "src/std/interop/result.lucb:74:5";
    struct lb_ownership_Object* lb_owner __attribute__((unused)) = (({ lb_r_ownership_Object_0p _lb_r12 = lb_ownership_reserve(&(lb_interop_9text_info), lb_size, ((lb_iface){ ((void*)0), ((void*)0) })); if (_lb_r12.failed) {
        return ((lb_r_interop_Owned_0g1_str){ .error = _lb_r12.error, .failed = true });
    } _lb_r12.value; }));
    lb_pos = "src/std/interop/result.lucb:75:5";
    lb_span lb_bytes __attribute__((unused)) = ((lb_span){(void*)(({ uint8_t* _lb_sq13 __attribute__((unused)) = ((uint8_t*)(lb_owner)); size_t _lb_sq14 __attribute__((unused)) = ((size_t)sizeof(lb_ownership_Object)); (_lb_sq13 + (ptrdiff_t)(_lb_sq14)); })), (size_t)((lb_value.length))});
    lb_pos = "src/std/interop/result.lucb:76:5";
    (void)(lb_memory_copy_0g1_u8(lb_bytes, ((lb_cspan){(void*)(lb_value.data), lb_value.length}), (lb_value.length)));
    lb_pos = "src/std/interop/result.lucb:77:5";
    lb_interop_Owned_0g1_str _lb_ret15 = ((lb_interop_Owned_0g1_str){.value = ({ lb_span _lb_sc16 = lb_bytes; const char* _lb_sb16 = (const char*)_lb_sc16.data; size_t _lb_sl16 = _lb_sc16.length; (lb_str){ _lb_sb16, _lb_sl16 }; }), .owner = lb_owner});
    return ((lb_r_interop_Owned_0g1_str){ .value = _lb_ret15, .failed = false });
    lb_trap("unreachable");
}
__attribute__((weak)) void lb_interop_Packet_0g1_str_init(lb_interop_Packet_0g1_str* self, lb_str lb_value, void* lb_storage, lb_fn_0F1_void_0p_unit lb_dispose) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
...
__attribute__((weak)) void lb_memory_copy_0g1_u8(lb_span lb_target, lb_cspan lb_source, size_t lb_count) {
    ...
    if (!!((((size_t)(lb_count)) > ((size_t)(0ULL))))) 
    {
        ...
        (void)(((void)(({ void* _lb_sq21 __attribute__((unused)) = ((uint8_t*)(lb_target.data)); const void* _lb_sq22 __attribute__((unused)) = ((const uint8_t*)(lb_source.data)); size_t _lb_sq23 __attribute__((unused)) = ({ size_t _lb_sq24 __attribute__((unused)) = lb_count; size_t _lb_sq25 __attribute__((unused)) = ((size_t)sizeof(uint8_t)); (size_t)(lb_mul_u((uint64_t)(_lb_sq24), (uint64_t)(_lb_sq25), 64)); }); ({ void* _lb_fr = lb_x_memory_memcpy(_lb_sq21, _lb_sq22, _lb_sq23); if (!_lb_fr) lb_trap("null_foreign"); _lb_fr; }); }))));
    }
}
__attribute__((weak)) lb_interop_Owned_0g1_str lb_interop_Owned_0g1_str_clone(const lb_interop_Owned_0g1_str* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/interop/result.lucb:8:9";
    struct lb_ownership_Object* _lb_o26 = self->owner;
    if (_lb_o26 != ((void*)0)) {
        struct lb_ownership_Object* lb_owner __attribute__((unused)) = _lb_o26;
        {
            lb_pos = "src/std/interop/result.lucb:9:13";
            (void)(((void)(lb_ownership_retain(lb_owner))));
        }
    }
    lb_pos = "src/std/interop/result.lucb:10:9";
    lb_interop_Owned_0g1_str _lb_ret27 = (*self);
    return _lb_ret27;
    lb_trap("unreachable");
}
__attribute__((weak)) void lb_interop_Owned_0g1_str_release(const lb_interop_Owned_0g1_str* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/interop/result.lucb:13:9";
    struct lb_ownership_Object* _lb_o28 = self->owner;
    if (_lb_o28 != ((void*)0)) {
        struct lb_ownership_Object* lb_owner __attribute__((unused)) = _lb_o28;
        {
            lb_pos = "src/std/interop/result.lucb:14:13";
...
__attribute__((weak)) void lb_interop_Owned_0g1_str_trace(const lb_interop_Owned_0g1_str* self, lb_fn_0F2_ownership_Object_0p_void_0p_unit lb_visit, void* lb_context) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/interop/result.lucb:17:9";
    struct lb_ownership_Object* _lb_o29 = self->owner;
    if (_lb_o29 != ((void*)0)) {
        struct lb_ownership_Object* lb_owner __attribute__((unused)) = _lb_o29;
        {
            lb_pos = "src/std/interop/result.lucb:18:13";
            (void)(lb_ownership_12check_thread(lb_owner));
            lb_pos = "src/std/interop/result.lucb:19:13";
