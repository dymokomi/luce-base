...
lb_gpu_frame_0init:
    ...
    mov x9, #0
    strb w9, [x14]
    adrp x14, lb_gpu_16frame_state_type
    ...
    add x15, x19, #16
    str x14, [x15]
    adrp x14, :got:lb_gpu_Frame_trace
    ldr x14, [x14, :got_lo12:lb_gpu_Frame_trace]
    add x15, x19, #24
    str x14, [x15]
    add x14, x19, #32
    movz x9, #1
    ...
    .size lb_gpu_frame_0init, .-lb_gpu_frame_0init
...
.L1_7:
    ...
    .size lb_gpu_FrameState_check, .-lb_gpu_FrameState_check
...
.L2_3:
    ...
    .size lb_gpu_FrameState_close, .-lb_gpu_FrameState_close
...
.L3_15:
    ...
    .size lb_gpu_Frame_init, .-lb_gpu_Frame_init
...
.L4_2:
    sub x19, x29, #80
    add x14, x19, #8
    adrp x15, lb_gpu_14frame_finished
    add x15, x15, :lo12:lb_gpu_14frame_finished
    ldr w15, [x15]
    str w15, [x14]
    adrp x15, .Ltext_3
...
.L4_5:
    ...
    .size lb_gpu_Frame_11state_value, .-lb_gpu_Frame_11state_value
...
.L5_7:
    ...
    .size lb_gpu_Frame_size, .-lb_gpu_Frame_size
...
.L6_9:
    ...
    ldr x3, [x9, #8]
    sub x8, x29, #464
    bl lb_interop_View_0g1_gpu_RenderTarget_make
    sub x15, x29, #464
    add x14, x15, #32
    ldrb w14, [x14]
    cbnz w14, .L6_12
...
.L6_14:
    ...
    .size lb_gpu_Frame_target, .-lb_gpu_Frame_target
...
.L7_11:
    sub x20, x29, #112
    add x14, x20, #8
    adrp x15, lb_gpu_unavailable
    add x15, x15, :lo12:lb_gpu_unavailable
    ldr w15, [x15]
    str w15, [x14]
    adrp x15, .Ltext_16
...
.L7_23:
    ...
    .size lb_gpu_Frame_present, .-lb_gpu_Frame_present
...
.L8_7:
    ...
    .size lb_gpu_Frame_close, .-lb_gpu_Frame_close
...
.L9_7:
    ...
    .size lb_gpu_Frame_trace, .-lb_gpu_Frame_trace
...
.L10_4:
    ...
    .size lb_gpu_RenderTarget_size, .-lb_gpu_RenderTarget_size
...
.L11_13:
    ...
    .size lb_gpu_RenderTarget_region, .-lb_gpu_RenderTarget_region
...
.L12_13:
    ...
    .size lb_gpu_RenderTarget_clipped, .-lb_gpu_RenderTarget_clipped
...
.L13_4:
    ...
    .size lb_gpu_RenderTarget_triangles, .-lb_gpu_RenderTarget_triangles
...
.L14_7:
    ...
    .size lb_gpu_RenderTarget_mask, .-lb_gpu_RenderTarget_mask
...
.L15_4:
    ...
    .size lb_gpu_11frame_scale, .-lb_gpu_11frame_scale
...
.L16_3:
    ...
    .size lb_gpu_12check_region, .-lb_gpu_12check_region
...
.L17_7:
    ...
    .size lb_gpu_14intersect_clip, .-lb_gpu_14intersect_clip
...
.L18_3:
    ...
    mov x1, x9
    sub x8, x29, #304
    bl lb_interop_Reservation_0g1_gpu_FrameState_init
    sub x22, x29, #304
    sub x25, x29, #344
    add x23, x25, #8
    mov x10, x22
...
.L18_5:
    ...
    ldr x2, [x9]
    ldr x3, [x9, #8]
    bl lb_interop_Reservation_0g1_gpu_FrameState_publish
    sub x16, x29, #368
    str x0, [x16, #0]
    sub x14, x29, #368
    sub x21, x29, #120
...
.L18_11:
    ...
    .size lb_interop_Reference_0g1_gpu_FrameState_adopt, .-lb_interop_Reference_0g1_gpu_FrameState_adopt
...
.L19_7:
    ...
    .size lb_interop_Reference_0g1_gpu_FrameState_lease, .-lb_interop_Reference_0g1_gpu_FrameState_lease
...
lb_interop_Reference_0g1_gpu_FrameState_release:
    ...
    .size lb_interop_Reference_0g1_gpu_FrameState_release, .-lb_interop_Reference_0g1_gpu_FrameState_release
...
.L22_1:
    ...
    mov x9, #0
    str x9, [x14]
    adrp x14, :got:lb_interop_ViewOwner_0g1_gpu_RenderTarget_9drop_view
    ldr x14, [x14, :got_lo12:lb_interop_ViewOwner_0g1_gpu_RenderTarget_9drop_view]
    add x15, x21, #32
    str x14, [x15]
    adrp x14, :got:lb_interop_ViewOwner_0g1_gpu_RenderTarget_10trace_view
    ldr x14, [x14, :got_lo12:lb_interop_ViewOwner_0g1_gpu_RenderTarget_10trace_view]
    add x15, x21, #40
    str x14, [x15]
    add x14, x21, #48
    mov x9, #0
...
.L22_7:
    ...
    .size lb_interop_View_0g1_gpu_RenderTarget_make, .-lb_interop_View_0g1_gpu_RenderTarget_make
...
.L23_3:
    ldr x14, [x19]
    mov x0, x14
    bl lb_interop_11close_owner_0g1_gpu_FrameState
    ldr x19, [sp, #24]
    mov sp, x29
    ldp x29, x30, [sp], #16
    ret

    .size lb_interop_Reference_0g1_gpu_FrameState_close, .-lb_interop_Reference_0g1_gpu_FrameState_close
...
lb_interop_Reference_0g1_gpu_FrameState_trace:
    ...
    .size lb_interop_Reference_0g1_gpu_FrameState_trace, .-lb_interop_Reference_0g1_gpu_FrameState_trace
...
.L25_3:
    ...
    movz x9, #200
    str x9, [x14]
    adrp x14, :got:lb_interop_Owner_0g1_gpu_FrameState_12finish_owner
    ldr x14, [x14, :got_lo12:lb_interop_Owner_0g1_gpu_FrameState_12finish_owner]
    add x15, x22, #24
    str x14, [x15]
    adrp x14, :got:lb_interop_Owner_0g1_gpu_FrameState_10drop_owner
    ldr x14, [x14, :got_lo12:lb_interop_Owner_0g1_gpu_FrameState_10drop_owner]
    add x15, x22, #32
    str x14, [x15]
    adrp x14, :got:lb_interop_Owner_0g1_gpu_FrameState_11trace_owner
    ldr x14, [x14, :got_lo12:lb_interop_Owner_0g1_gpu_FrameState_11trace_owner]
    add x15, x22, #40
    str x14, [x15]
    add x14, x22, #48
    mov x9, #0
...
.L25_7:
    ...
    .size lb_interop_Reservation_0g1_gpu_FrameState_init, .-lb_interop_Reservation_0g1_gpu_FrameState_init
...
.L26_7:
    ...
    .size lb_interop_Reservation_0g1_gpu_FrameState_publish, .-lb_interop_Reservation_0g1_gpu_FrameState_publish
...
.L28_1:
    ...
    .size lb_interop_Owner_0g1_gpu_FrameState_7is_open, .-lb_interop_Owner_0g1_gpu_FrameState_7is_open
...
1:
    ...
    .size lb_interop_Owner_0g1_gpu_FrameState_enter, .-lb_interop_Owner_0g1_gpu_FrameState_enter
...
.L30_4:
    mov x0, x19
    bl lb_interop_13dispose_owner_0g1_gpu_FrameState
    b .L30_6
.L30_5:
.L30_6:
    mov x0, x19
    ...
    .size lb_interop_Owner_0g1_gpu_FrameState_leave, .-lb_interop_Owner_0g1_gpu_FrameState_leave
...
lb_interop_ViewOwner_0g1_gpu_RenderTarget_9drop_view:
    ...
    .size lb_interop_ViewOwner_0g1_gpu_RenderTarget_9drop_view, .-lb_interop_ViewOwner_0g1_gpu_RenderTarget_9drop_view
...
lb_interop_ViewOwner_0g1_gpu_RenderTarget_10trace_view:
    ...
    .size lb_interop_ViewOwner_0g1_gpu_RenderTarget_10trace_view, .-lb_interop_ViewOwner_0g1_gpu_RenderTarget_10trace_view
...
lb_interop_View_0g1_gpu_RenderTarget_init:
    ...
    .size lb_interop_View_0g1_gpu_RenderTarget_init, .-lb_interop_View_0g1_gpu_RenderTarget_init
...
.L34_7:
    ...
    .size lb_interop_11close_owner_0g1_gpu_FrameState, .-lb_interop_11close_owner_0g1_gpu_FrameState
...
lb_interop_Owner_0g1_gpu_FrameState_12finish_owner:
    ...
    .size lb_interop_Owner_0g1_gpu_FrameState_12finish_owner, .-lb_interop_Owner_0g1_gpu_FrameState_12finish_owner
...
.L36_3:
    ...
    .size lb_interop_Owner_0g1_gpu_FrameState_10drop_owner, .-lb_interop_Owner_0g1_gpu_FrameState_10drop_owner
...
.L37_7:
    ...
    .size lb_interop_Owner_0g1_gpu_FrameState_11trace_owner, .-lb_interop_Owner_0g1_gpu_FrameState_11trace_owner
...
lb_interop_Reference_0g1_gpu_FrameState_init:
    ...
    .size lb_interop_Reference_0g1_gpu_FrameState_init, .-lb_interop_Reference_0g1_gpu_FrameState_init
...
.L39_7:
    ...
    .size lb_interop_13dispose_owner_0g1_gpu_FrameState, .-lb_interop_13dispose_owner_0g1_gpu_FrameState
