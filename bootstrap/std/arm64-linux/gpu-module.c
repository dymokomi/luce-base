...
void lb_gpu_14require_thread(void) {
    ...
    (void)(({ lb_error _lb_fe9 __attribute__((unused)); int32_t _lb_v9 __attribute__((unused)) = 0; (void)(({ lb_r_unit _lb_r10 = lb_gpu_12check_thread(); if (_lb_r10.failed) {
        _lb_fe9 = _lb_r10.error;
        goto _lb_fh9;
    } (void)0; })); goto _lb_cd9; _lb_fh9: { 
        lb_error lb_failure __attribute__((unused)) = _lb_fe9;
        {
...
lb_r_unit lb_gpu_11check_color(lb_gpu_Color lb_color) {
    ...
    if (!!((!(((((((((double)(lb_color.red)) >= ((double)(0x0p+0))) && (((double)(lb_color.red)) <= ((double)(0x1.0000000000000p+0)))) && (((double)(lb_color.green)) >= ((double)(0x0p+0)))) && (((double)(lb_color.green)) <= ((double)(0x1.0000000000000p+0)))) && (((double)(lb_color.blue)) >= ((double)(0x0p+0)))) && (((double)(lb_color.blue)) <= ((double)(0x1.0000000000000p+0)))))))) 
    {
        ...
        lb_r_unit _lb_err11 = ((lb_r_unit){ .error = { .code = (int32_t)(lb_gpu_13invalid_color), .message = ((lb_str){"GPU clear colors must be finite linear sRGB values in 0..1", 58}) }, .failed = true });
        return _lb_err11;
    }
    return ((lb_r_unit){ .failed = false });
}
