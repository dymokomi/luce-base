...
lb_math_expm1:
    ...
    ldr x15, [x15]
    adrp x19, lb_math_13exponent_mask
    add x19, x19, :lo12:lb_math_13exponent_mask
    ldr x19, [x19]
    orr x15, x15, x19
    cmp x14, x15
    b.ne .L16_2
...
lb_math_9next_down:
    ...
    and x14, x14, x15
    fmov x15, d26
    adrp x19, lb_math_9sign_mask
    add x19, x19, :lo12:lb_math_9sign_mask
    ldr x19, [x19]
    and x15, x15, x19
    orr x14, x14, x15
    fmov d25, x14
...
lb_math_min:
    ...
    ldr x15, [x15]
    and x19, x14, x15
    adrp x20, lb_math_13exponent_mask
    add x20, x20, :lo12:lb_math_13exponent_mask
    ldr x20, [x20]
    cmp x19, x20
    cset w19, hi
    and w19, w19, #255
