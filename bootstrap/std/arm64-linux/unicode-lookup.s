...
lb_unicode_lookup_0init:
    ...
    .size lb_unicode_lookup_0init, .-lb_unicode_lookup_0init
...
.L1_4:
    ...
    .size lb_unicode_10table_word, .-lb_unicode_10table_word
...
.L2_5:
    ...
    .size lb_unicode_11range_value, .-lb_unicode_11range_value
...
.L3_3:
    ...
    b .L3_5
.L3_4:
    adrp x15, lb_unicode_15mapping_scalars
    add x15, x15, :lo12:lb_unicode_15mapping_scalars
    ldr x20, [x19]
    mov x9, x14
    mov x10, x20
    adds x9, x9, x10
...
.L3_6:
    ...
    .size lb_unicode_Mapping_at, .-lb_unicode_Mapping_at
...
1:
    ...
    .size lb_unicode_mapped, .-lb_unicode_mapped
...
.L5_1:
    ...
    .size lb_unicode_16identity_mapping, .-lb_unicode_16identity_mapping
