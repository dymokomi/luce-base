...
typedef struct lb_t_0T2_usize_usize { size_t a0; size_t a1; } lb_t_0T2_usize_usize;
...
bool lb_strings_11starts_with(lb_str lb_text, lb_str lb_prefix) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/strings/search.lucb:2:5";
    if (!!((((size_t)((lb_prefix.length))) > ((size_t)((lb_text.length)))))) 
    {
        lb_pos = "src/std/strings/search.lucb:3:9";
        bool _lb_ret7 = false;
        return _lb_ret7;
    }
    lb_pos = "src/std/strings/search.lucb:4:5";
    bool _lb_ret8 = ({ lb_str _lb_sa9 = ({ lb_span _lb_sc10 = ({ lb_span _lb_sv11 = ((lb_cspan){(void*)(lb_text.data), lb_text.length}); size_t _lb_sn11 = _lb_sv11.length; uint8_t* _lb_sd11 = (uint8_t*)_lb_sv11.data; size_t _lb_ss11 = 0; size_t _lb_se11 = (size_t)((lb_prefix.length)); lb_check_index(_lb_ss11, _lb_sn11 + 1); lb_check_index(_lb_se11, _lb_sn11 + 1); if (_lb_ss11 > _lb_se11) lb_trap("index out of bounds"); (lb_cspan){ (void*)(_lb_sd11 + _lb_ss11), _lb_se11 - _lb_ss11 }; }); const char* _lb_sb10 = (const char*)_lb_sc10.data; size_t _lb_sl10 = _lb_sc10.length; (lb_str){ _lb_sb10, _lb_sl10 }; }); lb_str _lb_sb9 = lb_prefix; (_lb_sa9.length == _lb_sb9.length && (_lb_sa9.length == 0 || memcmp(_lb_sa9.data, _lb_sb9.data, _lb_sa9.length) == 0)); });
    return _lb_ret8;
    lb_trap("unreachable");
}
bool lb_strings_9ends_with(lb_str lb_text, lb_str lb_suffix) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/strings/search.lucb:7:5";
    if (!!((((size_t)((lb_suffix.length))) > ((size_t)((lb_text.length)))))) 
    {
        lb_pos = "src/std/strings/search.lucb:8:9";
        bool _lb_ret12 = false;
        return _lb_ret12;
    }
    lb_pos = "src/std/strings/search.lucb:9:5";
    bool _lb_ret13 = ({ lb_str _lb_sa14 = ({ lb_span _lb_sc15 = ({ lb_span _lb_sv16 = ((lb_cspan){(void*)(lb_text.data), lb_text.length}); size_t _lb_sn16 = _lb_sv16.length; uint8_t* _lb_sd16 = (uint8_t*)_lb_sv16.data; size_t _lb_ss16 = (size_t)((size_t)(lb_sub_u((uint64_t)((lb_text.length)), (uint64_t)((lb_suffix.length)), 64))); size_t _lb_se16 = _lb_sn16; lb_check_index(_lb_ss16, _lb_sn16 + 1); lb_check_index(_lb_se16, _lb_sn16 + 1); if (_lb_ss16 > _lb_se16) lb_trap("index out of bounds"); (lb_cspan){ (void*)(_lb_sd16 + _lb_ss16), _lb_se16 - _lb_ss16 }; }); const char* _lb_sb15 = (const char*)_lb_sc15.data; size_t _lb_sl15 = _lb_sc15.length; (lb_str){ _lb_sb15, _lb_sl15 }; }); lb_str _lb_sb14 = lb_suffix; (_lb_sa14.length == _lb_sb14.length && (_lb_sa14.length == 0 || memcmp(_lb_sa14.data, _lb_sb14.data, _lb_sa14.length) == 0)); });
    return _lb_ret13;
    lb_trap("unreachable");
}
lb_o_usize lb_strings_find(lb_str lb_text, lb_str lb_needle) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/strings/search.lucb:15:5";
    lb_o_usize _lb_ret17 = lb_strings_12search_bytes(((lb_cspan){(void*)(lb_text.data), lb_text.length}), ((lb_cspan){(void*)(lb_needle.data), lb_needle.length}), false);
    return _lb_ret17;
    lb_trap("unreachable");
}
lb_o_usize lb_strings_9find_from(lb_str lb_text, lb_str lb_needle, size_t lb_start) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/strings/search.lucb:20:5";
    if (!!((((size_t)(lb_start)) > ((size_t)((lb_text.length)))))) 
    {
        lb_pos = "src/std/strings/search.lucb:21:9";
        lb_o_usize _lb_ret18 = ((lb_o_usize){ .present = false });
        return _lb_ret18;
    }
    lb_pos = "src/std/strings/search.lucb:22:5";
    size_t lb_offset __attribute__((unused)) = ({ lb_o_usize _lb_o19 = lb_strings_12search_bytes(({ lb_span _lb_sv20 = ((lb_cspan){(void*)(lb_text.data), lb_text.length}); size_t _lb_sn20 = _lb_sv20.length; uint8_t* _lb_sd20 = (uint8_t*)_lb_sv20.data; size_t _lb_ss20 = (size_t)(lb_start); size_t _lb_se20 = _lb_sn20; lb_check_index(_lb_ss20, _lb_sn20 + 1); lb_check_index(_lb_se20, _lb_sn20 + 1); if (_lb_ss20 > _lb_se20) lb_trap("index out of bounds"); (lb_cspan){ (void*)(_lb_sd20 + _lb_ss20), _lb_se20 - _lb_ss20 }; }), ((lb_cspan){(void*)(lb_needle.data), lb_needle.length}), false); if (!_lb_o19.present) {
        lb_o_usize _lb_ret21 = ((lb_o_usize){ .present = false });
        return _lb_ret21;
    } _lb_o19.value; });
    lb_pos = "src/std/strings/search.lucb:23:5";
    lb_o_usize _lb_ret22 = ((lb_o_usize){ .value = (size_t)(lb_add_u((uint64_t)(lb_start), (uint64_t)(lb_offset), 64)), .present = true });
    return _lb_ret22;
    lb_trap("unreachable");
}
lb_o_usize lb_strings_9find_last(lb_str lb_text, lb_str lb_needle) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/strings/search.lucb:28:5";
    size_t lb_offset __attribute__((unused)) = ({ lb_o_usize _lb_o23 = lb_strings_12search_bytes(((lb_cspan){(void*)(lb_text.data), lb_text.length}), ((lb_cspan){(void*)(lb_needle.data), lb_needle.length}), true); if (!_lb_o23.present) {
        lb_o_usize _lb_ret24 = ((lb_o_usize){ .present = false });
        return _lb_ret24;
    } _lb_o23.value; });
    lb_pos = "src/std/strings/search.lucb:29:5";
    lb_o_usize _lb_ret25 = ((lb_o_usize){ .value = (size_t)(lb_sub_u((uint64_t)((size_t)(lb_sub_u((uint64_t)((lb_text.length)), (uint64_t)((lb_needle.length)), 64))), (uint64_t)(lb_offset), 64)), .present = true });
    return _lb_ret25;
    lb_trap("unreachable");
}
lb_o_usize lb_strings_last(lb_str lb_text, uint8_t lb_byte) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/strings/search.lucb:33:5";
    size_t lb_i __attribute__((unused)) = (lb_text.length);
    lb_pos = "src/std/strings/search.lucb:34:5";
    for (;;) {
        lb_pos = "src/std/strings/search.lucb:34:5";
        if (!((((size_t)(lb_i)) > ((size_t)(0ULL))))) break;
        {
            lb_pos = "src/std/strings/search.lucb:35:9";
            { size_t* lb__cell26 = &(lb_i);
            (*(lb__cell26)) = (size_t)(lb_sub_u((uint64_t)((*(lb__cell26))), (uint64_t)(1ULL), 64)); }
            lb_pos = "src/std/strings/search.lucb:36:9";
            if (!!(((*({ lb_cspan _lb_ix27 = ((lb_cspan){(void*)(lb_text.data), lb_text.length}); &((uint8_t*)_lb_ix27.data)[lb_at((uint64_t)(lb_i), _lb_ix27.length)]; })) == lb_byte))) 
            {
                lb_pos = "src/std/strings/search.lucb:37:13";
                lb_o_usize _lb_ret28 = ((lb_o_usize){ .value = lb_i, .present = true });
                return _lb_ret28;
            }
        }
    }
    lb_pos = "src/std/strings/search.lucb:38:5";
    lb_o_usize _lb_ret29 = ((lb_o_usize){ .present = false });
    return _lb_ret29;
    lb_trap("unreachable");
}
bool lb_strings_contains(lb_str lb_text, lb_str lb_needle) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/strings/search.lucb:41:5";
    bool _lb_ret30 = ({ lb_o_usize _lb_sq31 __attribute__((unused)) = lb_strings_find(lb_text, lb_needle); lb_o_usize _lb_sq32 __attribute__((unused)) = ((lb_o_usize){ .present = false }); (!({ lb_o_usize _lb_on33 = _lb_sq31; !_lb_on33.present; })); });
    return _lb_ret30;
    lb_trap("unreachable");
}
__attribute__((weak)) void lb_interop_Packet_0g1_str_init(lb_interop_Packet_0g1_str* self, lb_str lb_value, void* lb_storage, lb_fn_0F1_void_0p_unit lb_dispose) {
