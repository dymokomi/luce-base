...
void* lb_c_stdin(void);
void* lb_c_stdout(void);
void* lb_c_stderr(void);
...
int32_t lb_c_interrupted = ((int32_t)4ULL);
...
int32_t lb_c_errno(void) {
    ...
    lb_pos = "src/std/c.lucb:16:5";
    int32_t _lb_ret7 = (*(({ int32_t* _lb_fr = lb_c_c_11linux_errno(); if (!_lb_fr) lb_trap("null_foreign"); _lb_fr; })));
    return _lb_ret7;
    lb_trap("unreachable");
}
void lb_c_9set_errno(int32_t lb_value) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    {
        lb_pos = "src/std/c.lucb:26:9";
        (*(({ int32_t* _lb_fr = lb_c_c_11linux_errno(); if (!_lb_fr) lb_trap("null_foreign"); _lb_fr; }))) = lb_value;
    }
}
void* lb_c_stdin(void) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/c.lucb:34:5";
    (void)(lb_trap_text(((lb_str){"supplied by the backend", 23})));
    lb_trap("unreachable");
}
void* lb_c_stdout(void) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/c.lucb:37:5";
    (void)(lb_trap_text(((lb_str){"supplied by the backend", 23})));
    lb_trap("unreachable");
}
void* lb_c_stderr(void) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/c.lucb:40:5";
    (void)(lb_trap_text(((lb_str){"supplied by the backend", 23})));
    lb_trap("unreachable");
}
__attribute__((weak)) void lb_interop_Packet_0g1_str_init(lb_interop_Packet_0g1_str* self, lb_str lb_value, void* lb_storage, lb_fn_0F1_void_0p_unit lb_dispose) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/c.lucb:796:1";
    self->value = lb_value;
    lb_pos = "src/std/c.lucb:797:1";
    self->storage = lb_storage;
    lb_pos = "src/std/c.lucb:798:1";
    self->dispose = lb_dispose;
}
__attribute__((weak)) void lb_interop_Packet_0g1_str_release(const lb_interop_Packet_0g1_str* self) {
    const char* lb_saved_pos __attribute__((cleanup(lb_restore_pos), unused)) = lb_pos;
    lb_pos = "src/std/c.lucb:801:1";
    void* _lb_o8 = self->storage;
    if (_lb_o8 != ((void*)0)) {
        void* lb_storage __attribute__((unused)) = _lb_o8;
        {
            lb_pos = "src/std/c.lucb:802:1";
            (void)(((({ lb_fn_0F1_void_0p_unit _lb_o9 = self->dispose; if (_lb_o9 == ((void*)0)) {
