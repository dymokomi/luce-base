...
The target of the build, as constants (§19.5): generated by the compiler from `--target` (`Target.module_text`); this file is the placeholder the checker replaces when it reads the library. `os` re-exports these for programs; the standard library branches on them directly.
...
- `let wasm32: bool = platform.wasm32`
