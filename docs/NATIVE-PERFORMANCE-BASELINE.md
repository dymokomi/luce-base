# Native Base performance against C: original baseline

Historical report before the loop optimizations. See the
[current measurements](NATIVE-PERFORMANCE.md) for the completed follow-up.
