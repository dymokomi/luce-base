...
| 05: release multiplication | Fixed for invalid span metadata | The runtime-boundary commit containing this document checks byte multiplication before release in native, C and Seed emission. An impossible descriptor traps with integer overflow before reaching a probe allocator in all six Base modes. After 01, valid allocations cannot produce this overflow. |
