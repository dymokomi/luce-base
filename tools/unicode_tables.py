...
OUTPUT = ROOT / "src/std/unicode/tables.lucb"
...
def generate():
    ...
    return ("# Generated by tools/unicode_tables.py; edit the generator, not these tables.\n"
            "# Unicode 17.0.0 data: Copyright Unicode, Inc. Licensed under Unicode-3.0.\n"
            "# The full permission notice is in data/unicode/17.0.0/LICENSE.txt.\n\n" + "\n".join(tables))
